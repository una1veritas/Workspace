...
public class TimetableMainTest {
	public static void main(String args[]) throws Exception{
		...
		pass = "nishimura",file = "../t_valuate3-8.txt";
		...
		TimeTableSchedulingTest timetable = new TimeTableSchedulingTest(host,db,user,pass,file,readType);
		...
		for(int i = 1; i<=count; i++){
			...
			System.out.println(timetable.valuateTimeTableSQLFile());
			...
			case 2:
				timetable.local_search1();break;
			case 3:
				timetable.local_search2();break;			
			case 4:
				timetable.local_search2b();break;			
			case 5:
				timetable.local_search3();break;			
			case 6:
				timetable.local_search3b();break;
			case 7:
				//timetable.local_search3c();
				break;
			default:
				timetable.local_search3c();break;
			}
			sp.stop();
			System.out.println("StopWatchの時間:"+sp);
			System.out.println(timetable.count_offence2("timetableSQL"));
			valuate = timetable.valuateTimeTableSQLFile();
