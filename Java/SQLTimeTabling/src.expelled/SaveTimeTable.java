...
public class SaveTimeTable implements Comparable {
	...
	public int compareTo(Object o){
		...
		int temp = 0;
		if (stt.count_offence < count_offence)
			temp = 1;
		else 
			if (stt.count_offence > count_offence) temp = -1;
		else {
			if (stt.valuate < valuate) 
				temp = 1;
			else 
	...
	*/
	...
	public void saveTimeTable(DBConnectionPool cmanager,String table,int project_id) throws Exception{
		Connection con = null;
		PreparedStatement psmt = null;
		ResultSet rs = null;
		Statement smt = null;
