...
class Sorting {
    ...
    */
	...
	int i, j, t; // i for the length (end+1) of sorted-array.
	...
	ela = System.currentTimeMillis() - ela;
	System.out.println("Selection: \t"+ (((float)ela)/1000));
	...
	ela = System.currentTimeMillis() - ela;
	System.out.println("Bubble: \t"+ (((float)ela)/1000));
