...
class SuffixTree implements Serializable {
  ...
  protected class Reference {
	...
	return true;
      ...
      if ((anObject != null) && (anObject instanceof Reference)) {
	return (string == ((Reference) anObject).string);
      }
      return false;
    }
  }
