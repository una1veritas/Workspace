...
public class Bonsai {
    ...
    private Bonsai() {
        indexing = new AlphabetIndexing("12");
        dtree = null;
        posex = new Vector();
        negex = new Vector();
        postr = new Vector();
    ...
    public Bonsai(BufferedReader preader, BufferedReader nreader, double sampratio, int trsize) {
        this();
        String str;
    ...
    public DecisionTree setDecisionTree(DecisionTree tree) {
        dtree = tree;
        return tree;
    }
    ...
    public synchronized String toString() {
        ...
        tmp.append(" counter examples, selected ");
        tmp.append(postr.size());
        tmp.append(" training examples and ");
        tmp.append(negtr.size());
        tmp.append(" counter training examples.");
        return tmp.toString();
    }
