...
#ifndef __IOTMPM366FDFG_H
#define __IOTMPM366FDFG_H
 ...
 ***************************************************************************
 **
 **    TMPM366FDFG SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* DMACASoftSReq (DMACA Software Single Request Register ) */
typedef struct{
__REG32                       :14;
...
/* DMACBSoftSReq (DMACB Software Single Request Register ) */
typedef struct{
__REG32                       :10;
...
__IO_REG8_BIT(PGFR5,                0x400C0618,__READ_WRITE ,__pgfr5_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(DMACBIntStaus,          0x40001000,__READ       ,__dmacintstaus_bits);
__IO_REG32_BIT(DMACBIntTCStatus,       0x40001004,__READ       ,__dmacinttcstatus_bits);
__IO_REG32_BIT(DMACBIntTCClear,        0x40001008,__WRITE      ,__dmacinttcclear_bits);
__IO_REG32_BIT(DMACBIntErrorStatus,    0x4000100C,__READ       ,__dmacinterrorstatus_bits);
__IO_REG32_BIT(DMACBIntErrClr,         0x40001010,__WRITE      ,__dmacinterrclr_bits);
__IO_REG32_BIT(DMACBRawIntTCStatus,    0x40001014,__READ       ,__dmacrawinttcstatus_bits);
__IO_REG32_BIT(DMACBRawIntErrorStatus, 0x40001018,__READ       ,__dmacrawinterrorstatus_bits);
__IO_REG32_BIT(DMACBEnbldChns,         0x4000101C,__READ       ,__dmacenbldchns_bits);
__IO_REG32_BIT(DMACBSoftBReq,          0x40001020,__READ_WRITE ,__dmacsoftbreq_bits);
__IO_REG32_BIT(DMACBSoftSReq,          0x40001024,__READ_WRITE ,__dmacbsoftsreq_bits);
__IO_REG32_BIT(DMACBConfiguration,     0x40001030,__READ_WRITE ,__dmacconfiguration_bits);
__IO_REG32(    DMACBC0SrcAddr,         0x40001100,__READ_WRITE );
__IO_REG32(    DMACBC0DestAddr,        0x40001104,__READ_WRITE );
__IO_REG32(    DMACBC0LLI,             0x40001108,__READ_WRITE );
__IO_REG32_BIT(DMACBC0Control,         0x4000110C,__READ_WRITE ,__dmacccontrol_bits);
__IO_REG32_BIT(DMACBC0Configuration,   0x40001110,__READ_WRITE ,__dmaccconfiguration_bits);
__IO_REG32(    DMACBC1SrcAddr,         0x40001120,__READ_WRITE );
__IO_REG32(    DMACBC1DestAddr,        0x40001124,__READ_WRITE );
__IO_REG32(    DMACBC1LLI,             0x40001128,__READ_WRITE );
__IO_REG32_BIT(DMACBC1Control,         0x4000112C,__READ_WRITE ,__dmacccontrol_bits);
__IO_REG32_BIT(DMACBC1Configuration,   0x40001130,__READ_WRITE ,__dmaccconfiguration_bits);
...
__IO_REG32_BIT(UDFS2TMD,              0x40008208,__READ_WRITE ,__ud2tmd_bits);
...
__IO_REG32_BIT(UARTRSR,              0x40048004,__READ_WRITE ,__uartrsr_bits);
#define UARTECR     UARTRSR
__IO_REG32_BIT(UARTFR,               0x40048018,__READ       ,__uartfr_bits);
__IO_REG32_BIT(UARTILPR,             0x40048020,__READ_WRITE ,__uartilpr_bits);
...
/***************************************************************************
 **
 **  TMPM366FDFG DMACA Request Lines
 **
 ***************************************************************************/
...
#define DMACA_UART_RX         14          /* Full UART Reception           */
#define DMACA_UART_TX         15          /* Full UART Transmission        */

/***************************************************************************
 **
 **  TMPM366FDFG DMACB Request Lines
 **
 ***************************************************************************/
#define DMACB_TMRB6_COM        0          /* TMRB6 compare match           */
#define DMACB_TMRB7_COM        1          /* TMRB7 compare match           */
#define DMACB_TMRB0_CAP1       2          /* TMRB0 input capture 1         */
#define DMACB_TMRB2_CAP0       3          /* TMRB2 input capture 0         */
#define DMACB_TMRB2_CAP1       4          /* TMRB2 input capture 1         */
#define DMACB_TMRB3_CAP0       5          /* TMRB3 input capture 0         */
#define DMACB_TMRB3_CAP1       6          /* TMRB3 input capture 1         */
#define DMACB_TMRB6_CAP0       7          /* TMRB6 input capture 0         */
#define DMACB_TMRB6_CAP1       8          /* TMRB6 input capture 1         */
#define DMACB_ADC              9          /* A/D Conversion End            */
#define DMACB_SSP0_TX         10          /* SSP0 Transmission             */
#define DMACB_SSP0_RX         11          /* SSP0 Reception                */
#define DMACB_SSP1_TX         12          /* SSP1 Transmission             */
#define DMACB_SSP1_RX         13          /* SSP1 Reception                */
#define DMACB_SSP2_TX         14          /* SSP2 Transmission             */
#define DMACB_SSP2_RX         15          /* SSP2 Reception                */

/***************************************************************************
 **
 **  TMPM366FDFG Interrupt Lines
 **
 ***************************************************************************/
...
#define INT_UART             (35 + EII)   /* UART interrupt (UART channel.2) */
...
#define INT_SSP1             (58 + EII)   /* SPI serial interface 1       */
#define INT_SSP0             (59 + EII)   /* SPI serial interface 0       */
#define INT_DMAC0TC          (60 + EII)   /* DMAC0 transfer complete Interrupt */
#define INT_DMAC1TC          (61 + EII)   /* DMAC1 transfer complete Interrupt */
#define INT_DMAC0ERR         (62 + EII)   /* DMAC0 transfer error Interrupt */
#define INT_DMAC1ERR         (63 + EII)   /* DMAC0 transfer error Interrupt */

#endif    /* __IOTMPM366FxFG_H */
...
Interrupt39  = INTSSP2        0xBC
Interrupt40  = INTUSBPON      0xC8
Interrupt41  = INTUART        0xCC
...
Interrupt64  = INTSSP1        0x128
Interrupt65  = INTSSP0        0x12C
Interrupt66  = INTDMAC0TC     0x130
Interrupt67  = INTDMAC1TC     0x134
Interrupt68  = INTDMAC0ERR    0x138
Interrupt69  = INTDMAC1ERR    0x13C
