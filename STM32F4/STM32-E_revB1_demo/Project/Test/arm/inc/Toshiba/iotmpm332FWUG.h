...
#ifndef __IOTMPM332FWUG_H
#define __IOTMPM332FWUG_H
 ...
 ***************************************************************************
 **
 **    TMPM330FxFG SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(CECEN,               0x40040300, __READ_WRITE , __cecen_bits );
__IO_REG32_BIT(CECADD,              0x40040304, __READ_WRITE , __cecadd_bits);
__IO_REG32_BIT(CECRESET,            0x40040308, __WRITE      , __cecreset_bits);
__IO_REG32_BIT(CECREN,              0x4004030C, __READ_WRITE , __cecren_bits);
__IO_REG32_BIT(CECRBUF,             0x40040310, __READ       , __cecrbuf_bits);
__IO_REG32_BIT(CECRCR1,             0x40040314, __READ_WRITE , __cecrcr1_bits);
__IO_REG32_BIT(CECRCR2,             0x40040318, __READ_WRITE , __cecrcr2_bits);
__IO_REG32_BIT(CECRCR3,             0x4004031C, __READ_WRITE , __cecrcr3_bits);
__IO_REG32_BIT(CECTEN,              0x40040320, __READ_WRITE , __cecten_bits);
__IO_REG32_BIT(CECTBUF,             0x40040324, __READ_WRITE , __cectbuf_bits);
__IO_REG32_BIT(CECTCR,              0x40040328, __READ_WRITE , __cectcr_bits);
__IO_REG32_BIT(CECRSTAT,            0x4004032C, __READ       , __cecrstat_bits);
__IO_REG32_BIT(CECTSTAT,            0x40040330, __READ       , __cectstat_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(RMC0EN,              0x40040400, __READ_WRITE , __rmcen_bits );
__IO_REG32_BIT(RMC0REN,             0x40040404, __READ_WRITE , __rmcren_bits );
__IO_REG32(    RMC0RBUF1,           0x40040408, __READ);
__IO_REG32(    RMC0RBUF2,           0x4004040C, __READ);
__IO_REG32(    RMC0RBUF3,           0x40040410, __READ);
__IO_REG32_BIT(RMC0RCR1,            0x40040414, __READ_WRITE , __rmcrcr1_bits );
__IO_REG32_BIT(RMC0RCR2,            0x40040418, __READ_WRITE , __rmcrcr2_bits );
__IO_REG32_BIT(RMC0RCR3,            0x4004041C, __READ_WRITE , __rmcrcr3_bits );
__IO_REG32_BIT(RMC0RCR4,            0x40040420, __READ_WRITE , __rmcrcr4_bits );
__IO_REG32_BIT(RMC0RSTAT,           0x40040424, __READ       , __rmcrstat_bits );
...
#define INT_0                ( 0 + EII)   /* Interrupt pin (PJ0/43pin)    */
#define INT_1                ( 1 + EII)   /* Interrupt pin (PJ1/31pin)    */
#define INT_2                ( 2 + EII)   /* Interrupt pin (PJ2/55pin)    */
#define INT_3                ( 3 + EII)   /* Interrupt pin (PJ3/56pin)    */
...
Interrupt14  = INTRX0         0x58
Interrupt15  = INTTX0         0x5C
Interrupt16  = INTRX1         0x60
Interrupt17  = INTTX1         0x64
Interrupt18  = INTSBI0        0x68
Interrupt19  = INTSBI1        0x6C
Interrupt20  = INTCECRX       0x70
Interrupt21  = INTCECTX       0x74
Interrupt22  = INTAINTRMCRX0  0x78
Interrupt23  = INTADHP        0x7C
Interrupt24  = INTADM0        0x80
Interrupt25  = INTADM1        0x84
Interrupt26  = INTTB0         0x88
Interrupt27  = INTTB1         0x8C
Interrupt28  = INTTB2         0x90
Interrupt29  = INTTB3         0x94
Interrupt30  = INTTB4         0x98
Interrupt31  = INTTB5         0x9C
Interrupt32  = INTTB6         0xA0
Interrupt33  = INTRTC         0xA4
Interrupt34  = INTCAP00       0xA8
Interrupt35  = INTCAP01       0xAC
Interrupt36  = INTCAP10       0xB0
Interrupt37  = INTCAP11       0xB4
Interrupt38  = INTCAP50       0xB8
Interrupt39  = INTCAP51       0xBC
Interrupt40  = INTCAP60       0xC0
Interrupt41  = INTCAP61       0xC4
Interrupt42  = INTTB7         0xE0
Interrupt43  = INTTB8         0xE4
Interrupt44  = INTTB9         0xE8
Interrupt45  = INTAD          0x104
