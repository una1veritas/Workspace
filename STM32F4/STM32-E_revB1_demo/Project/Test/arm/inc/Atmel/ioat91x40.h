 ...
 **    AT91F40816/AT91FR40162/AT91FR4042/AT91FR4081
 **
 **    Define __WAVEMODE0, __WAVEMODE1 or __WAVEMODE2 to put the timer in
 **    wave mode instead of the default capture mode.
 **    
 ...
 ***************************************************************************
 **                            
 **    AT91X40 SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* PS peripherial clock enable/disable/status register */
typedef struct {
  __REG32      :2;
  __REG32 us0  :1;
  __REG32 us1  :1;
...
__IO_REG32_BIT(__PS_CR,0xffff4000,__WRITE,__psctrlr_bits);
__IO_REG32_BIT(__PS_PCER,0xffff4004,__WRITE,__pspclockr_bits);
__IO_REG32_BIT(__PS_PCDR,0xffff4008,__WRITE,__pspclockr_bits);
__IO_REG32_BIT(__PS_PCSR,0xffff400c,__READ,__pspclockr_bits);
...
__IO_REG32_BIT(__SF_MMR,0xfff0000c,__READ_WRITE,__sfmmr_bits);
/*RESERVED: 0xfff00010,0xfff00014 */
...
/*RESERVED: 0xfffe0048, 0xfffe004c */
