 ...
 ***************************************************************************
 **                            
 **    IOEP9301 SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
typedef struct{
__REG32 Tx_underflow        : 1;     
__REG32                     : 2;     
__REG32 Rx_overflow         : 1;     
__REG32                     : 2;     
__REG32 Tx_overflow         : 1;     
__REG32                     : 2;     
__REG32 Rx_underflow        : 1;     
__REG32                     : 2;     
__REG32 tx_fifo_full        : 1;     
__REG32 tx_fifo_empty       : 1;     
__REG32 tx_fifo_half_empty  : 1;     
__REG32 rx_fifo_full        : 1;     
__REG32 rx_fifo_empty       : 1;     
__REG32 rx_fifo_half_full   : 1;     
__REG32                     :14;     
} __i2sglsts_bits;
...
__IO_REG32_BIT(M2M0_BCR0,           0x80000110,__READ      ,__bcrx_bits);
__IO_REG32_BIT(M2M0_BCR1,           0x80000114,__READ      ,__bcrx_bits);
__IO_REG32(    M2M0_SAR_BASE0,      0x80000118,__READ_WRITE);
__IO_REG32(    M2M0_SAR_BASE1,      0x8000011C,__READ_WRITE);
__IO_REG32(    M2M0_SAR_CURRENT0,   0x80000124,__READ_WRITE);
__IO_REG32(    M2M0_SAR_CURRENT1,   0x80000128,__READ_WRITE);
__IO_REG32(    M2M0_DAR_BASE0,      0x8000012C,__READ_WRITE);
__IO_REG32(    M2M0_DAR_BASE1,      0x80000130,__READ_WRITE);
__IO_REG32(    M2M0_DAR_CURRENT0,   0x80000134,__READ_WRITE);
__IO_REG32(    M2M0_DAR_CURRENT1,   0x8000013C,__READ_WRITE);
...
__IO_REG32_BIT(M2M1_BCR0,           0x80000150,__READ      ,__bcrx_bits);
__IO_REG32_BIT(M2M1_BCR1,           0x80000154,__READ      ,__bcrx_bits);
__IO_REG32(    M2M1_SAR_BASE0,      0x80000158,__READ_WRITE);
__IO_REG32(    M2M1_SAR_BASE1,      0x8000015C,__READ_WRITE);
__IO_REG32(    M2M1_SAR_CURRENT0,   0x80000164,__READ_WRITE);
__IO_REG32(    M2M1_SAR_CURRENT1,   0x80000168,__READ_WRITE);
__IO_REG32(    M2M1_DAR_BASE0,      0x8000016C,__READ_WRITE);
__IO_REG32(    M2M1_DAR_BASE1,      0x80000170,__READ_WRITE);
__IO_REG32(    M2M1_DAR_CURRENT0,   0x80000174,__READ_WRITE);
__IO_REG32(    M2M1_DAR_CURRENT1,   0x8000017C,__READ_WRITE);
...
__IO_REG32_BIT(HcRhPortStatus2,     0x8002005C,__READ_WRITE,__hcrhportstatus_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32(    AC97DR,              0x80880000,__READ_WRITE);
__IO_REG32_BIT(AC97RXCR,            0x80880004,__READ_WRITE,__ac97rxcrx_bits);
__IO_REG32_BIT(AC97TXCR,            0x80880008,__READ_WRITE,__ac97txcrx_bits);
__IO_REG32_BIT(AC97SR,              0x8088000c,__READ      ,__ac97srx_bits);
__IO_REG32_BIT(AC97RISR,            0x80880010,__READ_WRITE,__ac97risrx_bits);
__IO_REG32_BIT(AC97ISR,             0x80880014,__READ      ,__ac97isrx_bits);
__IO_REG32_BIT(AC97IE,              0x80880018,__READ_WRITE,__ac97iex_bits);
...
__IO_REG32(    UART2IrLowPwrCntr,   0x808d0020,__READ_WRITE);
...
__IO_REG32_BIT(ADCClkDiv,           0x80930090,__READ_WRITE,__adcclkdiv_bits);
...
/*                          19     Reserved                                     */
#define VIC1_GPIO0INTR      20  /* GPIO interrupt 0                           */
#define VIC1_GPIO1INTR      21  /* GPIO interrupt 1                           */
#define VIC1_GPIO2INTR      22  /* GPIO interrupt 2                           */
...
#define VIC2_INT_EXT2        8  /* External interrupt 2                       */
/*                           9     Reserved                                     */
/*                          10     Reserved                                     */
/*                          11     Reserved                                     */
/*                          12     Reserved                                     */
