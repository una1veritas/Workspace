...
#define APBDIV      VPBDIV
#define APBDIV_bit  VPBDIV_bit
...
__IO_REG32_BIT(SSPMIS,          0xE005C01C,__READ      ,__sspmis_bits);
__IO_REG32_BIT(SSPICR,          0xE005C020,__WRITE     ,__sspicr_bits);
...
__IO_REG32_BIT(T0EMR, 0xE000403c,__READ_WRITE,__emr0_bits);
...
__IO_REG32_BIT(T1EMR, 0xE000803c,__READ_WRITE,__emr1_bits);
