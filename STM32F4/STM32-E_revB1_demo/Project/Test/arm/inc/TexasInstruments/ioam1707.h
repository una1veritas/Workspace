 ...
 ***************************************************************************
 **
 **    AM1707 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32(    McASP2_REV,            0x01D08000,__READ       );
__IO_REG32_BIT(McASP2_PFUNC,          0x01D08010,__READ_WRITE ,__mcasp_pfunc_bits);
__IO_REG32_BIT(McASP2_PDIR,           0x01D08014,__READ_WRITE ,__mcasp_pfunc_bits);
__IO_REG32_BIT(McASP2_PDOUT,          0x01D08018,__READ_WRITE ,__mcasp_pfunc_bits);
__IO_REG32_BIT(McASP2_PDIN,           0x01D0801C,__READ_WRITE ,__mcasp_pfunc_bits);
#define McASP2_PDSET     McASP2_PDIN
#define McASP2_PDSET_bit McASP2_PDIN_bit
__IO_REG32_BIT(McASP2_PDCLR,          0x01D08020,__READ_WRITE ,__mcasp_pfunc_bits);
__IO_REG32_BIT(McASP2_GBLCTL,         0x01D08044,__READ_WRITE ,__mcasp_gblctl_bits);
__IO_REG32_BIT(McASP2_AMUTE,          0x01D08048,__READ_WRITE ,__mcasp_amute_bits);
__IO_REG32_BIT(McASP2_DLBCTL,         0x01D0804C,__READ_WRITE ,__mcasp_dlbctl_bits);
__IO_REG32_BIT(McASP2_DITCTL,         0x01D08050,__READ_WRITE ,__mcasp_ditctl_bits);
__IO_REG32_BIT(McASP2_RGBLCTL,        0x01D08060,__READ_WRITE ,__mcasp_rgblctl_bits);
__IO_REG32_BIT(McASP2_RMASK,          0x01D08064,__READ_WRITE ,__mcasp_rmask_bits);
__IO_REG32_BIT(McASP2_RFMT,           0x01D08068,__READ_WRITE ,__mcasp_rfmt_bits);
__IO_REG32_BIT(McASP2_AFSRCTL,        0x01D0806C,__READ_WRITE ,__mcasp_afsrctl_bits);
__IO_REG32_BIT(McASP2_ACLKRCTL,       0x01D08070,__READ_WRITE ,__mcasp_aclkrctl_bits);
__IO_REG32_BIT(McASP2_AHCLKRCTL,      0x01D08074,__READ_WRITE ,__mcasp_ahclkrctl_bits);
__IO_REG32_BIT(McASP2_RTDM,           0x01D08078,__READ_WRITE ,__mcasp_rtdm_bits);
__IO_REG32_BIT(McASP2_RINTCTL,        0x01D0807C,__READ_WRITE ,__mcasp_rintctl_bits);
__IO_REG32_BIT(McASP2_RSTAT,          0x01D08080,__READ_WRITE ,__mcasp_rstat_bits);
__IO_REG32_BIT(McASP2_RSLOT,          0x01D08084,__READ       ,__mcasp_rslot_bits);
__IO_REG32_BIT(McASP2_RCLKCHK,        0x01D08088,__READ_WRITE ,__mcasp_rclkchk_bits);
__IO_REG32_BIT(McASP2_REVTCTL,        0x01D0808C,__READ_WRITE ,__mcasp_revtctl_bits);
__IO_REG32_BIT(McASP2_XGBLCTL,        0x01D080A0,__READ_WRITE ,__mcasp_xgblctl_bits);
__IO_REG32_BIT(McASP2_XMASK,          0x01D080A4,__READ_WRITE ,__mcasp_xmask_bits);
__IO_REG32_BIT(McASP2_XFMT,           0x01D080A8,__READ_WRITE ,__mcasp_xfmt_bits);
__IO_REG32_BIT(McASP2_AFSXCTL,        0x01D080AC,__READ_WRITE ,__mcasp_afsxctl_bits);
__IO_REG32_BIT(McASP2_ACLKXCTL,       0x01D080B0,__READ_WRITE ,__mcasp_aclkxctl_bits);
__IO_REG32_BIT(McASP2_AHCLKXCTL,      0x01D080B4,__READ_WRITE ,__mcasp_ahclkxctl_bits);
__IO_REG32_BIT(McASP2_XTDM,           0x01D080B8,__READ_WRITE ,__mcasp_xtdm_bits);
__IO_REG32_BIT(McASP2_XINTCTL,        0x01D080BC,__READ_WRITE ,__mcasp_xintctl_bits);
__IO_REG32_BIT(McASP2_XSTAT,          0x01D080C0,__READ_WRITE ,__mcasp_xstat_bits);
__IO_REG32_BIT(McASP2_XSLOT,          0x01D080C4,__READ       ,__mcasp_xslot_bits);
__IO_REG32_BIT(McASP2_XCLKCHK,        0x01D080C8,__READ_WRITE ,__mcasp_xclkchk_bits);
__IO_REG32_BIT(McASP2_XEVTCTL,        0x01D080CC,__READ_WRITE ,__mcasp_xevtctl_bits);
__IO_REG32(    McASP2_DITCSRA0,       0x01D08100,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRA1,       0x01D08104,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRA2,       0x01D08108,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRA3,       0x01D0810C,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRA4,       0x01D08110,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRA5,       0x01D08114,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRB0,       0x01D08118,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRB1,       0x01D0811C,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRB2,       0x01D08120,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRB3,       0x01D08124,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRB4,       0x01D08128,__READ_WRITE );
__IO_REG32(    McASP2_DITCSRB5,       0x01D0812C,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRA0,       0x01D08130,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRA1,       0x01D08134,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRA2,       0x01D08138,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRA3,       0x01D0813C,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRA4,       0x01D08140,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRA5,       0x01D08144,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRB0,       0x01D08148,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRB1,       0x01D0814C,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRB2,       0x01D08150,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRB3,       0x01D08154,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRB4,       0x01D08158,__READ_WRITE );
__IO_REG32(    McASP2_DITUDRB5,       0x01D0815C,__READ_WRITE );
__IO_REG32_BIT(McASP2_SRCTL0,         0x01D08180,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL1,         0x01D08184,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL2,         0x01D08188,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL3,         0x01D0818C,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL4,         0x01D08190,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL5,         0x01D08194,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL6,         0x01D08198,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL7,         0x01D0819C,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL8,         0x01D081A0,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL9,         0x01D081A4,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL10,        0x01D081A8,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL11,        0x01D081AC,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL12,        0x01D081B0,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL13,        0x01D081B4,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL14,        0x01D081B8,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32_BIT(McASP2_SRCTL15,        0x01D081BC,__READ_WRITE ,__mcasp_srctl_bits);
__IO_REG32(    McASP2_XBUF0,          0x01D08200,__READ_WRITE );
__IO_REG32(    McASP2_XBUF1,          0x01D08204,__READ_WRITE );
__IO_REG32(    McASP2_XBUF2,          0x01D08208,__READ_WRITE );
__IO_REG32(    McASP2_XBUF3,          0x01D0820C,__READ_WRITE );
__IO_REG32(    McASP2_XBUF4,          0x01D08210,__READ_WRITE );
__IO_REG32(    McASP2_XBUF5,          0x01D08214,__READ_WRITE );
__IO_REG32(    McASP2_XBUF6,          0x01D08218,__READ_WRITE );
__IO_REG32(    McASP2_XBUF7,          0x01D0821C,__READ_WRITE );
__IO_REG32(    McASP2_XBUF8,          0x01D08220,__READ_WRITE );
__IO_REG32(    McASP2_XBUF9,          0x01D08224,__READ_WRITE );
__IO_REG32(    McASP2_XBUF10,         0x01D08228,__READ_WRITE );
__IO_REG32(    McASP2_XBUF11,         0x01D0822C,__READ_WRITE );
__IO_REG32(    McASP2_XBUF12,         0x01D08230,__READ_WRITE );
__IO_REG32(    McASP2_XBUF13,         0x01D08234,__READ_WRITE );
__IO_REG32(    McASP2_XBUF14,         0x01D08238,__READ_WRITE );
__IO_REG32(    McASP2_XBUF15,         0x01D0823C,__READ_WRITE );
__IO_REG32(    McASP2_RBUF0,          0x01D08280,__READ_WRITE );
__IO_REG32(    McASP2_RBUF1,          0x01D08284,__READ_WRITE );
__IO_REG32(    McASP2_RBUF2,          0x01D08288,__READ_WRITE );
__IO_REG32(    McASP2_RBUF3,          0x01D0828C,__READ_WRITE );
__IO_REG32(    McASP2_RBUF4,          0x01D08290,__READ_WRITE );
__IO_REG32(    McASP2_RBUF5,          0x01D08294,__READ_WRITE );
__IO_REG32(    McASP2_RBUF6,          0x01D08298,__READ_WRITE );
__IO_REG32(    McASP2_RBUF7,          0x01D0829C,__READ_WRITE );
__IO_REG32(    McASP2_RBUF8,          0x01D082A0,__READ_WRITE );
__IO_REG32(    McASP2_RBUF9,          0x01D082A4,__READ_WRITE );
__IO_REG32(    McASP2_RBUF10,         0x01D082A8,__READ_WRITE );
__IO_REG32(    McASP2_RBUF11,         0x01D082AC,__READ_WRITE );
__IO_REG32(    McASP2_RBUF12,         0x01D082B0,__READ_WRITE );
__IO_REG32(    McASP2_RBUF13,         0x01D082B4,__READ_WRITE );
__IO_REG32(    McASP2_RBUF14,         0x01D082B8,__READ_WRITE );
__IO_REG32(    McASP2_RBUF15,         0x01D082BC,__READ_WRITE );
__IO_REG32(    McASP2_RBUF,           0x01D0A000,__READ_WRITE );
#define McASP2_XBUF      McASP2_RBUF
__IO_REG32(    McASP2_AFIFOREV,       0x01D09000,__READ_WRITE );
__IO_REG32_BIT(McASP2_WFIFOCTL,       0x01D09010,__READ_WRITE ,__mcasp_wfifoctl_bits);
__IO_REG32_BIT(McASP2_WFIFOSTS,       0x01D09014,__READ       ,__mcasp_wfifosts_bits);
__IO_REG32_BIT(McASP2_RFIFOCTL,       0x01D09018,__READ_WRITE ,__mcasp_rfifoctl_bits);
__IO_REG32_BIT(McASP2_RFIFOSTS,       0x01D0901C,__READ       ,__mcasp_rfifosts_bits);
