...
arduino/cores/arduino/%.o: ../arduino/cores/arduino/%.cpp
	...
	avr-g++ -I"/Users/sin/Documents/Eclipse/Workspace/Arduino_cores/arduino/variants/standard" -I"/Users/sin/Documents/Eclipse/Workspace/Arduino_cores/arduino/cores/arduino" -DARDUINO=100 -Wall -Os -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -fno-exceptions -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
...
arduino/cores/arduino/%.o: ../arduino/cores/arduino/%.c
	...
	avr-gcc -I"/Users/sin/Documents/Eclipse/Workspace/Arduino_cores/arduino/variants/standard" -I"/Users/sin/Documents/Eclipse/Workspace/Arduino_cores/arduino/cores/arduino" -DARDUINO=100 -Wall -Os -fpack-struct -fshort-enums -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
