...
#ifndef __IOLPC1850_H
#define __IOLPC1850_H
 ...
 ***************************************************************************
 **
 **    LPC1850 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
#define RGU_RESET_CTRL0_LCD_RST       ((uint32_t)0x00010000)
...
#define LCD_INTCLR_FUFIC   ((uint32_t)0x00000002)
#define LCD_INTCLR_LNBUIC  ((uint32_t)0x00000004)
#define LCD_INTCLR_VCOMPIC ((uint32_t)0x00000008)
#define LCD_INTCLR_BERIC   ((uint32_t)0x00000010)
...
#define CRSR_INTCLR_CRSRIC  ((uint32_t)0x00000001)
...
__IO_REG32_BIT(CCU1_CLK_M3_LCD_CFG,           0x40051418,__READ_WRITE ,__ccu_clk_cfg_bits);
__IO_REG32_BIT(CCU1_CLK_M3_LCD_STAT,          0x4005141C,__READ       ,__ccu_clk_cfg_bits);
...
__IO_REG32(    LCD_UPBASE,            0x40008010,__READ_WRITE );
__IO_REG32(    LCD_LPBASE,            0x40008014,__READ_WRITE );
...
__IO_REG32(    LCD_PAL_BASE,          0x40008200,__READ_WRITE );
__IO_REG32(    CRSR_IMG_BASE,         0x40008800,__READ_WRITE );
__IO_REG32_BIT(CRSR_CTRL,             0x40008C00,__READ_WRITE ,__crsr_ctrl_bits);
__IO_REG32_BIT(CRSR_CFG,              0x40008C04,__READ_WRITE ,__crsr_cfg_bits);
__IO_REG32_BIT(CRSR_PAL0,             0x40008C08,__READ_WRITE ,__crsr_pal0_bits);
__IO_REG32_BIT(CRSR_PAL1,             0x40008C0C,__READ_WRITE ,__crsr_pal1_bits);
__IO_REG32_BIT(CRSR_XY,               0x40008C10,__READ_WRITE ,__crsr_xy_bits);
__IO_REG32_BIT(CRSR_CLIP,             0x40008C14,__READ_WRITE ,__crsr_clip_bits);
__IO_REG32_BIT(CRSR_INTMSK,           0x40008C20,__READ_WRITE ,__crsr_intmsk_bits);
__IO_REG32(    CRSR_INTCLR,           0x40008C24,__WRITE      );
__IO_REG32_BIT(CRSR_INTRAW,           0x40008C28,__READ       ,__crsr_intraw_bits);
__IO_REG32_BIT(CRSR_INTSTAT,          0x40008C2C,__READ       ,__crsr_intstat_bits);
...
Interrupt13  = LCD            0x5C
Interrupt14  = USB0           0x60
Interrupt15  = USB1           0x64
Interrupt16  = SCT            0x68
Interrupt17  = RITIMER        0x6C
Interrupt18  = TIMER0         0x70
Interrupt19  = TIMER1         0x74
Interrupt20  = TIMER2         0x78
Interrupt21  = TIMER3         0x7C
Interrupt22  = MC             0x80
Interrupt23  = ADC0           0x84
Interrupt24  = I2C0           0x88
Interrupt25  = I2C1           0x8C
Interrupt26  = ADC1           0x94
Interrupt27  = SSP0           0x98
Interrupt28  = SSP1           0x9C
Interrupt29  = USART0         0xA0
Interrupt30  = UART1          0xA4
Interrupt31  = USART2         0xA8
Interrupt32  = USART3         0xAC
Interrupt33  = I2S0           0xB0
Interrupt34  = I2S1           0xB4
Interrupt35  = SPIFI          0xB8
Interrupt36  = GPIO0          0xC0
Interrupt37  = GPIO1          0xC4
Interrupt38  = GPIO2          0xC8
Interrupt39  = GPIO3          0xCC
Interrupt40  = GPIO4          0xD0
Interrupt41  = GPIO5          0xD4
Interrupt42  = GPIO6          0xD8
Interrupt43  = GPIO7          0xDC
Interrupt44  = GPIOG0         0xE0
Interrupt45  = GPIOG1         0xE4
Interrupt46  = EVNR           0xE8
Interrupt47  = C_CAN1         0xEC
Interrupt48  = AT             0xF8
Interrupt49  = RTC            0xFE
Interrupt50  = WWDT           0x104
Interrupt51  = C_CAN0         0x10C
Interrupt52  = QEI            0x110
