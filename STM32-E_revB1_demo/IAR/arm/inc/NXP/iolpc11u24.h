 ...
 ***************************************************************************
 **
 **    LPC11U24 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* EEPROM BIST signature register */
typedef struct{
__REG32 DATA_SIG    :16;
...
__IO_REG32_BIT(TMR16B0CR1,          0x4000C030,__READ,__sfrdef11_bits);
...
__IO_REG32_BIT(TMR16B1CR1,          0x40010030,__READ,__sfrdef11_bits);
...
__IO_REG32_BIT(WDT_TC,              0x40004004,__READ_WRITE,__sfrdef67_bits);
...
__IO_REG32_BIT(PIO1_0,              0x40044060,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_1,              0x40044064,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_2,              0x40044068,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_3,              0x4004406C,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_4,              0x40044070,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_5,              0x40044074,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_6,              0x40044078,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_7,              0x4004407C,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_8,              0x40044080,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_9,              0x40044084,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_10,             0x40044088,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_11,             0x4004408C,__READ_WRITE,__sfrdef7_bits);
__IO_REG32_BIT(PIO1_12,             0x40044090,__READ_WRITE,__sfrdef7_bits);
...
/***************************************************************************
 **
 ** Flash/EEPROM signature generation
 **
 ***************************************************************************/
...
__IO_REG32_BIT(EEMSSTART,           0x4003C09C,__READ_WRITE ,__eemsstart_bits);
__IO_REG32_BIT(EEMSSTOP,            0x4003C0A0,__READ_WRITE ,__eemsstop_bits);
__IO_REG32_BIT(EEMSSIG,             0x4003C0A4,__READ_WRITE ,__eemsstop_bits);
