...
#ifndef __IOLPC2294_H
#define __IOLPC2294_H
 ...
 ***************************************************************************
 **                            
 **    IOLPC2294 SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* Power control for peripherals register LPC2294 */
typedef struct {
  __REG32                 :1;
  __REG32 PCTIM0          :1;
  __REG32 PCTIM1          :1;
...
__IO_REG32_BIT(IO2PIN, 0xE0028020,__READ,__gpio2_bits);
...
__IO_REG32_BIT(IO3PIN, 0xE0028030,__READ,__gpio3_bits);
...
__IO_REG32_BIT(C3MOD,  0xE004C000,__READ_WRITE,__canmod_bits);
__IO_REG32_BIT(C3CMR,  0xE004C004,__WRITE,__cancmr_bits);
__IO_REG32_BIT(C3GSR,  0xE004C008,__READ_WRITE,__cangsr_bits);
__IO_REG32_BIT(C3ICR,  0xE004C00C,__READ,__canicr_bits);
__IO_REG32_BIT(C3IER,  0xE004C010,__READ_WRITE,__canier_bits);
__IO_REG32_BIT(C3BTR,  0xE004C014,__READ_WRITE,__canbtr_bits);
__IO_REG32_BIT(C3EWL,  0xE004C018,__READ_WRITE,__canewl_bits);
__IO_REG32_BIT(C3SR,   0xE004C01C,__READ,__cansr_bits);
__IO_REG32_BIT(C3RFS,  0xE004C020,__READ_WRITE,__canrfs_bits);
__IO_REG32_BIT(C3RID,  0xE004C024,__READ_WRITE,__canrid_bits);
__IO_REG32_BIT(C3RDA,  0xE004C028,__READ_WRITE,__canrda_bits);
__IO_REG32_BIT(C3RDB,  0xE004C02C,__READ_WRITE,__canrdb_bits);
__IO_REG32_BIT(C3TFI1, 0xE004C030,__READ_WRITE,__cantfi_bits);
__IO_REG32_BIT(C3TID1, 0xE004C034,__READ_WRITE,__cantid_bits);
__IO_REG32_BIT(C3TDA1, 0xE004C038,__READ_WRITE,__cantda_bits);
__IO_REG32_BIT(C3TDB1, 0xE004C03C,__READ_WRITE,__cantdb_bits);
__IO_REG32_BIT(C3TFI2, 0xE004C040,__READ_WRITE,__cantfi_bits);
__IO_REG32_BIT(C3TID2, 0xE004C044,__READ_WRITE,__cantid_bits);
__IO_REG32_BIT(C3TDA2, 0xE004C048,__READ_WRITE,__cantda_bits);
__IO_REG32_BIT(C3TDB2, 0xE004C04C,__READ_WRITE,__cantdb_bits);
__IO_REG32_BIT(C3TFI3, 0xE004C050,__READ_WRITE,__cantfi_bits);
__IO_REG32_BIT(C3TID3, 0xE004C054,__READ_WRITE,__cantid_bits);
__IO_REG32_BIT(C3TDA3, 0xE004C058,__READ_WRITE,__cantda_bits);
__IO_REG32_BIT(C3TDB3, 0xE004C05C,__READ_WRITE,__cantdb_bits);

__IO_REG32_BIT(C4MOD,  0xE0050000,__READ_WRITE,__canmod_bits);
__IO_REG32_BIT(C4CMR,  0xE0050004,__WRITE,__cancmr_bits);
__IO_REG32_BIT(C4GSR,  0xE0050008,__READ_WRITE,__cangsr_bits);
__IO_REG32_BIT(C4ICR,  0xE005000C,__READ,__canicr_bits);
__IO_REG32_BIT(C4IER,  0xE0050010,__READ_WRITE,__canier_bits);
__IO_REG32_BIT(C4BTR,  0xE0050014,__READ_WRITE,__canbtr_bits);
__IO_REG32_BIT(C4EWL,  0xE0050018,__READ_WRITE,__canewl_bits);
__IO_REG32_BIT(C4SR,   0xE005001C,__READ,__cansr_bits);
__IO_REG32_BIT(C4RFS,  0xE0050020,__READ_WRITE,__canrfs_bits);
__IO_REG32_BIT(C4RID,  0xE0050024,__READ_WRITE,__canrid_bits);
__IO_REG32_BIT(C4RDA,  0xE0050028,__READ_WRITE,__canrda_bits);
__IO_REG32_BIT(C4RDB,  0xE005002C,__READ_WRITE,__canrdb_bits);
__IO_REG32_BIT(C4TFI1, 0xE0050030,__READ_WRITE,__cantfi_bits);
__IO_REG32_BIT(C4TID1, 0xE0050034,__READ_WRITE,__cantid_bits);
__IO_REG32_BIT(C4TDA1, 0xE0050038,__READ_WRITE,__cantda_bits);
__IO_REG32_BIT(C4TDB1, 0xE005003C,__READ_WRITE,__cantdb_bits);
__IO_REG32_BIT(C4TFI2, 0xE0050040,__READ_WRITE,__cantfi_bits);
__IO_REG32_BIT(C4TID2, 0xE0050044,__READ_WRITE,__cantid_bits);
__IO_REG32_BIT(C4TDA2, 0xE0050048,__READ_WRITE,__cantda_bits);
__IO_REG32_BIT(C4TDB2, 0xE005004C,__READ_WRITE,__cantdb_bits);
__IO_REG32_BIT(C4TFI3, 0xE0050050,__READ_WRITE,__cantfi_bits);
__IO_REG32_BIT(C4TID3, 0xE0050054,__READ_WRITE,__cantid_bits);
__IO_REG32_BIT(C4TDA3, 0xE0050058,__READ_WRITE,__cantda_bits);
__IO_REG32_BIT(C4TDB3, 0xE005005C,__READ_WRITE,__cantdb_bits);
