 ...
 **    $Revision: 30254 $
 **
 **    Note: Only little endian addressing of 8/16 bit registers.
 ***************************************************************************/

#ifndef __IOLPC2210_H
#define __IOLPC2210_H
 ...
 ***************************************************************************
 **
 **   LPC2210 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* UART0 interrupt identification register and fifo control register */
typedef union{
  /*UxIIR*/
  struct {
__REG8  IP     : 1;     
...
/* UART1 interrupt identification register and fifo control register */
typedef union{
  /*UxIIR*/
  struct {
__REG32 IP       : 1;     
...
__IO_REG8_BIT( U0FCR,           0xE000C008,__READ_WRITE,__uartfcriir0_bits);
...
__IO_REG32_BIT(U1FCR,           0xE0010008,__READ_WRITE,__uartfcriir1_bits);
...
__IO_REG32_BIT(ADGDR,           0xE0034004,__READ_WRITE,__adgdr_bits);
...
#define VIC_SPI1        11  /* SPI&SSP (SPIF, MODF)               */
