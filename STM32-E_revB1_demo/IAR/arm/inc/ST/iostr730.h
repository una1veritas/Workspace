 ...
 ***************************************************************************
 **
 **   STR730 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* BRP Extension Register (CANn_BRPR) */
typedef struct {
  __REG16  BRPE           : 4;
  __REG16                 :12;
} __cannbrpr_bits;

/* IFn Command Request Registers (CANn_IFx_CRR) */
typedef struct {
  __REG16  MSGNO          : 6;
  __REG16                 : 9;
  __REG16  BUSY           : 1;
...
/* IFn Command Mask Registers (CANn_IFx_CMR) */
typedef struct {
  __REG16  DATAB          : 1;
  __REG16  DATAA          : 1;
  __REG16  TXRQST         : 1;
...
/* IFn Mask 1 Register (CANn_IFx_M1R) */
typedef struct {
  __REG16  MSK0           : 1;
  __REG16  MSK1           : 1;
  __REG16  MSK2           : 1;
...
/* IFn Mask 2 Register (CANn_IFx_M2R) */
typedef struct {
  __REG16  MSK16          : 1;
  __REG16  MSK17          : 1;
  __REG16  MSK18          : 1;
...
/* IFn Message Arbitration 1 Register (CANn_IFx_A1R) */
typedef struct {
  __REG16  ID0            : 1;
  __REG16  ID1            : 1;
  __REG16  ID2            : 1;
...
/* IFn Message Arbitration 2 Register (CANn_IFx_A2R) */
typedef struct {
  __REG16  ID16           : 1;
  __REG16  ID17           : 1;
  __REG16  ID18           : 1;
...
/* Message Control Registers (CANn_IFx_MCR) */
typedef struct {
  __REG16  DLC            : 4;
  __REG16                 : 3;
  __REG16  EOB            : 1;
...
/* IFn Data A/B Registers (CANn_IFx_DAnR and CANn_IFx_DBnR) */
typedef struct {
  __REG16  DATA0          : 8;
  __REG16  DATA1          : 8;
} __cannifxda1r_bits;
...
__IO_REG32(    CFG_PCGR0,    0x40000008,__READ_WRITE);
__IO_REG32(    CFG_PCGR1,    0x4000000C,__READ_WRITE);
__IO_REG32(    CFG_PECGR0,   0x40000010,__READ_WRITE);
__IO_REG32(    CFG_PECGR1,   0x40000014,__READ_WRITE);
__IO_REG32(    CFG_PCGRB0,   0x40000018,__READ_WRITE);
__IO_REG32(    CFG_PCGRB1,   0x4000001C,__READ_WRITE);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(FLASH_CR0,   0x80100000,__READ_WRITE,__flashctrl0_bits);
__IO_REG32_BIT(FLASH_CR1,   0x80100004,__READ_WRITE,__flashctrl1_bits);
__IO_REG32(    FLASH_DR0,   0x80100008,__READ_WRITE);
__IO_REG32(    FLASH_DR1,   0x8010000C,__READ_WRITE);
__IO_REG32_BIT(FLASH_AR,    0x80100010,__READ_WRITE,__flashadd_bits);
__IO_REG32_BIT(FLASH_ER,    0x80100014,__READ_WRITE,__flasherr_bits);
__IO_REG32_BIT(FLASH_NVWPAR,0x8010DFB0,__READ_WRITE,__flashwrprot_bits);
__IO_REG32_BIT(FLASH_NVAPR0,0x8010DFB8,__READ_WRITE,__flashaccprot0_bits);
__IO_REG32_BIT(FLASH_NVAPR1,0x8010DFBC,__READ_WRITE,__flashaccprot1_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM6_ICAR,   0xFFFFB080,__READ);
__IO_REG16(    TIM6_ICBR,   0xFFFFB084,__READ);
__IO_REG16(    TIM6_OCAR,   0xFFFFB088,__READ_WRITE);
__IO_REG16(    TIM6_OCBR,   0xFFFFB08C,__READ_WRITE);
__IO_REG16(    TIM6_CNTR,   0xFFFFB090,__READ);
__IO_REG16_BIT(TIM6_CR1,    0xFFFFB094,__READ_WRITE,__timcr1_bits);
__IO_REG16_BIT(TIM6_CR2,    0xFFFFB098,__READ_WRITE,__timcr2_bits);
__IO_REG16_BIT(TIM6_SR,     0xFFFFB09C,__READ_WRITE,__timsr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM7_ICAR,   0xFFFFB100,__READ);
__IO_REG16(    TIM7_ICBR,   0xFFFFB104,__READ);
__IO_REG16(    TIM7_OCAR,   0xFFFFB108,__READ_WRITE);
__IO_REG16(    TIM7_OCBR,   0xFFFFB10C,__READ_WRITE);
__IO_REG16(    TIM7_CNTR,   0xFFFFB110,__READ);
__IO_REG16_BIT(TIM7_CR1,    0xFFFFB114,__READ_WRITE,__timcr1_bits);
__IO_REG16_BIT(TIM7_CR2,    0xFFFFB118,__READ_WRITE,__timcr2_bits);
__IO_REG16_BIT(TIM7_SR,     0xFFFFB11C,__READ_WRITE,__timsr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM8_ICAR,   0xFFFFB180,__READ);
__IO_REG16(    TIM8_ICBR,   0xFFFFB184,__READ);
__IO_REG16(    TIM8_OCAR,   0xFFFFB188,__READ_WRITE);
__IO_REG16(    TIM8_OCBR,   0xFFFFB18C,__READ_WRITE);
__IO_REG16(    TIM8_CNTR,   0xFFFFB190,__READ);
__IO_REG16_BIT(TIM8_CR1,    0xFFFFB194,__READ_WRITE,__timcr1_bits);
__IO_REG16_BIT(TIM8_CR2,    0xFFFFB198,__READ_WRITE,__timcr2_bits);
__IO_REG16_BIT(TIM8_SR,     0xFFFFB19C,__READ_WRITE,__timsr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM9_ICAR,   0xFFFFB200,__READ);
__IO_REG16(    TIM9_ICBR,   0xFFFFB204,__READ);
__IO_REG16(    TIM9_OCAR,   0xFFFFB208,__READ_WRITE);
__IO_REG16(    TIM9_OCBR,   0xFFFFB20C,__READ_WRITE);
__IO_REG16(    TIM9_CNTR,   0xFFFFB210,__READ);
__IO_REG16_BIT(TIM9_CR1,    0xFFFFB214,__READ_WRITE,__timcr1_bits);
__IO_REG16_BIT(TIM9_CR2,    0xFFFFB218,__READ_WRITE,__timcr2_bits);
__IO_REG16_BIT(TIM9_SR,     0xFFFFB21C,__READ_WRITE,__timsr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(CAN0_CR,      0xFFFFC400,__READ_WRITE,__canncr_bits);
__IO_REG16_BIT(CAN0_SR,      0xFFFFC404,__READ_WRITE,__cannsr_bits);
__IO_REG16_BIT(CAN0_ERR,     0xFFFFC408,__READ      ,__cannerr_bits);
__IO_REG16_BIT(CAN0_BTR,     0xFFFFC40C,__READ_WRITE,__cannbtr_bits);
__IO_REG16(    CAN0_IDR,     0xFFFFC410,__READ);
__IO_REG16_BIT(CAN0_TESTR,   0xFFFFC414,__READ_WRITE,__canntestr_bits);
__IO_REG16_BIT(CAN0_BRPR,    0xFFFFC418,__READ_WRITE,__cannbrpr_bits);
__IO_REG16_BIT(CAN0_IF1_CRR, 0xFFFFC420,__READ_WRITE,__cannifxcrr_bits);
__IO_REG16_BIT(CAN0_IF1_CMR, 0xFFFFC424,__READ_WRITE,__cannifxcmr_bits);
__IO_REG16_BIT(CAN0_IF1_M1R, 0xFFFFC428,__READ_WRITE,__cannifxm1r_bits);
__IO_REG16_BIT(CAN0_IF1_M2R, 0xFFFFC42C,__READ_WRITE,__cannifxm2r_bits);
__IO_REG16_BIT(CAN0_IF1_A1R, 0xFFFFC430,__READ_WRITE,__cannifxa1r_bits);
__IO_REG16_BIT(CAN0_IF1_A2R, 0xFFFFC434,__READ_WRITE,__cannifxa2r_bits);
__IO_REG16_BIT(CAN0_IF1_MCR, 0xFFFFC438,__READ_WRITE,__cannifxmcr_bits);
__IO_REG16_BIT(CAN0_IF1_DA1R,0xFFFFC43C,__READ_WRITE,__cannifxda1r_bits);
__IO_REG16_BIT(CAN0_IF1_DA2R,0xFFFFC440,__READ_WRITE,__cannifxda2r_bits);
__IO_REG16_BIT(CAN0_IF1_DB1R,0xFFFFC444,__READ_WRITE,__cannifxdb1r_bits);
__IO_REG16_BIT(CAN0_IF1_DB2R,0xFFFFC448,__READ_WRITE,__cannifxdb2r_bits);
__IO_REG16_BIT(CAN0_IF2_CRR, 0xFFFFC480,__READ_WRITE,__cannifxcrr_bits);
__IO_REG16_BIT(CAN0_IF2_CMR, 0xFFFFC484,__READ_WRITE,__cannifxcmr_bits);
__IO_REG16_BIT(CAN0_IF2_M1R, 0xFFFFC488,__READ_WRITE,__cannifxm1r_bits);
__IO_REG16_BIT(CAN0_IF2_M2R, 0xFFFFC48C,__READ_WRITE,__cannifxm2r_bits);
__IO_REG16_BIT(CAN0_IF2_A1R, 0xFFFFC490,__READ_WRITE,__cannifxa1r_bits);
__IO_REG16_BIT(CAN0_IF2_A2R, 0xFFFFC494,__READ_WRITE,__cannifxa2r_bits);
__IO_REG16_BIT(CAN0_IF2_MCR, 0xFFFFC498,__READ_WRITE,__cannifxmcr_bits);
__IO_REG16_BIT(CAN0_IF2_DA1R,0xFFFFC49c,__READ_WRITE,__cannifxda1r_bits);
__IO_REG16_BIT(CAN0_IF2_DA2R,0xFFFFC4A0,__READ_WRITE,__cannifxda2r_bits);
__IO_REG16_BIT(CAN0_IF2_DB1R,0xFFFFC4A4,__READ_WRITE,__cannifxdb1r_bits);
__IO_REG16_BIT(CAN0_IF2_DB2R,0xFFFFC4A8,__READ_WRITE,__cannifxdb2r_bits);
__IO_REG32(    CAN0_TXR1R,   0xFFFFC500,__READ);
__IO_REG32(    CAN0_TXR2R,   0xFFFFC504,__READ);
__IO_REG32(    CAN0_ND1R,    0xFFFFC520,__READ);
__IO_REG32(    CAN0_ND2R,    0xFFFFC524,__READ);
__IO_REG32(    CAN0_IP1R,    0xFFFFC540,__READ);
__IO_REG32(    CAN0_IP2R,    0xFFFFC544,__READ);
__IO_REG32(    CAN0_MV1R,    0xFFFFC560,__READ);
__IO_REG32(    CAN0_MV2R,    0xFFFFC564,__READ);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(CAN1_CR,      0xFFFFC800,__READ_WRITE,__canncr_bits);
__IO_REG16_BIT(CAN1_SR,      0xFFFFC804,__READ_WRITE,__cannsr_bits);
__IO_REG16_BIT(CAN1_ERR,     0xFFFFC808,__READ      ,__cannerr_bits);
__IO_REG16_BIT(CAN1_BTR,     0xFFFFC80C,__READ_WRITE,__cannbtr_bits);
__IO_REG16(    CAN1_IDR,     0xFFFFC810,__READ);
__IO_REG16_BIT(CAN1_TESTR,   0xFFFFC814,__READ_WRITE,__canntestr_bits);
__IO_REG16_BIT(CAN1_BRPR,    0xFFFFC818,__READ_WRITE,__cannbrpr_bits);
__IO_REG16_BIT(CAN1_IF1_CRR, 0xFFFFC820,__READ_WRITE,__cannifxcrr_bits);
__IO_REG16_BIT(CAN1_IF1_CMR, 0xFFFFC824,__READ_WRITE,__cannifxcmr_bits);
__IO_REG16_BIT(CAN1_IF1_M1R, 0xFFFFC828,__READ_WRITE,__cannifxm1r_bits);
__IO_REG16_BIT(CAN1_IF1_M2R, 0xFFFFC82C,__READ_WRITE,__cannifxm2r_bits);
__IO_REG16_BIT(CAN1_IF1_A1R, 0xFFFFC830,__READ_WRITE,__cannifxa1r_bits);
__IO_REG16_BIT(CAN1_IF1_A2R, 0xFFFFC834,__READ_WRITE,__cannifxa2r_bits);
__IO_REG16_BIT(CAN1_IF1_MCR, 0xFFFFC838,__READ_WRITE,__cannifxmcr_bits);
__IO_REG16_BIT(CAN1_IF1_DA1R,0xFFFFC83C,__READ_WRITE,__cannifxda1r_bits);
__IO_REG16_BIT(CAN1_IF1_DA2R,0xFFFFC840,__READ_WRITE,__cannifxda2r_bits);
__IO_REG16_BIT(CAN1_IF1_DB1R,0xFFFFC844,__READ_WRITE,__cannifxdb1r_bits);
__IO_REG16_BIT(CAN1_IF1_DB2R,0xFFFFC848,__READ_WRITE,__cannifxdb2r_bits);
__IO_REG16_BIT(CAN1_IF2_CRR, 0xFFFFC880,__READ_WRITE,__cannifxcrr_bits);
__IO_REG16_BIT(CAN1_IF2_CMR, 0xFFFFC884,__READ_WRITE,__cannifxcmr_bits);
__IO_REG16_BIT(CAN1_IF2_M1R, 0xFFFFC888,__READ_WRITE,__cannifxm1r_bits);
__IO_REG16_BIT(CAN1_IF2_M2R, 0xFFFFC88C,__READ_WRITE,__cannifxm2r_bits);
__IO_REG16_BIT(CAN1_IF2_A1R, 0xFFFFC890,__READ_WRITE,__cannifxa1r_bits);
__IO_REG16_BIT(CAN1_IF2_A2R, 0xFFFFC894,__READ_WRITE,__cannifxa2r_bits);
__IO_REG16_BIT(CAN1_IF2_MCR, 0xFFFFC898,__READ_WRITE,__cannifxmcr_bits);
__IO_REG16_BIT(CAN1_IF2_DA1R,0xFFFFC89c,__READ_WRITE,__cannifxda1r_bits);
__IO_REG16_BIT(CAN1_IF2_DA2R,0xFFFFC8A0,__READ_WRITE,__cannifxda2r_bits);
__IO_REG16_BIT(CAN1_IF2_DB1R,0xFFFFC8A4,__READ_WRITE,__cannifxdb1r_bits);
__IO_REG16_BIT(CAN1_IF2_DB2R,0xFFFFC8A8,__READ_WRITE,__cannifxdb2r_bits);
__IO_REG32(    CAN1_TXR1R,   0xFFFFC900,__READ);
__IO_REG32(    CAN1_TXR2R,   0xFFFFC904,__READ);
__IO_REG32(    CAN1_ND1R,    0xFFFFC920,__READ);
__IO_REG32(    CAN1_ND2R,    0xFFFFC924,__READ);
__IO_REG32(    CAN1_IP1R,    0xFFFFC940,__READ);
__IO_REG32(    CAN1_IP2R,    0xFFFFC944,__READ);
__IO_REG32(    CAN1_MV1R,    0xFFFFC960,__READ);
__IO_REG32(    CAN1_MV2R,    0xFFFFC964,__READ);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(CAN2_CR,      0xFFFFCC00,__READ_WRITE,__canncr_bits);
__IO_REG16_BIT(CAN2_SR,      0xFFFFCC04,__READ_WRITE,__cannsr_bits);
__IO_REG16_BIT(CAN2_ERR,     0xFFFFCC08,__READ      ,__cannerr_bits);
__IO_REG16_BIT(CAN2_BTR,     0xFFFFCC0C,__READ_WRITE,__cannbtr_bits);
__IO_REG16(    CAN2_IDR,     0xFFFFCC10,__READ);
__IO_REG16_BIT(CAN2_TESTR,   0xFFFFCC14,__READ_WRITE,__canntestr_bits);
__IO_REG16_BIT(CAN2_BRPR,    0xFFFFCC18,__READ_WRITE,__cannbrpr_bits);
__IO_REG16_BIT(CAN2_IF1_CRR, 0xFFFFCC20,__READ_WRITE,__cannifxcrr_bits);
__IO_REG16_BIT(CAN2_IF1_CMR, 0xFFFFCC24,__READ_WRITE,__cannifxcmr_bits);
__IO_REG16_BIT(CAN2_IF1_M1R, 0xFFFFCC28,__READ_WRITE,__cannifxm1r_bits);
__IO_REG16_BIT(CAN2_IF1_M2R, 0xFFFFCC2C,__READ_WRITE,__cannifxm2r_bits);
__IO_REG16_BIT(CAN2_IF1_A1R, 0xFFFFCC30,__READ_WRITE,__cannifxa1r_bits);
__IO_REG16_BIT(CAN2_IF1_A2R, 0xFFFFCC34,__READ_WRITE,__cannifxa2r_bits);
__IO_REG16_BIT(CAN2_IF1_MCR, 0xFFFFCC38,__READ_WRITE,__cannifxmcr_bits);
__IO_REG16_BIT(CAN2_IF1_DA1R,0xFFFFCC3C,__READ_WRITE,__cannifxda1r_bits);
__IO_REG16_BIT(CAN2_IF1_DA2R,0xFFFFCC40,__READ_WRITE,__cannifxda2r_bits);
__IO_REG16_BIT(CAN2_IF1_DB1R,0xFFFFCC44,__READ_WRITE,__cannifxdb1r_bits);
__IO_REG16_BIT(CAN2_IF1_DB2R,0xFFFFCC48,__READ_WRITE,__cannifxdb2r_bits);
__IO_REG16_BIT(CAN2_IF2_CRR, 0xFFFFCC80,__READ_WRITE,__cannifxcrr_bits);
__IO_REG16_BIT(CAN2_IF2_CMR, 0xFFFFCC84,__READ_WRITE,__cannifxcmr_bits);
__IO_REG16_BIT(CAN2_IF2_M1R, 0xFFFFCC88,__READ_WRITE,__cannifxm1r_bits);
__IO_REG16_BIT(CAN2_IF2_M2R, 0xFFFFCC8C,__READ_WRITE,__cannifxm2r_bits);
__IO_REG16_BIT(CAN2_IF2_A1R, 0xFFFFCC90,__READ_WRITE,__cannifxa1r_bits);
__IO_REG16_BIT(CAN2_IF2_A2R, 0xFFFFCC94,__READ_WRITE,__cannifxa2r_bits);
__IO_REG16_BIT(CAN2_IF2_MCR, 0xFFFFCC98,__READ_WRITE,__cannifxmcr_bits);
__IO_REG16_BIT(CAN2_IF2_DA1R,0xFFFFCC9c,__READ_WRITE,__cannifxda1r_bits);
__IO_REG16_BIT(CAN2_IF2_DA2R,0xFFFFCCA0,__READ_WRITE,__cannifxda2r_bits);
__IO_REG16_BIT(CAN2_IF2_DB1R,0xFFFFCCA4,__READ_WRITE,__cannifxdb1r_bits);
__IO_REG16_BIT(CAN2_IF2_DB2R,0xFFFFCCA8,__READ_WRITE,__cannifxdb2r_bits);
__IO_REG32(    CAN2_TXR1R,   0xFFFFCD00,__READ);
__IO_REG32(    CAN2_TXR2R,   0xFFFFCD04,__READ);
__IO_REG32(    CAN2_ND1R,    0xFFFFCD20,__READ);
__IO_REG32(    CAN2_ND2R,    0xFFFFCD24,__READ);
__IO_REG32(    CAN2_IP1R,    0xFFFFCD40,__READ);
__IO_REG32(    CAN2_IP2R,    0xFFFFCD44,__READ);
__IO_REG32(    CAN2_MV1R,    0xFFFFCD60,__READ);
__IO_REG32(    CAN2_MV2R,    0xFFFFCD64,__READ);
...
__IO_REG16_BIT(ADC_D12,     0xFFFFF880,__READ,      __adcdx_bits);
__IO_REG16_BIT(ADC_D13,     0xFFFFF884,__READ,      __adcdx_bits);
__IO_REG16_BIT(ADC_D14,     0xFFFFF888,__READ,      __adcdx_bits);
__IO_REG16_BIT(ADC_D15,     0xFFFFF88C,__READ,      __adcdx_bits);
...
/***************************************************************************
 **
 **  STR730 IRQ Interrupt Vector Table
 **
 ***************************************************************************/
...
/***************************************************************************
 **
 **  STR730 FIQ Interrupt Vector Table
 **
 ***************************************************************************/
#define INT0_INT         0
#define TIM0_INT         1
