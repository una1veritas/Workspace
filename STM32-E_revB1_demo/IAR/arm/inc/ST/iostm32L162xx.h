...
#ifndef __IOSTM32L162xx_H
#define __IOSTM32L162xx_H
 ...
 ***************************************************************************
 **
 **   STM32L162xx SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(AES_CR,          	0x50060000,__READ_WRITE ,__aes_cr_bits);
__IO_REG32_BIT(AES_SR,          	0x50060004,__READ				,__aes_sr_bits);
__IO_REG32(		 AES_DINR,          0x50060008,__READ_WRITE );
__IO_REG32(		 AES_DOUTR,         0x5006000C,__READ				);
__IO_REG32(		 AES_KEYR0,         0x50060010,__READ_WRITE );
__IO_REG32(		 AES_KEYR1,         0x50060014,__READ_WRITE );
__IO_REG32(		 AES_KEYR2,         0x50060018,__READ_WRITE );
__IO_REG32(		 AES_KEYR3,         0x5006001C,__READ_WRITE );
__IO_REG32(		 AES_IVR0,          0x50060020,__READ_WRITE );
__IO_REG32(		 AES_IVR1,          0x50060024,__READ_WRITE );
__IO_REG32(		 AES_IVR2,          0x50060028,__READ_WRITE );
__IO_REG32(		 AES_IVR3,          0x5006002C,__READ_WRITE );
...
#define NVIC_AES		            71          /* AES global interrupt         */

#endif    /* __IOSTM32L162xx_H */
