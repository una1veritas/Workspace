 ...
 ***************************************************************************/
#ifndef __IOSTR912FA_H
#define __IOSTR912FA_H
 ...
 ***************************************************************************
 **
 **   STR912FA SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* BC 16th Entry Target Address register (FMI_BCE16ADDR) */
typedef struct{
  __REG32 BCE16ADDR       :24;
  __REG32                 : 8;
} __fmi_bce16addr_bits;
...
__REG32               : 2;
__REG32 BPM           : 1;
__REG32 SYNCREADDEV   : 1;
__REG32 BRLEN         : 2;
__REG32               : 4;
__REG32 BMWRITE       : 1;
__REG32 SYNCWRITEDEV  : 1;
__REG32 BWLEN         : 2;
__REG32               :12;
} __emi_bcr_bits;
...
/* Enhanced control register (MC_ECR) */
typedef struct{
__REG16 DUM  : 1;
__REG16 ESP  : 1;
__REG16 ATS  : 2;
...
__IO_REG32_BIT(FMI_BCE16ADDR,       0x54000020,__READ_WRITE ,__fmi_bce16addr_bits);
...
__IO_REG32_BIT(FMI_BCE16ADDR_BUF,   0x44000020,__READ_WRITE ,__fmi_bce16addr_bits);
...
__IO_REG32_BIT(EMI_BRDCR1,          0x7400001C,__READ_WRITE ,__emi_brdcr_bits);
...
__IO_REG32_BIT(EMI_BRDCR2,          0x7400003C,__READ_WRITE ,__emi_brdcr_bits);
...
__IO_REG32_BIT(EMI_BRDCR3,          0x7400005C,__READ_WRITE ,__emi_brdcr_bits);
...
__IO_REG32_BIT(EMI_BRDCR0,          0x740000FC,__READ_WRITE ,__emi_brdcr_bits);
__IO_REG32_BIT(EMI_CCR,             0x74000204,__READ_WRITE ,__emi_ccr_bits);
...
__IO_REG32_BIT(EMI_BRDCR1_BUF,      0x6400001C,__READ_WRITE ,__emi_brdcr_bits);
...
__IO_REG32_BIT(EMI_BRDCR2_BUF,      0x6400003C,__READ_WRITE ,__emi_brdcr_bits);
...
__IO_REG32_BIT(EMI_BRDCR3_BUF,      0x6400005C,__READ_WRITE ,__emi_brdcr_bits);
...
__IO_REG32_BIT(EMI_BRDCR0_BUF,      0x640000FC,__READ_WRITE ,__emi_brdcr_bits);
__IO_REG32_BIT(EMI_CCR_BUF,         0x64000204,__READ_WRITE ,__emi_ccr_bits);
...
__IO_REG16(    MC_CMPW,             0x5C003018,__READ_WRITE );
__IO_REG16(    MC_CMPV,             0x5C00301C,__READ_WRITE );
__IO_REG16(    MC_CMPU,             0x5C003020,__READ_WRITE );
__IO_REG16(    MC_CMP0,             0x5C003024,__READ_WRITE );
...
__IO_REG16_BIT(MC_ECR,              0x5C003048,__READ_WRITE ,__mc_ecr_bits);
__IO_REG16_BIT(MC_LOK,              0x5C00304C,__READ_WRITE ,__mc_lok_bits);
...
__IO_REG16(    MC_CMPW_BUF,         0x4C003018,__READ_WRITE );
__IO_REG16(    MC_CMPV_BUF,         0x4C00301C,__READ_WRITE );
__IO_REG16(    MC_CMPU_BUF,         0x4C003020,__READ_WRITE );
__IO_REG16(    MC_CMP0_BUF,         0x4C003024,__READ_WRITE );
...
__IO_REG16_BIT(MC_ECR_BUF,          0x4C003048,__READ_WRITE ,__mc_ecr_bits);
__IO_REG16_BIT(MC_LOK_BUF,          0x4C00304C,__READ_WRITE ,__mc_lok_bits);
...
__IO_REG16_BIT(ADC_DDR,             0x5C00A038,__READ       ,__adc_ddr_bits);
__IO_REG16_BIT(ADC_CR2,             0x5C00A03C,__READ_WRITE ,__adc_cr2_bits);
...
__IO_REG16_BIT(ADC_DDR_BUF,         0x4C00A038,__READ       ,__adc_ddr_bits);
__IO_REG16_BIT(ADC_CR2_BUF,         0x4C00A03C,__READ_WRITE ,__adc_cr2_bits);
