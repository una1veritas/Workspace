 ...
 ***************************************************************************
 **
 **    IOEP9315 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* Graphics Accelerator Source Pixel Start register */
/*  */
typedef struct{
__REG32 PEL  : 5;
__REG32      :27;
...
/* Graphics Accelerator Destination Pixel Start/End registeð */
typedef struct{
__REG32 SPEL  : 5;
__REG32       :11;
__REG32 EPEL  : 5;
...
/* Graphics Accelerator Block Function Source Width Register */
typedef struct{
__REG32  WIDTH :12;
__REG32        :20;
} __blksrcwidth_bits;

/* Graphics Accelerator Block Source Line Length Register */
typedef struct{
__REG32  LEN :12;
__REG32      :20;
} __srclinelength_bits;

/* Graphics Accelerator Block Function Destination Width Register */
typedef struct{
__REG32  WIDTH :12;
__REG32        :20;
} __blkdestwidth_bits;

/* Graphics Accelerator Block Function Destination Height Register */
typedef struct{
__REG32  HEIGHT :11;
__REG32         :21;
} __blkdestheight_bits;

/* Graphics Accelerator Block Destination Line Length Register */
typedef struct{
__REG32 LEN  :12;
__REG32      :20;
} __destlinelength_bits;

/* Graphics Accelerator Block Function Control Register*/
typedef struct{
__REG32 EN     : 1;
__REG32 INTEN  : 1;
__REG32 TRANS  : 1;
...
/* Graphics Accelerator Block Function Transparency Pattern Register */
typedef struct{
__REG32 PATRN  :24;
__REG32        : 8;
} __transpattrn_bits;

/* Graphics Accelerator Block Mask Register */
typedef struct{
__REG32 MASK  :24;
__REG32       : 8;
} __blockmask_bits;

/* Graphics Accelerator Block Function Background Register */
typedef struct{
__REG32 BG  :24;
__REG32     : 8;
} __background_bits;

/* Graphics Accelerator Line Draw Increment Register */
typedef struct{
__REG32  XINC :12;
__REG32       : 4;
__REG32  YINC :12;
...
/* Graphics Accelerator Line Draw Initialization Register */
typedef struct{
__REG32  XINIT :12;
__REG32        : 4;
__REG32  YINIT :12;
...
/* Graphics Accelerator Line Pattern Register */
typedef struct{
__REG32 PATRN :16;
__REG32 CNT0  : 1;
__REG32 CNT1  : 1;
...
__REG32     : 7;
__REG32 WA  : 1;
} __smcpcattribute_bits;

/* SMC PCCommon register */
typedef struct{
__REG32 PC  : 8;
__REG32 HC  : 4;
__REG32     : 4;
...
__IO_REG32_BIT(PC1Attribute,        0x80080020,__READ_WRITE,__smcpcattribute_bits);
__IO_REG32_BIT(PC1Common,           0x80080024,__READ_WRITE,__smcpccommon_bits);
__IO_REG32_BIT(PC1IO,               0x80080028,__READ_WRITE,__smcpcio_bits);
__IO_REG32_BIT(PC2Attribute,        0x80080030,__READ_WRITE,__smcpcattribute_bits);
__IO_REG32_BIT(PC2Common,           0x80080034,__READ_WRITE,__smcpccommon_bits);
__IO_REG32_BIT(PC2IO,               0x80080038,__READ_WRITE,__smcpcio_bits);
__IO_REG32_BIT(PCMCIACtrl,          0x80080040,__READ_WRITE,__smcpcmciactrl_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(SSP1CR0,             0x808a0000,__READ_WRITE,__sspcr0_bits);
__IO_REG32_BIT(SSP1CR1,             0x808a0004,__READ_WRITE,__sspcr1_bits);
__IO_REG32(    SSP1DR,              0x808a0008,__READ_WRITE);
__IO_REG32_BIT(SSP1SR,              0x808a000c,__READ_WRITE,__sspsr_bits);
__IO_REG32_BIT(SSP1CPSR,            0x808a0010,__READ_WRITE,__sspcpcr_bits);
__IO_REG32_BIT(SSP1IIR,             0x808a0014,__READ_WRITE,__sspiir_bits);
...
__IO_REG32(    UART3ModemTstCtrl,   0x808e0108,__READ      );
