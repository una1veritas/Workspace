...
/* PCI Interrupt Flag Register (PCIINT) */
typedef struct{
__REG32 SEIF            : 1;
__REG32 PEIF            : 1;
__REG32 MPEIF           : 1;
...
/* PCI Arbitration Register (PCIARB) */
typedef struct{
__REG32 AM              : 1;
__REG32 AP              : 1;
__REG32                 :30;
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(PCICTR,                0xB0002000,__READ_WRITE ,__pcictr_bits);
__IO_REG32_BIT(PCISTR,                0xB0002004,__READ_WRITE ,__pcistr_bits);
__IO_REG32_BIT(PCILATIMER,            0xB0002008,__READ_WRITE ,__pcilatimer_bits);
__IO_REG32_BIT(PCIINTEN,              0xB0002010,__READ_WRITE ,__pciinten_bits);
__IO_REG32_BIT(PCIINT,                0xB0002014,__READ       ,__pciint_bits);
__IO_REG32_BIT(CFGADDR,               0xB0002020,__READ_WRITE ,__cfgaddr_bits);
__IO_REG32(    CFGDATA,               0xB0002024,__READ_WRITE );
__IO_REG32_BIT(PCIARB,                0xB000204C,__READ_WRITE ,__pciarb_bits);
...
#define AIC_PCI         24  /* PCI Controller Interrupt                    */
