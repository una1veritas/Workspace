...
**
**     Reference manual:    KL05RM, Rev.0 Draft. C, May 2012
**     Version:             rev. 1.0, 2012-06-08
**
**     Abstract:
...
typedef enum IRQn {
  ...
  DebugMonitor_IRQn            = -4,               /**< Cortex-M0 Debug Monitor Interrupt */
  ...
  MCM_IRQn                     = 4,                /**< Normal interrupt */
  FTFA_IRQn                    = 5,                /**< FTFA command complete/read collision interrupt */
  LVD_LVW_IRQn                 = 6,                /**< Low Voltage Detect, Low Voltage Warning */
  LLW_IRQn                     = 7,                /**< Low Leakage Wakeup */
  I2C0_IRQn                    = 8,                /**< I2C0 interrupt */
  Reserved_25_IRQn             = 9,                /**< Reserved interrupt 25 */
  SPI0_IRQn                    = 10,               /**< SPI0 interrupt */
  Reserved_27_IRQn             = 11,               /**< Reserved interrupt 27 */
  UART0_IRQn                   = 12,               /**< UART0 status and error interrupt */
  Reserved_29_IRQn             = 13,               /**< Reserved interrupt 29 */
  Reserved_30_IRQn             = 14,               /**< Reserved interrupt 30 */
  ADC0_IRQn                    = 15,               /**< ADC0 interrupt */
  CMP0_IRQn                    = 16,               /**< CMP0 interrupt */
  TPM0_IRQn                    = 17,               /**< TPM0 fault, overflow and channels interrupt */
  Reserved_36_IRQn             = 18,               /**< Reserved interrupt 36 */
  Reserved_35_IRQn             = 19,               /**< Reserved interrupt 35 */
  RTC_IRQn                     = 20,               /**< RTC interrupt */
  RTC_Seconds_IRQn             = 21,               /**< RTC seconds interrupt */
  PIT_IRQn                     = 22,               /**< PIT timer channel 0 interrupt */
  Reserved_39_IRQn             = 23,               /**< Reserved interrupt 39 */
  Reserved_40_IRQn             = 24,               /**< Reserved interrupt 40 */
  DAC0_IRQn                    = 25,               /**< DAC0 interrupt */
  TSI0_IRQn                    = 26,               /**< TSI0 interrupt */
  MCG_IRQn                     = 27,               /**< MCG interrupt */
  LPTimer_IRQn                 = 28,               /**< LPTimer interrupt */
  Reserved_45_IRQn             = 29,               /**< Reserved interrupt 45 */
...
typedef struct {
  ...
  struct {                                         /* offset: 0x100, array step: 0x10 */
    ...
    union {                                          /* offset: 0x108, array step: 0x10 */
      ...
      __IO uint8_t DSR;                                /**< DMA_DSR0 register...DMA_DSR3 register., array offset: 0x108, array step: 0x10 */
    };
...
typedef struct {
  ...
  __I  uint8_t C8;                                 /**< MCG Control 8 Register, offset: 0xD */
} MCG_Type;
...
typedef struct {
  ...
  __I  uint32_t AUTHSTAT;                          /**< Lock Status Register, offset: 0xFB8 */
...
typedef struct {
  ...
  __I  uint32_t CTRL;                              /**< MTB DWT Control Register, offset: 0x1000 */
       uint8_t RESERVED_1[28];
  struct {                                         /* offset: 0x1020, array step: 0x10 */
    __IO uint32_t COMP;                              /**< MTB_DWT Comparator Register, array offset: 0x1020, array step: 0x10 */
    __IO uint32_t MASK;                              /**< MTB_DWT Comparator Mask Register, array offset: 0x1024, array step: 0x10 */
    __IO uint32_t FCT;                               /**< MTB_DWT Comparator Function Register 0..MTB_DWT Comparator Function Register 1, array offset: 0x1028, array step: 0x10 */
         uint8_t RESERVED_0[4];
  } COMPARATOR[2];
       uint8_t RESERVED_2[448];
  __IO uint32_t TBCTRL;                            /**< MTB_DWT Trace Buffer Control Register, offset: 0x1200 */
       uint8_t RESERVED_3[3524];
  __I  uint32_t DEVICECFG;                         /**< Device Configuration Register, offset: 0x1FC8 */
  __I  uint32_t DEVICETYPID;                       /**< Device Type Identifier Register, offset: 0x1FCC */
  __I  uint32_t PERIPHID[8];                       /**< Peripheral ID Register, array offset: 0x1FD0, array step: 0x4 */
  __I  uint32_t COMPID[4];                         /**< Component ID Register, array offset: 0x1FF0, array step: 0x4 */
} MTBDWT_Type;
...
typedef struct {
  ...
  __I  uint32_t ENTRY[3];                          /**< Entry, array offset: 0x2000, array step: 0x4 */
  __I  uint32_t TABLEMARK;                         /**< End of Table Marker Register, offset: 0x200C */
       uint8_t RESERVED_1[4032];
  __I  uint32_t PERIPHID4;                         /**< Peripheral ID Register, offset: 0x2FD0 */
  __I  uint32_t PERIPHID5;                         /**< Peripheral ID Register, offset: 0x2FD4 */
  __I  uint32_t PERIPHID6;                         /**< Peripheral ID Register, offset: 0x2FD8 */
  __I  uint32_t PERIPHID7;                         /**< Peripheral ID Register, offset: 0x2FDC */
  __I  uint32_t PERIPHID0;                         /**< Peripheral ID Register, offset: 0x2FE0 */
  __I  uint32_t PERIPHID1;                         /**< Peripheral ID Register, offset: 0x2FE4 */
  __I  uint32_t PERIPHID2;                         /**< Peripheral ID Register, offset: 0x2FE8 */
  __I  uint32_t PERIPHID3;                         /**< Peripheral ID Register, offset: 0x2FEC */
  __I  uint32_t COMPID[4];                         /**< Component ID Register, array offset: 0x2FF0, array step: 0x4 */
} ROM_Type;
...
typedef struct {
  ...
  __IO uint8_t DL;                                 /**< SPI data register, offset: 0x5 */
       uint8_t RESERVED_1[1];
  __IO uint8_t ML;                                 /**< SPI match register, offset: 0x7 */
} SPI_Type;
