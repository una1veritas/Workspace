...
#if !defined(MCU_MK53N512CMD100)  /* Check if this MCU has not been already activated... */

/* Check if another MCU has not been activated yet */
#if (defined(MCU_ACTIVE))
  #error MK53N512CMD100 MCU library: There is already active another MCU library. Do #include of one "*_MCU.h" only.
#else /* (!defined(MCU_ACTIVE)) */
  #define MCU_ACTIVE  /* Mark there is some MCU already active */
  #define MCU_MK53N512CMD100  /* Mark specific MCU as active */
