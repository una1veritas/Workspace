 ...
 **    Motorola MAC7200 microcontroller family
 **    (MAC7202, MAC7212, MAC7222, MAC7242, MAC7252)
 **
...
#ifndef __IOMAC7200_H
#define __IOMAC7200_H
 ...
 ***************************************************************************
 **
 **    MAC7200 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************/
...
/* SSM - Error Configuration Register */
typedef struct{
__REG16 BABORT  : 1;
__REG16         :15;
} __error_bits;
 ...
 **
 ***************************************************************************/
__IO_REG32(    PR_PFM,       0xfc004000,__READ_WRITE);
__IO_REG32(    CR_PFM,       0xfc004010,__READ_WRITE);
__IO_REG32_BIT(PR_SRAM,      0xfc004300,__READ_WRITE,__prport_bits);
__IO_REG32_BIT(CR_SRAM,      0xfc004310,__READ_WRITE,__crport_bits);
__IO_REG32(    PR_BAM,       0xfc004500,__READ_WRITE);
__IO_REG32(    CR_BAM,       0xfc004510,__READ_WRITE);
...
__IO_REG8(     NMICR,        0xfc04002b,__READ_WRITE);
__IO_REG8(     MUDCR,        0xfc040030,__READ_WRITE);
__IO_REG8(     ECR,          0xfc040043,__READ_WRITE);
__IO_REG8(     ESR,          0xfc040047,__READ_WRITE);
__IO_REG16(    EEGR,         0xfc04004a,__READ_WRITE);
__IO_REG32(    FEAR,         0xfc040050,__READ_WRITE);
__IO_REG8(     FEMR,         0xfc040056,__READ_WRITE);
__IO_REG8(     FEAT,         0xfc040057,__READ_WRITE);
__IO_REG32(    FEDR,         0xfc04005c,__READ_WRITE);
__IO_REG32(    REAR,         0xfc040060,__READ_WRITE);
__IO_REG8(     RESR,         0xfc040065,__READ_WRITE);
__IO_REG8(     REMR,         0xfc040066,__READ_WRITE);
__IO_REG8(     REAT,         0xfc040067,__READ_WRITE);
__IO_REG32(    REDR,         0xfc04006c,__READ_WRITE);
...
__IO_REG16_BIT(DEBUGPORT,    0xfc080006,__READ_WRITE,__debugport_bits);
__IO_REG16_BIT(ERROR,        0xfc080008,__READ_WRITE,__error_bits);
__IO_REG16(    SYSRESET,     0xfc08000c,__READ_WRITE);
...
__IO_REG32_BIT(DSPIA_CTAR2,  0xfc0b4014,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIA_CTAR3,  0xfc0b4018,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIA_CTAR4,  0xfc0b401c,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIA_CTAR5,  0xfc0b4020,__READ_WRITE,__dspix_ctarn_bits);
...
__IO_REG32_BIT(DSPIA_TXFR1,  0xfc0b4040,__READ      ,__dspix_txfrn_bits);
__IO_REG32_BIT(DSPIA_TXFR2,  0xfc0b4044,__READ      ,__dspix_txfrn_bits);
__IO_REG32_BIT(DSPIA_TXFR3,  0xfc0b4048,__READ      ,__dspix_txfrn_bits);
...
__IO_REG32_BIT(DSPIB_CTAR2,  0xfc0b8014,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIB_CTAR3,  0xfc0b8018,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIB_CTAR4,  0xfc0b801c,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIB_CTAR5,  0xfc0b8020,__READ_WRITE,__dspix_ctarn_bits);
...
__IO_REG32_BIT(DSPIB_TXFR1,  0xfc0b8040,__READ      ,__dspix_txfrn_bits);
__IO_REG32_BIT(DSPIB_TXFR2,  0xfc0b8044,__READ      ,__dspix_txfrn_bits);
__IO_REG32_BIT(DSPIB_TXFR3,  0xfc0b8048,__READ      ,__dspix_txfrn_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(DSPIC_MCR,    0xfc0bc000,__READ_WRITE,__dspix_mcr_bits);
__IO_REG32_BIT(DSPIC_TCR,    0xfc0bc008,__READ_WRITE,__dspix_tcr_bits);
__IO_REG32_BIT(DSPIC_CTAR0,  0xfc0bc00c,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIC_CTAR1,  0xfc0bc010,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIC_CTAR2,  0xfc0bc014,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIC_CTAR3,  0xfc0bc018,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIC_CTAR4,  0xfc0bc01c,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIC_CTAR5,  0xfc0bc020,__READ_WRITE,__dspix_ctarn_bits);
__IO_REG32_BIT(DSPIC_SR,     0xfc0bc02c,__READ_WRITE,__dspix_sr_bits);
__IO_REG32_BIT(DSPIC_RSER,   0xfc0bc030,__READ_WRITE,__dspix_rser_bits);
__IO_REG32_BIT(DSPIC_PUSHR,  0xfc0bc034,__READ_WRITE,__dspix_pushr_bits);
__IO_REG32_BIT(DSPIC_POPR,   0xfc0bc038,__READ      ,__dspix_popr_bits);
__IO_REG32_BIT(DSPIC_TXFR0,  0xfc0bc03c,__READ      ,__dspix_txfrn_bits);
__IO_REG32_BIT(DSPIC_TXFR1,  0xfc0bc040,__READ      ,__dspix_txfrn_bits);
__IO_REG32_BIT(DSPIC_TXFR2,  0xfc0bc044,__READ      ,__dspix_txfrn_bits);
__IO_REG32_BIT(DSPIC_TXFR3,  0xfc0bc048,__READ      ,__dspix_txfrn_bits);
__IO_REG32_BIT(DSPIC_RXFR0,  0xfc0bc07c,__READ      ,__dspix_rxfrn_bits);
__IO_REG32_BIT(DSPIC_RXFR1,  0xfc0bc080,__READ      ,__dspix_rxfrn_bits);
__IO_REG32_BIT(DSPIC_RXFR2,  0xfc0bc084,__READ      ,__dspix_rxfrn_bits);
__IO_REG32_BIT(DSPIC_RXFR3,  0xfc0bc088,__READ      ,__dspix_rxfrn_bits);
...
__IO_REG32(    ATDCAL_A,     0xfc0e0004,__READ_WRITE);
