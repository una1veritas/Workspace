...
#ifndef __IOMB9BF512N_H
#define __IOMB9BF512N_H
 ...
 ***************************************************************************
 **
 **   MB9BF512N SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* WFASZR (Work Flash Access Size Register) */
typedef struct {
  __REG32  ASZ            : 1;
  __REG32                 :31;
} __wfaszr_bits;

/* WFRWTR (Work Flash Read Wait Register) */
typedef struct {
  __REG32  RWT            : 3;
  __REG32                 :29;
} __wfrwtr_bits;

/* WFSTR (Work Flash Status Register) */
typedef struct {
  __REG32  RDY            : 1;
  __REG32  HNG            : 1;
  __REG32                 :30;
...
/* IGBT Mode Control Register (IGBTC) */
typedef struct {
  __REG8  IGBTMD          : 1;
  __REG8  IGTRGLV         : 1;
  __REG8  IGOSEL          : 2;
...
/* Interrupt Control Register L (QICRL) */
typedef struct {
  __REG8  QPCMIE         : 1;
  __REG8  QPCMF          : 1;
  __REG8  QPRCMIE        : 1;
...
/* Interrupt Control Register H (QICRH) */
typedef struct {
  __REG8  CDCIE          : 1;
  __REG8  CDCF           : 1;
  __REG8  DIRPC          : 1;
...
/* Interrupt Factor Vector Relocate Setting Register (IRQCMODER) */
typedef struct {
  __REG32  IRQCMODER      : 1;
  __REG32                 :31;
} __irqcmoder_bits;
...
/* IRQ25/26 Batch Read Register (IRQxxMON) */
typedef struct {
  __REG32  ADCINT         : 4;
  __REG32                 :28;
} __irqmon25_bits;

/* IRQ27 Batch Read Register (IRQ27MON) */
typedef struct {
  __REG32  ADCINT         : 4;
  __REG32                 :28;
} __irqmon27_bits;
...
/* IRQ47 Batch Read Register (IRQ47MON) */
typedef struct {
  __REG32                 :11;
  __REG32  FLASHINT       : 1;
  __REG32                 :20;
...
/* CAN Transmit Request Registers */
typedef struct {
    __REG32  TxRqst1        : 1;
    __REG32  TxRqst2        : 1;
    __REG32  TxRqst3        : 1;
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(WFASZR,            0x200E0000,__READ_WRITE ,__wfaszr_bits);
__IO_REG32_BIT(WFRWTR,            0x200E0004,__READ_WRITE ,__wfrwtr_bits);
__IO_REG32_BIT(WFSTR,             0x200E0008,__READ_WRITE ,__wfstr_bits);
...
__IO_REG32(    WDG_ICL,           0x4001100C,__READ_WRITE );
...
__IO_REG8_BIT( IGBTC,              0x40024380,__READ_WRITE ,__ppg_igbtc_bits);
...
__IO_REG8_BIT( QPRC0_QICRL,       0x40026014,__READ_WRITE ,__qdu_qicrl_bits);
__IO_REG8_BIT( QPRC0_QICRH,       0x40026015,__READ_WRITE ,__qdu_qicrh_bits);
__IO_REG8_BIT( QPRC0_QCRL,        0x40026018,__READ_WRITE ,__qdu_qcrl_bits);
__IO_REG8_BIT( QPRC0_QCRH,        0x40026019,__READ_WRITE ,__qdu_qcrh_bits);
__IO_REG16_BIT(QPRC0_QECR,        0x4002601C,__READ_WRITE ,__qdu_qecr_bits);
__IO_REG16(    QPRC0_QRCRR,       0x4002603C,__READ       );
__IO_REG16(    QPRC0_QPCRR,       0x4002603E,__READ       );
...
__IO_REG8_BIT( QPRC1_QICRL,       0x40026054,__READ_WRITE ,__qdu_qicrl_bits);
__IO_REG8_BIT( QPRC1_QICRH,       0x40026055,__READ_WRITE ,__qdu_qicrh_bits);
__IO_REG8_BIT( QPRC1_QCRL,        0x40026058,__READ_WRITE ,__qdu_qcrl_bits);
__IO_REG8_BIT( QPRC1_QCRH,        0x40026059,__READ_WRITE ,__qdu_qcrh_bits);
__IO_REG16_BIT(QPRC1_QECR,        0x4002605C,__READ_WRITE ,__qdu_qecr_bits);
__IO_REG16(    QPRC1_QRCRR,       0x4002607C,__READ       );
__IO_REG16(    QPRC1_QPCRR,       0x4002607E,__READ       );
...
__IO_REG8_BIT( QPRC2_QICRL,       0x40026094,__READ_WRITE ,__qdu_qicrl_bits);
__IO_REG8_BIT( QPRC2_QICRH,       0x40026095,__READ_WRITE ,__qdu_qicrh_bits);
__IO_REG8_BIT( QPRC2_QCRL,        0x40026098,__READ_WRITE ,__qdu_qcrl_bits);
__IO_REG8_BIT( QPRC2_QCRH,        0x40026099,__READ_WRITE ,__qdu_qcrh_bits);
__IO_REG16_BIT(QPRC2_QECR,        0x4002609C,__READ_WRITE ,__qdu_qecr_bits);
__IO_REG16(    QPRC2_QRCRR,       0x400260BC,__READ       );
__IO_REG16(    QPRC2_QPCRR,       0x400260BE,__READ       );
...
__IO_REG8_BIT( ODDPKS,            0x4003100B,__READ_WRITE ,__oddpks_bits);
__IO_REG32_BIT(IRQCMODER,         0x4003100C,__READ_WRITE ,__irqcmoder_bits);
...
__IO_REG32_BIT(IRQ47MON,          0x400310D0,__READ       ,__irqmon47_bits);
//__IO_REG8_BIT( ODDPKS,            0x4003120F,__READ_WRITE ,__oddpks_bits);
...
__IO_REG8_BIT( UPINT_STR,         0x40036020,__READ       ,__upint_str_bits);
__IO_REG8_BIT( UPCR5,             0x40036024,__READ_WRITE ,__upcr5_bits);
__IO_REG8_BIT( USBEN,             0x40036030,__READ_WRITE ,__usben0_bits);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT( CANPRE,            0x40037000,__READ_WRITE ,__canpre_bits);
...
__IO_REG8_BIT( WTDR,          0x4003B00F,__READ_WRITE ,__wthr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(CAN0_CTRLR,        0x40062000,__READ_WRITE ,__canx_ctrlr_bits);
__IO_REG16_BIT(CAN0_STATR,        0x40062002,__READ_WRITE ,__canx_statr_bits);
__IO_REG16_BIT(CAN0_ERRCNT,       0x40062004,__READ       ,__canx_errcnt_bits);
__IO_REG16_BIT(CAN0_BTR,          0x40062006,__READ_WRITE ,__canx_btr_bits);
__IO_REG16(    CAN0_INTR,         0x40062008,__READ       );
__IO_REG16_BIT(CAN0_TESTR,        0x4006200A,__READ_WRITE ,__canx_testr_bits);
__IO_REG16_BIT(CAN0_BRPER,        0x4006200C,__READ_WRITE ,__canx_brper_bits);
__IO_REG16_BIT(CAN0_IF1CREQ,      0x40062010,__READ_WRITE ,__canx_ifycreq_bits);
__IO_REG16_BIT(CAN0_IF1CMSK,      0x40062012,__READ_WRITE ,__canx_ifycmsk_bits);
__IO_REG32_BIT(CAN0_IF1MSK,       0x40062014,__READ_WRITE ,__canx_ifymsk_bits);
__IO_REG32_BIT(CAN0_IF1ARB,       0x40062018,__READ_WRITE ,__canx_ifyarb_bits);
__IO_REG16_BIT(CAN0_IF1MCTR,      0x4006201C,__READ_WRITE ,__canx_ifymctr_bits);
__IO_REG32_BIT(CAN0_IF1DTA,       0x40062020,__READ_WRITE ,__canx_ifydta_bits);
#define CAN0_IF1DTA1      CAN0_IF1DTA_bit.__shortl
#define CAN0_IF1DTA1_bit  CAN0_IF1DTA_bit.__shortl_bit
#define CAN0_IF1DTA2      CAN0_IF1DTA_bit.__shorth
#define CAN0_IF1DTA2_bit  CAN0_IF1DTA_bit.__shorth_bit
#define CAN0_IF1Data0	  CAN0_IF1DTA_bit.__byte0
#define CAN0_IF1Data1	  CAN0_IF1DTA_bit.__byte1
#define CAN0_IF1Data2	  CAN0_IF1DTA_bit.__byte2
#define CAN0_IF1Data3	  CAN0_IF1DTA_bit.__byte3
__IO_REG32_BIT(CAN0_IF1DTB,       0x40062024,__READ_WRITE ,__canx_ifydtb_bits);
#define CAN0_IF1DTB1      CAN0_IF1DTB_bit.__shortl
#define CAN0_IF1DTB1_bit  CAN0_IF1DTB_bit.__shortl_bit
#define CAN0_IF1DTB2      CAN0_IF1DTB_bit.__shorth
#define CAN0_IF1DTB2_bit  CAN0_IF1DTB_bit.__shorth_bit
#define CAN0_IF1Data4     CAN0_IF1DTB_bit.__byte4
#define CAN0_IF1Data5     CAN0_IF1DTB_bit.__byte5
#define CAN0_IF1Data6     CAN0_IF1DTB_bit.__byte6
#define CAN0_IF1Data7     CAN0_IF1DTB_bit.__byte7
__IO_REG16_BIT(CAN0_IF2CREQ,      0x40062040,__READ_WRITE ,__canx_ifycreq_bits);
__IO_REG16_BIT(CAN0_IF2CMSK,      0x40062042,__READ_WRITE ,__canx_ifycmsk_bits);
__IO_REG32_BIT(CAN0_IF2MSK,       0x40062044,__READ_WRITE ,__canx_ifymsk_bits);
__IO_REG32_BIT(CAN0_IF2ARB,       0x40062048,__READ_WRITE ,__canx_ifyarb_bits);
__IO_REG16_BIT(CAN0_IF2MCTR,      0x4006204C,__READ_WRITE ,__canx_ifymctr_bits);
__IO_REG32_BIT(CAN0_IF2DTA,       0x40062050,__READ_WRITE ,__canx_ifydta_bits);
#define CAN0_IF2DTA1      CAN0_IF2DTA_bit.__shortl
#define CAN0_IF2DTA1_bit  CAN0_IF2DTA_bit.__shortl_bit
#define CAN0_IF2DTA2      CAN0_IF2DTA_bit.__shorth
#define CAN0_IF2DTA2_bit  CAN0_IF2DTA_bit.__shorth_bit
#define CAN0_IF2Data0     CAN0_IF2DTA_bit.__byte0
#define CAN0_IF2Data1     CAN0_IF2DTA_bit.__byte1
#define CAN0_IF2Data2     CAN0_IF2DTA_bit.__byte2
#define CAN0_IF2Data3     CAN0_IF2DTA_bit.__byte3
__IO_REG32_BIT(CAN0_IF2DTB,       0x40062054,__READ_WRITE ,__canx_ifydtb_bits);
#define CAN0_IF2DTB1      CAN0_IF2DTB_bit.__shortl
#define CAN0_IF2DTB1_bit  CAN0_IF2DTB_bit.__shortl_bit
#define CAN0_IF2DTB2      CAN0_IF2DTB_bit.__shorth
#define CAN0_IF2DTB2_bit  CAN0_IF2DTB_bit.__shorth_bit
#define CAN0_IF2Data4     CAN0_IF2DTB_bit.__byte4
#define CAN0_IF2Data5     CAN0_IF2DTB_bit.__byte5
#define CAN0_IF2Data6     CAN0_IF2DTB_bit.__byte6
#define CAN0_IF2Data7     CAN0_IF2DTB_bit.__byte7
__IO_REG32_BIT(CAN0_TREQR,        0x40062080,__READ       ,__canx_treqr_bits);
__IO_REG32_BIT(CAN0_NEWDT,        0x40062090,__READ       ,__canx_newdt_bits);
__IO_REG32_BIT(CAN0_INTPND,       0x400620A0,__READ       ,__canx_intpnd_bits);
__IO_REG32_BIT(CAN0_MSGVAL,       0x400620B0,__READ       ,__canx_msgval_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(CAN1_CTRLR,        0x40063000,__READ_WRITE ,__canx_ctrlr_bits);
__IO_REG16_BIT(CAN1_STATR,        0x40063002,__READ_WRITE ,__canx_statr_bits);
__IO_REG16_BIT(CAN1_ERRCNT,       0x40063004,__READ       ,__canx_errcnt_bits);
__IO_REG16_BIT(CAN1_BTR,          0x40063006,__READ_WRITE ,__canx_btr_bits);
__IO_REG16(    CAN1_INTR,         0x40063008,__READ       );
__IO_REG16_BIT(CAN1_TESTR,        0x4006300A,__READ_WRITE ,__canx_testr_bits);
__IO_REG16_BIT(CAN1_BRPER,        0x4006300C,__READ_WRITE ,__canx_brper_bits);
__IO_REG16_BIT(CAN1_IF1CREQ,      0x40063010,__READ_WRITE ,__canx_ifycreq_bits);
__IO_REG16_BIT(CAN1_IF1CMSK,      0x40063012,__READ_WRITE ,__canx_ifycmsk_bits);
__IO_REG32_BIT(CAN1_IF1MSK,       0x40063014,__READ_WRITE ,__canx_ifymsk_bits);
__IO_REG32_BIT(CAN1_IF1ARB,       0x40063018,__READ_WRITE ,__canx_ifyarb_bits);
__IO_REG16_BIT(CAN1_IF1MCTR,      0x4006301C,__READ_WRITE ,__canx_ifymctr_bits);
__IO_REG32_BIT(CAN1_IF1DTA,       0x40063020,__READ_WRITE ,__canx_ifydta_bits);
#define CAN1_IF1DTA1      CAN1_IF1DTA_bit.__shortl
#define CAN1_IF1DTA1_bit  CAN1_IF1DTA_bit.__shortl_bit
#define CAN1_IF1DTA2      CAN1_IF1DTA_bit.__shorth
#define CAN1_IF1DTA2_bit  CAN1_IF1DTA_bit.__shorth_bit
#define CAN1_IF1Data0     CAN1_IF1DTA_bit.__byte0
#define CAN1_IF1Data1     CAN1_IF1DTA_bit.__byte1
#define CAN1_IF1Data2     CAN1_IF1DTA_bit.__byte2
#define CAN1_IF1Data3     CAN1_IF1DTA_bit.__byte3
__IO_REG32_BIT(CAN1_IF1DTB,       0x40063024,__READ_WRITE ,__canx_ifydtb_bits);
#define CAN1_IF1DTB1      CAN1_IF1DTB_bit.__shortl
#define CAN1_IF1DTB1_bit  CAN1_IF1DTB_bit.__shortl_bit
#define CAN1_IF1DTB2      CAN1_IF1DTB_bit.__shorth
#define CAN1_IF1DTB2_bit  CAN1_IF1DTB_bit.__shorth_bit
#define CAN1_IF1Data4     CAN1_IF1DTB_bit.__byte4
#define CAN1_IF1Data5     CAN1_IF1DTB_bit.__byte5
#define CAN1_IF1Data6     CAN1_IF1DTB_bit.__byte6
#define CAN1_IF1Data7     CAN1_IF1DTB_bit.__byte7
__IO_REG16_BIT(CAN1_IF2CREQ,      0x40063040,__READ_WRITE ,__canx_ifycreq_bits);
__IO_REG16_BIT(CAN1_IF2CMSK,      0x40063042,__READ_WRITE ,__canx_ifycmsk_bits);
__IO_REG32_BIT(CAN1_IF2MSK,       0x40063044,__READ_WRITE ,__canx_ifymsk_bits);
__IO_REG32_BIT(CAN1_IF2ARB,       0x40063048,__READ_WRITE ,__canx_ifyarb_bits);
__IO_REG16_BIT(CAN1_IF2MCTR,      0x4006304C,__READ_WRITE ,__canx_ifymctr_bits);
__IO_REG32_BIT(CAN1_IF2DTA,       0x40063050,__READ_WRITE ,__canx_ifydta_bits);
#define CAN1_IF2DTA1      CAN1_IF2DTA_bit.__shortl
#define CAN1_IF2DTA1_bit  CAN1_IF2DTA_bit.__shortl_bit
#define CAN1_IF2DTA2      CAN1_IF2DTA_bit.__shorth
#define CAN1_IF2DTA2_bit  CAN1_IF2DTA_bit.__shorth_bit
#define CAN1_IF2Data0     CAN1_IF2DTA_bit.__byte0
#define CAN1_IF2Data1     CAN1_IF2DTA_bit.__byte1
#define CAN1_IF2Data2     CAN1_IF2DTA_bit.__byte2
#define CAN1_IF2Data3     CAN1_IF2DTA_bit.__byte3
__IO_REG32_BIT(CAN1_IF2DTB,       0x40063054,__READ_WRITE ,__canx_ifydtb_bits);
#define CAN1_IF2DTB1      CAN1_IF2DTB_bit.__shortl
#define CAN1_IF2DTB1_bit  CAN1_IF2DTB_bit.__shortl_bit
#define CAN1_IF2DTB2      CAN1_IF2DTB_bit.__shorth
#define CAN1_IF2DTB2_bit  CAN1_IF2DTB_bit.__shorth_bit
#define CAN1_IF2Data4     CAN1_IF2DTB_bit.__byte4
#define CAN1_IF2Data5     CAN1_IF2DTB_bit.__byte5
#define CAN1_IF2Data6     CAN1_IF2DTB_bit.__byte6
#define CAN1_IF2Data7     CAN1_IF2DTB_bit.__byte7
__IO_REG32_BIT(CAN1_TREQR,        0x40063080,__READ       ,__canx_treqr_bits);
__IO_REG32_BIT(CAN1_NEWDT,        0x40063090,__READ       ,__canx_newdt_bits);
__IO_REG32_BIT(CAN1_INTPND,       0x400630A0,__READ       ,__canx_intpnd_bits);
__IO_REG32_BIT(CAN1_MSGVAL,       0x400630B0,__READ       ,__canx_msgval_bits);
...
#define NVIC_CAN0             48          /* CAN ch.0                                                                          */
#define NVIC_CAN1             49          /* CAN ch.1                                                                          */
...
#define NVIC_FLASH_RDY        63          /* Flash RDY, HANG interrupt                                                         */

#endif    /* __IOMB9BF512N_H */
...
Interrupt41  = CAN0           0xC0
Interrupt42  = CAN1           0xC4
