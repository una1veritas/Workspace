 ...
 **    Atmel Semiconductors AT91M55800
 **    
...
#ifndef __AT91M55800_H
#define __AT91M55800_H
 ...
 ***************************************************************************
 **                            
 **    AT91m55800 SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
typedef struct {
  __REG32 dbw  :2; /* databus width          */
  __REG32 nws  :3; /* number of wait states  */
  __REG32 wse  :1; /* wait state enable      */
  __REG32      :1;
  __REG32 pages:2; /* page size              */
  __REG32 tdf  :3; /* data float output time */
  __REG32 bat  :1; /* byte acces type        */
  __REG32 csen :1; /* chip select enable     */
  __REG32 wp   :1; /* write protect          */
  __REG32      :5;
  __REG32 ba   :12;/* base address           */
} __ebicsr_bits;


/* EBI remap control register */
typedef struct {
  __REG32 rcb  :1; /* remap command bit      */
  __REG32      :31;
} __ebircr_bits;	
...
typedef struct {
  __REG32      :4;
  __REG32 drp  :1; /* data read protocol    */
  __REG32      :27;
} __ebimcr_bits;	


/* APMC system clock enable/disable/status register */
typedef struct {
  __REG32 cpu  :1; /* system clock enable/disable/status bit */
  __REG32      :31;
} __apmcscr_bits;	


/* APMC peripherial clock enable/disable/status register */
typedef struct {
  __REG32      :2;
  __REG32 us0  :1;
  __REG32 us1  :1;
...
typedef struct {
  __REG32 moscbyp :1; /* main oscillator bypass */
  __REG32 moscen  :1; /* main oscillator enable */
  __REG32 mckods  :1; /* master clock output disable */
  __REG32         :1;
  __REG32 pres    :3; /* prescaler selection    */
  __REG32         :1;
  __REG32 mul     :6; /* phase lock loop factor */
  __REG32 css     :2; /* clock source selection */
  __REG32 oscount :8; /* main oscillator counter*/
  __REG32 pllcount:6; /* pll lock counter       */
  __REG32         :2;
} __apmccgmr_bits;	
...
typedef struct {
  __REG32 shdalc :1; /* shut down or alarm control */
  __REG32 wkackc :1; /* wake up or alarm acknoledge command */
  __REG32        :30;
} __apmcpcr_bits;	

/* APMC power mode register */
typedef struct {
  __REG32 shdals :2; /* shut down or alarm output selection          */
  __REG32 wkacks :2; /* wake up or alarm acknoledge output selection */
  __REG32 alwken :1; /* alarm wake up enable                         */
  __REG32 alshen :1; /* alarm shut down enable                       */
  __REG32 wkedg  :2; /* wake up input edge selection                 */
  __REG32        :24;
} __apmcpmr_bits;	

/* APMC status/interrupt enable/interrupt disable/interrupt mask register */
typedef struct {
  __REG32 moscs  :1; /* main oscillator        */
  __REG32 lock   :1; /* pll lock               */
  __REG32        :30;
} __apmcir_bits;	
...
typedef struct {
  __REG32 updtim :1; /* update request time register     */
  __REG32 updcal :1; /* update request calendar register */
  __REG32        :6;
  __REG32 tevsel :2; /* time event selection             */
  __REG32        :6; 
  __REG32 cevsel :2; /* calendar event selection         */
  __REG32        :14;
} __rtccr_bits;
	
/* RTC mode register */
typedef struct {
  __REG32 hrmod :1; /* 12/24 hour mode */
  __REG32       :31;
} __rtcmr_bits;
	
/* RTC time register */
typedef struct {
  __REG32 sec    :7; /* current second  */
  __REG32        :1; 
  __REG32 min    :7; /* current minute  */
  __REG32        :1;
  __REG32 hour   :6; /* current hour    */ 
  __REG32 ampm   :1; /* AM/PM indicator */
  __REG32        :9;
} __rtctimr_bits;
	
/* RTC calendar register */
typedef struct {
  __REG32 cent :6; /* current century */
  __REG32      :2;
  __REG32 year :8; /* current year    */
  __REG32 month:5; /* current month   */
  __REG32 day  :3; /* current day     */ 
  __REG32 date :6; /* current date    */
  __REG32      :2;
} __rtccalr_bits;
	
/* RTC time alarm register */
typedef struct {
  __REG32 sec   :7; /* second alarm        */
  __REG32 secen :1; /* second alarm enable */
  __REG32 min   :7; /* minute alarm        */
  __REG32 minen :1; /* minute alarm enable */
  __REG32 hour  :6; /* hour alarm          */
  __REG32 ampm  :1; /* AM/PM indicator     */
  __REG32 houren:1; /* hour alarm enable   */ 
  __REG32       :8;
} __rtctar_bits;    


/* RTC calender alarm register */
typedef struct {
  __REG32       :16; 
  __REG32 month :5; /* month alarm         */
  __REG32       :2; 
  __REG32 mthen :1; /* month alarm enable  */
  __REG32 date  :6; /* date alarm          */
  __REG32       :1;
  __REG32 daten :1; /* date alarm enable   */ 
} __rtccar_bits;    


/* RTC status/interrupt clear/interrupt enable/interrupt disable/
interrupt mask register */
typedef struct {
  __REG32 ackupd:1; /* acknoledge for update */
  __REG32 alarm :1; /* alarm flag            */
  __REG32 sec   :1; /* second event          */ 
  __REG32 timev :1; /* time event            */
  __REG32 calev :1; /* calendar event        */
  __REG32       :27;
} __rtcir_bits;   

/* RTC valid entry register */
typedef struct {
  __REG32 nvt   :1; /* non-valid time           */
  __REG32 nvc   :1; /* non-valid calendar       */
  __REG32 nvtal :1; /* non-valid time alarm     */ 
  __REG32 nvcal :1; /* non-valid calendar alarm */
  __REG32       :28;
} __rtcver_bits;   
...
typedef struct {
  __REG32 wden   :1; /* watch dog enable       */
  __REG32 rsten  :1; /* reset enable           */
  __REG32 irqen  :1; /* interrupt enable       */
  __REG32 exten  :1; /* external signal enable */ 
  __REG32 okey   :12;/* overflow access key    */
  __REG32        :16;
} __wdomr_bits;
	
/* WD: clock mode register */
typedef struct {
  __REG32 wdclks :2; /* clock selection             */
  __REG32 hpcv   :4; /* high pre-load counter value */
  __REG32        :1;  
  __REG32 ckey   :9; /* clock access key            */
  __REG32        :16;
} __wdcmr_bits;
	
/* WD: control register */
typedef struct {
  __REG32 rstkey :16; /* restart key */
  __REG32        :16;
} __wdcr_bits;
	
/* WD: status register */
typedef struct {
  __REG32 wdovf  :1; /* watchdog overflow */
  __REG32        :31;
} __wdsr_bits;

/* AIC source mode registers */
typedef struct {
  __REG32 prior   :3; /* priority level         */
  __REG32         :2;
  __REG32 srctype :2; /* interrupt source type  */
  __REG32         :25;
} __aicsmr_bits;
...
typedef struct {
  __REG32 vector  :32; /* interrupt handler address */
} __aicsvr_bits;
...
typedef struct {
  __REG32 irqid   :5; /* current IRQ identifier */
  __REG32         :27;
} __aicisr_bits;


/* AIC: interrupt pending/mask/enable command/disable command/
clear command/interrupt set command register */
typedef struct {
  __REG32 fiq     :1; 
  __REG32 swirq   :1;
  __REG32 us0irq  :1;
...
typedef struct {
  __REG32 spuvec  :32; /* spurious interrupt vector handler address*/
} __aicspur_bits;
...
/* SF: chip id register */
typedef struct {
  __REG32 version :5; /* chip version                    */
  __REG32         :3;
  __REG32 nvpsiz  :4; /* non-volatile program memory size*/
  __REG32 nvdsiz  :4; /*      -"-      data      -"-     */
  __REG32 vdsiz   :4; /* volatile data memory size       */ 
  __REG32 arch    :8; /* chip architecture               */
  __REG32 nvptyp  :3; /* non-volatile program memory type*/
  __REG32 ext     :1; /* extension flag                  */
} __sfcidr_bits;

/* Chip id extension register is reserved for future use */
...
typedef struct {
  __REG32         :5;
  __REG32 aic     :1; /* AIC protect mode enable  */
  __REG32         :10; 
  __REG32 pmrkey  :16;/* Protect mode register key*/
} __sfpmr_bits;

/* USART: control register */
typedef struct {
  __REG32         :2;
  __REG32 rstrx   :1; /* reset receiver     */
  __REG32 rsttx   :1; /* reset transmitter  */
  __REG32 rxen    :1; /* receiver enable    */
  __REG32 rxdis   :1; /* receiver disable   */
  __REG32 txen    :1; /* transmitter enable */
  __REG32 txdis   :1; /* transmitter disable*/
  __REG32 rststa  :1; /* reset status bits  */
  __REG32 sttbrk  :1; /* start break        */
  __REG32 stpbrk  :1; /* stop break         */
  __REG32 sttto   :1; /* start time-out     */ 
  __REG32 senda   :1; /* send address       */
  __REG32         :19;
} __usartcr_bits;
...
typedef struct {
  __REG32         :4;
  __REG32 usclks  :2; /* clock selection         */
  __REG32 chrl    :2; /* charachter length       */
  __REG32 sync    :1; /* synchronous mode select */
  __REG32 par     :3; /* parity type             */
  __REG32 nbstop  :2; /* number of stop bits     */
  __REG32 chmode  :2; /* channel mode            */
  __REG32         :1;
  __REG32 mode9   :1; /* 9-bit character length  */
  __REG32 clko    :1; /* clock output select     */
  __REG32         :13;
} __usartmr_bits;
...
typedef struct {
  __REG32 rxchr   :9; /* received character */
  __REG32         :23;
} __usartrhr_bits;
...
typedef struct {
  __REG32 txchr   :9; /*character to be transmitted */
  __REG32         :23;
} __usartthr_bits;

/* USART baud rate generator register */
typedef struct {
  __REG32 cd      :16; /* clock divisor */
  __REG32         :16;
} __usartbrgr_bits;

/* USART receiver time-out register */
typedef struct {
  __REG32 to      :8; /* time-out value */
  __REG32         :24;
} __usartrtr_bits;

/* USART transmitter time-guard register */
typedef struct {
  __REG32 tg      :8; /* time-guard value */
  __REG32         :24;
} __usartttr_bits;
...
typedef struct {
  __REG32 sync    :1; /* synchro command */
  __REG32         :31;
} __tcbcr_bits;

/* TC block mode register */
typedef struct {
  __REG32 tc0xc0s :2; /* external clock signal 0 selection */
  __REG32 tc1xc1s :2; /*        -"-            1   -"-     */
  __REG32 tc2xc2s :2; /*        -"-            2   -"-     */
  __REG32         :26;
} __tcbmr_bits;
...
typedef struct {
  __REG32 clken   :1; /* couter clock enable command   */
  __REG32 clkdis  :1; /*     -"-     disable   -"-     */
  __REG32 swtrg   :1; /* software trigger command      */
  __REG32         :29;
} __tcccr_bits;

/* TC channel mode register: capture mode */
typedef struct {
  __REG32 tcclks  :3; /* clock selection                       */
  __REG32 clki    :1; /* clock invert                          */
  __REG32 burst   :2; /* burst signal selection                */
  __REG32 ldbstop :1; /* counter clock stopped with RB loading */
  __REG32 ldbdis  :1; /*     -"-       disable     -"-         */
  __REG32 etrgedg :2; /* external trigger edge selection       */
  __REG32 abetrg  :1; /* 0=TIOB, 1=TIOA external trigger enable*/	
  __REG32         :3;	
  __REG32 cpctrg  :1; /* RC compare trigger enable             */
  __REG32 wave    :1; /* wave mode enable                      */
  __REG32 ldra    :2; /* RA loading selection                  */
  __REG32 ldrb    :2; /* RB    -"-                             */
  __REG32         :12;	 
} __tccmrcm_bits;
...
typedef struct {
  ...
  __REG32 cpcstop :1;
  __REG32 cpcdis  :1;
  __REG32 eevtedg :2; /* external event edge selection */
  __REG32 eevt    :2; /*        -"-     selection      */
  __REG32 enetrg  :1; /* external event trigger enable */	
  __REG32         :1;
  __REG32 cpctrg  :1;
  __REG32 wave    :1;
  __REG32 acpa    :2; /* RA compare     effect on TIOA     */
  __REG32 acpc    :2; /* RC                 -"-            */
  __REG32 aeevt   :2; /* external event     -"-            */
  __REG32 aswtrg  :2; /* software trigger   -"-            */
  __REG32 bcpb    :2; /* RB comapare    effect on TIOB     */
  __REG32 bcpc    :2; /* RC                -"-             */
  __REG32 beevt   :2; /* external event    -"-             */
  __REG32 bswtrg  :2; /* software trigger  -"-             */
} __tccmrwm_bits;
...
/* TC status register */
typedef struct {
  __REG32 covfs   :1; /* counter overflow status */
  __REG32 lovrs   :1; /* load overrun status     */
  __REG32 cpas    :1; /* RA compare status       */
  __REG32 cpbs    :1; /* RB       -"-            */
  __REG32 cpcs    :1; /* RC       -"-            */
  __REG32 ldras   :1; /* RA loading status       */
  __REG32 ldrbs   :1; /* RB loading status       */
  __REG32 etrgs   :1; /* external trigger status */
  __REG32         :8;
  __REG32 clksta  :1;	
  __REG32 mtioa   :1; /* TIOA mirror             */
  __REG32 mtiob   :1; /* TIOB -"-                */
  __REG32         :13;
} __tcsr_bits;
...
typedef struct {
  ...
  __REG32 spidis  :1;
  __REG32         :5;
  __REG32 swrst   :1; /*software reset*/
  __REG32         :24;
} __spcr_bits;

/* SPI mode register */
typedef struct {
  __REG32 mstr   :1; /* master/slave mode     */
  __REG32 ps     :1; /* peripheral select     */
  __REG32 pcsdec :1; /* chip select decode    */
  __REG32 mck32  :1; /* clock selection       */
  __REG32        :3;
  __REG32 llb    :1; /* local loopback enable */
  __REG32        :8;
  __REG32 pcs    :4; /* perpheral chip select */
  __REG32        :4;
  __REG32 dlybcs :8; /* delay between chip selects */
} __spmr_bits;


/* SPI receive data register */
typedef struct {
  __REG32 rd     :16; /* receive data */
  __REG32 pcs    :4;  /* peripheral chip select status */
  __REG32        :12; 
} __sprdr_bits;
...
typedef struct {
  __REG32 td     :16; /* transmit data */
  __REG32 pcs    :4;  /* peripheral chip select*/
  __REG32        :12; 
} __sptdr_bits;

/* SPI status register */
typedef struct {
  __REG32 rdrf   :1; /* receive data register full  */
  __REG32 tdre   :1; /* transmit data register empty*/
  __REG32 modf   :1; /* mode fault error            */
  __REG32 ovres  :1; /* overrun error status        */
  __REG32 spendrx:1; /* end of receiver transfer    */
  __REG32 spendtx:1; /* end of transmitter transfer */
  __REG32        :10;
  __REG32 spiens :1; /* spi enable status           */
  __REG32        :15;
} __spsr_bits;

/* SPI interrupt enable/interrupt disable/interrupt mask register */
typedef struct {
  __REG32 rdrf   :1; 
  __REG32 tdre   :1; 
  __REG32 modf   :1; 
...
typedef struct {
  __REG32 cpol  :1; /* clock polarity    */
  __REG32 ncpha :1; /* clock phase       */
  __REG32       :2;
  __REG32 bits  :4; /* bits per transfer */
  __REG32 scbr  :8; /* serial clock baud rate */
  __REG32 dlybs :8; /* delay before SPCK */
  __REG32 dlybct:8; /* delay between consecutive transfers */
} __spcsr_bits;
...
typedef struct {
  __REG32 swrst :1; /* software reset  */
  __REG32 start :1; /* start conversion*/ 
  __REG32       :30;
} __adccr_bits;
...
/* ADC mode register */
typedef struct {
  __REG32 trgen   :1; /* trigger enable      */
  __REG32 trgsel  :3; /* trigger selection   */
  __REG32 res     :1; /* resolution          */
  __REG32 sleep   :1; /* sleep mode          */
  __REG32         :2;
  __REG32 prescal :6; /* prescaler rate mode */
  __REG32         :18;
} __adcmr_bits;

/* ADC channel enable/disable/status register */
typedef struct {
  __REG32 ch0     :1; 
  __REG32 ch1     :1; 
  __REG32 ch2     :1; 
...
/* ADC status/interrupt enable/interrupt disable/interrupt mask register */
typedef struct {
  __REG32 eoc0    :1; /* end of conversion */
  __REG32 eoc1    :1; 
  __REG32 eoc2    :1; 
  __REG32 eoc3    :1;  
  __REG32         :4;
  __REG32 ovre0   :1; /* overrun error */
  __REG32 ovre1   :1; 
  __REG32 ovre2   :1; 
  __REG32 ovre3   :1;
  __REG32         :20;  
...
typedef struct {
  __REG32 data    :10; /* converted data */ 
  __REG32         :22; 
} __adccdr_bits;
...
typedef struct {
  __REG32 swrst   :1; /*software reset    */
  __REG32 loopen  :1; /*enable loop mode  */
  __REG32 loopdis :1; /*disable loop mode */
  __REG32         :29; 
} __daccr_bits;

/* DAC mode register */
typedef struct {
  __REG32 ttrgen  :1; /* timer trigger enable     */
  __REG32 ttrgsel :3; /* timer trigger selection  */
  __REG32 res     :1; /* resolution               */
  __REG32         :27; 
} __dacmr_bits;

/* DAC data holding/output register */
typedef struct {
  __REG32 data    :10; 
  __REG32         :22; 
} __dacdr_bits;
...
/* DAC status register */
typedef struct {
  __REG32 datrdy  :1; /* data ready for conversion */
  __REG32 wavend  :1; 
  __REG32         :14;
  __REG32 loop    :1; /* loop mode status */
  __REG32         :15;
} __dacsr_bits;

/* DAC interrupt enable/interrupt disable/interrupt mask register */
typedef struct {
  __REG32 datrdy  :1; 
  __REG32 wavend  :1; 
  __REG32         :30;
...
__IO_REG32_BIT(__APMC_SCER,0xffff4000,__WRITE,__apmcscr_bits);
__IO_REG32_BIT(__APMC_SCDR,0xffff4004,__WRITE,__apmcscr_bits);
__IO_REG32_BIT(__APMC_SCSR,0xffff4008,__READ,__apmcscr_bits);
/* Reserved: 0xffff400c */
__IO_REG32_BIT(__APMC_PCER,0xffff4010,__WRITE,__apmcpcxr_bits);
__IO_REG32_BIT(__APMC_PCDR,0xffff4014,__WRITE,__apmcpcxr_bits);
__IO_REG32_BIT(__APMC_PCSR,0xffff4018,__READ,__apmcpcxr_bits);
/* Reserved : 0xffff401c */
__IO_REG32_BIT(__APMC_CGMR,0xffff4020,__READ_WRITE,__apmccgmr_bits);
/* Reserved: 0xffff4024 */
__IO_REG32_BIT(__APMC_PCR,0xffff4028,__WRITE,__apmcpcr_bits);
__IO_REG32_BIT(__APMC_PMR,0xffff402c,__READ_WRITE,__apmcpmr_bits);
__IO_REG32_BIT(__APMC_SR,0xffff4030,__READ,__apmcir_bits);
__IO_REG32_BIT(__APMC_IER,0xffff4034,__WRITE,__apmcir_bits);
__IO_REG32_BIT(__APMC_IDR,0xffff4038,__WRITE,__apmcir_bits);
__IO_REG32_BIT(__APMC_IMR,0xffff403c,__READ,__apmcir_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(__RTC_CR,0xfffb8000,__READ_WRITE,__rtccr_bits);
__IO_REG32_BIT(__RTC_MR,0xfffb8004,__READ_WRITE,__rtcmr_bits);
__IO_REG32_BIT(__RTC_TIMR,0xfffb8008,__READ_WRITE,__rtctimr_bits);
__IO_REG32_BIT(__RTC_CALR,0xfffb800c,__READ_WRITE,__rtccalr_bits);
__IO_REG32_BIT(__RTC_TAR,0xfffb8010,__READ_WRITE,__rtctar_bits);
__IO_REG32_BIT(__RTC_CAR,0xfffb8014,__READ_WRITE,__rtccar_bits);
__IO_REG32_BIT(__RTC_SR,0xfffb8018,__READ,__rtcir_bits);
__IO_REG32_BIT(__RTC_SCCR,0xfffb801c,__WRITE,__rtcir_bits);
__IO_REG32_BIT(__RTC_IER,0xfffb8020,__WRITE,__rtcir_bits);
__IO_REG32_BIT(__RTC_IDR,0xfffb8024,__WRITE,__rtcir_bits);
__IO_REG32_BIT(__RTC_IMR,0xfffb8028,__READ,__rtcir_bits);
__IO_REG32_BIT(__RTC_VER,0xfffb802c,__READ,__rtcver_bits);
...
__IO_REG32_BIT(__AIC_FVR,0xfffff104,__READ,__aicfvr_bits);
...
__IO_REG32_BIT(__AIC_SPU,0xfffff134,__READ_WRITE,__aicspur_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(__SF_CIDR,0xfff00000,__READ,__sfcidr_bits);
...
__IO_REG32_BIT(__US_IER,0xfffc0008,__WRITE,__usartir_bits);
__IO_REG32_BIT(__US_IDR,0xfffc000c,__WRITE,__usartir_bits);

__IO_REG32_BIT(__US_IMR,0xfffc0010,__READ,__usartir_bits);
__IO_REG32_BIT(__US_CSR,0xfffc0014,__READ,__usartir_bits);
...
__IO_REG32_BIT(__SP_CR,0xfffbc000,__WRITE,__spcr_bits);
__IO_REG32_BIT(__SP_MR,0xfffbc004,__READ_WRITE,__spmr_bits);
__IO_REG32_BIT(__SP_RDR,0xfffbc008,__READ,__sprdr_bits);
__IO_REG32_BIT(__SP_TDR,0xfffbc00c,__WRITE,__sptdr_bits);
__IO_REG32_BIT(__SP_SR,0xfffbc010,__READ,__spsr_bits);
__IO_REG32_BIT(__SP_IER,0xfffbc014,__WRITE,__spir_bits);
__IO_REG32_BIT(__SP_IDR,0xfffbc018,__WRITE,__spir_bits);
__IO_REG32_BIT(__SP_IMR,0xfffbc01c,__READ,__spir_bits);
__IO_REG32_BIT(__SP_RPR,0xfffbc020,__READ_WRITE,__sprpr_bits);
__IO_REG32_BIT(__SP_RCR,0xfffbc024,__READ_WRITE,__sprcr_bits);
__IO_REG32_BIT(__SP_TPR,0xfffbc028,__READ_WRITE,__sptpr_bits);
__IO_REG32_BIT(__SP_TCR,0xfffbc02c,__READ_WRITE,__sptcr_bits);
__IO_REG32_BIT(__SP_CSR0,0xfffbc030,__READ_WRITE,__spcsr_bits);
__IO_REG32_BIT(__SP_CSR1,0xfffbc034,__READ_WRITE,__spcsr_bits);
__IO_REG32_BIT(__SP_CSR2,0xfffbc038,__READ_WRITE,__spcsr_bits);
__IO_REG32_BIT(__SP_CSR3,0xfffbc03c,__READ_WRITE,__spcsr_bits);


/***************************************************************************
 **
 **  Analog to Digital Conversion DAC 0
 **  
 ***************************************************************************/
__IO_REG32_BIT(__ADC_CR,0xfffb0000,__WRITE,__adccr_bits);
__IO_REG32_BIT(__ADC_MR,0xfffb0004,__READ_WRITE,__adcmr_bits);
/* Reserved: 0xfffb0008, 0xfffb000c */
__IO_REG32_BIT(__ADC_CHER,0xfffb0010,__WRITE,__adcchr_bits);
__IO_REG32_BIT(__ADC_CHDR,0xfffb0014,__WRITE,__adcchr_bits);
__IO_REG32_BIT(__ADC_CHSR,0xfffb0018,__READ,__adcchr_bits);
/* Reserved: 0xfffb001c */
__IO_REG32_BIT(__ADC_SR,0xfffb0020,__READ,__adcir_bits);
__IO_REG32_BIT(__ADC_IER,0xfffb0024,__WRITE,__adcir_bits);
__IO_REG32_BIT(__ADC_IDR,0xfffb0028,__WRITE,__adcir_bits);
__IO_REG32_BIT(__ADC_IMR,0xfffb002c,__READ,__adcir_bits);

__IO_REG32_BIT(__ADC_CDR0,0xfffb0030,__READ,__adccdr_bits);
__IO_REG32_BIT(__ADC_CDR1,0xfffb0034,__READ,__adccdr_bits);
__IO_REG32_BIT(__ADC_CDR2,0xfffb0038,__READ,__adccdr_bits);
__IO_REG32_BIT(__ADC_CDR3,0xfffb003c,__READ,__adccdr_bits);

/***************************************************************************
 **
 **  Analog to Digital Conversion DAC 1
 **  
 ***************************************************************************/
__IO_REG32_BIT(__ADC_CR1,0xfffb4000,__WRITE,__adccr_bits);
__IO_REG32_BIT(__ADC_MR1,0xfffb4004,__READ_WRITE,__adcmr_bits);
/* Reserved: 0xfffb4008, 0xfffb400c */
__IO_REG32_BIT(__ADC_CHER1,0xfffb4010,__WRITE,__adcchr_bits);
__IO_REG32_BIT(__ADC_CHDR1,0xfffb4014,__WRITE,__adcchr_bits);
__IO_REG32_BIT(__ADC_CHSR1,0xfffb4018,__READ,__adcchr_bits);
/* Reserved: 0xfffb401c */
__IO_REG32_BIT(__ADC_SR1,0xfffb4020,__READ,__adcir_bits);
__IO_REG32_BIT(__ADC_IER1,0xfffb4024,__WRITE,__adcir_bits);
__IO_REG32_BIT(__ADC_IDR1,0xfffb4028,__WRITE,__adcir_bits);
__IO_REG32_BIT(__ADC_IMR1,0xfffb402c,__READ,__adcir_bits);

__IO_REG32_BIT(__ADC_CDR01,0xfffb4030,__READ,__adccdr_bits);
__IO_REG32_BIT(__ADC_CDR11,0xfffb4034,__READ,__adccdr_bits);
__IO_REG32_BIT(__ADC_CDR21,0xfffb4038,__READ,__adccdr_bits);
__IO_REG32_BIT(__ADC_CDR31,0xfffb403c,__READ,__adccdr_bits);


/***************************************************************************
 **
 **  Digital to Analog Conversion DAC 0
 **  
 ***************************************************************************/
__IO_REG32_BIT(__DAC_CR,0xfffa8000,__WRITE,__daccr_bits);
__IO_REG32_BIT(__DAC_MR,0xfffa8004,__READ_WRITE,__dacmr_bits);
__IO_REG32_BIT(__DAC_DHR,0xfffa8008,__READ_WRITE,__dacdr_bits);
__IO_REG32_BIT(__DAC_DOR,0xfffa800c,__READ,__dacdr_bits);
__IO_REG32_BIT(__DAC_SR,0xfffa8010,__READ,__dacsr_bits);
__IO_REG32_BIT(__DAC_IER,0xfffa8014,__WRITE,__dacir_bits);
__IO_REG32_BIT(__DAC_IDR,0xfffa8018,__WRITE,__dacir_bits);
__IO_REG32_BIT(__DAC_IMR,0xfffa801c,__READ,__dacir_bits);
__IO_REG32_BIT(__DAC_DPR,0xfffa8020,__READ_WRITE,__dacdpr_bits);
__IO_REG32_BIT(__DAC_DCR,0xfffa8024,__READ_WRITE,__dacdcr_bits);

/***************************************************************************
 **
 **  Digital to Analog Conversion DAC 1
 **  
 ***************************************************************************/
__IO_REG32_BIT(__DAC_CR1,0xfffac000,__WRITE,__daccr_bits);
__IO_REG32_BIT(__DAC_MR1,0xfffac004,__READ_WRITE,__dacmr_bits);
__IO_REG32_BIT(__DAC_DHR1,0xfffac008,__READ_WRITE,__dacdr_bits);
__IO_REG32_BIT(__DAC_DOR1,0xfffac00c,__READ,__dacdr_bits);
__IO_REG32_BIT(__DAC_SR1,0xfffac010,__READ,__dacsr_bits);
__IO_REG32_BIT(__DAC_IER1,0xfffac014,__WRITE,__dacir_bits);
__IO_REG32_BIT(__DAC_IDR1,0xfffac018,__WRITE,__dacir_bits);
__IO_REG32_BIT(__DAC_IMR1,0xfffac01c,__READ,__dacir_bits);
__IO_REG32_BIT(__DAC_DPR1,0xfffac020,__READ_WRITE,__dacdpr_bits);
__IO_REG32_BIT(__DAC_DCR1,0xfffac024,__READ_WRITE,__dacdcr_bits);
...
/* Reserved: 21 and 22 */
#define IRQ6    23  /* External interrupt 6  */
