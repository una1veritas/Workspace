...
#ifndef __IOADI7029_H
#define __IOADI7029_H
 ...
 ***************************************************************************
 **                            
 **    ADuC7029 SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG32(I2CBASE, 0xFFFF0800,__READ_WRITE);
#define I2CMSTA I2CBASE
__IO_REG32(I2CSSTA, 0xFFFF0804,__READ);
__IO_REG32(I2CSRX, 0xFFFF0808,__READ);
__IO_REG32(I2CSTX, 0xFFFF080C,__WRITE);
__IO_REG32(I2CMRX, 0xFFFF0810,__READ);
__IO_REG32(I2CMTX, 0xFFFF0814,__WRITE);
__IO_REG32(I2CCNT, 0xFFFF0818,__READ_WRITE);
__IO_REG32(I2CADR, 0xFFFF081C,__READ_WRITE);
__IO_REG32(I2CBYTE, 0xFFFF0824,__READ_WRITE);
__IO_REG32(I2CALT, 0xFFFF0828,__READ_WRITE);
__IO_REG32(I2CCFG, 0xFFFF082C,__READ_WRITE);
__IO_REG32(I2CDIV, 0xFFFF0830,__READ_WRITE);
__IO_REG32(I2CID0, 0xFFFF0838,__READ_WRITE);
__IO_REG32(I2CID1, 0xFFFF083C,__READ_WRITE);
__IO_REG32(I2CID2, 0xFFFF0840,__READ_WRITE);
__IO_REG32(I2CID3, 0xFFFF0844,__READ_WRITE);
__IO_REG32(I2CCCNT, 0xFFFF0848,__READ_WRITE);
__IO_REG32(I2CFSTA, 0xFFFF084C,__READ_WRITE);
