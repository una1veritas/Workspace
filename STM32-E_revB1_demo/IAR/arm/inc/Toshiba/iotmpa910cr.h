...
#ifndef __IOTMPA910CR_H
#define __IOTMPA910CR_H
 ...
 ***************************************************************************
 **
 **    TMPA910CR SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* PR0CR (LPRG0 signal Control Register) */
typedef struct{
__REG32 LPR0EN                : 1;
__REG32 TFTSTN                : 1;
__REG32 DLY0TIME              : 4;
...
/* PR1CR (LPRG 1 signal Control Register) */
typedef struct{
__REG32 LPR1EN                : 1;
__REG32 ALTEN                 : 2;
__REG32 DLY1TIME              : 7;
...
/* PR2CR (LPRG 2 signal Control Register) */
typedef struct{
__REG32 LPR2EN                : 1;
__REG32                       : 1;
__REG32 DLY2TIME              : 8;
...
/* GPIOEFR1 (Port Function Register1) */
typedef struct{
__REG32 PE0F1                 : 1;
__REG32 PE1F1                 : 1;
__REG32 PE2F1                 : 1;
...
/* GPIOHDIR (Port Data Direction Register) */
typedef struct{
__REG32 PH0C                  : 1;
__REG32 PH1C                  : 1;
__REG32 PH2C                  : 1;
...
/* GPIOHFR1 (Port Function Register1) */
typedef struct{
__REG32 PH0F1                 : 1;
__REG32 PH1F1                 : 1;
__REG32 PH2F1                 : 1;
...
/* GPIOPDIR (Port Data Direction Register) */
typedef struct{
__REG32 PP0C                  : 1;
__REG32 PP1C                  : 1;
__REG32 PP2C                  : 1;
...
/* GPIOPIS (Port Interrupt Selection Register (Level and Edge)) */
typedef struct{
__REG32 PP0IS                 : 1;
__REG32 PP1IS                 : 1;
__REG32 PP2IS                 : 1;
...
/* GPIOPIBE (Port Interrupt Selection Register (Fellow edge and Both edge)) */
typedef struct{
__REG32 PP0IBE                : 1;
__REG32 PP1IBE                : 1;
__REG32 PP2IBE                : 1;
...
/* GPIOPIEV (Port Interrupt Selection Register (Fall down edge/Low level and Rising up edge/High level)) */
typedef struct{
__REG32 PP0IEV                : 1;
__REG32 PP1IEV                : 1;
__REG32 PP2IEV                : 1;
...
/* GPIOPIE (Port Interrupt Enable Register) */
typedef struct{
__REG32 PP0IE                 : 1;
__REG32 PP1IE                 : 1;
__REG32 PP2IE                 : 1;
...
/* GPIOPRIS (Port Interrupt Status Register (Raw)) */
typedef struct{
__REG32 PP0RIS                : 1;
__REG32 PP1RIS                : 1;
__REG32 PP2RIS                : 1;
...
/* GPIOPMIS (Port Interrupt Status Register (Masked)) */
typedef struct{
__REG32 PP0MIS                : 1;
__REG32 PP1MIS                : 1;
__REG32 PP2MIS                : 1;
...
/* GPIOPIC (Port Interrupt Clear Register) */
typedef struct{
__REG32 PP0IC                 : 1;
__REG32 PP1IC                 : 1;
__REG32 PP2IC                 : 1;
...
/* LDADVSRC0 (LCDDA Delta Value (Read Step) address Register of Source 0) */ 
typedef struct {
__REG32 DXS0                  : 3;
__REG32                       : 3;
__REG32 DYS0                  :12;
...
__IO_REG32_BIT(SYSCR0,                0xF0050000,__READ_WRITE ,__syscr0_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(PR0CR,                 0xF00B0000,__READ_WRITE ,__pr0cr_bits);
__IO_REG32_BIT(PR1CR,                 0xF00B0004,__READ_WRITE ,__pr1cr_bits);
__IO_REG32_BIT(PR2CR,                 0xF00B0008,__READ_WRITE ,__pr2cr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIOEDATA,             0xF08043FC,__READ_WRITE ,__gpioedata_bits);
__IO_REG32_BIT(GPIOEFR1,              0xF0804424,__READ_WRITE ,__gpioefr1_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIOHDATA,             0xF08073FC,__READ_WRITE ,__gpiohdata_bits);
__IO_REG32_BIT(GPIOHDIR,              0xF0807400,__READ_WRITE ,__gpiohdir_bits);
__IO_REG32_BIT(GPIOHFR1,              0xF0807424,__READ_WRITE ,__gpiohfr1_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIOPDATA,             0xF080D3FC,__READ_WRITE ,__gpiopdata_bits);
__IO_REG32_BIT(GPIOPDIR,              0xF080D400,__READ_WRITE ,__gpiopdir_bits);
__IO_REG32_BIT(GPIOPIS,               0xF080D804,__READ_WRITE ,__gpiopis_bits);
__IO_REG32_BIT(GPIOPIBE,              0xF080D808,__READ_WRITE ,__gpiopibe_bits);
__IO_REG32_BIT(GPIOPIEV,              0xF080D80C,__READ_WRITE ,__gpiopiev_bits);
__IO_REG32_BIT(GPIOPIE,               0xF080D810,__READ_WRITE ,__gpiopie_bits);
__IO_REG32_BIT(GPIOPRIS,              0xF080D814,__READ       ,__gpiopris_bits);
__IO_REG32_BIT(GPIOPMIS,              0xF080D818,__READ       ,__gpiopmis_bits);
__IO_REG32_BIT(GPIOPIC,               0xF080D81C,__WRITE      ,__gpiopic_bits);
...
**
***************************************************************************/
__IO_REG32_BIT(smc_timeout,           0xF00A0050,__READ_WRITE ,__smc_ebi_timeout_bits);
...
__IO_REG32_BIT(BRTRELE,               0xF0020210,__READ_WRITE ,__brtrele_bits);
...
__IO_REG32_BIT(BPPEDGE,               0xF0020228,__READ_WRITE ,__bppedge_bits);
...
__IO_REG32_BIT(BRTRINT,               0xF0020250,__READ_WRITE ,__brtrint_bits);
