...
#ifndef __IOTMPM384FxFG_H
#define __IOTMPM384FxFG_H
 ...
 ***************************************************************************
 **
 **    TMPM384FxFG SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/*Port Q open drain Control register */
typedef struct {
  __REG8  PQ0OD  : 1;
  __REG8  PQ1OD  : 1;
  __REG8  PQ2OD  : 1;
...
/*PORT Q Pull-Up Control Register */
typedef struct {
  __REG8  PQ0UP  : 1;
  __REG8  PQ1UP  : 1;
  __REG8  PQ2UP  : 1;
...
/*PORT Q Pull-Down Control Register */
typedef struct {
  __REG8  PQ0DN  : 1;
  __REG8  PQ1DN  : 1;
  __REG8  PQ2DN  : 1;
...
/*PORT Q Input Enable Control Register */
typedef struct {
  __REG8  PQ0IE  : 1;
  __REG8  PQ1IE  : 1;
  __REG8  PQ2IE  : 1;
...
/*Port R open drain Control register */
typedef struct {
  __REG8  PR0OD  : 1;
  __REG8  PR1OD  : 1;
  __REG8  PR2OD  : 1;
...
/*PORT R Pull-Up Control Register */
typedef struct {
  __REG8  PR0UP  : 1;
  __REG8  PR1UP  : 1;
  __REG8  PR2UP  : 1;
...
/*PORT R Pull-Down Control Register */
typedef struct {
  __REG8  PR0DN  : 1;
  __REG8  PR1DN  : 1;
  __REG8  PR2DN  : 1;
...
/*PORT R Input Enable Control Register */
typedef struct {
  __REG8  PR0IE  : 1;
  __REG8  PR1IE  : 1;
  __REG8  PR2IE  : 1;
...
/*Port S open drain Control register */
typedef struct {
  __REG8  PS0OD  : 1;
  __REG8  PS1OD  : 1;
  __REG8  PS2OD  : 1;
...
/*PORT S Pull-Up Control Register */
typedef struct {
  __REG8  PS0UP  : 1;
  __REG8  PS1UP  : 1;
  __REG8  PS2UP  : 1;
...
/*PORT S Pull-Down Control Register */
typedef struct {
  __REG8  PS0DN  : 1;
  __REG8  PS1DN  : 1;
  __REG8  PS2DN  : 1;
...
/*PORT S Input Enable Control Register */
typedef struct {
  __REG8  PS0IE  : 1;
  __REG8  PS1IE  : 1;
  __REG8  PS2IE  : 1;
...
/*PORT T Input Enable Control Register */
typedef struct {
  __REG8  PT0IE  : 1;
  __REG8  PT1IE  : 1;
  __REG8  PT2IE  : 1;
...
/*PORT U Input Enable Control Register */
typedef struct {
  __REG8  PU0IE  : 1;
  __REG8  PU1IE  : 1;
  __REG8  PU2IE  : 1;
...
/* Interrupt Set-Enable Registers 96-115 */
typedef struct {
  __REG32  SETENA96       : 1;
  __REG32  SETENA97       : 1;
  __REG32  SETENA98       : 1;
...
/* Interrupt Clear-Enable Registers 96-115 */
typedef struct {
  __REG32  CLRENA96       : 1;
  __REG32  CLRENA97       : 1;
  __REG32  CLRENA98       : 1;
...
/* Interrupt Set-Pending Register 96-115 */
typedef struct {
  __REG32  SETPEND96      : 1;
  __REG32  SETPEND97      : 1;
  __REG32  SETPEND98      : 1;
...
/* Interrupt Clear-Pending Register 96-115 */
typedef struct {
  __REG32  CLRPEND96      : 1;
  __REG32  CLRPEND97      : 1;
  __REG32  CLRPEND98      : 1;
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(PQDATA,               0x40000400,__READ_WRITE ,__pq_bits);
__IO_REG8_BIT(PQCR,                 0x40000404,__READ_WRITE ,__pqcr_bits);
__IO_REG8_BIT(PQOD,                 0x40000428,__READ_WRITE ,__pqod_bits);
__IO_REG8_BIT(PQPUP,                0x4000042C,__READ_WRITE ,__pqpup_bits);
__IO_REG8_BIT(PQPDN,                0x40000430,__READ_WRITE ,__pqpdn_bits);
__IO_REG8_BIT(PQIE,                 0x40000438,__READ_WRITE ,__pqie_bits);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(PRDATA,               0x40000440,__READ_WRITE ,__pr_bits);
__IO_REG8_BIT(PRCR,                 0x40000444,__READ_WRITE ,__prcr_bits);
__IO_REG8_BIT(PRFR1,                0x40000448,__READ_WRITE ,__prfr1_bits);
__IO_REG8_BIT(PRFR2,                0x4000044C,__READ_WRITE ,__prfr2_bits);
__IO_REG8_BIT(PROD,                 0x40000468,__READ_WRITE ,__prod_bits);
__IO_REG8_BIT(PRPUP,                0x4000046C,__READ_WRITE ,__prpup_bits);
__IO_REG8_BIT(PRPDN,                0x40000470,__READ_WRITE ,__prpdn_bits);
__IO_REG8_BIT(PRIE,                 0x40000478,__READ_WRITE ,__prie_bits);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(PSDATA,               0x40000480,__READ_WRITE ,__ps_bits);
__IO_REG8_BIT(PSCR,                 0x40000484,__READ_WRITE ,__pscr_bits);
__IO_REG8_BIT(PSOD,                 0x400004A8,__READ_WRITE ,__psod_bits);
__IO_REG8_BIT(PSPUP,                0x400004AC,__READ_WRITE ,__pspup_bits);
__IO_REG8_BIT(PSPDN,                0x400004B0,__READ_WRITE ,__pspdn_bits);
__IO_REG8_BIT(PSIE,                 0x400004B8,__READ_WRITE ,__psie_bits);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(PTDATA,               0x400004C0,__READ_WRITE ,__pt_bits);
__IO_REG8_BIT(PTCR,                 0x400004C4,__READ_WRITE ,__ptcr_bits);
__IO_REG8_BIT(PTFR1,                0x400004C8,__READ_WRITE ,__ptfr1_bits);
__IO_REG8_BIT(PTOD,                 0x400004E8,__READ_WRITE ,__ptod_bits);
__IO_REG8_BIT(PTPUP,                0x400004EC,__READ_WRITE ,__ptpup_bits);
__IO_REG8_BIT(PTPDN,                0x400004F0,__READ_WRITE ,__ptpdn_bits);
__IO_REG8_BIT(PTIE,                 0x400004F8,__READ_WRITE ,__ptie_bits);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(PUDATA,               0x40000500,__READ_WRITE ,__pu_bits);
__IO_REG8_BIT(PUCR,                 0x40000504,__READ_WRITE ,__pucr_bits);
__IO_REG8_BIT(PUOD,                 0x40000528,__READ_WRITE ,__puod_bits);
__IO_REG8_BIT(PUPUP,                0x4000052C,__READ_WRITE ,__pupup_bits);
__IO_REG8_BIT(PUPDN,                0x40000530,__READ_WRITE ,__pupdn_bits);
__IO_REG8_BIT(PUIE,                 0x40000538,__READ_WRITE ,__puie_bits);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(PVDATA,               0x40000540,__READ_WRITE ,__pv_bits);
__IO_REG8_BIT(PVPUP,                0x4000056C,__READ_WRITE ,__pvpup_bits);
__IO_REG8_BIT(PVIE,                 0x40000578,__READ_WRITE ,__pvie_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(TBAEN,               0x40010280, __READ_WRITE , __tbxen_bits);
__IO_REG32_BIT(TBARUN,              0x40010284, __READ_WRITE , __tbxrun_bits);
__IO_REG32_BIT(TBACR,               0x40010288, __READ_WRITE , __tbxcr_bits);
__IO_REG32_BIT(TBAMOD,              0x4001028C, __READ_WRITE , __tbxmod_bits);
__IO_REG32_BIT(TBAFFCR,             0x40010290, __READ_WRITE , __tbxffcr_bits);
__IO_REG32_BIT(TBAST,               0x40010294, __READ       , __tbxst_bits);
__IO_REG32_BIT(TBAIM,               0x40010298, __READ_WRITE , __tbxim_bits);
__IO_REG32_BIT(TBAUC,               0x4001029C, __READ_WRITE , __tbxuc_bits);
__IO_REG32_BIT(TBARG0,              0x400102A0, __READ_WRITE , __tbxrg0_bits);
__IO_REG32_BIT(TBARG1,              0x400102A4, __READ_WRITE , __tbxrg1_bits);
__IO_REG32_BIT(TBACP0,              0x400102A8, __READ_WRITE , __tbxcp0_bits);
__IO_REG32_BIT(TBACP1,              0x400102AC, __READ_WRITE , __tbxcp1_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(TBBEN,               0x400102C0, __READ_WRITE , __tbxen_bits);
__IO_REG32_BIT(TBBRUN,              0x400102C4, __READ_WRITE , __tbxrun_bits);
__IO_REG32_BIT(TBBCR,               0x400102C8, __READ_WRITE , __tbxcr_bits);
__IO_REG32_BIT(TBBMOD,              0x400102CC, __READ_WRITE , __tbxmod_bits);
__IO_REG32_BIT(TBBFFCR,             0x400102D0, __READ_WRITE , __tbxffcr_bits);
__IO_REG32_BIT(TBBST,               0x400102D4, __READ       , __tbxst_bits);
__IO_REG32_BIT(TBBIM,               0x400102D8, __READ_WRITE , __tbxim_bits);
__IO_REG32_BIT(TBBUC,               0x400102DC, __READ_WRITE , __tbxuc_bits);
__IO_REG32_BIT(TBBRG0,              0x400102E0, __READ_WRITE , __tbxrg0_bits);
__IO_REG32_BIT(TBBRG1,              0x400102E4, __READ_WRITE , __tbxrg1_bits);
__IO_REG32_BIT(TBBCP0,              0x400102E8, __READ_WRITE , __tbxcp0_bits);
__IO_REG32_BIT(TBBCP1,              0x400102EC, __READ_WRITE , __tbxcp1_bits);
...
__IO_REG32_BIT(MT0TBCR,             0x40050808, __READ_WRITE , __mtxcr_bits);
__IO_REG32_BIT(MT0TBMOD,            0x4005080C, __READ_WRITE , __mtxmod_bits);
__IO_REG32_BIT(MT0TBFFCR,           0x40050810, __READ_WRITE , __mtxffcr_bits);
__IO_REG32_BIT(MT0TBST,             0x40050814, __READ       , __mtxst_bits);
__IO_REG32_BIT(MT0TBIM,             0x40050818, __READ_WRITE , __mtxim_bits);
__IO_REG32_BIT(MT0TBUC,             0x4005081C, __READ       , __mtxuc_bits);
...
__IO_REG32_BIT(MT0IGCR,             0x40050830, __READ_WRITE , __mtigxcr_bits);
__IO_REG32_BIT(MT0IGRESTA,          0x40050834, __WRITE      , __mtigxresta_bits);
__IO_REG32_BIT(MT0IGST,             0x40050838, __READ_WRITE , __mtigxst_bits);
__IO_REG32_BIT(MT0IGICR,            0x4005083C, __READ_WRITE , __mtigxicr_bits);
__IO_REG32_BIT(MT0IGOCR,            0x40050840, __READ_WRITE , __mtigxocr_bits);
__IO_REG32_BIT(MT0IGRG2,            0x40050844, __READ_WRITE , __mtigxrg2_bits);
__IO_REG32_BIT(MT0IGRG3,            0x40050848, __READ_WRITE , __mtigxrg3_bits);
__IO_REG32_BIT(MT0IGRG4,            0x4005084C, __READ_WRITE , __mtigxrg4_bits);
__IO_REG32_BIT(MT0IGEMGCR,          0x40050850, __READ_WRITE , __mtigxemgcr_bits);
__IO_REG32_BIT(MT0IGEMGST,          0x40050854, __READ       , __mtigxemgst_bits);
...
__IO_REG32_BIT(MT1TBCR,             0x40050888, __READ_WRITE , __mtxcr_bits);
__IO_REG32_BIT(MT1TBMOD,            0x4005088C, __READ_WRITE , __mtxmod_bits);
__IO_REG32_BIT(MT1TBFFCR,           0x40050890, __READ_WRITE , __mtxffcr_bits);
__IO_REG32_BIT(MT1TBST,             0x40050894, __READ       , __mtxst_bits);
__IO_REG32_BIT(MT1TBIM,             0x40050898, __READ_WRITE , __mtxim_bits);
__IO_REG32_BIT(MT1TBUC,             0x4005089C, __READ       , __mtxuc_bits);
...
__IO_REG32_BIT(MT1IGCR,             0x400508B0, __READ_WRITE , __mtigxcr_bits);
__IO_REG32_BIT(MT1IGRESTA,          0x400508B4, __WRITE      , __mtigxresta_bits);
__IO_REG32_BIT(MT1IGST,             0x400508B8, __READ_WRITE , __mtigxst_bits);
__IO_REG32_BIT(MT1IGICR,            0x400508BC, __READ_WRITE , __mtigxicr_bits);
__IO_REG32_BIT(MT1IGOCR,            0x400508C0, __READ_WRITE , __mtigxocr_bits);
__IO_REG32_BIT(MT1IGRG2,            0x400508C4, __READ_WRITE , __mtigxrg2_bits);
__IO_REG32_BIT(MT1IGRG3,            0x400508C8, __READ_WRITE , __mtigxrg3_bits);
__IO_REG32_BIT(MT1IGRG4,            0x400508CC, __READ_WRITE , __mtigxrg4_bits);
__IO_REG32_BIT(MT1IGEMGCR,          0x400508D0, __READ_WRITE , __mtigxemgcr_bits);
__IO_REG32_BIT(MT1IGEMGST,          0x400508D4, __READ       , __mtigxemgst_bits);
...
__IO_REG32_BIT(MT2TBCR,             0x40050908, __READ_WRITE , __mtxcr_bits);
__IO_REG32_BIT(MT2TBMOD,            0x4005090C, __READ_WRITE , __mtxmod_bits);
__IO_REG32_BIT(MT2TBFFCR,           0x40050910, __READ_WRITE , __mtxffcr_bits);
__IO_REG32_BIT(MT2TBST,             0x40050914, __READ       , __mtxst_bits);
__IO_REG32_BIT(MT2TBIM,             0x40050918, __READ_WRITE , __mtxim_bits);
__IO_REG32_BIT(MT2TBUC,             0x4005091C, __READ       , __mtxuc_bits);
...
__IO_REG32_BIT(MT2IGCR,             0x40050930, __READ_WRITE , __mtigxcr_bits);
__IO_REG32_BIT(MT2IGRESTA,          0x40050934, __WRITE      , __mtigxresta_bits);
__IO_REG32_BIT(MT2IGST,             0x40050938, __READ_WRITE , __mtigxst_bits);
__IO_REG32_BIT(MT2IGICR,            0x4005093C, __READ_WRITE , __mtigxicr_bits);
__IO_REG32_BIT(MT2IGOCR,            0x40050940, __READ_WRITE , __mtigxocr_bits);
__IO_REG32_BIT(MT2IGRG2,            0x40050944, __READ_WRITE , __mtigxrg2_bits);
__IO_REG32_BIT(MT2IGRG3,            0x40050948, __READ_WRITE , __mtigxrg3_bits);
__IO_REG32_BIT(MT2IGRG4,            0x4005094C, __READ_WRITE , __mtigxrg4_bits);
__IO_REG32_BIT(MT2IGEMGCR,          0x40050950, __READ_WRITE , __mtigxemgcr_bits);
__IO_REG32_BIT(MT2IGEMGST,          0x40050954, __READ       , __mtigxemgst_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(MT3EN,               0x40050980, __READ_WRITE , __mtxen_bits);
__IO_REG32_BIT(MT3RUN,              0x40050984, __READ_WRITE , __mtxrun_bits);
__IO_REG32_BIT(MT3TBCR,             0x40050988, __READ_WRITE , __mtxcr_bits);
__IO_REG32_BIT(MT3TBMOD,            0x4005098C, __READ_WRITE , __mtxmod_bits);
__IO_REG32_BIT(MT3TBFFCR,           0x40050990, __READ_WRITE , __mtxffcr_bits);
__IO_REG32_BIT(MT3TBST,             0x40050994, __READ       , __mtxst_bits);
__IO_REG32_BIT(MT3TBIM,             0x40050998, __READ_WRITE , __mtxim_bits);
__IO_REG32_BIT(MT3TBUC,             0x4005099C, __READ       , __mtxuc_bits);
__IO_REG32_BIT(MT3RG0,              0x400509A0, __READ_WRITE , __mtxrg0_bits);
__IO_REG32_BIT(MT3RG1,              0x400509A4, __READ_WRITE , __mtxrg1_bits);
__IO_REG32_BIT(MT3CP0,              0x400509A8, __READ       , __mtxcp0_bits);
__IO_REG32_BIT(MT3CP1,              0x400509AC, __READ       , __mtxcp1_bits);
__IO_REG32_BIT(MT3IGCR,             0x400509B0, __READ_WRITE , __mtigxcr_bits);
__IO_REG32_BIT(MT3IGRESTA,          0x400509B4, __WRITE      , __mtigxresta_bits);
__IO_REG32_BIT(MT3IGST,             0x400509B8, __READ_WRITE , __mtigxst_bits);
__IO_REG32_BIT(MT3IGICR,            0x400509BC, __READ_WRITE , __mtigxicr_bits);
__IO_REG32_BIT(MT3IGOCR,            0x400509C0, __READ_WRITE , __mtigxocr_bits);
__IO_REG32_BIT(MT3IGRG2,            0x400509C4, __READ_WRITE , __mtigxrg2_bits);
__IO_REG32_BIT(MT3IGRG3,            0x400509C8, __READ_WRITE , __mtigxrg3_bits);
__IO_REG32_BIT(MT3IGRG4,            0x400509CC, __READ_WRITE , __mtigxrg4_bits);
__IO_REG32_BIT(MT3IGEMGCR,          0x400509D0, __READ_WRITE , __mtigxemgcr_bits);
__IO_REG32_BIT(MT3IGEMGST,          0x400509D4, __READ       , __mtigxemgst_bits);
...
__IO_REG32_BIT(MTPD0EMGREL,          0x40050430, __WRITE      , __emgrel_bits);
__IO_REG32_BIT(MTPD0EMGCR,           0x40050434, __READ_WRITE , __emgcr_bits);
__IO_REG32_BIT(MTPD0EMGSTA,          0x40050438, __READ       , __emgsta_bits);
...
__IO_REG32_BIT(MTPD1EMGREL,          0x400504B0, __WRITE      , __emgrel_bits);
__IO_REG32_BIT(MTPD1EMGCR,           0x400504B4, __READ_WRITE , __emgcr_bits);
__IO_REG32_BIT(MTPD1EMGSTA,          0x400504B8, __READ       , __emgsta_bits);
...
__IO_REG16_BIT(ADCMP00,             0x40030018, __READ_WRITE , __adxcmpx_bits);
__IO_REG16_BIT(ADCMP01,             0x4003001C, __READ_WRITE , __adxcmpx_bits);
__IO_REG16_BIT(ADREG00,             0x40030020, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG01,             0x40030024, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG02,             0x40030028, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG03,             0x4003002C, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG04,             0x40030030, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG05,             0x40030034, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG06,             0x40030038, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG07,             0x4003003C, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG08,             0x40030040, __READ       , __adxregx_bits);
__IO_REG16_BIT(ADREG09,             0x40030044, __READ       , __adxregx_bits);
...
#define INT0                 ( 0 + EII)   /* Interrupt Pin 								*/
#define INT1                 ( 1 + EII)   /* Interrupt Pin 								*/
#define INT2                 ( 2 + EII)   /* Interrupt Pin 								*/
#define INT3                 ( 3 + EII)   /* Interrupt Pin 								*/
#define INT4                 ( 4 + EII)   /* Interrupt Pin 								*/
#define INT5                 ( 5 + EII)   /* Interrupt Pin 								*/
#define INTRX0               ( 6 + EII)   /* Serial reception (channe0) 	*/
#define INTTX0               ( 7 + EII)   /* Serial transmit (channe0)  	*/
#define INTRX1               ( 8 + EII)   /* Serial reception (channel) 	*/
#define INTTX1               ( 9 + EII)   /* Serial transmit (channel)  	*/
...
#define INT6                 (38 + EII)   /* Interrupt Pin 								*/
#define INT7                 (39 + EII)   /* Interrupt Pin 								*/
#define INTRX2               (40 + EII)   /* Serial reception (channe2) 	*/
#define INTTX2               (41 + EII)   /* Serial transmit (channe2)  	*/
...
#define INTRX4               (44 + EII)   /* Serial reception (channe4) 	*/
#define INTTX4               (45 + EII)   /* Serial transmit (channe4)  	*/
...
#define INT8                 (58 + EII)   /* Interrupt Pin 								*/
#define INT9                 (59 + EII)   /* Interrupt Pin 								*/
#define INTA                 (60 + EII)   /* Interrupt Pin 								*/
#define INTB                 (61 + EII)   /* Interrupt Pin 								*/
#define INTENC0              (62 + EII)   /* Encoder input interrupt (channel.0)	*/
#define INTENC1              (63 + EII)   /* Encoder input interrupt (channel.1)	*/
#define INTRX3               (64 + EII)   /* Serial reception (channe3) 	*/
#define INTTX3               (65 + EII)   /* Serial transmit (channe3)  	*/
...
#define INTC                 (74 + EII)   /* Interrupt Pin 					                   */
#define INTD                 (75 + EII)   /* Interrupt Pin 					                   */
#define INTE                 (76 + EII)   /* Interrupt Pin 					                   */
#define INTF                 (77 + EII)   /* Interrupt Pin 					                   */
...
#define INTMTPTB11           (83 + EII)   /* 16-bit MPT1 IGBT period/ compare match detection 1/ Over flow */
#define INTMTPTB20           (84 + EII)   /* 16-bit MPT2 IGBT period/ compare match detection 0/ Over flow */
#define INTMTPTB21           (85 + EII)   /* 16-bit MPT2 IGBT period/ compare match detection 1/ Over flow */
...
#define INTTB80              (95 + EII)   /* 16bit TMRB8 compare match detection 0 / Over flow */
#define INTTB81              (96 + EII)   /* 16bit TMRB8 compare match detection 1     */
#define INTTB90              (97 + EII)   /* 16bit TMRB9 compare match detection 0 / Over flow */
#define INTTB91              (98 + EII)   /* 16bit TMRB9 compare match detection 1     */
#define INTTBA0              (99 + EII)   /* 16bit TMRBA compare match detection 0 / Over flow */
#define INTTBA1              (100+ EII)   /* 16bit TMRBA compare match detection 1     */
#define INTTBB0              (101+ EII)   /* 16bit TMRBB compare match detection 0 / Over flow */
#define INTTBB1              (102+ EII)   /* 16bit TMRBB compare match detection 1     */
#define INTCAP80             (103+ EII)   /* 16bit TMRB8 input capture 0               */
#define INTCAP81             (104+ EII)   /* 16bit TMRB8 input capture 1               */
#define INTCAP90             (105+ EII)   /* 16bit TMRB9 input capture 0               */
#define INTCAP91             (106+ EII)   /* 16bit TMRB9 input capture 1               */
#define INTCAPA0             (107+ EII)   /* 16bit TMRBA input capture 0               */
#define INTCAPA1             (108+ EII)   /* 16bit TMRBA input capture 1               */
#define INTCAPB0             (109+ EII)   /* 16bit TMRBB input capture 0               */
#define INTCAPB1             (110+ EII)   /* 16bit TMRBB input capture 1               */
#define INTMTTB30	           (111+ EII)   /* 16-bit MPT IGBT period/ compare match detection 0/ Over flow (channel 3) */
#define INTMTTB31	           (112+ EII)   /* 16-bit MPT IGBT trigger/ compare match detection 1 (channel 3) */
#define INTMTCAP30           (113+ EII)   /* 16-bit MPT input capture 0 (channel 3) */
#define INTMTCAP31           (114+ EII)   /* 16-bit MPT input capture 1 (channel 3) */
#define INTMTEMG3            (115+ EII)   /* 16-bit MPT IGBT EMG interrupt (channel 3) */

#endif    /* __IOTMPM384FxFG_H */
...
Interrupt90  = INTMTPTB11     0x18C
Interrupt91  = INTMTPTB20     0x190
Interrupt92  = INTMTPTB21     0x194
...
Interrupt102 = INTTB80        0x1BC
Interrupt103 = INTTB81        0x1C0
Interrupt104 = INTTB90        0x1C4
Interrupt105 = INTTB91        0x1C8
Interrupt106 = INTTBA0        0x1CC
Interrupt107 = INTTBA1        0x1D0
Interrupt108 = INTTBB0        0x1D4
Interrupt109 = INTTBB1        0x1D8
Interrupt110 = INTCAP80       0x1DC
Interrupt111 = INTCAP81       0x1E0
Interrupt112 = INTCAP90       0x1E4
Interrupt113 = INTCAP91       0x1E8
Interrupt114 = INTCAPA0       0x1EC
Interrupt115 = INTCAPA1       0x1F0
Interrupt116 = INTCAPB0       0x1F4
Interrupt117 = INTCAPB1       0x1F8
Interrupt118 = INTMTTB30	    0x1FC
Interrupt119 = INTMTTB31	    0x200
Interrupt120 = INTMTCAP30     0x204
Interrupt121 = INTMTCAP31     0x208
Interrupt122 = INTMTEMG3      0x20C
