...
**
***************************************************************************/
#ifndef __ioHT32F275x_H__

#define __ioHT32F275x_H__
 ...
 ***************************************************************************
 **
 **   ioHT32F275x SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
***************************************************************************/
...
__IO_REG32_BIT(CSIF_ENR,                0x400CC000, __READ_WRITE , __csif_enr_bits);
__IO_REG32_BIT(CSIF_CR,                 0x400CC004, __READ_WRITE , __csif_cr_bits);
__IO_REG32_BIT(CSIF_IMGWH,              0x400CC008, __READ_WRITE , __csif_imgwh_bits);
__IO_REG32_BIT(CSIF_WCR0,               0x400CC00C, __READ_WRITE , __csif_wcr0_bits);
__IO_REG32_BIT(CSIF_WCR1,               0x400CC010, __READ_WRITE , __csif_wcr1_bits);
__IO_REG32_BIT(CSIF_SMP,                0x400CC014, __READ_WRITE , __csif_smp_bits);
__IO_REG32_BIT(CSIF_SMPCOL,             0x400CC018, __READ_WRITE , __csif_smpcol_bits);
__IO_REG32_BIT(CSIF_SMPROW,             0x400CC01C, __READ_WRITE , __csif_smprow_bits);
__IO_REG32_BIT(CSIF_FIFO0,              0x400CC020, __READ_WRITE , __csif_fifo0_bits);
__IO_REG32_BIT(CSIF_FIFO1,              0x400CC024, __READ_WRITE , __csif_fifo1_bits);
__IO_REG32_BIT(CSIF_FIFO2,              0x400CC028, __READ_WRITE , __csif_fifo2_bits);
__IO_REG32_BIT(CSIF_FIFO3,              0x400CC02C, __READ_WRITE , __csif_fifo3_bits);
__IO_REG32_BIT(CSIF_FIFO4,              0x400CC030, __READ_WRITE , __csif_fifo4_bits);
__IO_REG32_BIT(CSIF_FIFO5,              0x400CC034, __READ_WRITE , __csif_fifo5_bits);
__IO_REG32_BIT(CSIF_FIFO6,              0x400CC038, __READ_WRITE , __csif_fifo6_bits);
__IO_REG32_BIT(CSIF_FIFO7,              0x400CC03C, __READ_WRITE , __csif_fifo7_bits);
__IO_REG32_BIT(CSIF_IER,                0x400CC040, __READ_WRITE , __csif_ier_bits);
__IO_REG32_BIT(CSIF_SR,                 0x400CC044, __READ_WRITE , __csif_sr_bits);
