 ...
 **    Samsung Semiconductors KS32C5000A
 **    
...
#ifndef __KS32C5000A_H
#define __KS32C5000A_H
 ...
 ***************************************************************************
 **                            
 **    KS32C5000A SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
typedef struct {
  ...
  __REG32 drxmadec   :1;
  __REG32 drxstoptc  :1;
  __REG32 txflagidle :1;
  __REG32 txpreamble :1;
  __REG32 txsdfl     :1;
  __REG32 txabtext   :1;
  __REG32 txloop     :1;
  __REG32 rxasen     :1;
...
/* HDLC: DMA memory address register for TX/RX */
typedef struct {
  __REG32 addr    :26;
  __REG32         :6;
} __hdmatxrxma_bits;

/* HDLC: DMA transfer count register for TX/RX */
typedef struct {
  __REG32 tc      :24;
  __REG32         :8;
} __hdmatxrxcnt_bits;

/* HDLC: DMA transfered bytes count register for RX */
typedef struct {
  __REG32 tbc     :24;
  __REG32         :8;
} __hdmarxbcnt_bits;
...
__IO_REG32_BIT(__IICCNT,0x03fff00c,__READ,__iiccnt_bits);
...
__IO_REG8(__EOF,0x03ff9800,__READ_WRITE);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(__HCON0A,0x03ff7000,__READ_WRITE,__hcon0_bits);
__IO_REG32_BIT(__HCON1A,0x03ff7004,__READ_WRITE,__hcon1_bits);
...
__IO_REG32_BIT(__HSADRA,0x03ff701c,__READ_WRITE,__hsadr_bits);
__IO_REG32_BIT(__HBRGTCA,0x03ff7020,__READ_WRITE,__hbrgtc_bits);
__IO_REG32_BIT(__HPRMBA,0x03ff7024,__READ_WRITE,__hprmb_bits);
__IO_REG32_BIT(__HDMATXMAA,0x03ff7028,__READ_WRITE,__hdmatxrxma_bits);
__IO_REG32_BIT(__HDMARXMAA,0x03ff702c,__READ_WRITE,__hdmatxrxma_bits);
__IO_REG32_BIT(__HDMATXCNTA,0x03ff7030,__READ_WRITE,__hdmatxrxcnt_bits);
__IO_REG32_BIT(__HDMARXCNTA,0x03ff7034,__READ_WRITE,__hdmatxrxcnt_bits);
__IO_REG32_BIT(__HDMARXBCNTA,0x03ff7038,__READ_WRITE,__hdmarxbcnt_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(__HCON0B,0x03ff8000,__READ_WRITE,__hcon0_bits);
__IO_REG32_BIT(__HCON1B,0x03ff8004,__READ_WRITE,__hcon1_bits);
...
__IO_REG32_BIT(__HSADRB,0x03ff801c,__READ_WRITE,__hsadr_bits);
__IO_REG32_BIT(__HBRGTCB,0x03ff8020,__READ_WRITE,__hbrgtc_bits);
__IO_REG32_BIT(__HPRMBB,0x03ff8024,__READ_WRITE,__hprmb_bits);
__IO_REG32_BIT(__HDMATXMAB,0x03ff8028,__READ_WRITE,__hdmatxrxma_bits);
__IO_REG32_BIT(__HDMARXMAB,0x03ff802c,__READ_WRITE,__hdmatxrxma_bits);
__IO_REG32_BIT(__HDMATXCNTB,0x03ff8030,__READ_WRITE,__hdmatxrxcnt_bits);
__IO_REG32_BIT(__HDMARXCNTB,0x03ff8034,__READ_WRITE,__hdmatxrxcnt_bits);
__IO_REG32_BIT(__HDMARXBCNTB,0x03ff8038,__READ_WRITE,__hdmarxbcnt_bits);
...
#define INT_U0R       5  /* uart0 receive interrupt          */
#define INT_U0ERR     6  /* uart0 error interrupt            */
#define INT_U1T       7  /* uart1 transmit interrupt         */
#define INT_U1R       8  /* uart1 receive interrupt          */
#define INT_U1ERR     9  /* uart1 error interrupt            */
#define INT_GDMA0    10  /* GDMA channel 0 interrupt         */
#define INT_GDMA1    11  /* GDMA channel 1 interrupt         */
#define INT_TIMER0   12  /* timer 0 interrupt                */
#define INT_TIMER1   13  /* timer 1 interrupt                */
#define INT_HDLCA    14  /* HDLC channel A interrupt         */
#define INT_HDLCB    15  /* HDLC channel B interrupt         */
#define INT_ECBDMATx 16  /* Eternet controller BDMA Tx intrrupt*/
#define INT_ECBDMARx 17  /* Eternet controller BDMA Rx intrrupt*/
#define INT_ECMACTx  18  /* Eternet controller BDMA Tx intrrupt*/
#define INT_ECMACRx  19  /* Eternet controller BDMA Rx intrrupt*/
#define INT_i2cbus   20  /* i2 C-bus interrupt                 */



#endif    /* __KS32C5000A_H */
