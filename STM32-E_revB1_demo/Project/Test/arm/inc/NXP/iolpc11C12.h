...
#ifndef __IOLPC11C12_H
#define __IOLPC11C12_H
 ...
 ***************************************************************************
 **
 **    LPC11C12 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG32_BIT(CANSTAT,               0x40050004,__READ_WRITE ,__canstat_bits);
__IO_REG32_BIT(CANEC,                 0x40050008,__READ       ,__canec_bits);
__IO_REG32_BIT(CANBT,                 0x4005000C,__READ_WRITE ,__canbt_bits);
__IO_REG32_BIT(CANINT,                0x40050010,__READ       ,__canint_bits);
__IO_REG32_BIT(CANTEST,               0x40050014,__READ_WRITE ,__cantest_bits);
__IO_REG32_BIT(CANBRPE,               0x40050018,__READ_WRITE ,__canbrpe_bits);
__IO_REG32_BIT(CANIF1_CMDREQ,         0x40050020,__READ_WRITE ,__canifx_cmdreq_bits);
__IO_REG32_BIT(CANIF1_CMDMSK,         0x40050024,__READ_WRITE ,__canifx_cmdmsk_bits);
__IO_REG32_BIT(CANIF1_MSK1,           0x40050028,__READ_WRITE ,__canifx_msk1_bits);
__IO_REG32_BIT(CANIF1_MSK2,           0x4005002C,__READ_WRITE ,__canifx_msk2_bits);
__IO_REG32_BIT(CANIF1_ARB1,           0x40050030,__READ_WRITE ,__canifx_arb1_bits);
__IO_REG32_BIT(CANIF1_ARB2,           0x40050034,__READ_WRITE ,__canifx_arb2_bits);
__IO_REG32_BIT(CANIF1_MCTRL,          0x40050038,__READ_WRITE ,__canifx_mctrl_bits);
__IO_REG32_BIT(CANIF1_DA1,            0x4005003C,__READ_WRITE ,__canifx_da1_bits);
__IO_REG32_BIT(CANIF1_DA2,            0x40050040,__READ_WRITE ,__canifx_da2_bits);
__IO_REG32_BIT(CANIF1_DB1,            0x40050044,__READ_WRITE ,__canifx_db1_bits);
__IO_REG32_BIT(CANIF1_DB2,            0x40050048,__READ_WRITE ,__canifx_db2_bits);
__IO_REG32_BIT(CANIF2_CMDREQ,         0x40050080,__READ_WRITE ,__canifx_cmdreq_bits);
__IO_REG32_BIT(CANIF2_CMDMSK,         0x40050084,__READ_WRITE ,__canifx_cmdmsk_bits);
__IO_REG32_BIT(CANIF2_MSK1,           0x40050088,__READ_WRITE ,__canifx_msk1_bits);
__IO_REG32_BIT(CANIF2_MSK2,           0x4005008C,__READ_WRITE ,__canifx_msk2_bits);
__IO_REG32_BIT(CANIF2_ARB1,           0x40050090,__READ_WRITE ,__canifx_arb1_bits);
__IO_REG32_BIT(CANIF2_ARB2,           0x40050094,__READ_WRITE ,__canifx_arb2_bits);
__IO_REG32_BIT(CANIF2_MCTRL,          0x40050098,__READ_WRITE ,__canifx_mctrl_bits);
__IO_REG32_BIT(CANIF2_DA1,            0x4005009C,__READ_WRITE ,__canifx_da1_bits);
__IO_REG32_BIT(CANIF2_DA2,            0x400500A0,__READ_WRITE ,__canifx_da2_bits);
__IO_REG32_BIT(CANIF2_DB1,            0x400500A4,__READ_WRITE ,__canifx_db1_bits);
__IO_REG32_BIT(CANIF2_DB2,            0x400500A8,__READ_WRITE ,__canifx_db2_bits);
__IO_REG32_BIT(CANTXREQ1,             0x40050100,__READ       ,__cantxreq1_bits);
__IO_REG32_BIT(CANTXREQ2,             0x40050104,__READ       ,__cantxreq2_bits);
__IO_REG32_BIT(CANND1,                0x40050120,__READ       ,__cannd1_bits);
__IO_REG32_BIT(CANND2,                0x40050124,__READ       ,__cannd2_bits);
__IO_REG32_BIT(CANIR1,                0x40050140,__READ       ,__canir1_bits);
__IO_REG32_BIT(CANIR2,                0x40050144,__READ       ,__canir2_bits);
__IO_REG32_BIT(CANMSGV1,              0x40050160,__READ       ,__canmsgv1_bits);
__IO_REG32_BIT(CANMSGV2,              0x40050164,__READ       ,__canmsgv2_bits);
__IO_REG32_BIT(CANCLKDIV,             0x40050180,__READ_WRITE ,__canclkdiv_bits);  
...
#define NVIC_C_CAN            29  /* C_CAN interrupt                                        */
...
Interrupt22  = C_CAN          0x74
Interrupt23  = SSP1           0x78
Interrupt24  = I2C0           0x7C
Interrupt25  = CT16B0         0x80
Interrupt26  = CT16B1         0x84
Interrupt27  = CT32B0         0x88
Interrupt28  = CT32B1         0x8C
Interrupt29  = SSP0           0x90
Interrupt30  = UART0          0x94
Interrupt31  = ADC            0xA0
Interrupt32  = WDT            0xA4
Interrupt33  = BOD            0xA8
Interrupt34  = PIO_3          0xB0
Interrupt35  = PIO_2          0xB4
Interrupt36  = PIO_1          0xB8
Interrupt37  = PIO_0          0xBC
###DDF-INTERRUPT-END###*/
