...
#ifndef __IOLPC1345_H
#define __IOLPC1345_H
 ...
 ***************************************************************************
 **
 **    LPC1345 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* USB clock status register (USBCLKST) */
typedef struct {
...
/* USB EP Command/Status List start address (EPLISTSTART) */
typedef struct {
  __REG32                      : 8;
  __REG32 EP_LIST              :24;
} __usb_epliststart_bits;

/* USB Data buffer start address (DATABUFSTART) */
typedef struct {
  __REG32                      :22;
  __REG32 DA_BUF               :10;
} __usb_databufstart_bits;
...
__IO_REG32_BIT(USBPLLCTRL,            0x40048010,__READ_WRITE ,__pllctrl_bits);
__IO_REG32_BIT(USBPLLSTAT,            0x40048014,__READ       ,__pllstat_bits);
...
__IO_REG32_BIT(USBPLLCLKSEL,          0x40048048,__READ_WRITE ,__clksel_bits);
...
__IO_REG32_BIT(USBCLKSEL,             0x400480C0,__READ_WRITE ,__clksel_bits);
__IO_REG32_BIT(USBCLKDIV,             0x400480C8,__READ_WRITE ,__clkdiv_bits);
...
__IO_REG32_BIT(USBCLKCTRL,            0x40048198,__READ_WRITE ,__usbclkctrl_bits);
__IO_REG32_BIT(USBCLKST,              0x4004819C,__READ       ,__usbclkst_bits);
...
**
***************************************************************************/
__IO_REG32_BIT(USB_DEVCMDSTAT,    0x40080000,__READ_WRITE ,__usb_devcmdstat_bits);
__IO_REG32_BIT(USB_INFO,          0x40080004,__READ_WRITE ,__usb_info_bits);
__IO_REG32_BIT(USB_EPLISTSTART,   0x40080008,__READ_WRITE ,__usb_epliststart_bits);
__IO_REG32_BIT(USB_DATABUFSTART,  0x4008000C,__READ_WRITE ,__usb_databufstart_bits);
__IO_REG32_BIT(USB_EPSKIP,        0x40080014,__READ_WRITE ,__usb_epskip_bits);
__IO_REG32_BIT(USB_EPINUSE,       0x40080018,__READ_WRITE ,__usb_epinuse_bits);
__IO_REG32_BIT(USB_EPBUFCFG,      0x4008001C,__READ_WRITE ,__usb_epbufcfg_bits);
__IO_REG32_BIT(USB_INTSTAT,       0x40080020,__READ_WRITE ,__usb_intstat_bits);
__IO_REG32_BIT(USB_INTEN,         0x40080024,__READ_WRITE ,__usb_inten_bits);
__IO_REG32_BIT(USB_INTSETSTAT,    0x40080028,__READ_WRITE ,__usb_intsetstat_bits);
__IO_REG32_BIT(USB_INTROUTING,    0x4008002C,__READ_WRITE ,__usb_introuting_bits);
__IO_REG32_BIT(USB_EPTOGGLE,      0x40080034,__READ       ,__usb_eptoggle_bits);
...
#define NVIC_USB_IRQ          38  /* USB_IRQ interrupt                                      */
#define NVIC_USB_FIQ          39  /* USB_FIQ interrupt                                      */
#define NVIC_ADC              40  /* ADC interrupt                                          */
#define NVIC_WWDT             41  /* WWDT interrupt                                         */
#define NVIC_BOD              42  /* BOD interrupt                                          */
#define NVIC_USB_WAKEUP       46  /* USB_WAKEUP interrupt                                   */
...
Interrupt27  = USB_IRQ        0x98
Interrupt28  = USB_FIQ        0x9C
Interrupt29  = ADC            0xA0
Interrupt30  = WWDT           0xA4
Interrupt31  = BOD            0xA8
Interrupt32  = USB_WAKEUP     0xB8
###DDF-INTERRUPT-END###*/
