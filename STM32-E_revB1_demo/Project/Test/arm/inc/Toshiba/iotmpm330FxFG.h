...
#ifndef __IOTMPM330FxFG_H
#define __IOTMPM330FxFG_H
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(RMC1EN,              0x40040440,  __READ_WRITE , __rmcen_bits );
__IO_REG32_BIT(RMC1REN,             0x40040444,  __READ_WRITE , __rmcren_bits );
__IO_REG32(    RMC1RBUF1,           0x40040448,  __READ);
__IO_REG32(    RMC1RBUF2,           0x4004044C,  __READ);
__IO_REG32(    RMC1RBUF3,           0x40040450,  __READ);
__IO_REG32_BIT(RMC1RCR1,            0x40040454,  __READ_WRITE , __rmcrcr1_bits );
__IO_REG32_BIT(RMC1RCR2,            0x40040458,  __READ_WRITE , __rmcrcr2_bits );
__IO_REG32_BIT(RMC1RCR3,            0x4004045C,  __READ_WRITE , __rmcrcr3_bits );
__IO_REG32_BIT(RMC1RCR4,            0x40040460,  __READ_WRITE , __rmcrcr4_bits );
__IO_REG32_BIT(RMC1RSTAT,           0x40040464,  __READ       , __rmcrstat_bits );
...
Interrupt23  = INTAINTRMCRX0  0x78
...
Interrupt47  = INTSBI2        0xD8
Interrupt48  = INTAINTRMCRX1  0xDC
Interrupt49  = INTTB7         0xE0
Interrupt50  = INTTB8         0xE4
Interrupt51  = INTTB9         0xE8
