 ...
 ***************************************************************************/
#ifndef __IONANO130_H
#define __IONANO130_H
 ...
 ***************************************************************************
 **
 **   NANO130 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
typedef struct {
  ...
  __REG32                 : 9;
  __REG32 SETUP           : 1;
} __usb_usb_intsts_bits;

/* Device's Function Address Register */
typedef struct {
  __REG32 FADDR           : 7;
  __REG32                 : 25;
} __usb_usb_faddr_bits;
...
typedef struct {
  ...
  __REG32 BUFSEG          : 6;
  __REG32                 : 23;
} __usb_usb_bufseg0_bits;

/* Endpoint 0 Maximal Payload Register */
typedef struct {
  __REG32 MXPLD           : 9;
  __REG32                 : 23;
} __usb_usb_mxpld0_bits;
...
typedef struct {
  ...
  __REG32 BUFSEG          : 6;
  __REG32                 : 23;
} __usb_usb_bufseg1_bits;

/* Endpoint 1 Maximal Payload Register */
typedef struct {
  __REG32 MXPLD           : 9;
  __REG32                 : 23;
} __usb_usb_mxpld1_bits;
...
typedef struct {
  ...
  __REG32 BUFSEG          : 6;
  __REG32                 : 23;
} __usb_usb_bufseg2_bits;

/* Endpoint 2 Maximal Payload Register */
typedef struct {
  __REG32 MXPLD           : 9;
  __REG32                 : 23;
} __usb_usb_mxpld2_bits;
...
typedef struct {
  ...
  __REG32 BUFSEG          : 6;
  __REG32                 : 23;
} __usb_usb_bufseg3_bits;

/* Endpoint 3 Maximal Payload Register */
typedef struct {
  __REG32 MXPLD           : 9;
  __REG32                 : 23;
} __usb_usb_mxpld3_bits;
...
typedef struct {
  ...
  __REG32 BUFSEG          : 6;
  __REG32                 : 23;
} __usb_usb_bufseg4_bits;

/* Endpoint 4 Maximal Payload Register */
typedef struct {
  __REG32 MXPLD           : 9;
  __REG32                 : 23;
} __usb_usb_mxpld4_bits;
...
typedef struct {
  ...
  __REG32 BUFSEG          : 6;
  __REG32                 : 23;
} __usb_usb_bufseg5_bits;

/* Endpoint 5 Maximal Payload Register */
typedef struct {
  __REG32 MXPLD           : 9;
  __REG32                 : 23;
} __usb_usb_mxpld5_bits;
...
typedef struct {
  ...
  __REG32 BV_SEL          : 1;
  __REG32                 : 1;
  __REG32 CPUMP_VOL_SET   : 3;
  __REG32 CPUMP_FREQ      : 3;
  __REG32                 : 18;
} __lcd_lcd_dispctl_bits;

/* LCD SEG_H data /COM0 */
typedef struct {
  __REG32 SEGData_31_39   : 8;
  __REG32                 : 24;
} __lcd_lcd_mem_4_bits;

/* LCD SEG_H data /COM1 */
typedef struct {
  __REG32 SEGData_31_39   : 8;
  __REG32                 : 24;
} __lcd_lcd_mem_5_bits;

/* LCD SEG_H data /COM2 */
typedef struct {
  __REG32 SEGData_31_39   : 8;
  __REG32                 : 24;
} __lcd_lcd_mem_6_bits;

/* LCD SEG_H data /COM3 */
typedef struct {
  __REG32 SEGData_31_39   : 8;
  __REG32                 : 24;
} __lcd_lcd_mem_7_bits;
...
__IO_REG32_BIT(GCR_LCDTRIM,           0x5000008C,__READ_WRITE ,__gcr_lcdtrim_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(USB_CTL,           0x40060000,__READ_WRITE ,__usb_usb_ctl_bits);
__IO_REG32_BIT(USB_BUSSTS,        0x40060004,__READ       ,__usb_usb_bussts_bits);
__IO_REG32_BIT(USB_INTEN,         0x40060008,__READ_WRITE ,__usb_usb_inten_bits);
__IO_REG32_BIT(USB_INTSTS,        0x4006000C,__READ_WRITE ,__usb_usb_intsts_bits);
__IO_REG32_BIT(USB_FADDR,         0x40060010,__READ_WRITE ,__usb_usb_faddr_bits);
__IO_REG32_BIT(USB_EPSTS,         0x40060014,__READ       ,__usb_usb_epsts_bits);
__IO_REG32_BIT(USB_BUFSEG,        0x40060018,__READ_WRITE ,__usb_usb_bufseg_bits);
__IO_REG32_BIT(USB_BUFSEG0,       0x40060020,__READ_WRITE ,__usb_usb_bufseg0_bits);
__IO_REG32_BIT(USB_MXPLD0,        0x40060024,__READ_WRITE ,__usb_usb_mxpld0_bits);
__IO_REG32_BIT(USB_CFG0,          0x40060028,__READ_WRITE ,__usb_usb_cfg0_bits);
__IO_REG32_BIT(USB_BUFSEG1,       0x40060030,__READ_WRITE ,__usb_usb_bufseg1_bits);
__IO_REG32_BIT(USB_MXPLD1,        0x40060034,__READ_WRITE ,__usb_usb_mxpld1_bits);
__IO_REG32_BIT(USB_CFG1,          0x40060038,__READ_WRITE ,__usb_usb_cfg1_bits);
__IO_REG32_BIT(USB_BUFSEG2,       0x40060040,__READ_WRITE ,__usb_usb_bufseg2_bits);
__IO_REG32_BIT(USB_MXPLD2,        0x40060044,__READ_WRITE ,__usb_usb_mxpld2_bits);
__IO_REG32_BIT(USB_CFG2,          0x40060048,__READ_WRITE ,__usb_usb_cfg2_bits);
__IO_REG32_BIT(USB_BUFSEG3,       0x40060050,__READ_WRITE ,__usb_usb_bufseg3_bits);
__IO_REG32_BIT(USB_MXPLD3,        0x40060054,__READ_WRITE ,__usb_usb_mxpld3_bits);
__IO_REG32_BIT(USB_CFG3,          0x40060058,__READ_WRITE ,__usb_usb_cfg3_bits);
__IO_REG32_BIT(USB_BUFSEG4,       0x40060060,__READ_WRITE ,__usb_usb_bufseg4_bits);
__IO_REG32_BIT(USB_MXPLD4,        0x40060064,__READ_WRITE ,__usb_usb_mxpld4_bits);
__IO_REG32_BIT(USB_CFG4,          0x40060068,__READ_WRITE ,__usb_usb_cfg4_bits);
__IO_REG32_BIT(USB_BUFSEG5,       0x40060070,__READ_WRITE ,__usb_usb_bufseg5_bits);
__IO_REG32_BIT(USB_MXPLD5,        0x40060074,__READ_WRITE ,__usb_usb_mxpld5_bits);
__IO_REG32_BIT(USB_CFG5,          0x40060078,__READ_WRITE ,__usb_usb_cfg5_bits);
__IO_REG32_BIT(USB_BIST,          0x400600A0,__READ_WRITE ,__usb_usb_bist_bits);
__IO_REG32_BIT(USB_PDMA,          0x400600A4,__READ_WRITE ,__usb_usb_pdma_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(LCD_CTL,           0x400B0000,__READ_WRITE ,__lcd_lcd_ctl_bits);
__IO_REG32_BIT(LCD_DISPCTL,       0x400B0004,__READ_WRITE ,__lcd_lcd_dispctl_bits);
__IO_REG32(    LCD_MEM_0,         0x400B0008,__READ_WRITE );
__IO_REG32(    LCD_MEM_1,         0x400B000C,__READ_WRITE );
__IO_REG32(    LCD_MEM_2,         0x400B0010,__READ_WRITE );
__IO_REG32(    LCD_MEM_3,         0x400B0014,__READ_WRITE );
__IO_REG32_BIT(LCD_MEM_4,         0x400B0018,__READ_WRITE ,__lcd_lcd_mem_4_bits);
__IO_REG32_BIT(LCD_MEM_5,         0x400B001C,__READ_WRITE ,__lcd_lcd_mem_5_bits);
__IO_REG32_BIT(LCD_MEM_6,         0x400B0020,__READ_WRITE ,__lcd_lcd_mem_6_bits);
__IO_REG32_BIT(LCD_MEM_7,         0x400B0024,__READ_WRITE ,__lcd_lcd_mem_7_bits);
__IO_REG32_BIT(LCD_FCR,           0x400B0028,__READ_WRITE ,__lcd_lcd_fcr_bits);
__IO_REG32_BIT(LCD_FCSTS,         0x400B002C,__READ_WRITE ,__lcd_lcd_fcsts_bits);
...
#define NVIC_USB_INT          39  /* USB interrupt                                          */
#define NVIC_TK_INT           40  /* TK interrupt                                           */
#define NVIC_LCD_INT          41  /* LCD interrupt                                          */
...
Interrupt21  = IRC_INT        0x84
Interrupt22  = I2C0_INT       0x88
Interrupt23  = I2C1_INT       0x8C
Interrupt24  = SC0_INT        0x94
Interrupt25  = SC1_INT        0x98
Interrupt26  = USB_INT        0x9C
Interrupt27  = TK_INT         0xA0
Interrupt28  = LCD_INT        0xA4
Interrupt29  = DMA_INT        0xA8
Interrupt30  = I2S_INT        0xAC
Interrupt31  = PD_WU_INT      0xB0
Interrupt32  = ADC_INT        0xB4
Interrupt33  = DAC_INT        0xB8
Interrupt34  = RTC_INT        0xBC
###DDF-INTERRUPT-END###*/