...
#ifndef __IOMB9BF618S_H
#define __IOMB9BF618S_H
 ...
 ***************************************************************************
 **
 **   MB9BF618S SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* IRQ33 Batch Read Register (IRQ33MON) */
typedef struct {
  __REG32                 : 1;
  __REG32  MAC1SBD        : 1;
  __REG32  MAC1PMI        : 1;
...
__IO_REG32_BIT(IRQ33MON,          0x40031098,__READ       ,__irqmon33_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(EMAC1_MCR,                   0x40067000,__READ_WRITE ,__emac_mcr_bits);
__IO_REG32_BIT(EMAC1_MFFR,                  0x40067004,__READ_WRITE ,__emac_mffr_bits);
__IO_REG32(    EMAC1_MHTRH,                 0x40067008,__READ_WRITE );
__IO_REG32(    EMAC1_MHTRL,                 0x4006700C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_GAR,                   0x40067010,__READ_WRITE ,__emac_gar_bits);
__IO_REG32_BIT(EMAC1_GDR,                   0x40067014,__READ_WRITE ,__emac_gdr_bits);
__IO_REG32_BIT(EMAC1_FCR,                   0x40067018,__READ_WRITE ,__emac_fcr_bits);
__IO_REG32_BIT(EMAC1_VTR,                   0x4006701C,__READ_WRITE ,__emac_vtr_bits);
__IO_REG32(    EMAC1_RWFFR,                 0x40067028,__READ_WRITE );
__IO_REG32_BIT(EMAC1_PMTR,                  0x4006702C,__READ_WRITE ,__emac_pmtr_bits);
__IO_REG32_BIT(EMAC1_LPICSR,                0x40067030,__READ_WRITE ,__emac_lpicsr_bits);
__IO_REG32_BIT(EMAC1_LPITCR,                0x40067034,__READ_WRITE ,__emac_lpitcr_bits);
__IO_REG32_BIT(EMAC1_ISR,                   0x40067038,__READ       ,__emac_isr_bits);
__IO_REG32_BIT(EMAC1_IMR,                   0x4006703C,__READ_WRITE ,__emac_imr_bits);
__IO_REG32_BIT(EMAC1_MAR0H,                 0x40067040,__READ_WRITE ,__emac_mar0h_bits);
__IO_REG32(    EMAC1_MAR0L,                 0x40067044,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR1H,                 0x40067048,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR1L,                 0x4006704C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR2H,                 0x40067050,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR2L,                 0x40067054,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR3H,                 0x40067058,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR3L,                 0x4006705C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR4H,                 0x40067060,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR4L,                 0x40067064,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR5H,                 0x40067068,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR5L,                 0x4006706C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR6H,                 0x40067070,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR6L,                 0x40067074,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR7H,                 0x40067078,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR7L,                 0x4006707C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR8H,                 0x40067080,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR8L,                 0x40067084,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR9H,                 0x40067088,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR9L,                 0x4006708C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR10H,                0x40067090,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR10L,                0x40067094,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR11H,                0x40067098,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR11L,                0x4006709C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR12H,                0x400670A0,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR12L,                0x400670A4,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR13H,                0x400670A8,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR13L,                0x400670AC,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR14H,                0x400670B0,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR14L,                0x400670B4,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR15H,                0x400670B8,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR15L,                0x400670BC,__READ_WRITE );
__IO_REG32_BIT(EMAC1_RGSR,                  0x400670D8,__READ       ,__emac_rgsr_bits);
__IO_REG32(    EMAC1_mmc_cntl,              0x40067100,__READ_WRITE );
__IO_REG32(    EMAC1_mmc_intr_rx,           0x40067104,__READ_WRITE );
__IO_REG32(    EMAC1_mmc_intr_tx,           0x40067108,__READ_WRITE );
__IO_REG32(    EMAC1_mmc_intr_mask_rx,      0x4006710C,__READ_WRITE );
__IO_REG32(    EMAC1_mmc_intr_mask_tx,      0x40067110,__READ_WRITE );
__IO_REG32(    EMAC1_txoctetcount_gb,       0x40067114,__READ       );
__IO_REG32(    EMAC1_txframecount_gb,       0x40067118,__READ       );
__IO_REG32(    EMAC1_txbroadcastframes_g,   0x4006711C,__READ       );
__IO_REG32(    EMAC1_txmulticastframes_g,   0x40067120,__READ       );
__IO_REG32(    EMAC1_tx64octets_gb,         0x40067124,__READ       );
__IO_REG32(    EMAC1_tx65to127octets_gb,    0x40067128,__READ       );
__IO_REG32(    EMAC1_tx128to255octets_gb,   0x4006712C,__READ       );
__IO_REG32(    EMAC1_tx256to511octets_gb,   0x40067130,__READ       );
__IO_REG32(    EMAC1_tx512to1023octets_gb,  0x40067134,__READ       );
__IO_REG32(    EMAC1_tx1024tomaxoctets_gb,  0x40067138,__READ       );
__IO_REG32(    EMAC1_txunicastframes_gb,    0x4006713C,__READ       );
__IO_REG32(    EMAC1_txmulticastframes_gb,  0x40067140,__READ       );
__IO_REG32(    EMAC1_txbroadcastframes_gb,  0x40067144,__READ       );
__IO_REG32(    EMAC1_txunderflowerror,      0x40067148,__READ       );
__IO_REG32(    EMAC1_txsinglecol_g,         0x4006714C,__READ       );
__IO_REG32(    EMAC1_txmulticol_g,          0x40067150,__READ       );
__IO_REG32(    EMAC1_txdeferred,            0x40067154,__READ       );
__IO_REG32(    EMAC1_txlatecol,             0x40067158,__READ       );
__IO_REG32(    EMAC1_txexesscol,            0x4006715C,__READ       );
__IO_REG32(    EMAC1_txcarriererrror,       0x40067160,__READ       );
__IO_REG32(    EMAC1_txoctetcount_g,        0x40067164,__READ       );
__IO_REG32(    EMAC1_txframecount_g,        0x40067168,__READ       );
__IO_REG32(    EMAC1_txexecessdef,          0x4006716C,__READ       );
__IO_REG32(    EMAC1_txpauseframes,         0x40067170,__READ       );
__IO_REG32(    EMAC1_txvlanframes_g,        0x40067174,__READ       );
__IO_REG32(    EMAC1_rxframecount_gb,       0x40067180,__READ       );
__IO_REG32(    EMAC1_rxoctetcount_gb,       0x40067184,__READ       );
__IO_REG32(    EMAC1_rxoctetcount_g,        0x40067188,__READ       );
__IO_REG32(    EMAC1_rxbroadcastframes_g,   0x4006718C,__READ       );
__IO_REG32(    EMAC1_rxmulticastframes_g,   0x40067190,__READ       );
__IO_REG32(    EMAC1_rxcrcerror,            0x40067194,__READ       );
__IO_REG32(    EMAC1_rxallignmenterror,     0x40067198,__READ       );
__IO_REG32(    EMAC1_rxrunterror,           0x4006719C,__READ       );
__IO_REG32(    EMAC1_rxjabbererror,         0x400671A0,__READ       );
__IO_REG32(    EMAC1_rxundersize_g,         0x400671A4,__READ       );
__IO_REG32(    EMAC1_rxoversize_g,          0x400671A8,__READ       );
__IO_REG32(    EMAC1_rx64octets_gb,         0x400671AC,__READ       );
__IO_REG32(    EMAC1_rx65to127octets_gb,    0x400671B0,__READ       );
__IO_REG32(    EMAC1_rx128to255octets_gb,   0x400671B4,__READ       );
__IO_REG32(    EMAC1_rx256to511octets_gb,   0x400671B8,__READ       );
__IO_REG32(    EMAC1_rx512to1023octets_gb,  0x400671BC,__READ       );
__IO_REG32(    EMAC1_rx1024tomaxoctets_gb,  0x400671C0,__READ       );
__IO_REG32(    EMAC1_rxunicastframes_g,     0x400671C4,__READ       );
__IO_REG32(    EMAC1_rxlengtherror,         0x400671C8,__READ       );
__IO_REG32(    EMAC1_rxoutofrangetype,      0x400671CC,__READ       );
__IO_REG32(    EMAC1_rxpauseframes,         0x400671D0,__READ       );
__IO_REG32(    EMAC1_rxfifooverflow,        0x400671D4,__READ       );
__IO_REG32(    EMAC1_rxvlanframes_gb,       0x400671D8,__READ       );
__IO_REG32(    EMAC1_rxwatchdogerror,       0x400671DC,__READ       );
__IO_REG32(    EMAC1_mmc_ipc_intr_mask_rx,  0x40067200,__READ_WRITE );
__IO_REG32(    EMAC1_mmc_ipc_intr_rx,       0x40067208,__READ_WRITE );
__IO_REG32(    EMAC1_rxipv4_gd_frms,        0x40067210,__READ       );
__IO_REG32(    EMAC1_rxipv4_hdrerr_frms,    0x40067214,__READ       );
__IO_REG32(    EMAC1_rxipv4_nopay_frms,     0x40067218,__READ       );
__IO_REG32(    EMAC1_rxipv4_frag_frms,      0x4006721C,__READ       );
__IO_REG32(    EMAC1_rxipv4_udsbl_frms,     0x40067220,__READ       );
__IO_REG32(    EMAC1_rxipv6_gd_frms,        0x40067224,__READ       );
__IO_REG32(    EMAC1_rxipv6_hdrerr_frms,    0x40067228,__READ       );
__IO_REG32(    EMAC1_rxipv6_nopay_frms,     0x4006722C,__READ       );
__IO_REG32(    EMAC1_rxudp_gd_frms,         0x40067230,__READ       );
__IO_REG32(    EMAC1_rxudp_err_frms,        0x40067234,__READ       );
__IO_REG32(    EMAC1_rxtcp_gd_frms,         0x40067238,__READ       );
__IO_REG32(    EMAC1_rxtcp_err_frms,        0x4006723C,__READ       );
__IO_REG32(    EMAC1_rxicmp_gd_frms,        0x40067240,__READ       );
__IO_REG32(    EMAC1_rxicmp_err_frms,       0x40067244,__READ       );
__IO_REG32(    EMAC1_rxipv4_gd_octets,      0x40067250,__READ       );
__IO_REG32(    EMAC1_rxipv4_hdrerr_octets,  0x40067254,__READ       );
__IO_REG32(    EMAC1_rxipv4_nopay_octets,   0x40067258,__READ       );
__IO_REG32(    EMAC1_rxipv4_frag_octets,    0x4006725C,__READ       );
__IO_REG32(    EMAC1_rxipv4_udsbl_octets,   0x40067260,__READ       );
__IO_REG32(    EMAC1_rxipv6_gd_octets,      0x40067264,__READ       );
__IO_REG32(    EMAC1_rxipv6_hdrerr_octets,  0x40067268,__READ       );
__IO_REG32(    EMAC1_rxipv6_nopay_octets,   0x4006726C,__READ       );
__IO_REG32(    EMAC1_rxudp_gd_octets,       0x40067270,__READ       );
__IO_REG32(    EMAC1_rxudp_err_octets,      0x40067274,__READ       );
__IO_REG32(    EMAC1_rxtcp_gd_octets,       0x40067278,__READ       );
__IO_REG32(    EMAC1_rxtcp_err_octets,      0x4006727C,__READ       );
__IO_REG32(    EMAC1_rxicmp_gd_octets,      0x40067280,__READ       );
__IO_REG32(    EMAC1_rxicmp_err_octets,     0x40067284,__READ       );
__IO_REG32_BIT(EMAC1_TSCR,                  0x40067700,__READ_WRITE ,__emac_tscr_bits);
__IO_REG32_BIT(EMAC1_SSIR,                  0x40067704,__READ_WRITE ,__emac_ssir_bits);
__IO_REG32(    EMAC1_STSR,                  0x40067708,__READ       );
__IO_REG32_BIT(EMAC1_STNR,                  0x4006770C,__READ       ,__emac_stnr_bits);
__IO_REG32(    EMAC1_STSUR,                 0x40067710,__READ_WRITE );
__IO_REG32_BIT(EMAC1_STSNUR,                0x40067714,__READ_WRITE ,__emac_stsnur_bits);
__IO_REG32(    EMAC1_TSAR,                  0x40067718,__READ_WRITE );
__IO_REG32(    EMAC1_TTSR,                  0x4006771C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_TTNR,                  0x40067720,__READ_WRITE ,__emac_ttnr_bits);
__IO_REG32_BIT(EMAC1_STHWSR,                0x40067724,__READ_WRITE ,__emac_sthwsr_bits);
__IO_REG32_BIT(EMAC1_TSR,                   0x40067728,__READ_WRITE ,__emac_tsr_bits);
__IO_REG32_BIT(EMAC1_PPSCR,                 0x4006772C,__READ_WRITE ,__emac_ppscr_bits);
__IO_REG32_BIT(EMAC1_ATNR,                  0x40067730,__READ       ,__emac_atnr_bits);
__IO_REG32(    EMAC1_ATSR,                  0x40067734,__READ       );
__IO_REG32_BIT(EMAC1_MAR16H,                0x40067800,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR16L,                0x40067804,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR17H,                0x40067808,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR17L,                0x4006780C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR18H,                0x40067810,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR18L,                0x40067814,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR19H,                0x40067818,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR19L,                0x4006781C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR20H,                0x40067820,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR20L,                0x40067824,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR21H,                0x40067828,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR21L,                0x4006782C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR22H,                0x40067830,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR22L,                0x40067834,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR23H,                0x40067838,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR23L,                0x4006783C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR24H,                0x40067840,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR24L,                0x40067844,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR25H,                0x40067848,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR25L,                0x4006784C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR26H,                0x40067850,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR26L,                0x40067854,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR27H,                0x40067858,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR27L,                0x4006785C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR28H,                0x40067860,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR28L,                0x40067864,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR29H,                0x40067868,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR29L,                0x4006786C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR30H,                0x40067870,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR30L,                0x40067874,__READ_WRITE );
__IO_REG32_BIT(EMAC1_MAR31H,                0x40067878,__READ_WRITE ,__emac_marxh_bits);
__IO_REG32(    EMAC1_MAR31L,                0x4006787C,__READ_WRITE );
__IO_REG32_BIT(EMAC1_BMR,                   0x40068000,__READ_WRITE ,__emac_bmr_bits);
__IO_REG32(    EMAC1_TPDR,                  0x40068004,__READ_WRITE );
__IO_REG32(    EMAC1_RPDR,                  0x40068008,__READ_WRITE );
__IO_REG32(    EMAC1_RDLAR,                 0x4006800C,__READ_WRITE );
__IO_REG32(    EMAC1_TDLAR,                 0x40068010,__READ_WRITE );
__IO_REG32_BIT(EMAC1_SR,                    0x40068014,__READ_WRITE ,__emac_sr_bits);
__IO_REG32_BIT(EMAC1_OMR,                   0x40068018,__READ_WRITE ,__emac_omr_bits);
__IO_REG32_BIT(EMAC1_IER,                   0x4006801C,__READ_WRITE ,__emac_ier_bits);
__IO_REG32_BIT(EMAC1_MFBOCR,                0x40068020,__READ_WRITE ,__emac_mfbocr_bits);
__IO_REG32_BIT(EMAC1_RIWTR,                 0x40068024,__READ_WRITE ,__emac_riwtr_bits);
__IO_REG32_BIT(EMAC1_AHBSR,                 0x4006802C,__READ       ,__emac_ahbsr_bits);
__IO_REG32(    EMAC1_CHTDR,                 0x40068048,__READ       );
__IO_REG32(    EMAC1_CHRDR,                 0x4006804C,__READ       );
__IO_REG32(    EMAC1_CHTBAR,                0x40068050,__READ       );
__IO_REG32(    EMAC1_CHRBAR,                0x40068054,__READ       );
...
#define NVIC_ETH1             49          /* Ethernet ch.1                                                                     */
...
Interrupt42  = ETH1           0xC4
Interrupt43  = USB0F          0xC8
Interrupt44  = USB0F_USB0H    0xCC
Interrupt45  = USB1F          0xD0
Interrupt46  = USB1F_USB1H    0xD4
Interrupt47  = DMAC0          0xD8
Interrupt48  = DMAC1          0xDC
Interrupt49  = DMAC2          0xE0
Interrupt50  = DMAC3          0xE4
Interrupt51  = DMAC4          0xE8
Interrupt52  = DMAC5          0xEC
Interrupt53  = DMAC6          0xF0
Interrupt54  = DMAC7          0xF4
Interrupt55  = BTIM8_15       0xF8
