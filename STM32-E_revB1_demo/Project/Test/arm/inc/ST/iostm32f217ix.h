...
#ifndef __IOSTM32F217Ix_H
#define __IOSTM32F217Ix_H
 ...
 ***************************************************************************
 **
 **   STM32F217Ix SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIOI_MODER,       0x40022000,__READ_WRITE ,__gpio_moder_bits);
__IO_REG32_BIT(GPIOI_OTYPER,      0x40022004,__READ_WRITE ,__gpio_otyper_bits);
__IO_REG32_BIT(GPIOI_OSPEEDR,     0x40022008,__READ_WRITE ,__gpio_ospeedr_bits);
__IO_REG32_BIT(GPIOI_PUPDR,       0x4002200C,__READ_WRITE ,__gpio_pupdr_bits);
__IO_REG32_BIT(GPIOI_IDR,         0x40022010,__READ       ,__gpio_idr_bits);
__IO_REG32_BIT(GPIOI_ODR,         0x40022014,__READ_WRITE ,__gpio_odr_bits);
__IO_REG32_BIT(GPIOI_BSRR,        0x40022018,__WRITE      ,__gpio_bsrr_bits);
__IO_REG32_BIT(GPIOI_LCKR,        0x4002201C,__READ_WRITE ,__gpio_lckr_bits);
__IO_REG32_BIT(GPIOI_AFRL,        0x40022020,__READ_WRITE ,__gpio_afrl_bits);
__IO_REG32_BIT(GPIOI_AFRH,        0x40022024,__READ_WRITE ,__gpio_afrh_bits);
...
Interrupt88  = CRYP               0x17C
Interrupt89  = HASH_RNG           0x180
