...
#ifndef __IOSPEAR300_H
#define __IOSPEAR300_H
 ...
 ***************************************************************************
 **
 **   SPEAR300 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************/
...
typedef struct
{
  ...
  __REG32  G8_G10       : 1;
  __REG32  NAND_NOR     : 4;
  __REG32  DAC_TELECOM  : 1;
  __REG32  I2S_SDIO     : 1;
  __REG32  _16BIT       : 1;
  __REG32  PL_CLK1      : 1;
} __ras_reg2_bits;

/* GenMemCtrl(i) registers */
typedef struct
{
  __REG32  BankEnable     : 1;
  __REG32  Muxed          : 1;
  __REG32  MemType        : 2;
  __REG32  DevWidth       : 2;
  __REG32  RstPwrDown     : 1;
  __REG32  Wprot          : 1;
  __REG32                 : 1;
  __REG32  WaitPolarity   : 1;
  __REG32                 : 1;
  __REG32  Wait_delay     : 1;
  __REG32  If_we          : 1;
  __REG32  Waiten         : 1;
  __REG32                 :18;
} __genmemctrl_bits;
...
typedef struct
{
  ...
  __REG32 GPIO7         : 1;
  __REG32               : 8;
} __telecom_it_gen_bits;

/* GPIOt/GPIOtt register*/
typedef struct
{
  __REG32 IT0           : 1;
  __REG32 IT1           : 1;
...
typedef struct
{
  __REG32 PV            : 8;
  __REG32               :24;
} __telecom_pers_data_bits;

/* TDM_timeselot_NBR register */
typedef struct
{
  __REG32 TSN           :11;
  __REG32               :21;
} __telecom_tdm_tslot_nbr_bits;

/* TDM_frame_NBR register */
typedef struct
{
  __REG32 FRN           :15;
  __REG32               :17;
} __telecom_tdm_frame_nbr_bits;

/* TDM_SYNC_GEN register */
typedef struct
{
  __REG32 M_S           : 1;
  __REG32 Use0          : 2;
  ...
  __REG32 BB            : 1;
  __REG32 Nsh           : 1;
} __telecom_tdm_sync_gen_bits;

/* SPI_I2C_usage register */
typedef struct
{
  __REG32 U0            : 1;
  __REG32 U1            : 1;
...
typedef struct
{
  ...
  __REG32 ST_mode       : 1;
  __REG32               : 7;
} __telecom_i2s_conf2_bits;

/* I2S_CLK_CONF register */
typedef struct
{
  __REG32 M_S           : 1;
  __REG32 Inv           : 1;
...
typedef struct
{
  ...
  __REG32 GPIODATA8     : 1;
  __REG32 GPIODATA9     : 1;
  __REG32 GPIODATA10    : 1;
  __REG32 GPIODATA11    : 1;
  __REG32 GPIODATA12    : 1;
  __REG32 GPIODATA13    : 1;
  __REG32 GPIODATA14    : 1;
  __REG32 GPIODATA15    : 1;
  __REG32 GPIODATA16    : 1;
  __REG32 GPIODATA17    : 1;
  __REG32               :14;
} __gpiodatareg_bits;
 ...
 **
 ***************************************************************************/
__IO_REG16(    UARTDR,                0xD0000000,__READ_WRITE );
__IO_REG8_BIT( UARTRSR,               0xD0000004,__READ_WRITE ,__uartrsr_bits);
#define UARTECR          UARTRSR
__IO_REG16_BIT(UARTFR,                0xD0000018,__READ       ,__uartfr_bits);
__IO_REG16(    UARTIBRD,              0xD0000024,__READ_WRITE );
__IO_REG8_BIT( UARTFBRD,              0xD0000028,__READ_WRITE ,__uartfbrd_bits);
__IO_REG16_BIT(UARTLCR_H,             0xD000002C,__READ_WRITE ,__uartlcr_h_bits);
__IO_REG16_BIT(UARTCR,                0xD0000030,__READ_WRITE ,__uartcr_bits);
__IO_REG16_BIT(UARTIFLS,              0xD0000034,__READ_WRITE ,__uartifls_bits);
__IO_REG16_BIT(UARTIMSC,              0xD0000038,__READ_WRITE ,__uartimsc_bits);
__IO_REG16_BIT(UARTRIS,               0xD000003C,__READ       ,__uartris_bits);
__IO_REG16_BIT(UARTMIS,               0xD0000040,__READ       ,__uartmis_bits);
__IO_REG16_BIT(UARTICR,               0xD0000044,__WRITE      ,__uarticr_bits);
__IO_REG16_BIT(UARTDMACR,             0xD0000048,__READ_WRITE ,__uartdmacr_bits);
__IO_REG32(    UARTPeriphID0,         0xD0000FE0,__READ       );
__IO_REG32(    UARTPeriphID1,         0xD0000FE4,__READ       );
__IO_REG32(    UARTPeriphID2,         0xD0000FE8,__READ       );
__IO_REG32(    UARTPeriphID3,         0xD0000FEC,__READ       );
__IO_REG32(    UARTPCellID0,          0xD0000FF0,__READ       );
__IO_REG32(    UARTPCellID1,          0xD0000FF4,__READ       );
__IO_REG32(    UARTPCellID2,          0xD0000FF8,__READ       );
__IO_REG32(    UARTPCellID3,          0xD0000FFC,__READ       );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(RAS_reg1,              0x99000000,__READ_WRITE ,__ras_reg1_bits);
__IO_REG32_BIT(RAS_reg2,              0x99000004,__READ_WRITE ,__ras_reg2_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GenMemCtrl0,           0x94000000,__READ_WRITE ,__genmemctrl_bits);
__IO_REG32_BIT(GenMemCtrl_tim0,       0x94000004,__READ_WRITE ,__genmemctrl_tim_bits);
__IO_REG32_BIT(GenMemCtrl1,           0x94000008,__READ_WRITE ,__genmemctrl_bits);
__IO_REG32_BIT(GenMemCtrl_tim1,       0x9400000C,__READ_WRITE ,__genmemctrl_tim_bits);
__IO_REG32_BIT(GenMemCtrl2,           0x94000010,__READ_WRITE ,__genmemctrl_bits);
__IO_REG32_BIT(GenMemCtrl_tim2,       0x94000014,__READ_WRITE ,__genmemctrl_tim_bits);
__IO_REG32_BIT(GenMemCtrl3,           0x94000018,__READ_WRITE ,__genmemctrl_bits);
__IO_REG32_BIT(GenMemCtrl_tim3,       0x9400001C,__READ_WRITE ,__genmemctrl_tim_bits);
__IO_REG32_BIT(GenMemCtrl_PC0,        0x94000040,__READ_WRITE ,__genmemctrl_pc_bits);
__IO_REG32_BIT(GenMemCtrl_Comm0,      0x94000048,__READ_WRITE ,__genmemctrl_comm_bits);
__IO_REG32_BIT(GenMemCtrl_Attrib0,    0x9400004C,__READ_WRITE ,__genmemctrl_comm_bits);
__IO_REG32_BIT(GenMemCtrl_ECCr0,      0x94000054,__READ       ,__genmemctrl_eccr_bits);
__IO_REG32_BIT(GenMemCtrl_PC1,        0x94000060,__READ_WRITE ,__genmemctrl_pc_bits);
__IO_REG32_BIT(GenMemCtrl_Comm1,      0x94000068,__READ_WRITE ,__genmemctrl_comm_bits);
__IO_REG32_BIT(GenMemCtrl_Attrib1,    0x9400006C,__READ_WRITE ,__genmemctrl_comm_bits);
__IO_REG32_BIT(GenMemCtrl_ECCr1,      0x94000074,__READ       ,__genmemctrl_eccr_bits);
__IO_REG32_BIT(GenMemCtrl_PC2,        0x94000080,__READ_WRITE ,__genmemctrl_pc_bits);
__IO_REG32_BIT(GenMemCtrl_Comm2,      0x94000088,__READ_WRITE ,__genmemctrl_comm_bits);
__IO_REG32_BIT(GenMemCtrl_Attrib2,    0x9400008C,__READ_WRITE ,__genmemctrl_comm_bits);
__IO_REG32_BIT(GenMemCtrl_PC3,        0x940000A0,__READ_WRITE ,__genmemctrl_pc_bits);
__IO_REG32_BIT(GenMemCtrl_Comm3,      0x940000A8,__READ_WRITE ,__genmemctrl_comm_bits);
__IO_REG32_BIT(GenMemCtrl_Attrib3,    0x940000AC,__READ_WRITE ,__genmemctrl_comm_bits);
__IO_REG32(    GenMemCtrl_PeriphID0,  0x94000FE0,__READ       );
__IO_REG32(    GenMemCtrl_PeriphID1,  0x94000FE4,__READ       );
__IO_REG32(    GenMemCtrl_PeriphID2,  0x94000FE8,__READ       );
__IO_REG32(    GenMemCtrl_PeriphID3,  0x94000FEC,__READ       );
__IO_REG32(    GenMemCtrl_PCellID0,   0x94000FF0,__READ       );
__IO_REG32(    GenMemCtrl_PCellID1,   0x94000FF4,__READ       );
__IO_REG32(    GenMemCtrl_PCellID2,   0x94000FF8,__READ       );
__IO_REG32(    GenMemCtrl_PCellID3,   0x94000FFC,__READ       );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(RS_GPIODATA,           0xA90003FC,__READ_WRITE ,__rs_gpiodata_bits);
__IO_REG32_BIT(RS_GPIODIR,            0xA9000400,__READ_WRITE ,__rs_gpiodir_bits);
__IO_REG32_BIT(RS_GPIOIS,             0xA9000404,__READ_WRITE ,__rs_gpiois_bits);
__IO_REG32_BIT(RS_GPIOIBE,            0xA9000408,__READ_WRITE ,__rs_gpioibe_bits);
__IO_REG32_BIT(RS_GPIOIEV,            0xA900040C,__READ_WRITE ,__rs_gpioiev_bits);
__IO_REG32_BIT(RS_GPIOIE,             0xA9000410,__READ_WRITE ,__rs_gpioie_bits);
__IO_REG32_BIT(RS_GPIORIS,            0xA9000414,__READ       ,__rs_gpioris_bits);
__IO_REG32_BIT(RS_GPIOMIS,            0xA9000418,__READ       ,__rs_gpiomis_bits);
__IO_REG32_BIT(RS_GPIOIC,             0xA900041C,__WRITE      ,__rs_gpioic_bits);
__IO_REG16(    RS_GPIOPeriphID0,      0xA9000FE0,__READ       );
__IO_REG16(    RS_GPIOPeriphID1,      0xA9000FE4,__READ       );
__IO_REG16(    RS_GPIOPeriphID2,      0xA9000FE8,__READ       );
__IO_REG16(    RS_GPIOPeriphID3,      0xA9000FEC,__READ       );
__IO_REG16(    RS_GPIOPCellID0,       0xA9000FF0,__READ       );
__IO_REG16(    RS_GPIOPCellID1,       0xA9000FF4,__READ       );
__IO_REG16(    RS_GPIOPCellID2,       0xA9000FF8,__READ       );
__IO_REG16(    RS_GPIOPCellID3,       0xA9000FFC,__READ       );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(LCDTiming0,            0x60000000,__READ_WRITE ,__lcdtiming0_bits);
__IO_REG32_BIT(LCDTiming1,            0x60000004,__READ_WRITE ,__lcdtiming1_bits);
__IO_REG32_BIT(LCDTiming2,            0x60000008,__READ_WRITE ,__lcdtiming2_bits);
__IO_REG32_BIT(LCDTiming3,            0x6000000C,__READ_WRITE ,__lcdtiming3_bits);
__IO_REG32(    LCDUPBase,             0x60000010,__READ_WRITE );
__IO_REG32(    LCDLPBase,             0x60000014,__READ_WRITE );
__IO_REG32_BIT(LCDMSC,                0x60000018,__READ_WRITE ,__lcdmsc_bits);
__IO_REG32_BIT(LCDControl,            0x6000001C,__READ_WRITE ,__lcdcontrol_bits);
__IO_REG32_BIT(LCDRIS,                0x60000020,__READ_WRITE ,__lcdris_bits);
__IO_REG32_BIT(LCDMIS,                0x60000024,__READ       ,__lcdmis_bits);
__IO_REG32_BIT(LCDICR,                0x60000028,__WRITE      ,__lcdris_bits);
__IO_REG32(    LCDUPCUR,              0x6000002C,__READ       );
__IO_REG32(    LCDLPCUR,              0x60000030,__READ       );
__IO_REG32(    LCDPaletteBase,        0x60000200,__READ_WRITE );
__IO_REG32(    LCDLPHERIPHID0,        0x60000FE0,__READ       );
__IO_REG32(    LCDLPHERIPHID1,        0x60000FE4,__READ       );
__IO_REG32(    LCDLPHERIPHID2,        0x60000FE8,__READ       );
__IO_REG32(    LCDLPHERIPHID3,        0x60000FEC,__READ       );
__IO_REG32(    LCDLPCELLIDID0,        0x60000FF0,__READ       );
__IO_REG32(    LCDLPCELLIDID1,        0x60000FF4,__READ       );
__IO_REG32(    LCDLPCELLIDID2,        0x60000FF8,__READ       );
__IO_REG32(    LCDLPCELLIDID3,        0x60000FFC,__READ       );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(TELECOM_BOOT,          0x50000000,__READ       ,__telecom_boot_bits);
__IO_REG32_BIT(TELECOM_TDM_CONF,      0x50000004,__READ_WRITE ,__telecom_tdm_conf_bits);
__IO_REG32_BIT(TELECOM_GPIO8_DIR,     0x50000008,__READ_WRITE ,__telecom_gpio8_dir_bits);
__IO_REG32_BIT(TELECOM_GPIO10_DIR,    0x5000000C,__READ_WRITE ,__telecom_gpio10_dir_bits);
__IO_REG32_BIT(TELECOM_GPIO8_OUT,     0x50000010,__READ_WRITE ,__telecom_gpio8_out_bits);
__IO_REG32_BIT(TELECOM_GPIO10_OUT,    0x50000014,__READ_WRITE ,__telecom_gpio10_out_bits);
__IO_REG32_BIT(TELECOM_GPIO8_IN,      0x50000018,__READ       ,__telecom_gpio8_in_bits);
__IO_REG32_BIT(TELECOM_GPIO10_IN,     0x5000001C,__READ       ,__telecom_gpio10_in_bits);
__IO_REG32_BIT(TELECOM_IT_GEN,        0x50000024,__READ_WRITE ,__telecom_it_gen_bits);
__IO_REG32_BIT(TELECOM_GPIOt,         0x50000028,__READ       ,__telecom_gpiot_bits);
__IO_REG32_BIT(TELECOM_GPIOtt,        0x5000002C,__READ       ,__telecom_gpiot_bits);
__IO_REG32_BIT(TELECOM_PERS_TIME,     0x50000030,__READ_WRITE ,__telecom_pers_time_bits);
__IO_REG32_BIT(TELECOM_PERS_DATA,     0x50000034,__READ_WRITE ,__telecom_pers_data_bits);
__IO_REG32_BIT(TELECOM_TDM_TSLOT_NBR, 0x50000038,__READ_WRITE ,__telecom_tdm_tslot_nbr_bits);
__IO_REG32_BIT(TELECOM_TDM_FRAME_NBR, 0x5000003C,__READ_WRITE ,__telecom_tdm_frame_nbr_bits);
__IO_REG32_BIT(TELECOM_TDM_SYNC_GEN,  0x50000040,__READ_WRITE ,__telecom_tdm_sync_gen_bits);
__IO_REG32_BIT(TELECOM_SPI_I2C_usage, 0x50000044,__READ_WRITE ,__telecom_spi_i2c_usage_bits);
__IO_REG32_BIT(TELECOM_SPI_I2C_active,0x50000048,__READ_WRITE ,__telecom_spi_i2c_active_bits);
__IO_REG32_BIT(TELECOM_I2S_CONF,      0x5000004C,__READ_WRITE ,__telecom_i2s_conf_bits);
__IO_REG32_BIT(TELECOM_I2S_CLK_CONF,  0x50000050,__READ_WRITE ,__telecom_i2s_clk_conf_bits);
__IO_REG32_BIT(TELECOM_INTM,          0x50000054,__READ_WRITE ,__telecom_intm_bits);
__IO_REG32_BIT(TELECOM_INTS,          0x50000058,__READ       ,__telecom_ints_bits);
__IO_REG32_BIT(TELECOM_I2S_CONF2,     0x5000006C,__READ_WRITE ,__telecom_i2s_conf2_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(MDCTRLREG,             0xA0000000,__READ_WRITE ,__mdctrlreg_bits);
__IO_REG32_BIT(GPIODIRREG,            0xA0000004,__WRITE      ,__gpiodirreg_bits);
__IO_REG32_BIT(GPIODATAREG,           0xA0000008,__READ_WRITE ,__gpiodatareg_bits);
__IO_REG32_BIT(STATUSREG,             0xA0000010,__READ_WRITE ,__statusreg_bits);
__IO_REG32_BIT(KBREG,                 0xA0000014,__READ_WRITE ,__kbreg_bits);
