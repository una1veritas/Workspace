...
#ifndef __IOSTM32L152xx_H
#define __IOSTM32L152xx_H
 ...
 ***************************************************************************
 **
 **   STM32L152xx SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(DMA_ISR,           0x40026000,__READ       ,__dma_isr_bits);
__IO_REG32_BIT(DMA_IFCR,          0x40026004,__WRITE      ,__dma_ifcr_bits);
__IO_REG32_BIT(DMA_CCR1,          0x40026008,__READ_WRITE ,__dma_ccr_bits);
__IO_REG32_BIT(DMA_CNDTR1,        0x4002600C,__READ_WRITE ,__dma_cndtr_bits);
__IO_REG32(    DMA_CPAR1,         0x40026010,__READ_WRITE );
__IO_REG32(    DMA_CMAR1,         0x40026014,__READ_WRITE );
__IO_REG32_BIT(DMA_CCR2,          0x4002601C,__READ_WRITE ,__dma_ccr_bits);
__IO_REG32_BIT(DMA_CNDTR2,        0x40026020,__READ_WRITE ,__dma_cndtr_bits);
__IO_REG32(    DMA_CPAR2,         0x40026024,__READ_WRITE );
__IO_REG32(    DMA_CMAR2,         0x40026028,__READ_WRITE );
__IO_REG32_BIT(DMA_CCR3,          0x40026030,__READ_WRITE ,__dma_ccr_bits);
__IO_REG32_BIT(DMA_CNDTR3,        0x40026034,__READ_WRITE ,__dma_cndtr_bits);
__IO_REG32(    DMA_CPAR3,         0x40026038,__READ_WRITE );
__IO_REG32(    DMA_CMAR3,         0x4002603C,__READ_WRITE );
__IO_REG32_BIT(DMA_CCR4,          0x40026044,__READ_WRITE ,__dma_ccr_bits);
__IO_REG32_BIT(DMA_CNDTR4,        0x40026048,__READ_WRITE ,__dma_cndtr_bits);
__IO_REG32(    DMA_CPAR4,         0x4002604C,__READ_WRITE );
__IO_REG32(    DMA_CMAR4,         0x40026050,__READ_WRITE );
__IO_REG32_BIT(DMA_CCR5,          0x40026058,__READ_WRITE ,__dma_ccr_bits);
__IO_REG32_BIT(DMA_CNDTR5,        0x4002605C,__READ_WRITE ,__dma_cndtr_bits);
__IO_REG32(    DMA_CPAR5,         0x40026060,__READ_WRITE );
__IO_REG32(    DMA_CMAR5,         0x40026064,__READ_WRITE );
__IO_REG32_BIT(DMA_CCR6,          0x4002606C,__READ_WRITE ,__dma_ccr_bits);
__IO_REG32_BIT(DMA_CNDTR6,        0x40026070,__READ_WRITE ,__dma_cndtr_bits);
__IO_REG32(    DMA_CPAR6,         0x40026074,__READ_WRITE );
__IO_REG32(    DMA_CMAR6,         0x40026078,__READ_WRITE );
__IO_REG32_BIT(DMA_CCR7,          0x40026080,__READ_WRITE ,__dma_ccr_bits);
__IO_REG32_BIT(DMA_CNDTR7,        0x40026084,__READ_WRITE ,__dma_cndtr_bits);
__IO_REG32(    DMA_CPAR7,         0x40026088,__READ_WRITE );
__IO_REG32(    DMA_CMAR7,         0x4002608C,__READ_WRITE );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(TIM10_CR1,         0x40010C00,__READ_WRITE ,__tim9_cr1_bits);
__IO_REG32_BIT(TIM10_SMCR,        0x40010C08,__READ_WRITE ,__tim10_smcr_bits);
__IO_REG32_BIT(TIM10_DIER,        0x40010C0C,__READ_WRITE ,__tim9_dier_bits);
__IO_REG32_BIT(TIM10_SR,          0x40010C10,__READ_WRITE ,__tim9_sr_bits);
__IO_REG32_BIT(TIM10_EGR,         0x40010C14,__READ_WRITE ,__tim9_egr_bits);
__IO_REG32_BIT(TIM10_CCMR1,       0x40010C18,__READ_WRITE ,__tim9_ccmr1_bits);
#define TIM10_OCMR1      TIM10_CCMR1
#define TIM10_OCMR1_bit  TIM10_CCMR1_bit
__IO_REG32_BIT(TIM10_CCER,        0x40010C20,__READ_WRITE ,__tim9_ccer_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(TIM11_CR1,         0x40011000,__READ_WRITE ,__tim9_cr1_bits);
__IO_REG32_BIT(TIM11_SMCR,        0x40011008,__READ_WRITE ,__tim10_smcr_bits);
__IO_REG32_BIT(TIM11_DIER,        0x4001100C,__READ_WRITE ,__tim9_dier_bits);
__IO_REG32_BIT(TIM11_SR,          0x40011010,__READ_WRITE ,__tim9_sr_bits);
__IO_REG32_BIT(TIM11_EGR,         0x40011014,__READ_WRITE ,__tim9_egr_bits);
__IO_REG32_BIT(TIM11_CCMR1,       0x40011018,__READ_WRITE ,__tim9_ccmr1_bits);
#define TIM11_OCMR1      TIM11_CCMR1
#define TIM11_OCMR1_bit  TIM11_CCMR1_bit
__IO_REG32_BIT(TIM11_CCER,        0x40011020,__READ_WRITE ,__tim9_ccer_bits);
