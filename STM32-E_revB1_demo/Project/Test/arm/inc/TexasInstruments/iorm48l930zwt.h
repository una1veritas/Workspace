...
#ifndef __IORM48L930ZWT_H
#define __IORM48L930ZWT_H
 ...
 ***************************************************************************
 **
 **    RM48L930ZWT SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
***************************************************************************/
...
/* OHCI Port 0/1 Status and Control Register (HCRHPORTSTATUS0/1) */
typedef struct {
  __REG32 CCS_CPE       : 1;
  __REG32 PES_SPE       : 1;
  __REG32 PSS_SPS       : 1;
...
/* OHCI Host UE Status Register (HOSTUESTATUS) */
typedef struct {
  __REG32 UEACCESS      : 1;
  __REG32               :31;
} __hostuestatus_bits;

/* OHCI Host Time-out Control Register (HOSTTIMEOUTCTRL) */
typedef struct {
  __REG32 TO_DIS	      : 1;
  __REG32               :31;
} __hosttimeoutctrl_bits;

/* OHCI Host Revision Register (HOSTREVISION) */
typedef struct {
  __REG32 MINORREV      : 4;
  __REG32 MAJORREV      : 4;
  __REG32               :24;
...
/* USB Revision Register (REV) */
typedef struct {
  __REG16 REV_NB	      : 8;
  __REG16               : 8;
} __usb_rev_bits;

/* USB Endpoint Selection Register (EP_NUM) */
typedef struct {
  __REG16 EP_NUM	      : 4;
  __REG16 EP_DIR	      : 1;
  __REG16 EP_SEL	      : 1;
...
/* USB Control Register (CTRL) */
typedef struct {
  __REG16 RESET_EP	    : 1;
  __REG16 CLR_EP	      : 1;
  __REG16 SET_FIFO_EN   : 1;
  __REG16               : 3;
  __REG16 SET_HALT      : 1;
  __REG16 CLR_HALT      : 1;
  __REG16               : 8;
...
/* USB Receive FIFO Status Register (RXFSTAT) */
typedef struct {
  __REG16 NON_ISO_FIFO_FULL		: 1;
  __REG16 NON_ISO_FIFO_EMPTY	: 1;
  __REG16 FIFO_EN					    : 1;
  __REG16 ACK							    : 1;
  __REG16 NAK							    : 1;
  __REG16 STALL						    : 1;
  __REG16 EP_HALTED				    : 1;
  __REG16 								    : 1;
  __REG16 ISO_FIFO_FULL 	    : 1;
  __REG16 ISO_FIFO_EMPTY 	    : 1;
  __REG16               			: 2;
  __REG16 ISO_ERR				      : 1;
  __REG16 DATA_FLUSH		      : 1;
  __REG16 MISS_IN				      : 1;
  __REG16 NO_RXPACKET		      : 1;
} __usb_stat_flg_bits;

/* USB Receive FIFO Status Register (RXFSTAT) */
typedef struct {
  __REG16 RXF_COUNT	    :10;
  __REG16               : 6;
} __usb_rxfstat_bits;

/* USB System Configuration Register 1 (SYSCON1) */
typedef struct {
  __REG16 PULLUP_EN	    : 1;
  __REG16 SOFF_DIS	    : 1;
  __REG16 SELF_PWR	    : 1;
  __REG16 AUTODEC_DIS   : 1;
  __REG16 NAK_EN		    : 1;
  __REG16 					    : 1;
  __REG16 DMA_ENDIAN    : 1;
  __REG16 DATA_ENDIAN   : 1;
  __REG16 CFG_LOCK	    : 1;
  __REG16               : 7;
} __usb_syscon1_bits;

/* USB System Configuration Register 2 (SYSCON2) */
typedef struct {
  __REG16               : 2;
  __REG16 CLR_CFG		    : 1;
  __REG16 DEV_CFG		    : 1;
...
/* USB Device Status Register (DEVSTAT) */
typedef struct {
  __REG16 ATT	         			: 1;
  __REG16 DEF				    		: 1;
  __REG16 ADD				    		: 1;
  ...
  __REG16 USB_RESET	    		: 1;
  __REG16 R_WK_OK		    		: 1;
  __REG16 A_ALT_HNP_SUPPORT	: 1;
  __REG16 A_HNP_SUPPORT	    : 1;
  __REG16 B_HNP_ENABLE	    : 1;
  __REG16             		  : 6;
} __usb_devstat_bits;

/* USB Start of Frame Register (SOF) */
typedef struct {
  __REG16 TS	         			:11;
  __REG16 TS_OK			    		: 1;
  __REG16 FT_LOCK		    		: 1;
...
/* USB Interrupt Enable Register (IRQ_EN) */
typedef struct {
  __REG16 EP0_IE       			: 1;
  __REG16             		  : 2;
  __REG16 DS_CHG_IE	    		: 1;
...
/* USB DMA Interrupt Enable Register (DMA_IRQ_EN) */
typedef struct {
  __REG16 RX0_EOT_IE   			: 1;
  __REG16 RX0_CNT_IE   			: 1;
  __REG16 TX0_DONE_IE  			: 1;
  __REG16             		  : 1;
  __REG16 RX1_EOT_IE    		: 1;
  __REG16 RX1_CNT_IE    		: 1;
  __REG16 TX1_DONE_IE    		: 1;
  __REG16             		  : 1;
  __REG16 RX2_EOT_IE    		: 1;
  __REG16 RX2_CNT_IE    		: 1;
  __REG16 TX2_DONE_IE    		: 1;
  __REG16             		  : 5;
} __usb_dma_irq_en_bits;

/* USB Interrupt Source Register (IRQ_SRC) */
typedef struct {
  __REG16 EP0_TX		   			: 1;
  __REG16 EP0_RX		   			: 1;
  __REG16 SETUP			  			: 1;
...
/* USB Non-ISO Endpoint Interrupt Status Register (EPN_STAT) */
typedef struct {
  __REG16 EPn_TX_IT_SRC			: 4;
  __REG16 					   			: 4;
  __REG16 EPn_RX_IT_SRC			: 4;
  __REG16 					   			: 4;
} __usb_epn_stat_bits;

/* USB Non-ISO DMA Interrupt Status Register (DMAN_STAT) */
typedef struct {
  __REG16 DMAn_TX_IT_SRC		: 4;
  __REG16 					   			: 4;
  __REG16 DMAn_RX_IT_SRC		: 4;
  __REG16 DMAn_RX_SB				: 1;
  __REG16 					   			: 3;
} __usb_dman_stat_bits;

/* USB DMA Receive Channels Configuration Register (RXDMA_CFG) */
typedef struct {
  __REG16 RXDMA0_EP					: 4;
  __REG16 RXDMA1_EP	   			: 4;
  __REG16 RXDMA2_EP					: 4;
  __REG16 RX_REQ						: 1;
  __REG16 					   			: 3;
} __usb_rxdma_cfg_bits;

/* USB DMA Transmit Channels Configuration Register (TXDMA_CFG) */
typedef struct {
  __REG16 TXDMA0_EP					: 4;
  __REG16 TXDMA1_EP	   			: 4;
  __REG16 TXDMA2_EP					: 4;
  __REG16 TX_REQ						: 1;
  __REG16 					   			: 3;
} __usb_txdma_cfg_bits;

/* USB Transmit DMA Control Register n (TXDMAn) */
typedef struct {
  __REG16 TXn_TSC						:10;
  __REG16 					   			: 4;
  __REG16 TXn_START					: 1;
...
/* USB Receive DMA Control Register n (RXDMAn) */
typedef struct {
  __REG16 RXn_TC						: 8;
  __REG16 					   			: 7;
  __REG16 RXn_STOP					: 1;
...
/* USB Endpoint 0 Configuration Register (EP0) */
typedef struct {
  __REG16 EP0_PTR						:11;
  __REG16 					   			: 1;
  __REG16 EP0_SIZE					: 2;
...
/* USB Receive Endpoint n Configuration Register (EPn_RX) */
typedef struct {
  __REG16 EPn_RX_PTR				:11;
  __REG16 EPn_RX_ISO  			: 1;
  __REG16 EPn_RX_SIZE				: 2;
  __REG16 EPn_RX_SIZE_DB		: 1;
  __REG16 EPn_RX_VALID			: 1;
} __usb_ep_rx_bits;

/* USB Transmit Endpoint n Configuration Register (EPn_TX) */
typedef struct {
  __REG16 EPn_TX_PTR				:11;
  __REG16 EPn_TX_ISO  			: 1;
  __REG16 EPn_TX_SIZE				: 2;
  __REG16 EPn_TX_SIZE_DB		: 1;
  __REG16 EPn_TX_VALID			: 1;
} __usb_ep_tx_bits;
...
__IO_REG32_BIT(SPI2INTVECT0,      0xFFF7F660,__READ       ,__spiintvect0_bits);
__IO_REG32_BIT(SPI2INTVECT1,      0xFFF7F664,__READ       ,__spiintvect1_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(HCREVISION,            0xFCF78B00,__READ       ,__hcrevision_bits);
__IO_REG32_BIT(HCCONTROL,             0xFCF78B04,__READ_WRITE ,__hccontrol_bits);
__IO_REG32_BIT(HCCOMMANDSTATUS,       0xFCF78B08,__READ_WRITE ,__hccommandstatus_bits);
__IO_REG32_BIT(HCINTERRUPTSTATUS,     0xFCF78B0C,__READ_WRITE ,__hcinterruptstatus_bits);
__IO_REG32_BIT(HCINTERRUPTENABLE,     0xFCF78B10,__READ_WRITE ,__hcinterruptenable_bits);
__IO_REG32_BIT(HCINTERRUPTDISABLE,    0xFCF78B14,__READ_WRITE ,__hcinterruptenable_bits);
__IO_REG32(    HCHCCA,                0xFCF78B18,__READ_WRITE );
__IO_REG32(    HCPERIODCURRENTED,     0xFCF78B1C,__READ       );
__IO_REG32(    HCCONTROLHEADED,       0xFCF78B20,__READ_WRITE );
__IO_REG32(    HCCONTROLCURRENTED,    0xFCF78B24,__READ_WRITE );
__IO_REG32(    HCBULKHEADED,          0xFCF78B28,__READ_WRITE );
__IO_REG32(    HCBULKCURRENTED,       0xFCF78B2C,__READ_WRITE );
__IO_REG32(    HCDONEHEAD,            0xFCF78B30,__READ_WRITE );
__IO_REG32_BIT(HCFMINTERVAL,          0xFCF78B34,__READ_WRITE ,__hcfminterval_bits);
__IO_REG32_BIT(HCFMREMAINING,         0xFCF78B38,__READ       ,__hcfmremaining_bits);
__IO_REG32_BIT(HCFMNUMBER,            0xFCF78B3C,__READ       ,__hcfmnumber_bits);
__IO_REG32_BIT(HCPERIODICSTART,       0xFCF78B40,__READ_WRITE ,__hcperiodicstart_bits);
__IO_REG32_BIT(HCLSTHRESHOLD,         0xFCF78B44,__READ_WRITE ,__hclsthreshold_bits);
__IO_REG32_BIT(HCRHDESCRIPTORA,       0xFCF78B48,__READ_WRITE ,__hcrhdescriptora_bits);
__IO_REG32_BIT(HCRHDESCRIPTORB,       0xFCF78B4C,__READ_WRITE ,__hcrhdescriptorb_bits);
__IO_REG32_BIT(HCRHSTATUS,            0xFCF78B50,__READ_WRITE ,__hcrhstatus_bits);
__IO_REG32_BIT(HCRHPORTSTATUS0,       0xFCF78B54,__READ_WRITE ,__hcrhportstatus_bits);
__IO_REG32_BIT(HCRHPORTSTATUS1,       0xFCF78B58,__READ_WRITE ,__hcrhportstatus_bits);
__IO_REG32(		 HOSTUEADDR,       			0xFCF78BE0,__READ				);
__IO_REG32_BIT(HOSTUESTATUS,       		0xFCF78BE4,__READ				,__hostuestatus_bits);
__IO_REG32_BIT(HOSTTIMEOUTCTRL,       0xFCF78BE8,__READ_WRITE ,__hosttimeoutctrl_bits);
__IO_REG32_BIT(HOSTREVISION,       		0xFCF78BEC,__READ				,__hostrevision_bits);
 ...
 **
***************************************************************************/
__IO_REG16_BIT(USB_REV,								0xFCF78A00,__READ				,__usb_rev_bits);
__IO_REG16_BIT(USB_EP_NUM,						0xFCF78A02,__READ_WRITE	,__usb_ep_num_bits);
__IO_REG16(    USB_DATA,						  0xFCF78A04,__READ_WRITE	);
__IO_REG16_BIT(USB_CTRL,							0xFCF78A06,__READ_WRITE	,__usb_ctrl_bits);
__IO_REG16_BIT(USB_STAT_FLG,					0xFCF78A08,__READ				,__usb_stat_flg_bits);
__IO_REG16_BIT(USB_RXFSTAT,						0xFCF78A0A,__READ				,__usb_rxfstat_bits);
__IO_REG16_BIT(USB_SYSCON1,						0xFCF78A0C,__READ_WRITE	,__usb_syscon1_bits);
__IO_REG16_BIT(USB_SYSCON2,						0xFCF78A0E,__READ_WRITE	,__usb_syscon2_bits);
__IO_REG16_BIT(USB_DEVSTAT,						0xFCF78A10,__READ				,__usb_devstat_bits);
__IO_REG16_BIT(USB_SOF,								0xFCF78A12,__READ				,__usb_sof_bits);
__IO_REG16_BIT(USB_IRQ_EN,						0xFCF78A14,__READ_WRITE	,__usb_irq_en_bits);
__IO_REG16_BIT(USB_DMA_IRQ_EN,				0xFCF78A16,__READ_WRITE	,__usb_dma_irq_en_bits);
__IO_REG16_BIT(USB_IRQ_SRC,						0xFCF78A18,__READ_WRITE	,__usb_irq_src_bits);
__IO_REG16_BIT(USB_EPN_STAT,					0xFCF78A1A,__READ				,__usb_epn_stat_bits);
__IO_REG16_BIT(USB_DMAN_STAT,					0xFCF78A1C,__READ				,__usb_dman_stat_bits);
__IO_REG16_BIT(USB_RXDMA_CFG,					0xFCF78A20,__READ_WRITE	,__usb_rxdma_cfg_bits);
__IO_REG16_BIT(USB_TXDMA_CFG,					0xFCF78A22,__READ_WRITE	,__usb_txdma_cfg_bits);
__IO_REG16(    USB_DATA_DMA,					0xFCF78A24,__READ_WRITE	);
__IO_REG16_BIT(USB_TXDMA0,						0xFCF78A26,__READ_WRITE	,__usb_txdma_bits);
__IO_REG16_BIT(USB_TXDMA1,						0xFCF78A28,__READ_WRITE	,__usb_txdma_bits);
__IO_REG16_BIT(USB_TXDMA2,						0xFCF78A2A,__READ_WRITE	,__usb_txdma_bits);
__IO_REG16_BIT(USB_RXDMA0,						0xFCF78A30,__READ_WRITE	,__usb_rxdma_bits);
__IO_REG16_BIT(USB_RXDMA1,						0xFCF78A32,__READ_WRITE	,__usb_rxdma_bits);
__IO_REG16_BIT(USB_RXDMA2,						0xFCF78A34,__READ_WRITE	,__usb_rxdma_bits);
__IO_REG16_BIT(USB_EP0,								0xFCF78A40,__READ_WRITE	,__usb_ep0_bits);
__IO_REG16_BIT(USB_EP1_RX,						0xFCF78A42,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP2_RX,						0xFCF78A44,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP3_RX,						0xFCF78A46,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP4_RX,						0xFCF78A48,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP5_RX,						0xFCF78A4A,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP6_RX,						0xFCF78A4C,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP7_RX,						0xFCF78A4E,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP8_RX,						0xFCF78A50,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP9_RX,						0xFCF78A52,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP10_RX,						0xFCF78A54,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP11_RX,						0xFCF78A56,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP12_RX,						0xFCF78A58,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP13_RX,						0xFCF78A5A,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP14_RX,						0xFCF78A5C,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP15_RX,						0xFCF78A5E,__READ_WRITE	,__usb_ep_rx_bits);
__IO_REG16_BIT(USB_EP1_TX,						0xFCF78A62,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP2_TX,						0xFCF78A64,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP3_TX,						0xFCF78A66,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP4_TX,						0xFCF78A68,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP5_TX,						0xFCF78A6A,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP6_TX,						0xFCF78A6C,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP7_TX,						0xFCF78A6E,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP8_TX,						0xFCF78A70,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP9_TX,						0xFCF78A72,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP10_TX,						0xFCF78A74,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP11_TX,						0xFCF78A76,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP12_TX,						0xFCF78A78,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP13_TX,						0xFCF78A7A,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP14_TX,						0xFCF78A7C,__READ_WRITE	,__usb_ep_tx_bits);
__IO_REG16_BIT(USB_EP15_TX,						0xFCF78A7E,__READ_WRITE	,__usb_ep_tx_bits);
...
#define VIM_SPI20	         		17    /* SPI2 level 0 interrupt */
...
#define VIM_SPI21          		30    /* SPI2 level 1 interrupt */
...
#define VIM_DMM0	         		36    /* DMM level 0 interrupt */
...
#define VIM_DMM1	         		43    /* DMM level 1 interrupt */
...
#define VIM_OHCI_INT	     		67    /* OHCI_INT */
#define VIM_USB_IRQISOON   		68    /* USB_FUNC.IRQISOON */
#define VIM_USB_IRQGENION  		69    /* USB_FUNC.IRQGENION */
#define VIM_USB_IRQNONISOON 	70    /* USB_FUNC.IRQNONISOON */
#define VIM_USB_DSWAKEREQON		71    /* not (USB_FUNC.DSWAKEREQON) */
#define VIM_USB_USBRESETO   	72    /* USB_FUNC.USBRESETO */
