...
#ifndef __IOADI7129_H
#define __IOADI7129_H
 ...
 ***************************************************************************
 **                            
 **    ADuC7129 SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
#define ADCCHNP ADCCP
__IO_REG32(ADCCN, 0xFFFF0508,__READ_WRITE);
#define ADCCHNN ADCCN
...
#define IDACCON DACBASE
__IO_REG32(DACDAT, 0xFFFF06B4,__READ_WRITE);
#define IDACDAT DACDAT
...
#define I2C0ADR1 I2C0ADR
__IO_REG32(I2C0BYT, 0xFFFF0824,__READ_WRITE);
#define I2C0BYTE I2C0BYT
...
#define I2C0CCNT I2C0SSC
__IO_REG32(I2C0FIF, 0xFFFF084C,__READ_WRITE);
#define I2C0FSTA I2C0FIF
...
#define I2C1ADR1 I2C1ADR
__IO_REG32(I2C1BYT, 0xFFFF0924,__READ_WRITE);
#define I2C1BYTE I2C1BYT
...
#define I2C1CCNT I2C1SSC
__IO_REG32(I2C1FIF, 0xFFFF094C,__READ_WRITE);
#define I2C1FSTA I2C1FIF
...
__IO_REG32(EPBASE, 0xFFFF0C00,__READ_WRITE);
#define XMCFG EPBASE
__IO_REG32(XM0CON, 0xFFFF0C10,__READ_WRITE);
__IO_REG32(XM1CON, 0xFFFF0C14,__READ_WRITE);
__IO_REG32(XM2CON, 0xFFFF0C18,__READ_WRITE);
__IO_REG32(XM3CON, 0xFFFF0C1C,__READ_WRITE);
__IO_REG32(XM0PAR, 0xFFFF0C20,__READ_WRITE);
__IO_REG32(XM1PAR, 0xFFFF0C24,__READ_WRITE);
__IO_REG32(XM2PAR, 0xFFFF0C28,__READ_WRITE);
__IO_REG32(XM3PAR, 0xFFFF0C2C,__READ_WRITE);
