...
typedef struct {        /* Watchdog Status Register (0x00201008) Reset (0x00000000)*/
  ...
  __REG32               : 7;    /* Bits 1       - Watchdog Enable Control*/
...
/* ------------ USB Interrupt Mask Register     (0x0021201C) reset 0x8000 0x00FF*/
typedef struct {
...
typedef struct {
  __REG32 PWRMD         : 1;    /* Bit  0       - Power Mode—Determines the power mode of USBD*/
...
typedef struct { /* Global Peripheral Control Register (0x0021B80C) Reset (0x00000000) */
  ...
  __REG32               : 2;    /* Bits 14-13   - Reserved*/
  __REG32 TEST_EN_REG   : 1;    /* Bit 15       - Test Enable Register*/
  __REG32               :16;    /* Bits 31-16   - Reserved*/
} __GPCR_bits ;
...
typedef struct {        /* Global Clock Control Register (0x0021B810) Reset (0x0000000F) */
  ...
  __REG32 SSI2_CLK_EN   : 1;    /* Bit 5        - SSI 2 Clock Enable*/
  __REG32 UART3_CLK_EN  : 1;    /* Bit 6        - UART 3 Clock Enable*/
  __REG32               :25;    /* Bits 31-7    - Reserved*/
} __GCCR_bits ;
...
/*               EIM registers                                              */
/* -------------------------------------------------------------------------*/
typedef struct {        /* Chip Select 0 Upper Control Register (0x00220000) Reset CS0(0x00003E00)*/
  __REG32 EDC           : 4;    /* Bit  0-3     - Extra Dead Cycles*/
  __REG32 WWS           : 3;    /* Bits 4-6     - Write Wait State*/
  __REG32               : 1;    /* Bits 7       - Reserved*/
  __REG32 WSC           : 6;    /* Bits 8-13    - Wait State Control*/
  __REG32 CNC           : 2;    /* Bits 14-15   - Chip Select Negation Clock Cycles*/
  __REG32 DOL           : 4;    /* Bits 16-19   - Data Output Length*/
  __REG32 SYNC          : 1;    /* Bits 20      - Synchronous Burst Mode Enable*/
  __REG32 PME           : 1;    /* Bits 21      - Page Mode Emulation*/
  __REG32 PSZ           : 2;    /* Bits 23-22   - Page Size*/
  __REG32 BCS           : 4;    /* Bits 24-27   - Burst Clock Start*/
  __REG32 BCD           : 2;    /* Bits 28-29   - Burst Clock Divisor*/
  __REG32               : 2;    /* Bits 30-31   - Reserved*/
} __CSU0_bits ;

typedef struct {        /* Chip Select 0 Lower Control Register (0x0022000C) Reset CS2-5(0x00000802)*/
  __REG32 CSEN          : 1;    /* Bit  0       - Chip Select Enable*/
  __REG32               : 3;    /* Bits 1-15    - Reserved*/
...
typedef struct {        /* Chip Select 1-5 Upper Control Register (0x00220008) Reset CS0(0x00003E00) CS2-5(0x00000000)*/
  __REG32 EDC           : 4;    /* Bit  0-3     - Extra Dead Cycles*/
  __REG32 WWS           : 3;    /* Bits 4-6     - Write Wait State                  */
  __REG32               : 1;    /* Bits 7       - Reserved                          */
  __REG32 WSC           : 6;    /* Bits 8-13    - Wait State Control                */
  ...
  __REG32 BCS           : 4;    /* Bits 24-27   - Burst Clock Start                 */
  __REG32 BCD           : 2;    /* Bits 28-29   - Burst Clock Divisor               */
  __REG32               : 1;    /* Bits 30      - Reserved                          */
  __REG32 DTACK_SEL     : 1;    /* Bits 31      - DTACK Select   NOT CS0*/
} __CSU_bits ;

typedef struct {        /* Chip Select 1-5 Lower Control Register (0x0022000C) Reset CS2-5(0x00000802)*/
  __REG32 CSEN          : 1;    /* Bit  0       - Chip Select Enable*/
...
typedef struct {        /* SDRAM 0 Control Register (0x00201000) Reset  (0x01000300)*/
  ...
  __REG32               : 2;    /* Bits 10-11   - Cache Inhibit*/
...
__IO_REG32_BIT(WDG_WSTR,0x00201008,__READ,__WDG_WSTR_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32(SSA,0x00205000,__READ_WRITE);
...
__IO_REG32_BIT(LCDISR,0x00205040,__READ,__LCDISR_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(URX0D_1 ,0x00206000,__READ,__URXD_bits);
__IO_REG32_BIT(URX1D_1 ,0x00206004,__READ,__URXD_bits);
__IO_REG32_BIT(URX2D_1 ,0x00206008,__READ,__URXD_bits);
__IO_REG32_BIT(URX3D_1 ,0x0020600c,__READ,__URXD_bits);
__IO_REG32_BIT(URX4D_1 ,0x00206010,__READ,__URXD_bits);
__IO_REG32_BIT(URX5D_1 ,0x00206014,__READ,__URXD_bits);
__IO_REG32_BIT(URX6D_1 ,0x00206018,__READ,__URXD_bits);
__IO_REG32_BIT(URX7D_1 ,0x0020601c,__READ,__URXD_bits);
__IO_REG32_BIT(URX8D_1 ,0x00206020,__READ,__URXD_bits);
__IO_REG32_BIT(URX9D_1 ,0x00206024,__READ,__URXD_bits);
__IO_REG32_BIT(URX10D_1,0x00206028,__READ,__URXD_bits);
__IO_REG32_BIT(URX11D_1,0x0020602c,__READ,__URXD_bits);
__IO_REG32_BIT(URX12D_1,0x00206030,__READ,__URXD_bits);
__IO_REG32_BIT(URX13D_1,0x00206034,__READ,__URXD_bits);
__IO_REG32_BIT(URX14D_1,0x00206038,__READ,__URXD_bits);
__IO_REG32_BIT(URX15D_1,0x0020603c,__READ,__URXD_bits);
__IO_REG32_BIT(UTX0D_1 ,0x00206040,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX1D_1 ,0x00206044,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX2D_1 ,0x00206048,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX3D_1 ,0x0020604c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX4D_1 ,0x00206050,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX5D_1 ,0x00206054,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX6D_1 ,0x00206058,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX7D_1 ,0x0020605c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX8D_1 ,0x00206060,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX9D_1 ,0x00206064,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX10D_1,0x00206068,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX11D_1,0x0020606c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX12D_1,0x00206070,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX13D_1,0x00206074,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX14D_1,0x00206078,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX15D_1,0x0020607c,__WRITE,__UTXD_bits);
...
__IO_REG32_BIT(USR1_1  ,0x00206094,__READ,__USR1_bits);
__IO_REG32_BIT(USR2_1  ,0x00206098,__READ,__USR2_bits);
...
__IO_REG32_BIT(UBRC_1  ,0x002060ac,__READ,__UBRC_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(URX0D_2 ,0x00207000,__READ,__URXD_bits);
__IO_REG32_BIT(URX1D_2 ,0x00207004,__READ,__URXD_bits);
__IO_REG32_BIT(URX2D_2 ,0x00207008,__READ,__URXD_bits);
__IO_REG32_BIT(URX3D_2 ,0x0020700c,__READ,__URXD_bits);
__IO_REG32_BIT(URX4D_2 ,0x00207010,__READ,__URXD_bits);
__IO_REG32_BIT(URX5D_2 ,0x00207014,__READ,__URXD_bits);
__IO_REG32_BIT(URX6D_2 ,0x00207018,__READ,__URXD_bits);
__IO_REG32_BIT(URX7D_2 ,0x0020701c,__READ,__URXD_bits);
__IO_REG32_BIT(URX8D_2 ,0x00207020,__READ,__URXD_bits);
__IO_REG32_BIT(URX9D_2 ,0x00207024,__READ,__URXD_bits);
__IO_REG32_BIT(URX10D_2,0x00207028,__READ,__URXD_bits);
__IO_REG32_BIT(URX11D_2,0x0020702c,__READ,__URXD_bits);
__IO_REG32_BIT(URX12D_2,0x00207030,__READ,__URXD_bits);
__IO_REG32_BIT(URX13D_2,0x00207034,__READ,__URXD_bits);
__IO_REG32_BIT(URX14D_2,0x00207038,__READ,__URXD_bits);
__IO_REG32_BIT(URX15D_2,0x0020703c,__READ,__URXD_bits);
__IO_REG32_BIT(UTX0D_2 ,0x00207040,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX1D_2 ,0x00207044,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX2D_2 ,0x00207048,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX3D_2 ,0x0020704c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX4D_2 ,0x00207050,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX5D_2 ,0x00207054,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX6D_2 ,0x00207058,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX7D_2 ,0x0020705c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX8D_2 ,0x00207060,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX9D_2 ,0x00207064,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX10D_2,0x00207068,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX11D_2,0x0020706c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX12D_2,0x00207070,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX13D_2,0x00207074,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX14D_2,0x00207078,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX15D_2,0x0020707c,__WRITE,__UTXD_bits);
...
__IO_REG32_BIT(USR1_2  ,0x00207094,__READ,__USR1_bits);
__IO_REG32_BIT(USR2_2  ,0x00207098,__READ,__USR2_bits);
...
__IO_REG32_BIT(UBRC_2  ,0x002070ac,__READ,__UBRC_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(URX0D_3 ,0x0020A000,__READ,__URXD_bits);
__IO_REG32_BIT(URX1D_3 ,0x0020A004,__READ,__URXD_bits);
__IO_REG32_BIT(URX2D_3 ,0x0020A008,__READ,__URXD_bits);
__IO_REG32_BIT(URX3D_3 ,0x0020A00c,__READ,__URXD_bits);
__IO_REG32_BIT(URX4D_3 ,0x0020A010,__READ,__URXD_bits);
__IO_REG32_BIT(URX5D_3 ,0x0020A014,__READ,__URXD_bits);
__IO_REG32_BIT(URX6D_3 ,0x0020A018,__READ,__URXD_bits);
__IO_REG32_BIT(URX7D_3 ,0x0020A01c,__READ,__URXD_bits);
__IO_REG32_BIT(URX8D_3 ,0x0020A020,__READ,__URXD_bits);
__IO_REG32_BIT(URX9D_3 ,0x0020A024,__READ,__URXD_bits);
__IO_REG32_BIT(URX10D_3,0x0020A028,__READ,__URXD_bits);
__IO_REG32_BIT(URX11D_3,0x0020A02c,__READ,__URXD_bits);
__IO_REG32_BIT(URX12D_3,0x0020A030,__READ,__URXD_bits);
__IO_REG32_BIT(URX13D_3,0x0020A034,__READ,__URXD_bits);
__IO_REG32_BIT(URX14D_3,0x0020A038,__READ,__URXD_bits);
__IO_REG32_BIT(URX15D_3,0x0020A03C,__READ,__URXD_bits);
__IO_REG32_BIT(UTX0D_3 ,0x0020A040,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX1D_3 ,0x0020A044,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX2D_3 ,0x0020A048,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX3D_3 ,0x0020A04c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX4D_3 ,0x0020A050,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX5D_3 ,0x0020A054,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX6D_3 ,0x0020A058,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX7D_3 ,0x0020A05c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX8D_3 ,0x0020A060,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX9D_3 ,0x0020A064,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX10D_3,0x0020A068,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX11D_3,0x0020A06c,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX12D_3,0x0020A070,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX13D_3,0x0020A074,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX14D_3,0x0020A078,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UTX15D_3,0x0020A07C,__WRITE,__UTXD_bits);
__IO_REG32_BIT(UCR1_3  ,0x0020A080,__READ_WRITE,__UCR1_bits);
__IO_REG32_BIT(UCR2_3  ,0x0020A084,__READ_WRITE,__UCR2_bits);
__IO_REG32_BIT(UCR3_3  ,0x0020A088,__READ_WRITE,__UCR3_23_bits);
__IO_REG32_BIT(UCR4_3  ,0x0020A08c,__READ_WRITE,__UCR4_bits);
__IO_REG32_BIT(UFCR_3  ,0x0020A090,__READ_WRITE,__UFCR_bits);
__IO_REG32_BIT(USR1_3  ,0x0020A094,__READ,__USR1_bits);
__IO_REG32_BIT(USR2_3  ,0x0020A098,__READ,__USR2_bits);
__IO_REG32_BIT(UESC_3  ,0x0020A09c,__READ_WRITE,__UESC_bits);
__IO_REG32_BIT(UTIM_3  ,0x0020A0a0,__READ_WRITE,__UTIM_bits);
__IO_REG32_BIT(UBIR_3  ,0x0020A0a4,__READ_WRITE,__UBIR_bits);
__IO_REG32_BIT(UBMR_3  ,0x0020A0a8,__READ_WRITE,__UBMR_bits);
__IO_REG32_BIT(UBRC_3  ,0x0020A0ac,__READ,__UBRC_bits);
__IO_REG32_BIT(BIPR1_3 ,0x0020A0b0,__READ_WRITE,__BIPR_bits);
__IO_REG32_BIT(BIPR2_3 ,0x0020A0b4,__READ_WRITE,__BIPR_bits);
__IO_REG32_BIT(BIPR3_3 ,0x0020A0b8,__READ_WRITE,__BIPR_bits);
__IO_REG32_BIT(BIPR4_3 ,0x0020A0bc,__READ_WRITE,__BIPR_bits);
__IO_REG32_BIT(BMPR1_3 ,0x0020A0c0,__READ_WRITE,__BMPR_bits);
__IO_REG32_BIT(BMPR2_3 ,0x0020A0c4,__READ_WRITE,__BMPR_bits);
__IO_REG32_BIT(BMPR3_3 ,0x0020A0c8,__READ_WRITE,__BMPR_bits);
__IO_REG32_BIT(BMPR4_3 ,0x0020A0cc,__READ_WRITE,__BMPR_bits);
__IO_REG32_BIT(UTS_3   ,0x0020A0d0,__READ_WRITE,__UTS_bits);
...
__IO_REG32_BIT(RCV_BUF,      0x00211020,__READ,__RCV_BUF_bits);
...
__IO_REG32_BIT(USB_SPEC,     0x00212004,__READ,__USB_SPEC_bits);
__IO_REG32_BIT(USB_STAT,     0x00212008,__READ,__USB_STAT_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(RXDATAREG1, 0x00213000,__READ,__RXTXDATAREG_bits);
__IO_REG32_BIT(TXDATAREG1, 0x00213004,__WRITE,__RXTXDATAREG_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(RXDATAREG2, 0x00219000,__READ,__RXTXDATAREG_bits);
__IO_REG32_BIT(TXDATAREG2, 0x00219004,__WRITE,__RXTXDATAREG_bits);
...
__IO_REG32_BIT(REV_NO,        0x00214020,__READ,__REV_NO_bits);
...
__IO_REG32_BIT(RES_FIFO,      0x00214034,__READ,__RES_FIFO_bits);
...
__IO_REG32_BIT(ASP_FIFO_PTR,0x00215034,__READ,__ASP_FIFO_PTR_bits);
...
__IO_REG32_BIT(HECCRC_CONTROL,        0x00216030,__WRITE,__HECCRC_CONTROL_bits);
__IO_REG32_BIT(WHITE_CONTROL,         0x00216034,__WRITE,__WHITE_CONTROL_bits);
__IO_REG32_BIT(ENCRYPTION_CONTROL_X13,0x00216038,__WRITE,__ENCRYPTION_CONTROL_X13_bits);
...
__IO_REG32_BIT(RF_GPO,                0x00216048,__WRITE,__RF_GPO_bits);
__IO_REG32_BIT(PWM_RSSI,              0x0021604C,__READ_WRITE,__PWM_RSSI_bits);
__IO_REG32_BIT(TIME_A_B,              0x00216050,__WRITE,__TIME_A_B_bits);
__IO_REG32_BIT(TIME_C_D,              0x00216054,__WRITE,__TIME_C_D_bits);
__IO_REG32_BIT(PWM_TX,                0x00216058,__WRITE,__PWM_TX_bits);
__IO_REG32_BIT(RF_CONTROLSTATUS,      0x0021605C,__READ_WRITE,__RF_CONTROLSTATUS_bits);
__IO_REG32_BIT(RX_TIME,               0x00216060,__WRITE,__RX_TIME_bits);
__IO_REG32_BIT(TX_TIME,               0x00216064,__WRITE,__TX_TIME_bits);
__IO_REG32_BIT(BAT,                   0x00216068,__WRITE,__BAT_bits);
...
__IO_REG32_BIT(SYNCH_WORD_0,          0x00216070,__WRITE,__16BIT_WORD_bits);
__IO_REG32_BIT(SYNCH_WORD_1,          0x00216074,__WRITE,__16BIT_WORD_bits);
__IO_REG32_BIT(SYNCH_WORD_2,          0x00216078,__WRITE,__16BIT_WORD_bits);
__IO_REG32_BIT(SYNCH_WORD_3,          0x0021607C,__WRITE,__16BIT_WORD_bits);
...
__IO_REG32_BIT(WU_COUNT,              0x00216114,__READ,__WU_COUNT_bits);
...
__IO_REG32_BIT(SPI_WORD1,             0x00216124,__WRITE,__SPI_WORD1_bits);
__IO_REG32_BIT(SPI_WORD2,             0x00216128,__WRITE,__SPI_WORD2_bits);
__IO_REG32_BIT(SPI_WORD3,             0x0021612C,__WRITE,__SPI_WORD3_bits);
__IO_REG32_BIT(SPI_WRITE_ADDR,        0x00216130,__WRITE,__SPI_READWRITE_ADDR_bits);
__IO_REG32_BIT(SPI_READ_ADDR,         0x00216134,__WRITE,__SPI_READWRITE_ADDR_bits);
...
__IO_REG32_BIT(HOP1,                  0x00216144,__WRITE,__HOP1_bits);
__IO_REG32_BIT(HOP2,                  0x00216148,__WRITE,__HOP2_bits);
__IO_REG32_BIT(HOP3,                  0x0021614C,__WRITE,__HOP3_bits);
__IO_REG32_BIT(HOP4,                  0x00216150,__WRITE,__HOP4_bits);
__IO_REG32_BIT(INTERRUPT_VECTOR,      0x00216160,__READ_WRITE,__INTERRUPT_VECTOR_bits);
__IO_REG32_BIT(SYNC_METRIC,           0x00216170,__READ,__SYNC_METRIC_bits);
__IO_REG32_BIT(SYNC_FC,               0x00216174,__READ,__SYNC_FC_bits);
...
__IO_REG32_BIT(SRX,    0x00218004,__READ,__SRX_bits);
...
__IO_REG32_BIT(SRX_2,  0x0021D004,__READ,__SRX_bits);
...
__IO_REG32_BIT(STSR_2, 0x0021D01C,__WRITE,__STSR_bits);
...
__IO_REG32_BIT(SSR_A,    0x0021C024,__READ,__PORT_REG_31_0_bits);
...
__IO_REG32_BIT(SSR_B,    0x0021C124,__READ,__PORT_REG_31_0_bits);
...
__IO_REG32_BIT(SSR_C,    0x0021C224,__READ,__PORT_REG_31_0_bits);
...
__IO_REG32_BIT(SSR_D,    0x0021C324,__READ,__PORT_REG_31_0_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(CS0U,0x00220000,__READ_WRITE,__CSU0_bits);
__IO_REG32_BIT(CS0L,0x00220004,__READ_WRITE,__CSL0_bits);
...
__IO_REG32_BIT(SDRST,        0x00221018,__WRITE,__SDRST_bits);
...
__IO_REG32_BIT(MMA_MAC_FIFO_STAT,0x0022201C,__READ,__MMA_MAC_FIFO_STAT_bits);
...
__IO_REG32_BIT(INTSRCH,0x00223048,__READ,__INTSRCH_bits);
__IO_REG32_BIT(INTSRCL,0x0022304C,__READ,__INTSRCL_bits);
...
__IO_REG32_BIT(NIPNDH,0x00223058,__READ,__NIPNDH_bits);
__IO_REG32_BIT(NIPNDL,0x0022305C,__READ,__NIPNDL_bits);
__IO_REG32_BIT(FIPNDH,0x00223060,__READ,__FIPNDH_bits);
__IO_REG32_BIT(FIPNDL,0x00223064,__READ,__FIPNDL_bits);
