...
#include <avr/iom2560.h> // did this because PORTG #define couldn't be found. Damn.
#endif
...
#define SPI_BIT_SS 0x1				// Standard SS line Pin 53
...
#define SPI_SS(x) { if (x) SPI_PORT |= SPI_BIT_SS; else SPI_PORT &= ~SPI_BIT_SS; } // default SS.

#define SPI_TIMEOUT 100 // Timeout to get access to SPI bus in mS
