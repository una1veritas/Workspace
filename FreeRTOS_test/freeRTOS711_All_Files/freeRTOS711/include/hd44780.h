...
//#define FreetronicsLCD		// Define whether we're using Freetronics LCD or PololuLCD conections.
...
#define _LCD_ROWS		4		/* Number of Rows (1,2 or 4) Retrograde Project uses 4 else 2 */
#define _LCD_COLS		20		/* Number of Columns (8..40) Retrograde Project uses 20 else 16 */
