...
// Otherwise for Arduino Mega Rev3 and Pololu SVP 1284P, Timer3 should be the default
    ...
    #define configTOTAL_HEAP_SIZE	( (size_t ) ( 32767 ) )			// used for heap_1.c and heap2.c only
																	// around 6000 works for standard memory
                                                                    // Should be 0xffff - 0x7fff = 32767 for heap in Extended RAM

//	#define portQUAD_RAM											// Use the Rugged Circuits External (512kByte) QuadRAM device, only one 56kByte bank.
//	#define portEXT_RAM_8_BANK										// Memory is available as 8 banks of 56kByte.
	#define portMEGA_RAM											// Use the Rugged Circuits External (128kByte) MegaRAM device, only one 56kByte bank.
...
//	#define configCPU_CLOCK_HZ		( ( uint32_t ) 16000000 )  		// Arduino with 328p device
    ...
    #define configTOTAL_HEAP_SIZE	( (size_t ) ( 1480 ) )			// used for heap_1.c and heap2.c only
    ...
    #define configTICK_RATE_HZ		( ( portTickType ) 500 )		// Use 500Hz for TIMER3
                                                                    // Use 1000Hz to get mSec timing.
    #define configTOTAL_HEAP_SIZE	( (size_t ) ( 14000 ) )			// used for heap_1.c and heap2.c only
