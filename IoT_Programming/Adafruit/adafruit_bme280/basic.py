...
class Adafruit_BME280:
    ...
    def __init__(self):
        ...
        self._iir_filter = _IIR_FILTER_DISABLE
        self.overscan_humidity = _OVERSCAN_X1
        self.overscan_temperature = _OVERSCAN_X1
        self.overscan_pressure = _OVERSCAN_X16
        self._t_standby = _STANDBY_TC_125
    ...
    def _read_temperature(self):
        ...
        if self.mode != _MODE.NORMAL:
            self.mode = _MODE.FORCE
    ...
    def _write_config(self):
        ...
        if self._mode == _MODE.NORMAL:
            ...
            normal_flag = True
            self.mode = _MODE.SLEEP  # So we switch to Sleep mode first
