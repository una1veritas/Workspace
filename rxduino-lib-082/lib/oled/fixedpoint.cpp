...
// Table for sin, tan
//=====================
static const unsigned long TBL_SIN[90] =
{
...
static const unsigned long TBL_TAN[45] =
{
...
{
    signed long long ia64, ib64;
    signed long long iab64;
    signed long iab32;
    fix32_t fc;

    ia64 = (signed long long) ((signed long) fa);
    ib64 = (signed long long) ((signed long) fb);
    iab64 = ia64 * ib64;    
    iab32 = (signed long) (iab64 >> FIXQ);
    fc = (fix32_t) iab32;
    return fc;
}
...
fix32_t FIX_Div(fix32_t fa, fix32_t fb)
{
    ...
    ia64 = ((signed long long) ((signed long) fa)) << FIXQ;
    ib64 = (signed long long) ((signed long) fb);
    iab64 = ia64 / ib64;
    iab32 = (signed long) iab64;
    fc = (fix32_t) iab32;
    return fc;
}
...
// Integer Square Root
//========================
signed long long INT_Sqrt(signed long long x)
{
    signed long long s, t;
...
{
    signed long long ia64;
    signed long long ib64;
    signed long ib32;
    fix32_t fb;

    ia64 = ((signed long long) ((signed long) fa)) << FIXQ;
    ib64 = INT_Sqrt(ia64);
    ib32 = (signed long) ib64;
    fb = (fix32_t) ib32;
    return fb;
}
...
fix32_t FIX_Atan_Deg(fix32_t fval)
{
    ...
    unsigned long over_one;
    unsigned long indexA, indexB, indexM;
