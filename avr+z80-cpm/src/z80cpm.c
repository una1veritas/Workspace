...
void var_calc() // recalculation global variables 
{
	...
	cpm_clst_no = (DWORD)(Sect_no + Track_no * SECT_CNT);	//CPM��128�o�C�g�P�ʂŌ����N���X�^No.
	Block_no = cpm_clst_no / CPM_CLST_CNT_PER_BLOCK;	//SDC�̏����P�ʂł̃u���b�NNo.
	Buff_offset = cpm_clst_no % CPM_CLST_CNT_PER_BLOCK;	// 0�`7(1�u���b�N1024�o�C�g�A1�Z�N�^128�o�C�g�̏ꍇ)

	Sdc_clst_no = Block_no * SDC_CLST_CNT_PER_BLOCK;	//SDC�̃N���X�^No.(1�N���X�^512�o�C�g)
}
...
void sdc_write(){	// Z80 RAM -> AVR buffer -> SDC
	DRESULT rs;
	var_calc();
	if(Block_no != Pre_block_no){	//�u���b�N���ړ������ꍇ
		if(F_unwritten){	//�������݂̏ꍇ�܂��O�̃u���b�N��SDC�֏�����ł���
		...
		rs = disk_read (0, Block_buff, Sdc_clst_no, SDC_CLST_CNT_PER_BLOCK);	//SDC����o�b�t�@�֓Ǎ���
		if(rs != RES_OK){
			DMA_mode = DMA_NG;
			St = STA_NOINIT;
			return;
	...
	DMA_mode = DMA_OK;
	F_unwritten = 1;	//�������݃t���O�����Ă�
	Write_back_timer = 0;	//�^�C�}�����Z�b�g
}
...
void rom_load(){	// AVR EEPROM -> Z80 RAM (for Z80 MONITOR program)
	...
	Block_no = 0xFFFF; //ROM�̃v���O������SDC��ǂޏꍇ�ɔ����ēK���ɂ��炵�Ă���
...
void reset_proc(){	// SDC first sector -> Z80 RAM and reset
	...
	if(St & STA_NOINIT){	// SDC�Ǎ��݂Ɏ��s�����ꍇ��EEPROM���烂�j�^�v���O���������[�h����
		rom_load();
	}else{
