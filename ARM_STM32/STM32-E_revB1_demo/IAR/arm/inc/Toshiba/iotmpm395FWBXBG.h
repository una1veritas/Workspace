...
#ifndef __IOTMPM395FWBXBG_H
#define __IOTMPM395FWBXBG_H
 ...
 ***************************************************************************
 **
 **    TMPM395FWBXBG SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG8_BIT(PBFR2,                0x400C004C,__READ_WRITE ,__pbfr2_bits);
__IO_REG8_BIT(PBPUP,                0x400C006C,__READ_WRITE ,__pbpup_bits);
__IO_REG8_BIT(PBOD,                 0x400C0068,__READ_WRITE ,__pbod_bits);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(PMDATA,               0x400C0300,__READ_WRITE ,__pm_bits);
__IO_REG8_BIT(PMCR,                 0x400C0304,__READ_WRITE ,__pmcr_bits);
__IO_REG8_BIT(PMFR1,                0x400C0308,__READ_WRITE ,__pmfr1_bits);
__IO_REG8_BIT(PMOD,                 0x400C0328,__READ_WRITE ,__pmod_bits);
__IO_REG8_BIT(PMPUP,                0x400C032C,__READ_WRITE ,__pmpup_bits);
__IO_REG8_BIT(PMIE,                 0x400C0338,__READ_WRITE ,__pmie_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(SSP1CR0,             0x40061000, __READ_WRITE , __sspcr0_bits);
__IO_REG32_BIT(SSP1CR1,             0x40061004, __READ_WRITE , __sspcr1_bits);
__IO_REG32_BIT(SSP1DR,              0x40061008, __READ_WRITE , __sspdr_bits);
__IO_REG32_BIT(SSP1SR,              0x4006100C, __READ       , __sspsr_bits);
__IO_REG32_BIT(SSP1CPSR,            0x40061010, __READ_WRITE , __sspcpsr_bits);
__IO_REG32_BIT(SSP1IMSC,            0x40061014, __READ_WRITE , __sspimsc_bits);
__IO_REG32_BIT(SSP1RIS,             0x40061018, __READ       , __sspris_bits);
__IO_REG32_BIT(SSP1MIS,             0x4006101C, __READ       , __sspmis_bits);
__IO_REG32_BIT(SSP1ICR,             0x40061020, __WRITE      , __sspicr_bits);
__IO_REG32_BIT(SSP1INTSEL,          0x400E1100, __READ_WRITE , __sspintsel_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(SSP2CR0,             0x40062000, __READ_WRITE , __sspcr0_bits);
__IO_REG32_BIT(SSP2CR1,             0x40062004, __READ_WRITE , __sspcr1_bits);
__IO_REG32_BIT(SSP2DR,              0x40062008, __READ_WRITE , __sspdr_bits);
__IO_REG32_BIT(SSP2SR,              0x4006200C, __READ       , __sspsr_bits);
__IO_REG32_BIT(SSP2CPSR,            0x40062010, __READ_WRITE , __sspcpsr_bits);
__IO_REG32_BIT(SSP2IMSC,            0x40062014, __READ_WRITE , __sspimsc_bits);
__IO_REG32_BIT(SSP2RIS,             0x40062018, __READ       , __sspris_bits);
__IO_REG32_BIT(SSP2MIS,             0x4006201C, __READ       , __sspmis_bits);
__IO_REG32_BIT(SSP2ICR,             0x40062020, __WRITE      , __sspicr_bits);
__IO_REG32_BIT(SSP2INTSEL,          0x400E1200, __READ_WRITE , __sspintsel_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(SSP3CR0,             0x40063000, __READ_WRITE , __sspcr0_bits);
__IO_REG32_BIT(SSP3CR1,             0x40063004, __READ_WRITE , __sspcr1_bits);
__IO_REG32_BIT(SSP3DR,              0x40063008, __READ_WRITE , __sspdr_bits);
__IO_REG32_BIT(SSP3SR,              0x4006300C, __READ       , __sspsr_bits);
__IO_REG32_BIT(SSP3CPSR,            0x40063010, __READ_WRITE , __sspcpsr_bits);
__IO_REG32_BIT(SSP3IMSC,            0x40063014, __READ_WRITE , __sspimsc_bits);
__IO_REG32_BIT(SSP3RIS,             0x40063018, __READ       , __sspris_bits);
__IO_REG32_BIT(SSP3MIS,             0x4006301C, __READ       , __sspmis_bits);
__IO_REG32_BIT(SSP3ICR,             0x40063020, __WRITE      , __sspicr_bits);
__IO_REG32_BIT(SSP3INTSEL,          0x400E1300, __READ_WRITE , __sspintsel_bits);
...
#define INT_8                (50 + EII)   /* Interrupt pin (PK3)          */
#define INT_9                (51 + EII)   /* Interrupt pin (PK4)          */
#define INT_10               (52 + EII)   /* Interrupt pin (PK5)          */
#define INT_SPI0             (53 + EII)   /* SPI serial interface (channel.0)*/
#define INT_SPI1             (54 + EII)   /* SPI serial interface (channel.1)*/
#define INT_SPI2             (55 + EII)   /* SPI serial interface (channel.2)*/
#define INT_SPI3             (56 + EII)   /* SPI serial interface (channel.3)*/

#endif    /* __IOTMPM395FWBXBG_H */
...
Interrupt56  = INTCAP40       0xFC
Interrupt57  = INTCAP41       0x100
Interrupt58  = INTAD          0x104
Interrupt59  = INT8           0x108
Interrupt60  = INT9           0x10C
Interrupt61  = INT10          0x110
Interrupt62  = INTSPI0        0x114
Interrupt63  = INTSPI1        0x118
Interrupt64  = INTSPI2        0x11C
Interrupt65  = INTSPI3        0x120
