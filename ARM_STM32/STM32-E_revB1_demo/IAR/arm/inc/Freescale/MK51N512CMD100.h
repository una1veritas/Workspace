/*
** ###################################################################
**     Processor:           MK51N512CMD100
**     Compilers:           Freescale C/C++ for Embedded ARM
**                          IAR ANSI C/C++ Compiler for ARM
**     Reference manual:    K51P144M100SF2RM Rev. 4 Draft B, 7 Dec 2010
**     Version:             rev. 0.1, 2010-12-13
**
**     Abstract:
**         This header file implements peripheral memory map for MK51N512CMD100
**         processor.
**
...
/*! \file MK51N512CMD100.h */
/*! \version 0.1 */
/*! \date 2010-12-13 */
/*! \brief Peripheral memory map for MK51N512CMD100 */
/*! \detailed This header file implements peripheral memory map for MK51N512CMD100
      processor. */
...
#if !defined(MCU_MK51N512CMD100)  /* Check if this MCU has not been already activated... */

/* Check if another MCU has not been activated yet */
#if (defined(MCU_ACTIVE))
  #error MK51N512CMD100 MCU library: There is already active another MCU library. Do #include of one "*_MCU.h" only.
#else /* (!defined(MCU_ACTIVE)) */
  #define MCU_ACTIVE  /* Mark there is some MCU already active */
  #define MCU_MK51N512CMD100  /* Mark specific MCU as active */
#endif /* (!defined(MCU_ACTIVE)) */

#include <stdint.h>

/*! Memory map version 0.1 */
#define MCU_MEM_MAP_VERSION ((0 << 8) | 1)
...
#endif  /* #if !defined(MCU_MK51N512CMD100) */

/* MK51N512CMD100.h, eof. */
