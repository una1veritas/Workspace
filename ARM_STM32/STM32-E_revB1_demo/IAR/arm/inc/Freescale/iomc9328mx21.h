...
__REG32 DS_PF16    : 3;     /* Bits 9  - 11  - Driving Strength Fast I/O*/
...
typedef struct{
__REG32 ONEMS :16;     /* Bits 0-15    -Baud Rate Count Register*/
__REG32       :16;
} __UBRC_bits;
...
/*__IO_REG32_BIT(PMCTL,                     0x1002702C,__READ_WRITE,__PMCTL_bits);*/
/*__IO_REG32_BIT(PMCOUNT,                   0x10027030,__READ_WRITE,__PMCOUNT_bits);*/
...
__IO_REG16_BIT(ECC_RSLT_MA_8,             0xDF003E0E,__READ      ,__ECC_RSLT_MA_bits);
...
__IO_REG32_BIT(EIM_CNF,                   0xDF001030,__READ_WRITE,__EIM_bits);
...
/***************************************************************************
 **
 **   MC9328MX21 DMA Channels
 **
 ***************************************************************************/
/*#define Unused                0                 Unused*/
#define DMA_CSPI3_RX_FIFO       1
#define DMA_CSPI3_TX_FIFO       2
#define DMA_EXT_REQ             3
#define DMA_FIRI_RX_FIFO        4
#define DMA_FIRI_TX_FIFO        5
#define DMA_SDHC2               6
#define DMA_SDHC1               7
...
#define DMA_BMI_TX_FIFO         28
#define DMA_BMI_RX_FIFO         29
