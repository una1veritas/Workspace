 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(VIC0_ISR,            0xFFFFF000,__READ       ,__vic0_bits);
__IO_REG32_BIT(VIC0_FSR,            0xFFFFF004,__READ       ,__vic0_bits);
__IO_REG32_BIT(VIC0_RINTSR,         0xFFFFF008,__READ       ,__vic0_bits);
__IO_REG32_BIT(VIC0_INTSR,          0xFFFFF00C,__READ_WRITE ,__vic0_bits);
__IO_REG32_BIT(VIC0_INTER,          0xFFFFF010,__READ_WRITE ,__vic0_bits);
__IO_REG32_BIT(VIC0_INTECR,         0xFFFFF014,__WRITE      ,__vic0_bits);
__IO_REG32_BIT(VIC0_SWINTR,         0xFFFFF018,__READ_WRITE ,__vic0_bits);
__IO_REG32_BIT(VIC0_SWINTCR,        0xFFFFF01C,__WRITE      ,__vic0_bits);
__IO_REG32_BIT(VIC0_PER,            0xFFFFF020,__READ_WRITE ,__vic_protection_bits);
__IO_REG32(    VIC0_VAR,            0xFFFFF030,__READ_WRITE );
__IO_REG32(    VIC0_DVAR,           0xFFFFF034,__READ_WRITE );
__IO_REG32(    VIC0_VA0R,           0xFFFFF100,__READ_WRITE );
__IO_REG32(    VIC0_VA1R,           0xFFFFF104,__READ_WRITE );
__IO_REG32(    VIC0_VA2R,           0xFFFFF108,__READ_WRITE );
__IO_REG32(    VIC0_VA3R,           0xFFFFF10C,__READ_WRITE );
__IO_REG32(    VIC0_VA4R,           0xFFFFF110,__READ_WRITE );
__IO_REG32(    VIC0_VA5R,           0xFFFFF114,__READ_WRITE );
__IO_REG32(    VIC0_VA6R,           0xFFFFF118,__READ_WRITE );
__IO_REG32(    VIC0_VA7R,           0xFFFFF11C,__READ_WRITE );
__IO_REG32(    VIC0_VA8R,           0xFFFFF120,__READ_WRITE );
__IO_REG32(    VIC0_VA9R,           0xFFFFF124,__READ_WRITE );
__IO_REG32(    VIC0_VA10R,          0xFFFFF128,__READ_WRITE );
__IO_REG32(    VIC0_VA11R,          0xFFFFF12C,__READ_WRITE );
__IO_REG32(    VIC0_VA12R,          0xFFFFF130,__READ_WRITE );
__IO_REG32(    VIC0_VA13R,          0xFFFFF134,__READ_WRITE );
__IO_REG32(    VIC0_VA14R,          0xFFFFF138,__READ_WRITE );
__IO_REG32(    VIC0_VA15R,          0xFFFFF13C,__READ_WRITE );
__IO_REG32_BIT(VIC0_VC0R,           0xFFFFF200,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC1R,           0xFFFFF204,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC2R,           0xFFFFF208,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC3R,           0xFFFFF20C,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC4R,           0xFFFFF210,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC5R,           0xFFFFF214,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC6R,           0xFFFFF218,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC7R,           0xFFFFF21C,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC8R,           0xFFFFF220,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC9R,           0xFFFFF224,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC10R,          0xFFFFF228,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC11R,          0xFFFFF22C,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC12R,          0xFFFFF230,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC13R,          0xFFFFF234,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC14R,          0xFFFFF238,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC0_VC15R,          0xFFFFF23C,__READ_WRITE ,__vic_vectcntl_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(VIC1_ISR,            0xFC000000,__READ       ,__vic1_bits);
__IO_REG32_BIT(VIC1_FSR,            0xFC000004,__READ       ,__vic1_bits);
__IO_REG32_BIT(VIC1_RINTSR,         0xFC000008,__READ       ,__vic1_bits);
__IO_REG32_BIT(VIC1_INTSR,          0xFC00000C,__READ_WRITE ,__vic1_bits);
__IO_REG32_BIT(VIC1_INTER,          0xFC000010,__READ_WRITE ,__vic1_bits);
__IO_REG32_BIT(VIC1_INTECR,         0xFC000014,__WRITE      ,__vic1_bits);
__IO_REG32_BIT(VIC1_SWINTR,         0xFC000018,__READ_WRITE ,__vic1_bits);
__IO_REG32_BIT(VIC1_SWINTCR,        0xFC00001C,__WRITE      ,__vic1_bits);
__IO_REG32_BIT(VIC1_PER,            0xFC000020,__READ_WRITE ,__vic_protection_bits);
__IO_REG32(    VIC1_VAR,            0xFC000030,__READ_WRITE );
__IO_REG32(    VIC1_DVAR,           0xFC000034,__READ_WRITE );
__IO_REG32(    VIC1_VA0R,           0xFC000100,__READ_WRITE );
__IO_REG32(    VIC1_VA1R,           0xFC000104,__READ_WRITE );
__IO_REG32(    VIC1_VA2R,           0xFC000108,__READ_WRITE );
__IO_REG32(    VIC1_VA3R,           0xFC00010C,__READ_WRITE );
__IO_REG32(    VIC1_VA4R,           0xFC000110,__READ_WRITE );
__IO_REG32(    VIC1_VA5R,           0xFC000114,__READ_WRITE );
__IO_REG32(    VIC1_VA6R,           0xFC000118,__READ_WRITE );
__IO_REG32(    VIC1_VA7R,           0xFC00011C,__READ_WRITE );
__IO_REG32(    VIC1_VA8R,           0xFC000120,__READ_WRITE );
__IO_REG32(    VIC1_VA9R,           0xFC000124,__READ_WRITE );
__IO_REG32(    VIC1_VA10R,          0xFC000128,__READ_WRITE );
__IO_REG32(    VIC1_VA11R,          0xFC00012C,__READ_WRITE );
__IO_REG32(    VIC1_VA12R,          0xFC000130,__READ_WRITE );
__IO_REG32(    VIC1_VA13R,          0xFC000134,__READ_WRITE );
__IO_REG32(    VIC1_VA14R,          0xFC000138,__READ_WRITE );
__IO_REG32(    VIC1_VA15R,          0xFC00013C,__READ_WRITE );
__IO_REG32_BIT(VIC1_VC0R,           0xFC000200,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC1R,           0xFC000204,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC2R,           0xFC000208,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC3R,           0xFC00020C,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC4R,           0xFC000210,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC5R,           0xFC000214,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC6R,           0xFC000218,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC7R,           0xFC00021C,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC8R,           0xFC000220,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC9R,           0xFC000224,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC10R,          0xFC000228,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC11R,          0xFC00022C,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC12R,          0xFC000230,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC13R,          0xFC000234,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC14R,          0xFC000238,__READ_WRITE ,__vic_vectcntl_bits);
__IO_REG32_BIT(VIC1_VC15R,          0xFC00023C,__READ_WRITE ,__vic_vectcntl_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM0_IC1R_BUF,       0x48002000,__READ       );
__IO_REG16(    TIM0_IC2R_BUF,       0x48002004,__READ       );
__IO_REG16(    TIM0_OC1R_BUF,       0x48002008,__READ_WRITE );
__IO_REG16(    TIM0_OC2R_BUF,       0x4800200C,__READ_WRITE );
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM1_IC1R,           0x58003000,__READ       );
__IO_REG16(    TIM1_IC2R,           0x58003004,__READ       );
__IO_REG16(    TIM1_OC1R,           0x58003008,__READ_WRITE );
__IO_REG16(    TIM1_OC2R,           0x5800300C,__READ_WRITE );
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM1_IC1R_BUF,       0x48003000,__READ       );
__IO_REG16(    TIM1_IC2R_BUF,       0x48003004,__READ       );
__IO_REG16(    TIM1_OC1R_BUF,       0x48003008,__READ_WRITE );
__IO_REG16(    TIM1_OC2R_BUF,       0x4800300C,__READ_WRITE );
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM2_IC1R,           0x58004000,__READ       );
__IO_REG16(    TIM2_IC2R,           0x58004004,__READ       );
__IO_REG16(    TIM2_OC1R,           0x58004008,__READ_WRITE );
__IO_REG16(    TIM2_OC2R,           0x5800400C,__READ_WRITE );
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM2_IC1R_BUF,       0x48004000,__READ       );
__IO_REG16(    TIM2_IC2R_BUF,       0x48004004,__READ       );
__IO_REG16(    TIM2_OC1R_BUF,       0x48004008,__READ_WRITE );
__IO_REG16(    TIM2_OC2R_BUF,       0x4800400C,__READ_WRITE );
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM3_IC1R,           0x58005000,__READ       );
__IO_REG16(    TIM3_IC2R,           0x58005004,__READ       );
__IO_REG16(    TIM3_OC1R,           0x58005008,__READ_WRITE );
__IO_REG16(    TIM3_OC2R,           0x5800500C,__READ_WRITE );
 ...
 **
 ***************************************************************************/
__IO_REG16(    TIM3_IC1R_BUF,       0x48005000,__READ       );
__IO_REG16(    TIM3_IC2R_BUF,       0x48005004,__READ       );
__IO_REG16(    TIM3_OC1R_BUF,       0x48005008,__READ_WRITE );
__IO_REG16(    TIM3_OC2R_BUF,       0x4800500C,__READ_WRITE );
...
__IO_REG32(    DMA_LLI0,            0x78000108,__READ_WRITE );
...
__IO_REG32(    DMA_LLI1,            0x78000128,__READ_WRITE );
...
__IO_REG32(    DMA_LLI2,            0x78000148,__READ_WRITE );
...
__IO_REG32(    DMA_LLI3,            0x78000168,__READ_WRITE );
...
__IO_REG32(    DMA_LLI4,            0x78000188,__READ_WRITE );
...
__IO_REG32(    DMA_LLI5,            0x780001A8,__READ_WRITE );
...
__IO_REG32(    DMA_LLI6,            0x780001C8,__READ_WRITE );
...
__IO_REG32(    DMA_LLI7,            0x780001E8,__READ_WRITE );
...
__IO_REG32(    DMA_LLI0_BUF,        0x68000108,__READ_WRITE );
...
__IO_REG32(    DMA_LLI1_BUF,        0x68000128,__READ_WRITE );
...
__IO_REG32(    DMA_LLI2_BUF,        0x68000148,__READ_WRITE );
...
__IO_REG32(    DMA_LLI3_BUF,        0x68000168,__READ_WRITE );
...
__IO_REG32(    DMA_LLI4_BUF,        0x68000188,__READ_WRITE );
...
__IO_REG32(    DMA_LLI5_BUF,        0x680001A8,__READ_WRITE );
...
__IO_REG32(    DMA_LLI6_BUF,        0x680001C8,__READ_WRITE );
...
__IO_REG32(    DMA_LLI7_BUF,        0x680001E8,__READ_WRITE );
...
__IO_REG16_BIT(UART0_RSECR,         0x5C004004,__READ_WRITE ,__uart_rsecr_bits);
...
__IO_REG16_BIT(UART0_RSECR_BUF,     0x4C004004,__READ_WRITE ,__uart_rsecr_bits);
...
__IO_REG16_BIT(UART1_RSECR,         0x5C005004,__READ_WRITE ,__uart_rsecr_bits);
...
__IO_REG16_BIT(UART1_RSECR_BUF,     0x4C005004,__READ_WRITE ,__uart_rsecr_bits);
...
__IO_REG16_BIT(UART2_RSECR,         0x5C006004,__READ_WRITE ,__uart_rsecr_bits);
...
__IO_REG16_BIT(UART2_RSECR_BUF,     0x4C006004,__READ_WRITE ,__uart_rsecr_bits);
...
__IO_REG16(    USB_BTABLE,          0x70000850,__READ_WRITE );
...
__IO_REG16(    USB_BTABLE_BUF,      0x60000850,__READ_WRITE );
...
__IO_REG16_BIT(ADC_HTR,             0x5C00A008,__READ_WRITE ,__adc_htr_bits);
__IO_REG16_BIT(ADC_LTR,             0x5C00A00C,__READ_WRITE ,__adc_ltr_bits);
...
__IO_REG16_BIT(ADC_HTR_BUF,         0x4C00A008,__READ_WRITE ,__adc_htr_bits);
__IO_REG16_BIT(ADC_LTR_BUF,         0x4C00A00C,__READ_WRITE ,__adc_ltr_bits);
...
#define VIC0_SCU        10  /* System Control Unit(SCU)except Early warning*/
#define VIC0_ENET_DMA   11  /* Logic OR of Ethernet MAC interrupts via its
                               own dedicated DMA channel*/
...
#define VIC1_USB_WU     14  /* USB Bus Resume Wake-up                      */
 ...
 **
 ***************************************************************************/
#define DMA_USB_RX       0  /* USB RX                                      */
#define DMA_USB_TX       1  /* USB TX                                      */
#define DMA_TIM0         2  /* TIM 0                                       */
#define DMA_TIM1         3  /* TIM 1                                       */
#define DMA_UART0_RX     4  /* UART0 RX                                    */
#define DMA_UART0_TX     5  /* UART0 TX                                    */
#define DMA_UART1_RX     6  /* UART1 RX                                    */
#define DMA_UART1_TX     7  /* UART1 TX                                    */
...
#define DMA_SSP0_RX     12  /* SSP0 RX                                     */
#define DMA_SSP0_TX     13  /* SSP0 TX                                     */
#define DMA_SSP1_RX     14  /* SSP1 RX                                     */
#define DMA_SSP1_TX     15  /* SSP1 TX                                     */
