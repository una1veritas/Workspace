 ...
 ***************************************************************************
 **
 **   STR751 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
typedef struct {
  __REG32  TIM0_REMAP     : 1;
  __REG32  TIM2_REMAP     : 1;
...
/* Synchro Control Register (TB_SCR) */
typedef struct {
  __REG16                 : 2;
  __REG16  SME            : 1;
  __REG16  SMS            : 2;
...
/* Repetition Counter Register (PWM_RCR) */
typedef struct {
  __REG16  REP            : 8;
  __REG16                 : 8;
} __pwm_rcr_bits;
...
/* Clock Prescaler Register (SSP_PR) */
typedef struct {
  __REG16 CPSDVSR         : 8;
  __REG16                 : 8;
} __ssp_pr_bits;
...
__IO_REG16_BIT(WDG_PR,                0xFFFFB004,__READ_WRITE,__wdg_pr_bits);
...
__IO_REG16_BIT(TB_SCR,                0xFFFF8804,__READ_WRITE,__tb_scr_bits);
...
__IO_REG16_BIT(PWM_RCR,               0xFFFF982C,__READ_WRITE,__pwm_rcr_bits);
...
__IO_REG16_BIT(SSP0_PR,               0xFFFFB810,__READ_WRITE,__ssp_pr_bits);
...
__IO_REG16_BIT(SSP1_PR,               0xFFFFBC10,__READ_WRITE,__ssp_pr_bits);
...
/***************************************************************************
 **
 **  STR751 IRQ Interrupt Vector Table
 **
 ***************************************************************************/
#define INO_WAKEUP       0
#define INO_TIM2_OC2     1
#define INO_TIM2_OC1     2
#define INO_TIM2_IC12    3
#define INO_TIM2_UPDATE  4
#define INO_TIM1_OC2     5
#define INO_TIM1_OC1     6
#define INO_TIM1_IC12    7
#define INO_TIM1_UPDATE  8
#define INO_TIM0_OC2     9
#define INO_TIM0_OC1    10
#define INO_TIM0_IC12   11
#define INO_TIM0_UPDATE 12
#define INO_PWM_OC123   13
#define INO_PWM_EMG     14
#define INO_PWM_UPDATE  15
#define INO_I2C         16
#define INO_SPI1        17
#define INO_SPI0        18
#define INO_UART2       19
#define INO_UART1       20
#define INO_UART0       21
#define INO_USB_LP      23
#define INO_USB_HP      24
#define INO_ADC         25
#define INO_DMA         26
#define INO_EXTIT       27
#define INO_MRCC        28
...
/***************************************************************************
 **
 **  STR751 FIQ Interrupt Vector Table
 **
 ***************************************************************************/
#define INT0_INT         0
#define WDG_INT          1
