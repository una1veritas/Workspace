...
#ifndef __IOSTA2051_H
#define __IOSTA2051_H
 ...
 ***************************************************************************
 **
 **   STA2051 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG16_BIT(PLL2CTL,     0xA000004C,__READ_WRITE,__pll2ctl_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(RTCCRH,      0xE000D000,__READ_WRITE,__rtc_crh_bits);
__IO_REG16_BIT(RTCCRL,      0xE000D004,__READ_WRITE,__rtc_crl_bits);
__IO_REG16_BIT(RTC_LHI,     0xE000D008,__WRITE     ,__rtc_prlh_bits);
__IO_REG16(    RTC_LLO,     0xE000D00C,__WRITE);
__IO_REG16_BIT(RTC_DIVH,    0xE000D010,__READ      ,__rtc_divh_bits);
__IO_REG16(    RTC_DLO,     0xE000D014,__READ);
__IO_REG16(    RTCCNT_H,    0xE000D018,__READ_WRITE);
__IO_REG16(    RTCCNT_L,    0xE000D01C,__READ_WRITE);
__IO_REG16(    RTC_AHI,     0xE000D020,__WRITE);
__IO_REG16(    RTC_ALO,     0xE000D024,__WRITE);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(WUSRL,        0xE000101C,__READ_WRITE,__BITS8);
__IO_REG8_BIT(WUCTRL,       0xE0001024,__READ_WRITE,__wuctrl_bits);
__IO_REG8_BIT(WUMRH,        0xE0001028,__READ_WRITE,__BITS8H_bits);
__IO_REG8_BIT(WUMRL,        0xE000102C,__READ_WRITE,__BITS8);
__IO_REG8_BIT(WUTRH,        0xE0001030,__READ_WRITE,__BITS8H_bits);
__IO_REG8_BIT(WUTRL,        0xE0001034,__READ_WRITE,__BITS8);
__IO_REG8_BIT(WUPRH,        0xE0001038,__READ_WRITE,__BITS8H_bits);
__IO_REG8_BIT(WUPRL,        0xE000103C,__READ_WRITE,__BITS8);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(WDTCR,       0xE000E000,__READ_WRITE,__wdtcr_bits);
__IO_REG16_BIT(WDTPR,       0xE000E004,__READ_WRITE,__wdtpr_bits);
__IO_REG16(    WDTVR,       0xE000E008,__READ_WRITE);
__IO_REG16(    WDTCNT,      0xE000E00C,__READ);
__IO_REG16_BIT(WDTSR,       0xE000E010,__READ_WRITE,__wdtsr_bits);
__IO_REG16_BIT(WDTMR,       0xE000E014,__READ_WRITE,__wdtmr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(USB_EP0R,    0xC0008800,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP1R,    0xC0008804,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP2R,    0xC0008808,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP3R,    0xC000880C,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP4R,    0xC0008810,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP5R,    0xC0008814,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP6R,    0xC0008818,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP7R,    0xC000881C,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP8R,    0xC0008820,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP9R,    0xC0008824,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP10R,   0xC0008828,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP11R,   0xC000882C,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP12R,   0xC0008830,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP13R,   0xC0008834,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP14R,   0xC0008838,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_EP15R,   0xC000883C,__READ_WRITE,__usb_epr_bits);
__IO_REG16_BIT(USB_CNTR,    0xC0008840,__READ_WRITE,__usb_cntr_bits);
__IO_REG16_BIT(USB_ISTR,    0xC0008844,__READ_WRITE,__usb_st_bits);
__IO_REG16_BIT(USB_FNR,     0xC0008848,__READ      ,__usb_fnr_bits);
__IO_REG16_BIT(USB_DADDR,   0xC000884C,__READ_WRITE,__usb_daddr_bits);
__IO_REG16(    USB_BTABLE,  0xC0008850,__READ_WRITE);
