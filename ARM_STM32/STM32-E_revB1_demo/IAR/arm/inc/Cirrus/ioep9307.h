 ...
 ***************************************************************************
 **
 **    IOEP9307 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* DMA pheripheral port allocation register */
typedef struct{
__REG32 PPALLOC  : 4;
__REG32          :28;
} __ppalloc_bits;
...
/* UART UART1CTRL/UART3CTRL register */
typedef struct{
__REG32 UARTE  : 1;
__REG32        : 2;
__REG32 MSIE   : 1;
...
/* UART UART3HDLCRXINFOBUF register */
typedef struct{
__REG32 BRAB   : 1;     /* Buffered Reciever Abort*/
__REG32 BCRE   : 1;     /* Buffered CRC Error*/
__REG32 BROR   : 1;     /* Buffered Rx FIFO Overrun*/
...
__REG32 LNKIDL  : 1;
__REG32 PLLCC   : 1;     /* DPLL Carrier Sense*/
__REG32 PLLE    : 1;     /* DPLL error*/
__REG32         :14;
} __uartxhdlcsts_bits;

/* UART UART3HDLCSTS register */
typedef struct{
__REG32 TFS     : 1;     /* Tx FIFO Service Request*/
__REG32 TFC     : 1;     /* Tx Frame Complete*/
__REG32 TAB     : 1;     /* Tx Frame Aborted*/
...
/* UART2TMR SIR Loopback register */
typedef struct {
__REG32         : 1;
__REG32 SIRTEST : 1;
__REG32         : 6; /* must be 0 */
...
/*IRDA FIR interrupt mask register */
typedef struct{
__REG32 TFS : 1;
__REG32 TFC : 1;
__REG32 TAB : 1;
...
/* Timer Timer4ValueHigh */
typedef struct {
__REG32 Value : 8;
__REG32 Enable: 1;
__REG32       : 23;
} __timer4valuehigh_bits;
...
__REG32 HEIGHT  : 12;
__REG32         : 20;
} __blkdestheight_bits;

/* Block destination line length register */
typedef struct {
__REG32 LEN  : 12;
__REG32      : 20;
} __destlinelength_bits;
...
/* Block function transparancy pattern register */
typedef struct {
__REG32 PATTRN  :24;
__REG32         : 8;
} __transpattrn_bits;
...
__IO_REG32_BIT(ChipID,              0x80930094,__READ      ,__chipid_bits);
...
__IO_REG32(    HashTbl_Low,         0x80010050,__READ_WRITE);
__IO_REG32(    HashTbl_High,        0x80010054,__READ_WRITE);
#define IndAd_Low HashTbl_Low
#define IndAd_High HashTbl_High
...
__IO_REG32_BIT(HcInterruptDisable,  0x80020014,__READ_WRITE,__hcinterruptenable_bits);
...
__IO_REG32_BIT(RefrshTimr,          0x80060008,__READ_WRITE,__refrshtimr_bits);
__IO_REG32_BIT(BootSts,             0x8006000c,__READ      ,__bootsts_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(UART1Data,           0x808c0000,__READ_WRITE,__uartxdata_bits);
...
__IO_REG32_BIT(UART1Flag,           0x808c0018,__READ      ,__uartxflag_bits);
__IO_REG32_BIT(UART1IntIDIntClr,    0x808c001c,__READ_WRITE,__uartxintidintclr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(UART2Data,           0x808d0000,__READ_WRITE,__uartxdata_bits);
...
__IO_REG32_BIT(UART2Ctrl,           0x808d0014,__READ_WRITE,__uart2ctrl_bits);
__IO_REG32_BIT(UART2Flag,           0x808d0018,__READ_WRITE,__uartxflag_bits);
__IO_REG32_BIT(UART2IntIDIntClr,    0x808d001c,__READ_WRITE,__uartxintidintclr_bits);
...
__IO_REG32_BIT(UART2TMR,            0x808d0084,__READ_WRITE,__uart2tmr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(UART3Data,           0x808e0000,__READ_WRITE,__uartxdata_bits);
...
__IO_REG32_BIT(UART3IntIDIntClr,    0x808e001c,__READ_WRITE,__uartxintidintclr_bits);
__IO_REG32(    UART3LowPwrCntr,     0x808e0020,__READ_WRITE);
__IO_REG32_BIT(UART3DMACtrl,        0x808e0028,__READ_WRITE,__uartxdmactrl_bits);
__IO_REG32_BIT(UART3ModemCtrl,      0x808e0100,__READ_WRITE,__uart3modemctrl_bits);
__IO_REG32_BIT(UART3HDLCCtrl,       0x808e020c,__READ_WRITE,__uart3hdlcctrl_bits);
__IO_REG32(    UART3HDLCAddMtchVal, 0x808e0210,__READ_WRITE);
__IO_REG32(    UART3HDLCAddMask,    0x808e0214,__READ_WRITE);
__IO_REG32_BIT(UART3HDLCRXInfoBuf,  0x808e0218,__READ_WRITE,__uart3hdlcrxinfobuf_bits);
__IO_REG32_BIT(UART3HDLCSts,        0x808e021c,__READ_WRITE,__uart3hdlcsts_bits);
...
__IO_REG32_BIT(MISR,                0x808b0080,__READ_WRITE,__misr_bits);
__IO_REG32_BIT(MIMR,                0x808b0084,__READ_WRITE,__mimr_bits);
__IO_REG32_BIT(MIIR,                0x808b0088,__READ      ,__miir_bits);
__IO_REG32_BIT(FISR,                0x808b0180,__READ_WRITE,__fisr_bits);
__IO_REG32_BIT(FIMR,                0x808b0184,__READ_WRITE,__fimr_bits);
__IO_REG32_BIT(FIIR,                0x808b0188,__READ      ,__fiir_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(Timer1Load,          0x80810000,__READ_WRITE,__timerxload_bits);
__IO_REG32_BIT(Timer1Value,         0x80810004,__READ      ,__timerxvalue_bits);
__IO_REG32_BIT(Timer1Control,       0x80810008,__READ_WRITE,__timerxcontrol_bits);
__IO_REG32(    Timer1Clear,         0x8081000c,__WRITE     );
__IO_REG32_BIT(Timer2Load,          0x80810020,__READ_WRITE,__timerxload_bits);
__IO_REG32_BIT(Timer2Value,         0x80810024,__READ      ,__timerxvalue_bits);
...
__IO_REG32_BIT(Timer4ValueHigh,     0x80810064,__READ_WRITE,__timer4valuehigh_bits);
...
__IO_REG32(    I2SRX0Lft,           0x80820040,__READ       );
__IO_REG32(    I2SRX0Rt,            0x80820044,__READ       );
__IO_REG32(    I2SRX1Lft,           0x80820048,__READ       );
__IO_REG32(    I2SRX1Rt,            0x8082004c,__READ       );
__IO_REG32(    I2SRX2Lft,           0x80820050,__READ       );
__IO_REG32(    I2SRX2Rt,            0x80820054,__READ       );
...
__IO_REG32_BIT(AC97RISR2,           0x80880030,__READ      ,__ac97risrx_bits);
...
__IO_REG32_BIT(AC97RISR3,           0x80880050,__READ      ,__ac97risrx_bits);
...
__IO_REG32_BIT(AC97RISR4,           0x80880070,__READ      ,__ac97risrx_bits);
__IO_REG32_BIT(AC97ISR4,            0x80880074,__READ      ,__ac97isrx_bits);
__IO_REG32_BIT(AC97IE4,             0x80880078,__READ_WRITE,__ac97iex_bits);

__IO_REG32_BIT(AC97S1Data,          0x80880080,__READ_WRITE,__ac97s1data_bits);
__IO_REG32_BIT(AC97S2Data,          0x80880084,__READ_WRITE,__ac97s2data_bits);
__IO_REG32_BIT(AC97S12Data,         0x80880088,__READ_WRITE,__ac97s12data_bits);
...
__IO_REG32_BIT(SSPDR,              0x808a0008,__READ_WRITE,__sspdr_bits);
__IO_REG32_BIT(SSPSR,              0x808a000c,__READ      ,__sspsr_bits);
...
__IO_REG32_BIT(TSXYResult,          0x80900008,__READ      ,__tsxyresult_bits);
...
__IO_REG32_BIT(KeyRegister,         0x808f0008,__READ      ,__keyregister_bits);
...
__IO_REG32_BIT(IntStsF,             0x8084005c,__READ      ,__intstsx_bits);
__IO_REG32_BIT(RawIntStsF,          0x80840060,__READ      ,__rawintstsx_bits);
...
__IO_REG32_BIT(GPIOFEOI,            0x80840054,__WRITE     ,__gpioxeoi_bits);
__IO_REG32_BIT(GPIOFIntEn,          0x80840058,__READ_WRITE,__gpioxinten_bits);
__IO_REG32_BIT(IntStsA,             0x808400a0,__READ      ,__intstsx_bits);
__IO_REG32_BIT(RAWIntStsA,          0x808400a4,__READ      ,__rawintstsx_bits);
...
__IO_REG32_BIT(GPIOAEOI,            0x80840098,__WRITE     ,__gpioxeoi_bits);
...
__IO_REG32_BIT(GPIOBEOI,            0x808400b4,__WRITE     ,__gpioxeoi_bits);
__IO_REG32_BIT(GPIOBIntEn,          0x808400b8,__READ_WRITE,__gpioxinten_bits);
__IO_REG32_BIT(IntStsB,             0x808400bc,__READ      ,__intstsx_bits);
__IO_REG32_BIT(RawIntStsB,          0x808400c0,__READ      ,__rawintstsx_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(ExtensionID,         0x80832714,__READ      ,__extensionid_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(SRCPIXELSTRT,        0x80040000,__READ_WRITE, __srcpixelstrt_bits);
__IO_REG32_BIT(DESTPIXELSTRT,       0x80040004,__READ_WRITE,__destpixelstrt_bits);
__IO_REG32(    BLKSRCSTRT,          0x80040008,__READ_WRITE);
__IO_REG32(    BLKDESTSTRT,         0x8004000c,__READ_WRITE);
__IO_REG32_BIT(BLKSRCWIDTH,         0x80040010,__READ_WRITE,__blksrcwidth_bits);
__IO_REG32_BIT(SRCLINELENGTH,       0x80040014,__READ_WRITE,__srclinelength_bits);
__IO_REG32_BIT(BLKDESTWIDTH,        0x80040018,__READ_WRITE,__blkdestwidth_bits);
__IO_REG32_BIT(BLKDESTHEIGHT,       0x8004001c,__READ_WRITE,__blkdestheight_bits);
__IO_REG32_BIT(DESTLINELENGTH,      0x80040020,__READ_WRITE,__destlinelength_bits);
__IO_REG32_BIT(BLOCKCTRL,           0x80040024,__READ_WRITE,__blockctrl_bits);
__IO_REG32_BIT(TRANSPATTRN,         0x80040028,__READ_WRITE,__transpattrn_bits);
__IO_REG32_BIT(BLOCKMASK,           0x8004002c,__READ_WRITE,__blockmask_bits);
__IO_REG32_BIT(BACKGROUND,          0x80040030,__READ_WRITE,__background_bits);
__IO_REG32_BIT(LINEINC,             0x80040034,__READ_WRITE,__lineinc_bits);
__IO_REG32_BIT(LINEINIT,            0x80040038,__READ_WRITE,__lineinit_bits);
__IO_REG32_BIT(LINEPATTRN,          0x8004003c,__READ_WRITE,__linepattrn_bits);
...
#define VIC1_UART2RXINTR2   25  /* UART 2 Receive Interrupt                   */
#define VIC1_UART2TXINTR2   26  /* UART 2 Transmit Interrupt                  */
#define VIC1_UART3RXINTR3   27  /* UART 3 Receive Interrupt                   */
#define VIC1_UART3TXINTR3   28  /* UART 3 Transmit Interrupt                  */
