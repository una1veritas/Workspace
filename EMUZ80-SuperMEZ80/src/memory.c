...
static void write_to_sram_low_addr(uint32_t dest, const /*void*/ uint8_t *buf, unsigned int len)
{
...
static void read_from_sram_low_addr(uint32_t src, /*void*/ uint8_t *buf, unsigned int len)
{
    uint16_t addr_gap_mask = ~board_low_addr_mask();
