 ...
 * Board identifier.
 */
#define BOARD_AVR_ATMEGA1284P
#define BOARD_NAME "AVR_ATMEGA1284P"
...
*/
/*        B7  B6 d13  B4  B3  B2  B1  d8
 *        IN  IN OUT  IN  IN  IN  IN  IN
 * DDRA    0   0   1   0   0   0   0   0
 *        HiZ HiZ LOW HiZ HiZ HiZ HiZ HiZ
 * PORTA   0   0   0   0   0   0   0   0
 */
#define VAL_DDRB  0x20
#define VAL_PORTB 0x00

/*        C7  C6  A5  A4  A3  A2  A1  A0
 *        OUT OUT OUT OUT IN  IN  IN  IN
 * DDRC    1   1   1   1   0   0   0   0
 *        PU  PU  PU  PU   Z   Z   Z   Z
 * PORTC   0   0   1   1   0   0   0   0
 */
#define VAL_DDRC  0xF0
#define VAL_PORTC 0x30

/*       PD7 PD6 PD5 PD4 TX2 RX2 TX1 RX1
