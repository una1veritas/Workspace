...
VECT_T:	EQU	$00000000
PROG_B:	EQU	$00000400
SHAD_M: EQU	$00000100	;PIC <-> 68008 Shared Memory
...
CONIN:
	move.b	#REQ_CONIN, CREQ_COM	; set CONIB request
...
CONST:
	move.b	#REQ_CONST, CREQ_COM	; set CONST request
	bsr	cin0
...
CONOUT:
	move.b	#REQ_CONOUT, CREQ_COM	; set CONOUT request
	move.b	d0, CBI_CHR		; set output character
	bra	cin0
