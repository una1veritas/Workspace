...
OBJS += \
./stm32f4/STM32_USB_OTG_Driver/src/usb_dcd.o \
./stm32f4/STM32_USB_OTG_Driver/src/usb_dcd_int.o 

C_DEPS += \
./stm32f4/STM32_USB_OTG_Driver/src/usb_dcd.d \
./stm32f4/STM32_USB_OTG_Driver/src/usb_dcd_int.d 


# Each subdirectory must supply rules for building sources it contributes
stm32f4/STM32_USB_OTG_Driver/src/%.o: ../stm32f4/STM32_USB_OTG_Driver/src/%.c
	@echo 'Building file: $<'
