...
public class ControlClient {
  ...
  public ControlClient() {   
	...
	os.write(ch);
      ...
      System.out.println("StudentServer に対する ControlClient が暗号通信を設定できません。");
      System.exit(0);
    }
    
    String id = commonInfo.SecretKillerCode;
    String password = commonInfo.SecretKillerPassword;
    String message = "SERVER_CONTROLLER|ControlClient|STUDENT_SERVER:" + id + "|" + password;
    try {
  ...
  public void printLoginList() {
	...
	System.out.println("loginCount = 0");
	return;
      }
