...
public class StudentHandler extends Thread {
  ...
  private StudentHandlerMethods handlerMethods;
  
  public StudentHandler(Socket socket, CommonInfo commonInfo) {
    this.socket = socket;
    ...
    handlerMethods = new StudentHandlerMethods(commonInfo, socket, 
...
/*
	...
	if ((commandType.equals("QUERY")) && (serviceName.equals("COMMON_QUERY"))) {
	  ...
	  if ((commandCode.equals("STUDENT_SERVER")) && 
