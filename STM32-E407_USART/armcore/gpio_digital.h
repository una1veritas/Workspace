...
#define CLK_SLOW 	GPIO_Speed_2MHz
#define CLK_MED 	GPIO_Speed_25MHz
#define CLK_FAST 	GPIO_Speed_50MHz
#define CLK_HIGH 	GPIO_Speed_100MHz
...
void GPIOMode(GPIO_TypeDef * port, uint16 pin,
		GPIOMode_TypeDef mode,
		GPIOSpeed_TypeDef clk  = GPIO_Speed_50MHz,
		GPIOPuPd_TypeDef pupd = GPIO_PuPd_NOPULL);
