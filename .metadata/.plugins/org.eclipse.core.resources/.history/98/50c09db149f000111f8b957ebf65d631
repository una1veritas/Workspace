...
OBJS += \
./home_libraries/TouchScreen/TouchScreen.o 

CPP_DEPS += \
./home_libraries/TouchScreen/TouchScreen.d 


# Each subdirectory must supply rules for building sources it contributes
home_libraries/TouchScreen/TouchScreen.o: /Users/sin/Documents/Arduino/libraries/TouchScreen/TouchScreen.cpp
	@echo 'Building file: $<'
