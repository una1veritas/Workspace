...
OBJS += \
./home_libraries/Sparkfun6DOF/IMU.o 

CPP_DEPS += \
./home_libraries/Sparkfun6DOF/IMU.d 


# Each subdirectory must supply rules for building sources it contributes
home_libraries/Sparkfun6DOF/IMU.o: /Users/sin/Documents/Arduino/libraries/Sparkfun6DOF/IMU.cpp
	@echo 'Building file: $<'
