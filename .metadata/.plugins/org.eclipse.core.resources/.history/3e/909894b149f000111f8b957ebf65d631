...
OBJS += \
./home_libraries/CapacitiveSense/CapSense.o 

CPP_DEPS += \
./home_libraries/CapacitiveSense/CapSense.d 


# Each subdirectory must supply rules for building sources it contributes
home_libraries/CapacitiveSense/CapSense.o: /Users/sin/Documents/Arduino/libraries/CapacitiveSense/CapSense.cpp
	@echo 'Building file: $<'
