...
# 2 "<built-in>" 2
# 1 "../src/boards/MEZ88_bd.c" 2
# 17 "../src/boards/MEZ88_bd.c"
# 1 "../src/boards/../mez88.h" 1
# 27 "../src/boards/../mez88.h"
# 1 "../src/boards/../../src/picconfig.h" 1
# 28 "../src/boards/../mez88.h" 2
...
# 31 "../src/boards/../mez88.h" 2
# 66 "../src/boards/../mez88.h"
typedef struct {
 uint8_t UREQ_COM;
 uint8_t UNI_CHR;
 uint16_t STR_off;
...
# 20 "../src/boards/MEZ88_bd.c" 2
# 1 "../src/boards/../../drivers/picregister.h" 1
# 21 "../src/boards/MEZ88_bd.c" 2
...
# 25 "../src/boards/MEZ88_bd.c" 2
# 61 "../src/boards/MEZ88_bd.c"
# 1 "../src/boards/mez88_com.c" 1
# 26 "../src/boards/mez88_com.c"
unsigned char rx_buf[128];
unsigned int rx_wp, rx_rp, rx_cnt;



unsigned char ax_buf[128];
unsigned int ax_wp, ax_rp, ax_cnt;

TPB tim_pb;
# 44 "../src/boards/mez88_com.c"
uint8_t rtc[7];

static uint8_t cnt_sec;
...
int cnv_rtc_tim(void) {
 if ( read_I2C(0b11010000, 0, 7, &rtc[0]) == 0xFF) return 1;
 cvt_bcd_bin();
 return 0;
}
...
void __attribute__((picinterrupt(("irq(U3RX),base(8)")))) URT3Rx_ISR(){
 ...
 if ( ctlq_ev == 0x11 && rx_data == 0x11 ) nmi_sig = 1;
 if (rx_cnt < 128) {
...
void __attribute__((picinterrupt(("irq(U5RX),base(8)")))) URT5Rx_ISR(){
