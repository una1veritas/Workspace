...
;	2025.08.11 modifued for MEZ88_RAM by A.honda
;
;-------------------------------------------
...
;	?debug	L 1242
	...
	jb	L_419
	cmp	word ptr _cip,_listbuf+list_bufs-1
	jae	L_419
	mov	bx,word ptr _clp
	cmp	byte ptr [bx],0
	je	L_419
