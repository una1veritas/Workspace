...
#ifndef __IOLM3S618_H
#define __IOLM3S618_H
 ...
 ***************************************************************************
 **
 **   LM3S618 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG32_BIT(FMPPE,             0x400FE134,__READ_WRITE ,__fmppe_bits);
...
__IO_REG32_BIT(ADCTMLB,           0x40038100,__READ_WRITE ,__adctmlb_bits);
...
__IO_REG32_BIT(WDTTEST,           0x40000018,__READ       ,__wdttest_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(QEICTL,            0x4002C000,__READ_WRITE  ,__qeictl_bits);
__IO_REG32_BIT(QEISTAT,           0x4002C004,__READ        ,__qeistat_bits);
__IO_REG32_BIT(QEIPOS,            0x4002C008,__READ_WRITE  ,__qeipos_bits);
__IO_REG32_BIT(QEIMAXPOS,         0x4002C00C,__READ_WRITE  ,__qeimaxpos_bits);
__IO_REG32_BIT(QEILOAD,           0x4002C010,__READ_WRITE  ,__qeiload_bits);
__IO_REG32_BIT(QEITIME,           0x4002C014,__READ        ,__qeitime_bits);
__IO_REG32_BIT(QEICOUNT,          0x4002C018,__READ        ,__qeicount_bits);
__IO_REG32_BIT(QEISPEED,          0x4002C01C,__READ        ,__qeispeed_bits);
__IO_REG32_BIT(QEIINTEN,          0x4002C020,__READ_WRITE  ,__qeiinten_bits);
__IO_REG32_BIT(QEIRIS,            0x4002C024,__READ        ,__qeiris_bits);
__IO_REG32_BIT(QEIISC,            0x4002C028,__READ_WRITE  ,__qeiisc_bits);
...
Interrupt17  = PWM0           0x68
Interrupt18  = PWM1           0x6C
Interrupt19  = PWM2           0x70
Interrupt20  = QEI0           0x74
Interrupt21  = ADC0           0x78
Interrupt22  = ADC1           0x7C
Interrupt23  = ADC2           0x80
Interrupt24  = ADC3           0x84
Interrupt25  = WDT            0x88
Interrupt26  = TIMER0A        0x8C
Interrupt27  = TIMER0B        0x90
Interrupt28  = TIMER1A        0x94
Interrupt29  = TIMER1B        0x98
Interrupt30  = TIMER2A        0x9C
Interrupt31  = TIMER2B        0xA0
Interrupt32  = ACOMP0         0xA4
Interrupt33  = SysCtrl        0xB0
Interrupt34  = FlashCtrl      0xB4
###DDF-INTERRUPT-END###*/
