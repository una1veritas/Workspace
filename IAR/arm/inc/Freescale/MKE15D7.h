...
**
**     Abstract:
**         This header file implements peripheral memory map for MKE15D7
**         processor.
**
 ...
 * @version 2.0
 * @date 2012-02-20
 * @brief Peripheral memory map for MKE15D7
 *
 * This header file implements peripheral memory map for MKE15D7 processor.
 */
...
#if !defined(MCU_MKE15D7)  /* Check if memory map has not been already included */
#define MCU_MKE15D7

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MKE15D7 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef struct TSI_MemMap {
  ...
  uint8_t RESERVED_0[244];
  uint32_t CNTR[8];                                /**< Counter Register, array offset: 0x100, array step: 0x4 */
...
#define TSI_CNTR_REG(base,index)                 ((base)->CNTR[index])
...
#define TSI0_BASE_PTR                            ((TSI_MemMapPtr)0x40030000u)
...
#define TSI0_CNTR1                               TSI_CNTR_REG(TSI0_BASE_PTR,0)
#define TSI0_CNTR3                               TSI_CNTR_REG(TSI0_BASE_PTR,1)
#define TSI0_CNTR5                               TSI_CNTR_REG(TSI0_BASE_PTR,2)
#define TSI0_CNTR7                               TSI_CNTR_REG(TSI0_BASE_PTR,3)
#define TSI0_CNTR9                               TSI_CNTR_REG(TSI0_BASE_PTR,4)
#define TSI0_CNTR11                              TSI_CNTR_REG(TSI0_BASE_PTR,5)
#define TSI0_CNTR13                              TSI_CNTR_REG(TSI0_BASE_PTR,6)
#define TSI0_CNTR15                              TSI_CNTR_REG(TSI0_BASE_PTR,7)
#define TSI0_THRESHOLD                           TSI_THRESHOLD_REG(TSI0_BASE_PTR)

/* TSI - Register array accessors */
#define TSI0_CNTR(index)                         TSI_CNTR_REG(TSI0_BASE_PTR,index)
