 ...
 **
 ***************************************************************************/
__IO_REG8_BIT( IBAD,         0xfc0ac000,__READ_WRITE,__ibad_bits);
__IO_REG8_BIT( IBFD,         0xfc0ac001,__READ_WRITE,__ibfd_bits);
__IO_REG8_BIT( IBCR,         0xfc0ac002,__READ_WRITE,__ibcr_bits);
__IO_REG8_BIT( IBSR,         0xfc0ac003,__READ_WRITE,__ibsr_bits);
__IO_REG8(     IBDR,         0xfc0ac004,__READ_WRITE);
