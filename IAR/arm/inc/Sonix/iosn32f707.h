 ...
 ***************************************************************************
 **
 **   Sonix SN32F707 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(USART1_RB,            0x40056000,__READ_WRITE ,__USARTn_RB_bits);
#define USART1_TH           USART1_RB
#define USART1_TH_bit       USART1_RB_bit
#define USART1_DLL          USART1_RB
#define USART1_DLL_bit      USART1_RB_bit
__IO_REG32_BIT(USART1_DLM,           0x40056004,__READ_WRITE ,__USARTn_DLM_bits);
#define USART1_IE           USART1_DLM
#define USART1_IE_bit       USART1_DLM_bit
__IO_REG32_BIT(USART1_II,            0x40056008,__READ_WRITE ,__USARTn_II_bits);
#define USART1_FIFOCTRL     USART1_II
#define USART1_FIFOCTRL_bit USART1_II_bit.__USARTn_FIFOCTRL_bits
__IO_REG32_BIT(USART1_LC,            0x4005600C,__READ_WRITE ,__USARTn_LC_bits);
__IO_REG32_BIT(USART1_MC,            0x40056010,__READ_WRITE ,__USARTn_MC_bits);
__IO_REG32_BIT(USART1_LS,            0x40056014,__READ_WRITE ,__USARTn_LS_bits);
__IO_REG32_BIT(USART1_MS,            0x40056018,__READ_WRITE ,__USARTn_MS_bits);
__IO_REG32_BIT(USART1_SP,            0x4005601C,__READ_WRITE ,__USARTn_SP_bits);
__IO_REG32_BIT(USART1_ABCTRL,        0x40056020,__READ_WRITE ,__USARTn_ABCTRL_bits);
__IO_REG32_BIT(USART1_IRDACTRL,      0x40056024,__READ_WRITE ,__USARTn_IRDACTRL_bits);
__IO_REG32_BIT(USART1_FD,            0x40056028,__READ_WRITE ,__USARTn_FD_bits);
__IO_REG32_BIT(USART1_CTRL,          0x40056030,__READ_WRITE ,__USARTn_CTRL_bits);
__IO_REG32_BIT(USART1_HDEN,          0x40056034,__READ_WRITE ,__USARTn_HDEN_bits);
__IO_REG32_BIT(USART1_SCICTRL,       0x40056038,__READ_WRITE ,__USARTn_SCICTRL_bits);
__IO_REG32_BIT(USART1_RS485CTRL,     0x4005603C,__READ_WRITE ,__USARTn_RS485CTRL_bits);
__IO_REG32_BIT(USART1_RS485ADRMATCH, 0x40056040,__READ_WRITE ,__USARTn_RS485ADRMATCH_bits);
__IO_REG32_BIT(USART1_RS485DLYV,     0x40056044,__READ_WRITE ,__USARTn_RS485DLYV_bits);
__IO_REG32_BIT(USART1_SYNCCTRL,      0x40056048,__READ_WRITE ,__USARTn_SYNCCTRL_bits);
...
*/
/******  SN32F707 Specific Interrupt Numbers  *****************************************/
#define MAIN_STACK           0
#define Reset                1
