...
#ifndef __IOTMPM370FxFG_H
#define __IOTMPM370FxFG_H
 ...
 ***************************************************************************
 **
 **    TMPM370FxFG SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(AMPCTLA,             0x40030400, __READ_WRITE , __AMPCTLx_bits);
__IO_REG32_BIT(AMPCTLB,             0x40030408, __READ_WRITE , __AMPCTLx_bits);
__IO_REG32_BIT(AMPCTLC,             0x40030410, __READ_WRITE , __AMPCTLx_bits);
__IO_REG32_BIT(AMPCTLD,             0x40030418, __READ_WRITE , __AMPCTLx_bits);
__IO_REG32_BIT(CMPCTLA,             0x40030420, __READ_WRITE , __CMPCTLx_bits);
__IO_REG32_BIT(CMPCTLB,             0x40030428, __READ_WRITE , __CMPCTLx_bits);
__IO_REG32_BIT(CMPCTLC,             0x40030430, __READ_WRITE , __CMPCTLx_bits);
__IO_REG32_BIT(CMPCTLD,             0x40030438, __READ_WRITE , __CMPCTLx_bits);
...
__IO_REG32_BIT(VEMCTLF0,            0x40050044, __READ_WRITE , __mctlfx_bits);
__IO_REG32_BIT(VEMODE0,             0x40050048, __READ_WRITE , __modex_bits);
__IO_REG32_BIT(VEFMODE0,            0x4005004C, __READ_WRITE , __fmodex_bits);
__IO_REG32_BIT(VETPWM0,             0x40050050, __READ_WRITE , __tpwmx_bits);
__IO_REG32_BIT(VEOMEGA0,            0x40050054, __READ_WRITE , __omegax_bits);
__IO_REG32_BIT(VETHETA0,            0x40050058, __READ_WRITE , __thetax_bits);
__IO_REG32_BIT(VEIDREF0,            0x4005005C, __READ_WRITE , __idrefx_bits);
__IO_REG32_BIT(VEIQREF0,            0x40050060, __READ_WRITE , __iqrefx_bits);
__IO_REG32_BIT(VEVD0,               0x40050064, __READ_WRITE , __vdx_bits);
__IO_REG32_BIT(VEVQ0,               0x40050068, __READ_WRITE , __vqx_bits);
__IO_REG32_BIT(VECIDKI0,            0x4005006C, __READ_WRITE , __cidkix_bits);
__IO_REG32_BIT(VECIDKP0,            0x40050070, __READ_WRITE , __cidkpx_bits);
__IO_REG32_BIT(VECIQKI0,            0x40050074, __READ_WRITE , __ciqkix_bits);
__IO_REG32_BIT(VECIQKP0,            0x40050078, __READ_WRITE , __ciqkpx_bits);
__IO_REG32_BIT(VEVDIH0,             0x4005007C, __READ_WRITE , __vdihx_bits);
__IO_REG32_BIT(VEVDILH0,            0x40050080, __READ_WRITE , __vdilhx_bits);
__IO_REG32_BIT(VEVQIH0,             0x40050084, __READ_WRITE , __vqihx_bits);
__IO_REG32_BIT(VEVQILH0,            0x40050088, __READ_WRITE , __vqilhx_bits);
__IO_REG32_BIT(VEFPWMCHG0,          0x4005008C, __READ_WRITE , __fpwmchgx_bits);
__IO_REG32_BIT(VEMDPRD0,            0x40050090, __READ_WRITE , __vmdprdx_bits);
__IO_REG32_BIT(VEMINPLS0,           0x40050094, __READ_WRITE , __minplsx_bits);
__IO_REG32_BIT(VETRGCRC0,           0x40050098, __READ_WRITE , __trgcrcx_bits);
__IO_REG32_BIT(VECOS0,              0x400500A0, __READ_WRITE , __cosx_bits);
__IO_REG32_BIT(VESIN0,              0x400500A4, __READ_WRITE , __sinx_bits);
__IO_REG32_BIT(VECOSM0,             0x400500A8, __READ_WRITE , __cosmx_bits);
__IO_REG32_BIT(VESINM0,             0x400500AC, __READ_WRITE , __sinmx_bits);
__IO_REG32_BIT(VESECTOR0,           0x400500B0, __READ_WRITE , __sectorx_bits);
__IO_REG32_BIT(VESECTORM0,          0x400500B4, __READ_WRITE , __sectormx_bits);
__IO_REG32_BIT(VEIAO0,              0x400500B8, __READ_WRITE , __iaox_bits);
__IO_REG32_BIT(VEIBO0,              0x400500BC, __READ_WRITE , __ibox_bits);
__IO_REG32_BIT(VEICO0,              0x400500C0, __READ_WRITE , __icox_bits);
__IO_REG32_BIT(VEIAADC0,            0x400500C4, __READ_WRITE , __iaadcx_bits);
__IO_REG32_BIT(VEIBADC0,            0x400500C8, __READ_WRITE , __ibadcx_bits);
__IO_REG32_BIT(VEICADC0,            0x400500CC, __READ_WRITE , __icadcx_bits);
__IO_REG32_BIT(VEVDC0,              0x400500D0, __READ_WRITE , __vdcx_bits);
__IO_REG32_BIT(VEID0,               0x400500D4, __READ_WRITE , __idx_bits);
__IO_REG32_BIT(VEIQ0,               0x400500D8, __READ_WRITE , __iqx_bits);     
...
__IO_REG32_BIT(VEOUTCR0,            0x40050188, __READ_WRITE , __outcrx_bits);
__IO_REG32_BIT(VETRGCMP00,          0x4005018C, __READ_WRITE , __vtrgcmp0x_bits);
__IO_REG32_BIT(VETRGCMP10,          0x40050190, __READ_WRITE , __vtrgcmp1x_bits);
__IO_REG32_BIT(VETRGSEL0,           0x40050194, __READ_WRITE , __vtrgselx_bits);
__IO_REG32_BIT(VEEMGRS0,            0x40050198, __WRITE      , __emgrsx_bits);   
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(PMD0MDEN,            0x40050400, __READ_WRITE , __mdenx_bits);
__IO_REG32_BIT(PMD0PORTMD,          0x40050404, __READ_WRITE , __portmdx_bits);
__IO_REG32_BIT(PMD0MDCR,            0x40050408, __READ_WRITE , __mdcrx_bits);
__IO_REG32_BIT(PMD0CNTSTA,          0x4005040C, __READ       , __cntstax_bits);
__IO_REG32_BIT(PMD0MDCNT,           0x40050410, __READ       , __mdcntx_bits);
__IO_REG32_BIT(PMD0MDPRD,           0x40050414, __READ_WRITE , __mdprdx_bits);
__IO_REG32_BIT(PMD0CMPU,            0x40050418, __READ_WRITE , __cmpux_bits);
__IO_REG32_BIT(PMD0CMPV,            0x4005041C, __READ_WRITE , __cmpvx_bits);
__IO_REG32_BIT(PMD0CMPW,            0x40050420, __READ_WRITE , __cmpwx_bits);
__IO_REG32_BIT(PMD0MODESEL,         0x40050424, __READ_WRITE , __modeselx_bits);
__IO_REG32_BIT(PMD0MDOUT,           0x40050428, __READ_WRITE , __mdoutx_bits);
__IO_REG32_BIT(PMD0MDPOT,           0x4005042C, __READ_WRITE , __mdpotx_bits);
__IO_REG32_BIT(PMD0EMGREL,          0x40050430, __WRITE      , __emgrelx_bits);
__IO_REG32_BIT(PMD0EMGCR,           0x40050434, __READ_WRITE , __emgcrx_bits);
__IO_REG32_BIT(PMD0EMGSTA,          0x40050438, __READ       , __emgstax_bits);
__IO_REG32_BIT(PMD0OVVCR,           0x4005043C, __READ_WRITE , __ovvcrx_bits);
__IO_REG32_BIT(PMD0OVVSTA,          0x40050440, __READ       , __ovvstax_bits);
__IO_REG32_BIT(PMD0DTR,             0x40050444, __READ_WRITE , __dtrx_bits);
__IO_REG32_BIT(PMD0TRGCMP0,         0x40050448, __READ_WRITE , __trgcmp0x_bits);
__IO_REG32_BIT(PMD0TRGCMP1,         0x4005044C, __READ_WRITE , __trgcmp1x_bits);
__IO_REG32_BIT(PMD0TRGCMP2,         0x40050450, __READ_WRITE , __trgcmp2x_bits);
__IO_REG32_BIT(PMD0TRGCMP3,         0x40050454, __READ_WRITE , __trgcmp3x_bits);
__IO_REG32_BIT(PMD0TRGCR,           0x40050458, __READ_WRITE , __trgcrx_bits);
__IO_REG32_BIT(PMD0TRGMD,           0x4005045C, __READ_WRITE , __trgmdx_bits);
__IO_REG32_BIT(PMD0TRGSEL,          0x40050460, __READ_WRITE , __trgselx_bits);
...
#define INT_0                ( 0 + EII)   /* Interrupt Pin (PH0/AINA0/96pin or 98pin)*/
#define INT_1                ( 1 + EII)   /* Interrupt Pin (PH1/AINA1/95pin or 97pin)*/
#define INT_2                ( 2 + EII)   /* Interrupt Pin (PH2/AINA2/94pin or 96pin)*/
...
#define INT_9                (59 + EII)   /* Interrupt Pin (PD3/33pin or 35pin)                */
#define INT_A                (60 + EII)   /* Interrupt Pin (FTEST2/PL1/21pin or 23pin)         */
#define INT_B                (61 + EII)   /* Interrupt Pin (FTEST3/PL0/20pin or 22pin)         */
...
Interrupt19  = INTVCNA        0x68
Interrupt20  = INTVCNB        0x6C
Interrupt21  = INTEMG0        0x70
Interrupt22  = INTEMG1        0x74
Interrupt23  = INTOVV0        0x78
Interrupt24  = INTOVV1        0x7C
Interrupt25  = INTADAPDA      0x80
Interrupt26  = INTADBPDA      0x84
Interrupt27  = INTADAPDB      0x88
Interrupt28  = INTADBPDB      0x8C
...
Interrupt51  = INTADACPA      0xE8
Interrupt52  = INTADBCPA      0xEC
Interrupt53  = INTADACPB      0xF0
Interrupt54  = INTADBCPB      0xF4
...
Interrupt63  = INTADASFT      0x118 
Interrupt64  = INTADBSFT      0x11C 
Interrupt65  = INTADATMR      0x120 
Interrupt66  = INTADBTMR      0x124 
Interrupt67  = INT8           0x128 
Interrupt68  = INT9           0x12C 
Interrupt69  = INTA           0x130 
Interrupt70  = INTB           0x134 
Interrupt71  = INTENC0        0x138 
Interrupt72  = INTENC1        0x13C 
Interrupt73  = INTRX3         0x140 
Interrupt74  = INTTX3         0x144 
Interrupt75  = INTTB60        0x148 
Interrupt76  = INTTB61        0x14C 
Interrupt77  = INTTB70        0x150 
Interrupt78  = INTTB71        0x154 
Interrupt79  = INTCAP60       0x158
Interrupt80  = INTCAP61       0x15C
Interrupt81  = INTCAP70       0x160
Interrupt82  = INTCAP71       0x164
Interrupt83  = INTC           0x168
Interrupt84  = INTD           0x16C
Interrupt85  = INTE           0x170
Interrupt86  = INTF           0x174
