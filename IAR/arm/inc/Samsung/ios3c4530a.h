 ...
 **    Samsung Semiconductors S3C4530A
 **
 ...
 ***************************************************************************
 **
 **    S3C4530A SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
typedef struct {
  ...
  __REG32 rb5we:1;  /* ROM bank 5 wait enable  */
  __REG32 addre:1;  /* ROM bank 5 address/data bus Mux enable */
  __REG32 tac  :2;  /* Mux bus address cycle   */
  __REG32 rb5wd:1;  /* ROM bank 5 wait 1 cycle delay */
  __REG32 rb4we:1;  /* ROM bank 4 wait enable */
  __REG32 rb4wd:1;  /* ROM bank 4 wait 1 cycle delay */
  __REG32 rb3we:1;  /* ROM bank 3 wait enable */
  __REG32 rb3wd:1;  /* ROM bank 3 wait 1 cycle delay */
  __REG32 rb2we:1;  /* ROM bank 2 wait enable */
  __REG32 rb2wd:1;  /* ROM bank 2 wait 1 cycle delay */
  __REG32 rb1we:1;  /* ROM bank 1 wait enable */
  __REG32 rb1wd:1;  /* ROM bank 1 wait 1 cycle delay */
  __REG32 rb0we:1;  /* ROM bank 0 wait enable */
  __REG32 rb0wd:1;  /* ROM bank 0 wait 1 cycle delay */
...
/* HDLC: syncronization register */
typedef struct {
  __REG32 sp      :8;
  __REG32         :24;
} __hsync_bits;

/* HDLC: Transparent control register */
typedef struct {
  __REG32 ds      :2;
  __REG32         :2;
  __REG32 rts     :1;
...
/* HDLC: TSA configuration register */
typedef struct {
  __REG32 tsaen   :1;
  __REG32 amode   :1;
  __REG32 bmode   :1;
...
/* HDLC: TSA channel time slot register */
typedef struct {
  __REG32 start   :12;
  __REG32         :4;
  __REG32 stop    :12;
...
__IO_REG32_BIT(__HSYNCA,0x03ff7048,__READ_WRITE,__hsync_bits);
__IO_REG32_BIT(__TCONA,0x03ff704c,__READ_WRITE,__tcon_bits);
__IO_REG32_BIT(__TSACFG,0x03ff7800,__READ_WRITE,__tsacfg_bits);
__IO_REG32_BIT(__TSAASLOT,0x03ff7804,__READ_WRITE,__tsaslot_bits);
__IO_REG32_BIT(__TSABSLOT,0x03ff7808,__READ_WRITE,__tsaslot_bits);
...
__IO_REG32_BIT(__HSYNCB,0x03ff8048,__READ_WRITE,__hsync_bits);
__IO_REG32_BIT(__TCONB,0x03ff804c,__READ_WRITE,__tcon_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(__UCON0,0x03ffd000,__READ_WRITE,__ucon_bits);
__IO_REG32_BIT(__UCON1,0x03ffe000,__READ_WRITE,__ucon_bits);
__IO_REG32_BIT(__USTAT0,0x03ffd004,__READ,__ustat_bits);
__IO_REG32_BIT(__USTAT1,0x03ffe004,__READ,__ustat_bits);
__IO_REG32_BIT(__UINTEN0,0x03ffd008,__READ,__uinten_bits);
__IO_REG32_BIT(__UINTEN1,0x03ffe008,__READ,__uinten_bits);
...
__IO_REG32_BIT(__CONCHAR1_0,0x03ffd018,__READ_WRITE,__conchar1_bits);
__IO_REG32_BIT(__CONCHAR1_1,0x03ffe018,__READ_WRITE,__conchar1_bits);
__IO_REG32_BIT(__CONCHAR2_0,0x03ffd01c,__READ_WRITE,__conchar2_bits);
__IO_REG32_BIT(__CONCHAR2_1,0x03ffe01c,__READ_WRITE,__conchar2_bits);
...
__IO_REG32_BIT(__IOPCON0,0x03ff5004,__READ_WRITE,__iopcon0_bits);
__IO_REG32_BIT(__IOPDATA,0x03ff5008,__READ_WRITE,__iopdata_bits);
__IO_REG32_BIT(__IOPCON1,0x03ff500c,__READ_WRITE,__iopcon1_bits);
...
#define ECMACTx  18  /* Eternet controller MAC  Tx intrrupt*/
#define ECMACRx  19  /* Eternet controller MAC  Rx intrrupt*/
