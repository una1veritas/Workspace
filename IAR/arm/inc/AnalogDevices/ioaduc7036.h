/***************************************************************************
===============================================																		
ADuC7036 HEADER FILE REV 1.3																		
===============================================																		
***************************************************************************/

#ifndef __IOADI7036_H
#define __IOADI7036_H
 ...
 ***************************************************************************
 **                            
 **    ADuC7036 SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG32(ADC2DAT, 0xFFFF0528,__READ);
...
__IO_REG32(ADC0THV, 0xFFFF0558,__READ);
__IO_REG32(ADC0ACC, 0xFFFF055C,__READ);
__IO_REG32(SYSALI, 0xFFFF0560,__READ_WRITE);
...
__IO_REG32(LHSCAP, 0xFFFF0794,__READ);
__IO_REG32(LHSCMP, 0xFFFF0798,__READ_WRITE);
...
__IO_REG32(STIBASE, 0xFFFF0880,__READ_WRITE);
#define STIKEY0 STIBASE
__IO_REG32(STICON, 0xFFFF0884,__READ_WRITE);
__IO_REG32(STIKEY1, 0xFFFF0888,__WRITE);
__IO_REG32(STIDAT0, 0xFFFF088C,__READ_WRITE);
__IO_REG32(STIDAT1, 0xFFFF0890,__READ_WRITE);
__IO_REG32(STIDAT2, 0xFFFF0894,__READ_WRITE);
