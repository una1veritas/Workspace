...
__IO_REG32_BIT(OUTCOUNT0,            0xFFFF5058, __READ,       __usb_outcount_bits       );    /* USB Number of received bytes in Endpoint 0 FIFO (INDEX register set to select Endpoint 0)  Number of bytes in OUT endpoint FIFO (lower byte) (INDEX register set to select Endpoints 1 – 3), init value = 0x00000000 */
#define OUTCOUNT1      OUTCOUNT0
#define OUTCOUNT1_bit  OUTCOUNT0_bit
