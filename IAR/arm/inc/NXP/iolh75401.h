 ...
 ***************************************************************************
 **
 **    LH75401 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG32(VIC_VectAddr6,   0xfffff118,__READ_WRITE);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(CLCDC_Timing0,   0xffff4000,__READ_WRITE,__LCD_Timing0_bits);
__IO_REG32_BIT(CLCDC_Timing1,   0xffff4004,__READ_WRITE,__LCD_Timing1_bits);
__IO_REG32_BIT(CLCDC_Timing2,   0xffff4008,__READ_WRITE,__LCD_Timing2_bits);
__IO_REG32_BIT(CLCDC_UPBASE,    0xffff4010,__READ_WRITE,__LCD_UPBASE_bits);
__IO_REG32_BIT(CLCDC_LPBASE,    0xffff4014,__READ_WRITE,__LCD_LPBASE_bits);
__IO_REG32_BIT(CLCDC_INTRENABLE,0xffff4018,__READ_WRITE,__LCD_INTRENABLE_bits);
__IO_REG32_BIT(CLCDC_Ctrl,      0xffff401c,__READ_WRITE,__CLCDC_Ctrl_bits);
__IO_REG32_BIT(CLCDC_Status,    0xffff4020,__READ_WRITE,__LCD_Status_bits);
__IO_REG32_BIT(CLCDC_Interrupt, 0xffff4024,__READ_WRITE,__CLCDC_Interrupt_bits);
__IO_REG32(CLCDC_UPCURR,        0xffff4028,__READ_WRITE);
__IO_REG32(CLCDC_LPCURR,        0xffff402c,__READ_WRITE);
__IO_REG32(CLCDC_Palette,       0xFFFF4200,__READ_WRITE);

__IO_REG32_BIT(HRTFTC_Setup,  0xfffe4000,__READ_WRITE,__HRTFTC_Setup_bits);
__IO_REG32_BIT(HRTFTC_CTRL,   0xfffe4004,__READ_WRITE,__HRTFTC_CTRL_bits);
__IO_REG32_BIT(HRTFTC_Timing1,0xfffe4008,__READ_WRITE,__HRTFTC_Timing1_bits);
__IO_REG32_BIT(HRTFTC_Timing2,0xfffe400c,__READ_WRITE,__HRTFTC_Timing2_bits);
...
#define VIC_TIMER0       4  /* Timer 0                                     */
#define VIC_TIMER1       5  /* Timer 1                                     */
#define VIC_TIMER2       6  /* Timer 2                                     */
#define VIC_EXT_INT0     7  /* External Interrupt 0                        */
#define VIC_EXT_INT1     8  /* External Interrupt 1                        */
#define VIC_EXT_INT2     9  /* External Interrupt 2                        */
#define VIC_EXT_INT3    10  /* External Interrupt 3                        */
#define VIC_EXT_INT4    11  /* External Interrupt 4                        */
#define VIC_EXT_INT5    12  /* External Interrupt 5                        */
#define VIC_EXT_INT6    13  /* External Interrupt 6                        */
#define VIC_RTC         15  /* Real Time Clock                             */
#define VIC_ADC_TSCIRQ  16  /* Analog-to-Digital Converter                 */
#define VIC_ADC_BOD     17  /* Brown Out Detector                          */
#define VIC_ADC_PENIRQ  18  /* Analog-to-Digital Converter                 */
#define VIC_LCD         19  /* LCD Controller                              */
#define VIC_SSPTXINTR   20  /* Synchronous Serial Port                     */
#define VIC_SSPRXINTR   21  /* Synchronous Serial Port                     */
#define VIC_SSPRORINTR  22  /* Synchronous Serial Port                     */
#define VIC_SSPRXTOINTR 23  /* Synchronous Serial Port                     */
#define VIC_SSPINTR     24  /* Synchronous Serial Port                     */
#define VIC_UART0RX     25  /* UART channel 0  Rx                          */
#define VIC_UART0TX     26  /* UART channel 0  Tx                          */
#define VIC_UART1RX     27  /* UART channel 1  Rx                          */
#define VIC_UART1TX     28  /* UART channel 1  Tx                          */
#define VIC_UART2       29  /* UART channel 2                              */
#define VIC_DMA         30  /* DMA                                         */
#define VIC_CAN         31  /* CAN                                         */
 ...
 **
 ***************************************************************************/
#define DMA_UART1_RX     0  /* UART1 RX                                    */
#define DMA_UART1_TX     1  /* UART1 TX                                    */
#define DMA_UART0_RX     2  /* UART0 RX                                    */
#define DMA_UART0_TX     3  /* UART0 TX                                    */
