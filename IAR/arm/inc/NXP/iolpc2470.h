...
__IO_REG32_BIT(EMCDINAMICCTRL,        0xFFE08020,__READ_WRITE ,__emc_dctrl_bits);
__IO_REG32_BIT(EMCDINAMICRFR,         0xFFE08024,__READ_WRITE ,__emc_drfr_bits);
__IO_REG32_BIT(EMCDINAMICRDCFG,       0xFFE08028,__READ_WRITE ,__emc_drdcfg_bits);
__IO_REG32_BIT(EMCDYNAMICRP,          0xFFE08030,__READ_WRITE ,__emc_drp_bits);
__IO_REG32_BIT(EMCDYNAMICRAS,         0xFFE08034,__READ_WRITE ,__emc_dras_bits);
__IO_REG32_BIT(EMCDYNAMICSREX,        0xFFE08038,__READ_WRITE ,__emc_dsrex_bits);
__IO_REG32_BIT(EMCDYNAMICAPR,         0xFFE0803C,__READ_WRITE ,__emc_dapr_bits);
__IO_REG32_BIT(EMCDYNAMICDAL,         0xFFE08040,__READ_WRITE ,__emc_ddal_bits);
__IO_REG32_BIT(EMCDYNAMICWR,          0xFFE08044,__READ_WRITE ,__emc_dwr_bits);
__IO_REG32_BIT(EMCDYNAMICRC,          0xFFE08048,__READ_WRITE ,__emc_drc_bits);
__IO_REG32_BIT(EMCDYNAMICRFC,         0xFFE0804C,__READ_WRITE ,__emc_drfc_bits);
__IO_REG32_BIT(EMCDYNAMICXSR,         0xFFE08050,__READ_WRITE ,__emc_dxsr_bits);
__IO_REG32_BIT(EMCDYNAMICRRD,         0xFFE08054,__READ_WRITE ,__emc_drrd_bits);
__IO_REG32_BIT(EMCDYNAMICMRD,         0xFFE08058,__READ_WRITE ,__emc_dmrd_bits);
__IO_REG32_BIT(EMCSTATICEXTENDEDWAIT, 0xFFE08080,__READ_WRITE ,__emc_s_ext_wait_bits);
__IO_REG32_BIT(EMCDYNAMICCFG0,        0xFFE08100,__READ_WRITE ,__emc_d_config_bits);
__IO_REG32_BIT(EMCDYNAMICRASCAS0,     0xFFE08104,__READ_WRITE ,__emc_d_ras_cas_bits);
__IO_REG32_BIT(EMCDYNAMICCFG1,        0xFFE08120,__READ_WRITE ,__emc_d_config_bits);
__IO_REG32_BIT(EMCDYNAMICRASCAS1,     0xFFE08124,__READ_WRITE ,__emc_d_ras_cas_bits);
__IO_REG32_BIT(EMCDYNAMICCFG2,        0xFFE08140,__READ_WRITE ,__emc_d_config_bits);
__IO_REG32_BIT(EMCDYNAMICRASCAS2,     0xFFE08144,__READ_WRITE ,__emc_d_ras_cas_bits);
__IO_REG32_BIT(EMCDYNAMICCFG3,        0xFFE08160,__READ_WRITE ,__emc_d_config_bits);
__IO_REG32_BIT(EMCDYNAMICRASCAS3,     0xFFE08164,__READ_WRITE ,__emc_d_ras_cas_bits);
...
__IO_REG32_BIT(EMCSTATICCNFG2,        0xFFE08240,__READ_WRITE ,__emc_s_config_bits);
__IO_REG32_BIT(EMCSTATICWAITWEN2,     0xFFE08244,__READ_WRITE ,__emc_s_wait_wen_bits);
__IO_REG32_BIT(EMCSTATICWAITOEN2,     0xFFE08248,__READ_WRITE ,__emc_s_wait_oen_bits);
__IO_REG32_BIT(EMCSTATICWAITRD2,      0xFFE0824C,__READ_WRITE ,__emc_s_wait_rd_bits);
__IO_REG32_BIT(EMCSTATICWAITPG2,      0xFFE08250,__READ_WRITE ,__emc_s_wait_pg_bits);
__IO_REG32_BIT(EMCSTATICWAITWR2,      0xFFE08254,__READ_WRITE ,__emc_s_wait_wr_bits);
__IO_REG32_BIT(EMCSTATICWAITTURN2,    0xFFE08258,__READ_WRITE ,__emc_s_wait_turn_bits);
__IO_REG32_BIT(EMCSTATICCNFG3,        0xFFE08260,__READ_WRITE ,__emc_s_config_bits);
__IO_REG32_BIT(EMCSTATICWAITWEN3,     0xFFE08264,__READ_WRITE ,__emc_s_wait_wen_bits);
__IO_REG32_BIT(EMCSTATICWAITOEN3,     0xFFE08268,__READ_WRITE ,__emc_s_wait_oen_bits);
__IO_REG32_BIT(EMCSTATICWAITRD3,      0xFFE0826C,__READ_WRITE ,__emc_s_wait_rd_bits);
__IO_REG32_BIT(EMCSTATICWAITPG3,      0xFFE08270,__READ_WRITE ,__emc_s_wait_pg_bits);
__IO_REG32_BIT(EMCSTATICWAITWR3,      0xFFE08274,__READ_WRITE ,__emc_s_wait_wr_bits);
__IO_REG32_BIT(EMCSTATICWAITTURN3,    0xFFE08278,__READ_WRITE ,__emc_s_wait_turn_bits);
...
__IO_REG32_BIT(PINSEL11,              0xE002C02C,__READ_WRITE ,__pinsel11_bits);
...
__IO_REG32_BIT(IO2INTENR,             0xE00280B0,__READ_WRITE ,__gpio2_bits);
__IO_REG32_BIT(IO2INTENF,             0xE00280B4,__READ_WRITE ,__gpio2_bits);
__IO_REG32_BIT(IO2INTSTATR,           0xE00280A4,__READ       ,__gpio2_bits);
__IO_REG32_BIT(IO2INTSTATF,           0xE00280A8,__READ       ,__gpio2_bits);
__IO_REG32_BIT(IO2INTCLR,             0xE00280AC,__WRITE      ,__gpio2_bits);
...
__IO_REG32_BIT(CRSR_INTSTAT,          0xFFE10C2C,__READ       ,__crsr_intstat_bits);
...
__IO_REG32_BIT(LUTERR,                0xE003C01C,__READ       ,__luterr_bits);
...
__IO_REG32_BIT(USBCLKST,              0xFFE0CFF8,__READ       ,__usbclkst_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(HCREVISION,            0xFFE0C000,__READ       ,__hcrevision_bits);
__IO_REG32_BIT(HCCONTROL,             0xFFE0C004,__READ_WRITE ,__hccontrol_bits);
__IO_REG32_BIT(HCCOMMANDSTATUS,       0xFFE0C008,__READ_WRITE ,__hccommandstatus_bits);
__IO_REG32_BIT(HCINTERRUPTSTATUS,     0xFFE0C00C,__READ_WRITE ,__hcinterruptstatus_bits);
__IO_REG32_BIT(HCINTERRUPTENABLE,     0xFFE0C010,__READ_WRITE ,__hcinterruptenable_bits);
__IO_REG32_BIT(HCINTERRUPTDISABLE,    0xFFE0C014,__READ_WRITE ,__hcinterruptenable_bits);
__IO_REG32_BIT(HCHCCA,                0xFFE0C018,__READ_WRITE ,__hchcca_bits);
__IO_REG32_BIT(HCPERIODCURRENTED,     0xFFE0C01C,__READ       ,__hcperiodcurrented_bits);
__IO_REG32_BIT(HCCONTROLHEADED,       0xFFE0C020,__READ_WRITE ,__hccontrolheaded_bits);
__IO_REG32_BIT(HCCONTROLCURRENTED,    0xFFE0C024,__READ_WRITE ,__hccontrolcurrented_bits);
__IO_REG32_BIT(HCBULKHEADED,          0xFFE0C028,__READ_WRITE ,__hcbulkheaded_bits);
__IO_REG32_BIT(HCBULKCURRENTED,       0xFFE0C02C,__READ_WRITE ,__hcbulkcurrented_bits);
__IO_REG32_BIT(HCDONEHEAD,            0xFFE0C030,__READ       ,__hcdonehead_bits);
__IO_REG32_BIT(HCFMINTERVAL,          0xFFE0C034,__READ_WRITE ,__hcfminterval_bits);
__IO_REG32_BIT(HCFMREMAINING,         0xFFE0C038,__READ       ,__hcfmremaining_bits);
__IO_REG32_BIT(HCFMNUMBER,            0xFFE0C03C,__READ       ,__hcfmnumber_bits);
__IO_REG32_BIT(HCPERIODICSTART,       0xFFE0C040,__READ_WRITE ,__hcperiodicstart_bits);
__IO_REG32_BIT(HCLSTHRESHOLD,         0xFFE0C044,__READ_WRITE ,__hclsthreshold_bits);
__IO_REG32_BIT(HCRHDESCRIPTORA,       0xFFE0C048,__READ_WRITE ,__hcrhdescriptora_bits);
__IO_REG32_BIT(HCRHDESCRIPTORB,       0xFFE0C04C,__READ_WRITE ,__hcrhdescriptorb_bits);
__IO_REG32_BIT(HCRHSTATUS,            0xFFE0C050,__READ_WRITE ,__hcrhstatus_bits);
__IO_REG32_BIT(HCRHPORTSTATUS1,       0xFFE0C054,__READ_WRITE ,__hcrhportstatus_bits);
__IO_REG32_BIT(HCRHPORTSTATUS2,       0xFFE0C058,__READ_WRITE ,__hcrhportstatus_bits);
__IO_REG32(    HCRMID,                0xFFE0C0FC,__READ);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(OTGINTST,              0xFFE0C100,__READ       ,__otgintst_bits);
__IO_REG32_BIT(OTGINTEN,              0xFFE0C104,__READ_WRITE ,__otgintst_bits);
__IO_REG32_BIT(OTGINTSET,             0xFFE0C108,__WRITE      ,__otgintst_bits);
__IO_REG32_BIT(OTGINTCLR,             0xFFE0C10C,__WRITE      ,__otgintst_bits);
#define OTGSTCTRL     USBPORTSEL
#define OTGSTCTRL_bit USBPORTSEL_bit
__IO_REG32_BIT(OTGTMR,                0xFFE0C114,__READ_WRITE ,__otgtmr_bits);
__IO_REG32_BIT(I2C_RX,                0xFFE0C300,__READ_WRITE ,__otg_i2c_rx_tx_bits);
#define I2C_TX      I2C_RX
#define I2C_TX_bit  I2C_RX_bit
__IO_REG32_BIT(I2C_STS,               0xFFE0C304,__READ_WRITE ,__otg_i2c_sts_bits);
__IO_REG32_BIT(I2C_CTL,               0xFFE0C308,__READ_WRITE ,__otg_i2c_ctl_bits);
__IO_REG32_BIT(I2C_CLKHI,             0xFFE0C30C,__READ_WRITE ,__i2c_clkhi_bits);
__IO_REG32_BIT(I2C_CLKLO,             0xFFE0C310,__READ_WRITE ,__i2c_clklo_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(PWM0IR,                0xE0014000,__READ_WRITE ,__pwmir_bits);
__IO_REG32_BIT(PWM0TCR,               0xE0014004,__READ_WRITE ,__pwmtcr0_bits);
...
__IO_REG32_BIT(PWM0MCR,               0xE0014014,__READ_WRITE ,__pwmmcr_bits);
...
__IO_REG32_BIT(PWM0CCR,               0xE0014028,__READ_WRITE ,__pwmccr_bits);
...
__IO_REG32_BIT(PWM0PCR,               0xE001404C,__READ_WRITE ,__pwmpcr_bits);
__IO_REG32_BIT(PWM0LER,               0xE0014050,__READ_WRITE ,__pwmler_bits);
__IO_REG32_BIT(PWM0CTCR,              0xE0014070,__READ_WRITE ,__pwmctcr_bits);
...
__IO_REG32_BIT(DMACC1CONFIGURATION,   0xFFE04130,__READ_WRITE,__dma_cfg_bits);
