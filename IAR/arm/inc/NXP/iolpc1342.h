...
#ifndef __IOLPC1342_H
#define __IOLPC1342_H
 ...
 ***************************************************************************
 **
 **    LPC1342 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
__IO_REG32_BIT(USBPLLCLKUEN,          0x4004804C,__READ_WRITE ,__clkuen_bits);
...
__IO_REG32_BIT(USBCLKUEN,             0x400480C4,__READ_WRITE ,__clkuen_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(USBDevIntSt,           0x40020000,__READ       ,__usbdevintst_bits);
__IO_REG32_BIT(USBDevIntEn,           0x40020004,__READ_WRITE ,__usbdevintst_bits);
__IO_REG32_BIT(USBDevIntClr,          0x40020008,__WRITE      ,__usbdevintst_bits);
__IO_REG32_BIT(USBDevIntSet,          0x4002000C,__WRITE      ,__usbdevintst_bits);
__IO_REG32_BIT(USBDevFIQSel,          0x4002002C,__WRITE      ,__usbdevfiqsel_bits);
__IO_REG32(    USBRxData,             0x40020018,__READ       );
__IO_REG32(    USBTxData,             0x4002001C,__WRITE      );
__IO_REG32_BIT(USBRxPLen,             0x40020020,__READ       ,__usbrxplen_bits);
__IO_REG32_BIT(USBTxPLen,             0x40020024,__WRITE      ,__usbtxplen_bits);
__IO_REG32_BIT(USBCtrl,               0x40020028,__READ_WRITE ,__usbctrl_bits);
__IO_REG32_BIT(USBCmdCode,            0x40020010,__WRITE      ,__usbcmdcode_bits);
__IO_REG32_BIT(USBCmdData,            0x40020014,__READ       ,__usbcmddata_bits);
...
#define NVIC_USB_IRQ          63  /* USB IRQ interrupt                                      */
#define NVIC_USB_FIQ          64  /* USB FIQ interrupt                                      */
...
Interrupt56  = USB_IRQ        0xFC
Interrupt57  = USB_FIQ        0x100
Interrupt58  = ADC            0x104
Interrupt59  = WDT            0x108
Interrupt60  = BOD            0x10C
Interrupt61  = PIO_3          0x114
Interrupt62  = PIO_2          0x118
Interrupt63  = PIO_1          0x11C
Interrupt64  = PIO_0          0x120
###DDF-INTERRUPT-END###*/
