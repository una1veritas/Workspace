...
OBJS += \
./libraries/Adafruit_PCD8544_Nokia_LCD/Adafruit_PCD8544.o 

CPP_DEPS += \
./libraries/Adafruit_PCD8544_Nokia_LCD/Adafruit_PCD8544.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/Adafruit_PCD8544_Nokia_LCD/Adafruit_PCD8544.o: /Users/sin/Documents/Arduino/libraries/Adafruit_PCD8544_Nokia_LCD/Adafruit_PCD8544.cpp
	@echo 'Building file: $<'
