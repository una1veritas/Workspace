 ...
 **    Texas Instruments TMS470R1B768
 **
 **    Used with ARM IAR C/C++ Compiler and Assembler.
 **
 **    (c) Copyright IAR Systems and Texas Instruments 2006
 **
 **    $Revision: 46075 $
 **
***************************************************************************/

#ifndef __IOTMS470R1B768_H
#define __IOTMS470R1B768_H
 ...
 ***************************************************************************
 **
 **    TMS470R1B768 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
***************************************************************************/
...
/* SMC - GCR_N Global Control Register */
typedef struct {
  __REG32                 :18;
  __REG32 FMENA           :1;
  __REG32 DMOD            :6;
...
__IO_REG32_BIT(GCR_N,    0xffffffcc,__READ_WRITE,__gcr_n_bits);
...
__IO_REG32_BIT(SPI3CTRL1,0xfff7d500,__READ_WRITE,__spictrl1_bits);
__IO_REG32_BIT(SPI3CTRL2,0xfff7d504,__READ_WRITE,__spictrl2_bits);
__IO_REG32_BIT(SPI3CTRL3,0xfff7d508,__READ_WRITE,__spictrl3_bits);
__IO_REG32_BIT(SPI3DAT0, 0xfff7d50c,__READ_WRITE,__spidat0_bits);
__IO_REG32_BIT(SPI3DAT1, 0xfff7d510,__READ_WRITE,__spidat1_bits);
__IO_REG32_BIT(SPI3BUF,  0xfff7d514,__READ_WRITE,__spibuf_bits);
__IO_REG32_BIT(SPI3EMU,  0xfff7d518,__READ_WRITE,__spiemu_bits);
__IO_REG32_BIT(SPI3PC1,  0xfff7d51c,__READ_WRITE,__spipc1_bits);
__IO_REG32_BIT(SPI3PC2,  0xfff7d520,__READ_WRITE,__spipc2_bits);
__IO_REG32_BIT(SPI3PC3,  0xfff7d524,__READ_WRITE,__spipc3_bits);
__IO_REG32_BIT(SPI3PC4,  0xfff7d528,__READ_WRITE,__spipc4_bits);
__IO_REG32_BIT(SPI3PC5,  0xfff7d52c,__READ_WRITE,__spipc5_bits);
__IO_REG32_BIT(SPI3PC6,  0xfff7d530,__READ_WRITE,__spipc6_bits);
...
__IO_REG32_BIT(SPI4CTRL1,0xfff7d600,__READ_WRITE,__spictrl1_bits);
__IO_REG32_BIT(SPI4CTRL2,0xfff7d604,__READ_WRITE,__spictrl2_bits);
__IO_REG32_BIT(SPI4CTRL3,0xfff7d608,__READ_WRITE,__spictrl3_bits);
__IO_REG32_BIT(SPI4DAT0, 0xfff7d60c,__READ_WRITE,__spidat0_bits);
__IO_REG32_BIT(SPI4DAT1, 0xfff7d610,__READ_WRITE,__spidat1_bits);
__IO_REG32_BIT(SPI4BUF,  0xfff7d614,__READ_WRITE,__spibuf_bits);
__IO_REG32_BIT(SPI4EMU,  0xfff7d618,__READ_WRITE,__spiemu_bits);
__IO_REG32_BIT(SPI4PC1,  0xfff7d61c,__READ_WRITE,__spipc1_bits);
__IO_REG32_BIT(SPI4PC2,  0xfff7d620,__READ_WRITE,__spipc2_bits);
__IO_REG32_BIT(SPI4PC3,  0xfff7d624,__READ_WRITE,__spipc3_bits);
__IO_REG32_BIT(SPI4PC4,  0xfff7d628,__READ_WRITE,__spipc4_bits);
__IO_REG32_BIT(SPI4PC5,  0xfff7d62c,__READ_WRITE,__spipc5_bits);
__IO_REG32_BIT(SPI4PC6,  0xfff7d630,__READ_WRITE,__spipc6_bits);
...
__IO_REG32_BIT(SPI5CTRL1,0xfff7d700,__READ_WRITE,__spictrl1_bits);
__IO_REG32_BIT(SPI5CTRL2,0xfff7d704,__READ_WRITE,__spictrl2_bits);
__IO_REG32_BIT(SPI5CTRL3,0xfff7d708,__READ_WRITE,__spictrl3_bits);
__IO_REG32_BIT(SPI5DAT0, 0xfff7d70c,__READ_WRITE,__spidat0_bits);
__IO_REG32_BIT(SPI5DAT1, 0xfff7d710,__READ_WRITE,__spidat1_bits);
__IO_REG32_BIT(SPI5BUF,  0xfff7d714,__READ_WRITE,__spibuf_bits);
__IO_REG32_BIT(SPI5EMU,  0xfff7d718,__READ_WRITE,__spiemu_bits);
__IO_REG32_BIT(SPI5PC1,  0xfff7d71c,__READ_WRITE,__spipc1_bits);
__IO_REG32_BIT(SPI5PC2,  0xfff7d720,__READ_WRITE,__spipc2_bits);
__IO_REG32_BIT(SPI5PC3,  0xfff7d724,__READ_WRITE,__spipc3_bits);
__IO_REG32_BIT(SPI5PC4,  0xfff7d728,__READ_WRITE,__spipc4_bits);
__IO_REG32_BIT(SPI5PC5,  0xfff7d72c,__READ_WRITE,__spipc5_bits);
__IO_REG32_BIT(SPI5PC6,  0xfff7d730,__READ_WRITE,__spipc6_bits);
 ...
 ***************************************************************************/
/*Control Packet 00*/
__IO_REG32(    DWCTRL,  0xFFFFFF60,__READ_WRITE);
__IO_REG32_BIT(DWPRLD,  0xFFFFFF64,__READ_WRITE,__dwprld_bits);
__IO_REG32(    DWKEY,   0xFFFFFF68,__READ_WRITE);
__IO_REG32_BIT(DWCNT,   0xFFFFFF6C,__READ_WRITE,__dwcnt_bits);
