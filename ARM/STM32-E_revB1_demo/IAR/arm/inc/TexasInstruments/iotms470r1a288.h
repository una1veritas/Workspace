...
__IO_REG32(    SCC1CANLAM0, 0xfff7e080,__READ_WRITE);
...
__IO_REG32(    SCC2CANLAM0, 0xfff7e280,__READ_WRITE);
__IO_REG32(    SCC2CANLAM3, 0xfff7e28c,__READ_WRITE);
 ...
 **
 ***************************************************************************/
__IO_REG8_BIT(C2SIBISR,   0xfff7c803,__READ      ,__c2sibisr_bits);
__IO_REG8_BIT(C2SIBICR,   0xfff7c807,__READ_WRITE,__c2sibicr_bits);
__IO_REG8_BIT(C2SIBGSR,   0xfff7c80b,__READ      ,__c2sibgsr_bits);
__IO_REG8_BIT(C2SIBGCR,   0xfff7c80f,__READ_WRITE,__c2sibgcr_bits);
__IO_REG8(    C2SIBTDB,   0xfff7c813,__READ_WRITE);
__IO_REG8_BIT(C2SIBCCSR,  0xfff7c817,__READ      ,__c2sibccsr_bits);
...
__IO_REG8_BIT(C2SIBBRK,   0xfff7c83f,__READ      ,__c2sibbrk_bits);
...
#define IEM_HECCA      38  /* HECC1 interrupt B                  */
#define IEM_HECCB      39  /* HECC1 interrupt B                  */
/*#define IEM_RES       40     SCI2 receive interrupt               */
/*#define IEM_RES       41     SCI1 transmit interrupt              */
/*#define IEM_RES           42     I2C4 interrupt                        */
/*#define IEM_RES           43     I2C5 interrupt                         */
