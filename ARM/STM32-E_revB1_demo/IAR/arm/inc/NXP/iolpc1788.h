...
#ifndef __IOLPC1788_H
#define __IOLPC1788_H
 ...
 ***************************************************************************
 **
 **    LPC1788 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(MAC1,                  0x20084000,__READ_WRITE ,__mac1_bits);
__IO_REG32_BIT(MAC2,                  0x20084004,__READ_WRITE ,__mac2_bits);
__IO_REG32_BIT(IPGT,                  0x20084008,__READ_WRITE ,__ipgt_bits);
__IO_REG32_BIT(IPGR,                  0x2008400C,__READ_WRITE ,__ipgr_bits);
__IO_REG32_BIT(CLRT,                  0x20084010,__READ_WRITE ,__clrt_bits);
__IO_REG32_BIT(MAXF,                  0x20084014,__READ_WRITE ,__maxf_bits);
__IO_REG32_BIT(SUPP,                  0x20084018,__READ_WRITE ,__supp_bits);
__IO_REG32_BIT(TEST,                  0x2008401C,__READ_WRITE ,__test_bits);
__IO_REG32_BIT(MCFG,                  0x20084020,__READ_WRITE ,__mcfg_bits);
__IO_REG32_BIT(MCMD,                  0x20084024,__READ_WRITE ,__mcmd_bits);
__IO_REG32_BIT(MADR,                  0x20084028,__READ_WRITE ,__madr_bits);
__IO_REG32_BIT(MWTD,                  0x2008402C,__WRITE      ,__mwtd_bits);
__IO_REG32_BIT(MRDD,                  0x20084030,__READ       ,__mrdd_bits);
__IO_REG32_BIT(MIND,                  0x20084034,__READ       ,__mind_bits);
__IO_REG32_BIT(SA0,                   0x20084040,__READ_WRITE ,__sa0_bits);
__IO_REG32_BIT(SA1,                   0x20084044,__READ_WRITE ,__sa1_bits);
__IO_REG32_BIT(SA2,                   0x20084048,__READ_WRITE ,__sa2_bits);
__IO_REG32_BIT(Command,               0x20084100,__READ_WRITE ,__command_bits);
__IO_REG32_BIT(Status,                0x20084104,__READ       ,__status_bits);
__IO_REG32(    RxDescriptor,          0x20084108,__READ_WRITE );
__IO_REG32(    RxStatus,              0x2008410C,__READ_WRITE );
__IO_REG32_BIT(RxDescriptorNumber,    0x20084110,__READ_WRITE ,__rxdescrn_bits);
__IO_REG32_BIT(RxProduceIndex,        0x20084114,__READ       ,__rxprodind_bits);
__IO_REG32_BIT(RxConsumeIndex,        0x20084118,__READ_WRITE ,__rxcomind_bits);
__IO_REG32(    TxDescriptor,          0x2008411C,__READ_WRITE );
__IO_REG32(    TxStatus,              0x20084120,__READ_WRITE );
__IO_REG32_BIT(TxDescriptorNumber,    0x20084124,__READ_WRITE ,__txdescrn_bits);
__IO_REG32_BIT(TxProduceIndex,        0x20084128,__READ_WRITE ,__txprodind_bits);
__IO_REG32_BIT(TxConsumeIndex,        0x2008412C,__READ       ,__txcomind_bits);
__IO_REG32_BIT(TSV0,                  0x20084158,__READ       ,__tsv0_bits);
__IO_REG32_BIT(TSV1,                  0x2008415C,__READ       ,__tsv1_bits);
__IO_REG32_BIT(RSV,                   0x20084160,__READ       ,__rsv_bits);
__IO_REG32_BIT(FlowControlCounter,    0x20084170,__READ_WRITE ,__fwctrlcnt_bits);
__IO_REG32_BIT(FlowControlStatus,     0x20084174,__READ       ,__fwctrlstat_bits);
__IO_REG32_BIT(RxFilterCtrl,          0x20084200,__READ_WRITE ,__rxflctrl_bits);
__IO_REG32_BIT(RxFilterWoLStatus,     0x20084204,__READ_WRITE ,__rxflwolstat_bits);
__IO_REG32_BIT(RxFilterWoLClear,      0x20084208,__READ_WRITE ,__rxflwolclr_bits);
__IO_REG32(    HashFilterL,           0x20084210,__READ_WRITE );
__IO_REG32(    HashFilterH,           0x20084214,__READ_WRITE );
__IO_REG32_BIT(IntStatus,             0x20084FE0,__READ       ,__intstat_bits);
__IO_REG32_BIT(IntEnable,             0x20084FE4,__READ_WRITE ,__intena_bits);
__IO_REG32_BIT(IntClear,              0x20084FE8,__WRITE      ,__intclr_bits);
__IO_REG32_BIT(IntSet,                0x20084FEC,__WRITE      ,__intset_bits);
__IO_REG32_BIT(PowerDown,             0x20084FF4,__READ_WRITE ,__pwrdn_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(LCD_CFG,               0x400FC1B8,__READ_WRITE ,__lcd_cfg_bits);
__IO_REG32_BIT(LCD_TIMH,              0x20088000,__READ_WRITE ,__lcd_timh_bits);
__IO_REG32_BIT(LCD_TIMV,              0x20088004,__READ_WRITE ,__lcd_timv_bits);
__IO_REG32_BIT(LCD_POL,               0x20088008,__READ_WRITE ,__lcd_pol_bits);
__IO_REG32_BIT(LCD_LE,                0x2008800C,__READ_WRITE ,__lcd_le_bits);
__IO_REG32(    LCD_UPBASE,            0x20088010,__READ_WRITE );
__IO_REG32(    LCD_LPBASE,            0x20088014,__READ_WRITE );
__IO_REG32_BIT(LCD_CTRL,              0x20088018,__READ_WRITE ,__lcd_ctrl_bits);
__IO_REG32_BIT(LCD_INTMSK,            0x2008801C,__READ_WRITE ,__lcd_intmsk_bits);
__IO_REG32_BIT(LCD_INTRAW,            0x20088020,__READ       ,__lcd_intraw_bits);
__IO_REG32_BIT(LCD_INTSTAT,           0x20088024,__READ       ,__lcd_intstat_bits);
__IO_REG32_BIT(LCD_INTCLR,            0x20088028,__WRITE      ,__lcd_intclr_bits);
__IO_REG32(    LCD_UPCURR,            0x2008802C,__READ       );
__IO_REG32(    LCD_LPCURR,            0x20088030,__READ       );
__IO_REG32(    LCD_PAL_BASE,          0x20088200,__READ_WRITE );
__IO_REG32(    CRSR_IMG_BASE,         0x20088800,__READ_WRITE );
__IO_REG32_BIT(CRSR_CTRL,             0x20088C00,__READ_WRITE ,__crsr_ctrl_bits);
__IO_REG32_BIT(CRSR_CFG,              0x20088C04,__READ_WRITE ,__crsr_cfg_bits);
__IO_REG32_BIT(CRSR_PAL0,             0x20088C08,__READ_WRITE ,__crsr_pal0_bits);
__IO_REG32_BIT(CRSR_PAL1,             0x20088C0C,__READ_WRITE ,__crsr_pal1_bits);
__IO_REG32_BIT(CRSR_XY,               0x20088C10,__READ_WRITE ,__crsr_xy_bits);
__IO_REG32_BIT(CRSR_CLIP,             0x20088C14,__READ_WRITE ,__crsr_clip_bits);
__IO_REG32_BIT(CRSR_INTMSK,           0x20088C20,__READ_WRITE ,__crsr_intmsk_bits);
__IO_REG32_BIT(CRSR_INTCLR,           0x20088C24,__WRITE      ,__crsr_intclr_bits);
__IO_REG32_BIT(CRSR_INTRAW,           0x20088C28,__READ       ,__crsr_intraw_bits);
__IO_REG32_BIT(CRSR_INTSTAT,          0x20088C2C,__READ       ,__crsr_intstat_bits);
...
#define NVIC_LCDC             53  /* LCD controller                                         */
...
Interrupt36  = ETHR           0xB0
Interrupt37  = SD             0xB4
Interrupt38  = MC             0xB8
Interrupt39  = QE             0xBC
Interrupt40  = PLL1           0xC0
Interrupt41  = USB_ACT        0xC4
Interrupt42  = CAN_ACT        0xC8
Interrupt43  = UART4          0xCC
Interrupt44  = SSP2           0xD0
Interrupt45  = LCDC           0xD4
Interrupt46  = GPIO           0xD8
Interrupt47  = PWM0           0xDC
Interrupt48  = EEPROM         0xE0
