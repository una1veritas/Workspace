...
#ifndef __IOLPC2939_H
#define __IOLPC2939_H
 ...
 ***************************************************************************
 **
 **    LPC2939 SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* UART RS-485 Delay value register */
typedef struct{
  __REG32 DLY             : 8;
  __REG32                 :24;
} __uartrs485dly_bits;
...
/***************************************************************************
 **
 ** SMC (SRAM Memory Controller)
 **
 ***************************************************************************/
__IO_REG32_BIT(SMBIDCYR0,             0x60000000,__READ_WRITE ,__smbidcyrx_bits  );
__IO_REG32_BIT(SMBWST1R0,             0x60000004,__READ_WRITE ,__smbwst1rx_bits  );
__IO_REG32_BIT(SMBWST2R0,             0x60000008,__READ_WRITE ,__smbwst2rx_bits  );
__IO_REG32_BIT(SMBWSTOENR0,           0x6000000C,__READ_WRITE ,__smbwstoenrx_bits);
__IO_REG32_BIT(SMBWSTWENR0,           0x60000010,__READ_WRITE ,__smbwstwenrx_bits);
__IO_REG32_BIT(SMBCR0,                0x60000014,__READ_WRITE ,__smbcrx_bits     );
__IO_REG32_BIT(SMBSR0,                0x60000018,__READ_WRITE ,__smbsrx_bits     );
__IO_REG32_BIT(SMBIDCYR1,             0x6000001C,__READ_WRITE ,__smbidcyrx_bits  );
__IO_REG32_BIT(SMBWST1R1,             0x60000020,__READ_WRITE ,__smbwst1rx_bits  );
__IO_REG32_BIT(SMBWST2R1,             0x60000024,__READ_WRITE ,__smbwst2rx_bits  );
__IO_REG32_BIT(SMBWSTOENR1,           0x60000028,__READ_WRITE ,__smbwstoenrx_bits);
__IO_REG32_BIT(SMBWSTWENR1,           0x6000002C,__READ_WRITE ,__smbwstwenrx_bits);
__IO_REG32_BIT(SMBCR1,                0x60000030,__READ_WRITE ,__smbcrx_bits     );
__IO_REG32_BIT(SMBSR1,                0x60000034,__READ_WRITE ,__smbsrx_bits     );
__IO_REG32_BIT(SMBIDCYR2,             0x60000038,__READ_WRITE ,__smbidcyrx_bits  );
__IO_REG32_BIT(SMBWST1R2,             0x6000003C,__READ_WRITE ,__smbwst1rx_bits  );
__IO_REG32_BIT(SMBWST2R2,             0x60000040,__READ_WRITE ,__smbwst2rx_bits  );
__IO_REG32_BIT(SMBWSTOENR2,           0x60000044,__READ_WRITE ,__smbwstoenrx_bits);
__IO_REG32_BIT(SMBWSTWENR2,           0x60000048,__READ_WRITE ,__smbwstwenrx_bits);
__IO_REG32_BIT(SMBCR2,                0x6000004C,__READ_WRITE ,__smbcrx_bits     );
__IO_REG32_BIT(SMBSR2,                0x60000050,__READ_WRITE ,__smbsrx_bits     );
__IO_REG32_BIT(SMBIDCYR3,             0x60000054,__READ_WRITE ,__smbidcyrx_bits  );
__IO_REG32_BIT(SMBWST1R3,             0x60000058,__READ_WRITE ,__smbwst1rx_bits  );
__IO_REG32_BIT(SMBWST2R3,             0x6000005C,__READ_WRITE ,__smbwst2rx_bits  );
__IO_REG32_BIT(SMBWSTOENR3,           0x60000060,__READ_WRITE ,__smbwstoenrx_bits);
__IO_REG32_BIT(SMBWSTWENR3,           0x60000064,__READ_WRITE ,__smbwstwenrx_bits);
__IO_REG32_BIT(SMBCR3,                0x60000068,__READ_WRITE ,__smbcrx_bits     );
__IO_REG32_BIT(SMBSR3,                0x6000006C,__READ_WRITE ,__smbsrx_bits     );
__IO_REG32_BIT(SMBIDCYR4,             0x60000070,__READ_WRITE ,__smbidcyrx_bits  );
__IO_REG32_BIT(SMBWST1R4,             0x60000074,__READ_WRITE ,__smbwst1rx_bits  );
__IO_REG32_BIT(SMBWST2R4,             0x60000078,__READ_WRITE ,__smbwst2rx_bits  );
__IO_REG32_BIT(SMBWSTOENR4,           0x6000007C,__READ_WRITE ,__smbwstoenrx_bits);
__IO_REG32_BIT(SMBWSTWENR4,           0x60000080,__READ_WRITE ,__smbwstwenrx_bits);
__IO_REG32_BIT(SMBCR4,                0x60000084,__READ_WRITE ,__smbcrx_bits     );
__IO_REG32_BIT(SMBSR4,                0x60000088,__READ_WRITE ,__smbsrx_bits     );
__IO_REG32_BIT(SMBIDCYR5,             0x6000008C,__READ_WRITE ,__smbidcyrx_bits  );
__IO_REG32_BIT(SMBWST1R5,             0x60000090,__READ_WRITE ,__smbwst1rx_bits  );
__IO_REG32_BIT(SMBWST2R,              0x60000094,__READ_WRITE ,__smbwst2rx_bits  );
__IO_REG32_BIT(SMBWSTOENR5,           0x60000098,__READ_WRITE ,__smbwstoenrx_bits);
__IO_REG32_BIT(SMBWSTWENR5,           0x6000009C,__READ_WRITE ,__smbwstwenrx_bits);
__IO_REG32_BIT(SMBCR5,                0x600000A0,__READ_WRITE ,__smbcrx_bits     );
__IO_REG32_BIT(SMBSR5,                0x600000A4,__READ_WRITE ,__smbsrx_bits     );
__IO_REG32_BIT(SMBIDCYR6,             0x600000A8,__READ_WRITE ,__smbidcyrx_bits  );
__IO_REG32_BIT(SMBWST1R6,             0x600000AC,__READ_WRITE ,__smbwst1rx_bits  );
__IO_REG32_BIT(SMBWST2R6,             0x600000B0,__READ_WRITE ,__smbwst2rx_bits  );
__IO_REG32_BIT(SMBWSTOENR6,           0x600000B4,__READ_WRITE ,__smbwstoenrx_bits);
__IO_REG32_BIT(SMBWSTWENR6,           0x600000B8,__READ_WRITE ,__smbwstwenrx_bits);
__IO_REG32_BIT(SMBCR6,                0x600000BC,__READ_WRITE ,__smbcrx_bits     );
__IO_REG32_BIT(SMBSR6,                0x600000C0,__READ_WRITE ,__smbsrx_bits     );
__IO_REG32_BIT(SMBIDCYR7,             0x600000C4,__READ_WRITE ,__smbidcyrx_bits  );
__IO_REG32_BIT(SMBWST1R7,             0x600000C8,__READ_WRITE ,__smbwst1rx_bits  );
__IO_REG32_BIT(SMBWST2R7,             0x600000CC,__READ_WRITE ,__smbwst2rx_bits  );
__IO_REG32_BIT(SMBWSTOENR7,           0x600000D0,__READ_WRITE ,__smbwstoenrx_bits);
__IO_REG32_BIT(SMBWSTWENR7,           0x600000D4,__READ_WRITE ,__smbwstwenrx_bits);
__IO_REG32_BIT(SMBCR7,                0x600000D8,__READ_WRITE ,__smbcrx_bits     );
__IO_REG32_BIT(SMBSR7,                0x600000DC,__READ_WRITE ,__smbsrx_bits     );
...
__IO_REG32_BIT(SMC_RST_SRC,           0xFFFF9498,__READ_WRITE ,__warm_rst_src_bits      );
...
__IO_REG32_BIT(CLK_CFG_GPIO2,         0xFFFFA260,__READ_WRITE ,__CLK_CFG_xx_bits );
__IO_REG32_BIT(CLK_STAT_GPIO2,        0xFFFFA264,__READ       ,__CLK_STAT_xx_bits);
__IO_REG32_BIT(CLK_CFG_GPIO3,         0xFFFFA268,__READ_WRITE ,__CLK_CFG_xx_bits );
__IO_REG32_BIT(CLK_STAT_GPIO3,        0xFFFFA26C,__READ       ,__CLK_STAT_xx_bits);
...
__IO_REG32_BIT(CLK_CFG_GPIO4,         0xFFFFA280,__READ_WRITE ,__CLK_CFG_xx_bits );
__IO_REG32_BIT(CLK_STAT_GPIO4,        0xFFFFA284,__READ       ,__CLK_STAT_xx_bits);
...
__IO_REG32_BIT(CLK_CFG_ADC0_APB,      0xFFFFA538,__READ_WRITE ,__CLK_CFG_xx_bits );
__IO_REG32_BIT(CLK_STAT_ADC0_APB,     0xFFFFA53C,__READ       ,__CLK_STAT_xx_bits);
...
__IO_REG32_BIT(CLK_CFG_ADC0,          0xFFFFAA00,__READ_WRITE ,__CLK_CFG_xx_bits );
__IO_REG32_BIT(CLK_STAT_ADC0,         0xFFFFAA04,__READ       ,__CLK_STAT_xx_bits);
...
__IO_REG32_BIT(CLK_CFG_USB_I2C,       0xFFFFAC00,__READ_WRITE ,__CLK_CFG_xx_bits );
__IO_REG32_BIT(CLK_STAT_USB_I2C,      0xFFFFAC04,__READ       ,__CLK_STAT_xx_bits);
...
/***************************************************************************
 **
 ** SFSP2 (SCU Function Select Port 2)
 **
 ***************************************************************************/
__IO_REG32_BIT(SFSP2_0,               0xE0001200,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_1,               0xE0001204,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_2,               0xE0001208,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_3,               0xE000120C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_4,               0xE0001210,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_5,               0xE0001214,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_6,               0xE0001218,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_7,               0xE000121C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_8,               0xE0001220,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_9,               0xE0001224,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_10,              0xE0001228,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_11,              0xE000122C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_12,              0xE0001230,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_13,              0xE0001234,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_14,              0xE0001238,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_15,              0xE000123C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_16,              0xE0001240,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_17,              0xE0001244,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_18,              0xE0001248,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_19,              0xE000124C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_20,              0xE0001250,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_21,              0xE0001254,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_22,              0xE0001258,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_23,              0xE000125C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_24,              0xE0001260,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_25,              0xE0001264,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_26,              0xE0001268,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP2_27,              0xE000126C,__READ_WRITE ,__sfspx_y_bits);

/***************************************************************************
 **
 ** SFSP3 (SCU Function Select Port 3)
 **
 ***************************************************************************/
__IO_REG32_BIT(SFSP3_0,               0xE0001300,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_1,               0xE0001304,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_2,               0xE0001308,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_3,               0xE000130C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_4,               0xE0001310,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_5,               0xE0001314,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_6,               0xE0001318,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_7,               0xE000131C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_8,               0xE0001320,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_9,               0xE0001324,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_10,              0xE0001328,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_11,              0xE000132C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_12,              0xE0001330,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_13,              0xE0001334,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_14,              0xE0001338,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP3_15,              0xE000133C,__READ_WRITE ,__sfspx_y_bits);

/***************************************************************************
 **
 ** SFSP4 (SCU Function Select Port 4)
 **
 ***************************************************************************/
__IO_REG32_BIT(SFSP4_0,               0xE0001400,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_1,               0xE0001404,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_2,               0xE0001408,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_3,               0xE000140C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_4,               0xE0001410,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_5,               0xE0001414,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_6,               0xE0001418,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_7,               0xE000141C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_8,               0xE0001420,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_9,               0xE0001424,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_10,              0xE0001428,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_11,              0xE000142C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_12,              0xE0001430,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_13,              0xE0001434,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_14,              0xE0001438,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_15,              0xE000143C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_16,              0xE0001440,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_17,              0xE0001444,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_18,              0xE0001448,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_19,              0xE000144C,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_20,              0xE0001450,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_21,              0xE0001454,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_22,              0xE0001458,__READ_WRITE ,__sfspx_y_bits);
__IO_REG32_BIT(SFSP4_23,              0xE000145C,__READ_WRITE ,__sfspx_y_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(SFSP5_16,              0xE0001540,__READ_WRITE ,__sfsp5_16_bits);
...
__IO_REG32_BIT(U0MCR,              0xE0045010,__READ_WRITE ,__uartmcr_bits);
__IO_REG32_BIT(U0LSR,              0xE0045014,__READ       ,__uartlsr_bits);
__IO_REG32_BIT(U0MSR,              0xE0045018,__READ       ,__uartmsr_bits);
...
__IO_REG32_BIT(U0RS485DLY,         0xE0045054,__READ_WRITE ,__uartrs485dly_bits);
...
__IO_REG32_BIT(U1MCR,              0xE0046010,__READ_WRITE ,__uartmcr_bits);
__IO_REG32_BIT(U1LSR,              0xE0046014,__READ       ,__uartlsr_bits);
__IO_REG32_BIT(U1MSR,              0xE0046018,__READ       ,__uartmsr_bits);
...
__IO_REG32_BIT(U1RS485DLY,         0xE0046054,__READ_WRITE ,__uartrs485dly_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIO2_PINS,            0xE004C000,__READ       ,__gpio2_pins_bits);
__IO_REG32_BIT(GPIO2_OR,              0xE004C004,__READ_WRITE ,__gpio2_or_bits  );
__IO_REG32_BIT(GPIO2_DR,              0xE004C008,__READ_WRITE ,__gpio2_dr_bits  );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIO3_PINS,            0xE004D000,__READ       ,__gpio3_pins_bits);
__IO_REG32_BIT(GPIO3_OR,              0xE004D004,__READ_WRITE ,__gpio3_or_bits  );
__IO_REG32_BIT(GPIO3_DR,              0xE004D008,__READ_WRITE ,__gpio3_dr_bits  );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIO4_PINS,            0xE004E000,__READ       ,__gpio4_pins_bits);
__IO_REG32_BIT(GPIO4_OR,              0xE004E004,__READ_WRITE ,__gpio4_or_bits  );
__IO_REG32_BIT(GPIO4_DR,              0xE004E008,__READ_WRITE ,__gpio4_dr_bits  );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(ADC0_ACC0,               0xE00C2000,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC1,               0xE00C2004,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC2,               0xE00C2008,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC3,               0xE00C200C,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC4,               0xE00C2010,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC5,               0xE00C2014,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC6,               0xE00C2018,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC7,               0xE00C201C,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC8,               0xE00C2020,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC9,               0xE00C2024,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC10,              0xE00C2028,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC11,              0xE00C202C,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC12,              0xE00C2030,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC13,              0xE00C2034,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC14,              0xE00C2038,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_ACC15,              0xE00C203C,__READ_WRITE ,__adc_acc_bits);
__IO_REG32_BIT(ADC0_COMP0,              0xE00C2100,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP1,              0xE00C2104,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP2,              0xE00C2108,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP3,              0xE00C210C,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP4,              0xE00C2110,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP5,              0xE00C2114,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP6,              0xE00C2118,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP7,              0xE00C211C,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP8,              0xE00C2120,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP9,              0xE00C2124,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP10,             0xE00C2128,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP11,             0xE00C212C,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP12,             0xE00C2130,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP13,             0xE00C2134,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP14,             0xE00C2138,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_COMP15,             0xE00C213C,__READ_WRITE ,__adc_comp_bits);
__IO_REG32_BIT(ADC0_ACD0,               0xE00C2200,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD1,               0xE00C2204,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD2,               0xE00C2208,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD3,               0xE00C220C,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD4,               0xE00C2210,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD5,               0xE00C2214,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD6,               0xE00C2218,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD7,               0xE00C221C,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD8,               0xE00C2220,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD9,               0xE00C2224,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD10,              0xE00C2228,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD11,              0xE00C222C,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD12,              0xE00C2230,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD13,              0xE00C2234,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD14,              0xE00C2238,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_ACD15,              0xE00C223C,__READ       ,__adc_acd_bits);
__IO_REG32_BIT(ADC0_COMP_STATUS,        0xE00C2300,__READ       ,__adc_comp_status_bits);
__IO_REG32_BIT(ADC0_COMP_STATUS_CLR,    0xE00C2304,__WRITE      ,__adc_comp_status_clr_bits);
__IO_REG32_BIT(ADC0_CONFIG,             0xE00C2400,__READ_WRITE ,__adc_config_bits);
__IO_REG32_BIT(ADC0_CONTROL,            0xE00C2404,__READ_WRITE ,__adc_control_bits);
__IO_REG32_BIT(ADC0_STATUS,             0xE00C2408,__READ       ,__adc_status_bits);
__IO_REG32_BIT(ADC0_INT_CLR_ENABLE,     0xE00C2FD8,__WRITE      ,__adc_int_bits);
__IO_REG32_BIT(ADC0_INT_SET_ENABLE,     0xE00C2FDC,__WRITE      ,__adc_int_bits);
__IO_REG32_BIT(ADC0_INT_STATUS,         0xE00C2FE0,__READ       ,__adc_int_bits);
__IO_REG32_BIT(ADC0_INT_ENABLE,         0xE00C2FE4,__READ       ,__adc_int_bits);
__IO_REG32_BIT(ADC0_INT_CLR_STATUS,     0xE00C2FE8,__WRITE      ,__adc_int_bits);
__IO_REG32_BIT(ADC0_INT_SET_STATUS,     0xE00C2FEC,__WRITE      ,__adc_int_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(HCREVISION,            0xE0100000,__READ       ,__hcrevision_bits);
__IO_REG32_BIT(HCCONTROL,             0xE0100004,__READ_WRITE ,__hccontrol_bits);
__IO_REG32_BIT(HCCOMMANDSTATUS,       0xE0100008,__READ_WRITE ,__hccommandstatus_bits);
__IO_REG32_BIT(HCINTERRUPTSTATUS,     0xE010000C,__READ_WRITE ,__hcinterruptstatus_bits);
__IO_REG32_BIT(HCINTERRUPTENABLE,     0xE0100010,__READ_WRITE ,__hcinterruptenable_bits);
__IO_REG32_BIT(HCINTERRUPTDISABLE,    0xE0100014,__READ_WRITE ,__hcinterruptenable_bits);
__IO_REG32_BIT(HCHCCA,                0xE0100018,__READ_WRITE ,__hchcca_bits);
__IO_REG32_BIT(HCPERIODCURRENTED,     0xE010001C,__READ       ,__hcperiodcurrented_bits);
__IO_REG32_BIT(HCCONTROLHEADED,       0xE0100020,__READ_WRITE ,__hccontrolheaded_bits);
__IO_REG32_BIT(HCCONTROLCURRENTED,    0xE0100024,__READ_WRITE ,__hccontrolcurrented_bits);
__IO_REG32_BIT(HCBULKHEADED,          0xE0100028,__READ_WRITE ,__hcbulkheaded_bits);
__IO_REG32_BIT(HCBULKCURRENTED,       0xE010002C,__READ_WRITE ,__hcbulkcurrented_bits);
__IO_REG32_BIT(HCDONEHEAD,            0xE0100030,__READ       ,__hcdonehead_bits);
__IO_REG32_BIT(HCFMINTERVAL,          0xE0100034,__READ_WRITE ,__hcfminterval_bits);
__IO_REG32_BIT(HCFMREMAINING,         0xE0100038,__READ       ,__hcfmremaining_bits);
__IO_REG32_BIT(HCFMNUMBER,            0xE010003C,__READ       ,__hcfmnumber_bits);
__IO_REG32_BIT(HCPERIODICSTART,       0xE0100040,__READ_WRITE ,__hcperiodicstart_bits);
__IO_REG32_BIT(HCLSTHRESHOLD,         0xE0100044,__READ_WRITE ,__hclsthreshold_bits);
__IO_REG32_BIT(HCRHDESCRIPTORA,       0xE0100048,__READ_WRITE ,__hcrhdescriptora_bits);
__IO_REG32_BIT(HCRHDESCRIPTORB,       0xE010004C,__READ_WRITE ,__hcrhdescriptorb_bits);
__IO_REG32_BIT(HCRHSTATUS,            0xE0100050,__READ_WRITE ,__hcrhstatus_bits);
__IO_REG32_BIT(HCRHPORTSTATUS1,       0xE0100054,__READ_WRITE ,__hcrhportstatus_bits);
__IO_REG32_BIT(HCRHPORTSTATUS2,       0xE0100058,__READ_WRITE ,__hcrhportstatus_bits);
__IO_REG32(    HCRMID,                0xE01000FC,__READ);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(OTGINTST,              0xE0100100,__READ       ,__otgintst_bits);
__IO_REG32_BIT(OTGINTEN,              0xE0100104,__READ_WRITE ,__otgintst_bits);
__IO_REG32_BIT(OTGINTSET,             0xE0100108,__WRITE      ,__otgintst_bits);
__IO_REG32_BIT(OTGINTCLR,             0xE010010C,__WRITE      ,__otgintst_bits);
__IO_REG32_BIT(OTGSTCTRL,             0xE0100110,__READ_WRITE ,__otgstctrl_bits);
__IO_REG32_BIT(OTGTMR,                0xE0100114,__READ_WRITE ,__otgtmr_bits);
__IO_REG32_BIT(I2C_RX,                0xE0100300,__READ_WRITE ,__otg_i2c_rx_tx_bits);
#define I2C_TX      I2C_RX
#define I2C_TX_bit  I2C_RX_bit
__IO_REG32_BIT(I2C_STS,               0xE0100304,__READ_WRITE ,__otg_i2c_sts_bits);
__IO_REG32_BIT(I2C_CTL,               0xE0100308,__READ_WRITE ,__otg_i2c_ctl_bits);
__IO_REG32_BIT(I2C_CLKHI,             0xE010030C,__READ_WRITE ,__i2c_clkhi_bits);
__IO_REG32_BIT(I2C_CLKLO,             0xE0100310,__READ_WRITE ,__i2c_clklo_bits);
...
#define VIC_ADC0          16  /* ADC interrupt from ADC 0                                                    */
...
#define VIC_USB_ATX       50  /* USB ATX                                                                     */
#define VIC_USB_OTG_TMR   51  /* USB OTG timer                                                               */
