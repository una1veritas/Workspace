 ...
 **    Atmel Semiconductors AT91M42800
 **    
...
#ifndef __AT91M42800_H
#define __AT91M42800_H
 ...
 ***************************************************************************
 **                            
 **    AT91M42800 SPECIAL FUNCTION REGISTERS
 **                            
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* EBI abort address status register */
typedef struct {
  __REG32 abtadd  :32;
} __ebiaasr_bits;	
...
/* PMC status/interrupt enable/interrupt disable/interrupt mask
 register */
typedef struct {
  __REG32 lock  :1;
  __REG32       :31;
...
/* ST system timer control register */
typedef struct {
  __REG32 wdrst:1;
  __REG32      :31;
} __stcr_bits;	

/* ST system timer period interval mode register */
typedef struct {
  __REG32 piv  :16;
  __REG32      :16;
} __stpimr_bits;	

/* ST system timer watchdog mode register */
typedef struct {
  __REG32 wdv  :16;
  __REG32 rsten:1;
  __REG32 exten:1;
...
/* ST system timer real-time mode register */
typedef struct {
  __REG32 rtpres :16;
  __REG32        :16;
} __strtmr_bits;	

/* ST system timer status/interrupt enable/ interrupt disable/interrupt mask register */
typedef struct {
  __REG32 pits  :1;
  __REG32 wdovf :1;
  __REG32 rttinc:1;
...
/* ST system timer real-time alarm register */
typedef struct {
  __REG32 almv :24;
  __REG32      :8;
} __strtar_bits;	

/* ST system timer current real-time register */
typedef struct {
  __REG32 crtv :24;
  __REG32      :8;
} __stcrtr_bits;	
...
/*RESERVED: 0xffe00028, 0xffe0002c  */
__IO_REG32_BIT(__EBI_ASR,0xffe00030,__READ,__ebiasr_bits);
__IO_REG32_BIT(__EBI_AASR,0xffe00034,__READ,__ebiaasr_bits);
...
/*RESERVED: 0xffff401c */
__IO_REG32_BIT(__PMC_CGMR,0xffff4020,__READ_WRITE,__pmccgmr_bits);
/*RESERVED: 0xffff4024, 0xffff4028, 0xffff402c */
__IO_REG32_BIT(__PMC_SR,0xffff4030,__READ,__pmcir_bits);
__IO_REG32_BIT(__PMC_IER,0xffff4034,__WRITE,__pmcir_bits);
__IO_REG32_BIT(__PMC_IDR,0xffff4038,__WRITE,__pmcir_bits);
__IO_REG32_BIT(__PMC_IMR,0xffff403c,__READ,__pmcir_bits);
...
__IO_REG32_BIT(__ST_CR,0xffff8000,__WRITE,__stcr_bits);
__IO_REG32_BIT(__ST_PIMR,0xffff8004,__READ_WRITE,__stpimr_bits);
__IO_REG32_BIT(__ST_WDMR,0xffff8008,__READ_WRITE,__stwmr_bits);
__IO_REG32_BIT(__ST_RTMR,0xffff800c,__READ_WRITE,__strtmr_bits);
__IO_REG32_BIT(__ST_SR,0xffff8010,__READ,__stir_bits);
__IO_REG32_BIT(__ST_IER,0xffff8014,__WRITE,__stir_bits);
__IO_REG32_BIT(__ST_IDR,0xffff8018,__WRITE,__stir_bits);
__IO_REG32_BIT(__ST_IMR,0xffff801c,__READ,__stir_bits);
__IO_REG32_BIT(__ST_RTAR,0xffff8020,__READ_WRITE,__strtar_bits);
__IO_REG32_BIT(__ST_CRTR,0xffff8024,__READ,__stcrtr_bits);
...
/***************************************************************************
 **
 **  Serial Peripherial Interface SPIA 
 **  
 ***************************************************************************/

__IO_REG32_BIT(__SP_CR,0xfffc8000,__WRITE,__spicr_bits);
__IO_REG32_BIT(__SP_MR,0xfffc8004,__READ_WRITE,__spimr_bits);
__IO_REG32_BIT(__SP_RDR,0xfffc8008,__READ,__spirdr_bits);
__IO_REG32_BIT(__SP_TDR,0xfffc800c,__WRITE,__spitdr_bits);
__IO_REG32_BIT(__SP_SR,0xfffc8010,__READ,__spisr_bits);
__IO_REG32_BIT(__SP_IER,0xfffc8014,__WRITE,__spiir_bits);
__IO_REG32_BIT(__SP_IDR,0xfffc8018,__WRITE,__spiir_bits);
__IO_REG32_BIT(__SP_IMR,0xfffc801c,__READ,__spiir_bits);
__IO_REG32_BIT(__SP_RPR,0xfffc8020,__READ_WRITE,__spirpr_bits);
__IO_REG32_BIT(__SP_RCR,0xfffc8024,__READ_WRITE,__spircr_bits);
__IO_REG32_BIT(__SP_TPR,0xfffc8028,__READ_WRITE,__spitpr_bits);
__IO_REG32_BIT(__SP_TCR,0xfffc802c,__READ_WRITE,__spitcr_bits);
__IO_REG32_BIT(__SP_CSR0,0xfffc8030,__READ_WRITE,__spicsr_bits);
__IO_REG32_BIT(__SP_CSR1,0xfffc8034,__READ_WRITE,__spicsr_bits);
__IO_REG32_BIT(__SP_CSR2,0xfffc8038,__READ_WRITE,__spicsr_bits);
__IO_REG32_BIT(__SP_CSR3,0xfffc803c,__READ_WRITE,__spicsr_bits);


/***************************************************************************
 **
 **  Serial Peripherial Interface SPIB 
 **  
 ***************************************************************************/

__IO_REG32_BIT(__SP_CRB,0xfffcc000,__WRITE,__spicr_bits);
__IO_REG32_BIT(__SP_MRB,0xfffcc004,__READ_WRITE,__spimr_bits);
__IO_REG32_BIT(__SP_RDRB,0xfffcc008,__READ,__spirdr_bits);
__IO_REG32_BIT(__SP_TDRB,0xfffcc00c,__WRITE,__spitdr_bits);
__IO_REG32_BIT(__SP_SRB,0xfffcc010,__READ,__spisr_bits);
__IO_REG32_BIT(__SP_IERB,0xfffcc014,__WRITE,__spiir_bits);
__IO_REG32_BIT(__SP_IDRB,0xfffcc018,__WRITE,__spiir_bits);
__IO_REG32_BIT(__SP_IMRB,0xfffcc01c,__READ,__spiir_bits);
__IO_REG32_BIT(__SP_RPRB,0xfffcc020,__READ_WRITE,__spirpr_bits);
__IO_REG32_BIT(__SP_RCRB,0xfffcc024,__READ_WRITE,__spircr_bits);
__IO_REG32_BIT(__SP_TPRB,0xfffcc028,__READ_WRITE,__spitpr_bits);
__IO_REG32_BIT(__SP_TCRB,0xfffcc02c,__READ_WRITE,__spitcr_bits);
__IO_REG32_BIT(__SP_CSR0B,0xfffcc030,__READ_WRITE,__spicsr_bits);
__IO_REG32_BIT(__SP_CSR1B,0xfffcc034,__READ_WRITE,__spicsr_bits);
__IO_REG32_BIT(__SP_CSR2B,0xfffcc038,__READ_WRITE,__spicsr_bits);
__IO_REG32_BIT(__SP_CSR3B,0xfffcc03c,__READ_WRITE,__spicsr_bits);
...
/***************************************************************************
 **
 **   AT91M42800 AIC interrupt sources
 **  
 ***************************************************************************/

#define FIQ  0  /* Fast interrupt                        */
#define SW   1  /* Soft interrupt (generated by the AIC) */
#define US0  2  /* USART channel 0 interrupt             */
#define US1  3  /* USART channel 1 interrupt             */
#define SPIA 4  /* SPI channel A interrupt               */
#define SPIB 5  /* SPI channel B interrupt               */
#define TC0  6  /* Timer channel 0 interrupt             */
#define TC1  7  /* Timer channel 1 interrupt             */
#define TC2  8  /* Timer channel 2 interrupt             */
#define TC3  9  /* Timer channel 3 interrupt             */
#define TC4  10 /* Timer channel 4 interrupt             */
#define TC5  11 /* Timer channel 5 interrupt             */
#define ST   12 /* System timer interrupt                */
#define PIOA 13 /* Parallell I/O controller A interrupt  */ 
#define PIOB 14 /* Parallell I/O controller B interrupt  */
#define PMC  15 /* Power management controller interrupt */
/*16-27 reserved */
