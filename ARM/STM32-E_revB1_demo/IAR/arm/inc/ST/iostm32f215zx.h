...
#ifndef __IOSTM32F215Zx_H
#define __IOSTM32F215Zx_H
 ...
 ***************************************************************************
 **
 **   STM32F215Zx SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
/* HASH interrupt mask register (HASH_IMR) */
typedef struct {
  __REG32 DINIM           : 1;
  __REG32 DCIM            : 1;
  __REG32                 :30;
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIOF_MODER,       0x40021400,__READ_WRITE ,__gpio_moder_bits);
__IO_REG32_BIT(GPIOF_OTYPER,      0x40021404,__READ_WRITE ,__gpio_otyper_bits);
__IO_REG32_BIT(GPIOF_OSPEEDR,     0x40021408,__READ_WRITE ,__gpio_ospeedr_bits);
__IO_REG32_BIT(GPIOF_PUPDR,       0x4002140C,__READ_WRITE ,__gpio_pupdr_bits);
__IO_REG32_BIT(GPIOF_IDR,         0x40021410,__READ       ,__gpio_idr_bits);
__IO_REG32_BIT(GPIOF_ODR,         0x40021414,__READ_WRITE ,__gpio_odr_bits);
__IO_REG32_BIT(GPIOF_BSRR,        0x40021418,__WRITE      ,__gpio_bsrr_bits);
__IO_REG32_BIT(GPIOF_LCKR,        0x4002141C,__READ_WRITE ,__gpio_lckr_bits);
__IO_REG32_BIT(GPIOF_AFRL,        0x40021420,__READ_WRITE ,__gpio_afrl_bits);
__IO_REG32_BIT(GPIOF_AFRH,        0x40021424,__READ_WRITE ,__gpio_afrh_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(GPIOG_MODER,       0x40021800,__READ_WRITE ,__gpio_moder_bits);
__IO_REG32_BIT(GPIOG_OTYPER,      0x40021804,__READ_WRITE ,__gpio_otyper_bits);
__IO_REG32_BIT(GPIOG_OSPEEDR,     0x40021808,__READ_WRITE ,__gpio_ospeedr_bits);
__IO_REG32_BIT(GPIOG_PUPDR,       0x4002180C,__READ_WRITE ,__gpio_pupdr_bits);
__IO_REG32_BIT(GPIOG_IDR,         0x40021810,__READ       ,__gpio_idr_bits);
__IO_REG32_BIT(GPIOG_ODR,         0x40021814,__READ_WRITE ,__gpio_odr_bits);
__IO_REG32_BIT(GPIOG_BSRR,        0x40021818,__WRITE      ,__gpio_bsrr_bits);
__IO_REG32_BIT(GPIOG_LCKR,        0x4002181C,__READ_WRITE ,__gpio_lckr_bits);
__IO_REG32_BIT(GPIOG_AFRL,        0x40021820,__READ_WRITE ,__gpio_afrl_bits);
__IO_REG32_BIT(GPIOG_AFRH,        0x40021824,__READ_WRITE ,__gpio_afrh_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(CRYP_CR,           0x50060000,__READ_WRITE ,__cryp_cr_bits);
__IO_REG32_BIT(CRYP_SR,           0x50060004,__READ       ,__cryp_sr_bits);
__IO_REG32(    CRYP_DIN,          0x50060008,__READ_WRITE );
__IO_REG32(		 CRYP_DOUT,         0x5006000C,__READ       );
__IO_REG32_BIT(CRYP_DMACR,        0x50060010,__READ_WRITE ,__cryp_dmacr_bits);
__IO_REG32_BIT(CRYP_IMSCR,        0x50060014,__READ_WRITE ,__cryp_imscr_bits);
__IO_REG32_BIT(CRYP_RISR,         0x50060018,__READ       ,__cryp_risr_bits);
__IO_REG32_BIT(CRYP_MISR,         0x5006001C,__READ       ,__cryp_misr_bits);
__IO_REG32(    CRYP_K0LR,         0x50060020,__WRITE      );
__IO_REG32(    CRYP_K0RR,         0x50060024,__WRITE      );
__IO_REG32(    CRYP_K1LR,         0x50060028,__WRITE      );
__IO_REG32(    CRYP_K1RR,         0x5006002C,__WRITE      );
__IO_REG32(    CRYP_K2LR,         0x50060030,__WRITE      );
__IO_REG32(    CRYP_K2RR,         0x50060034,__WRITE      );
__IO_REG32(    CRYP_K3LR,         0x50060038,__WRITE      );
__IO_REG32(    CRYP_K3RR,         0x5006003C,__WRITE      );
__IO_REG32(    CRYP_IV0LR,        0x50060040,__READ_WRITE );
__IO_REG32(    CRYP_IV0RR,        0x50060044,__READ_WRITE );
__IO_REG32(    CRYP_IV1LR,        0x50060048,__READ_WRITE );
__IO_REG32(    CRYP_IV1RR,        0x5006004C,__READ_WRITE );
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(HASH_CR,           0x50060400,__READ_WRITE ,__hash_cr_bits);
__IO_REG32(    HASH_DIN,          0x50060404,__READ_WRITE );
__IO_REG32_BIT(HASH_STR,          0x50060408,__READ_WRITE ,__hash_str_bits);
__IO_REG32(    HASH_HR0,          0x5006040C,__READ       );
__IO_REG32(    HASH_HR1,          0x50060410,__READ       );
__IO_REG32(    HASH_HR2,          0x50060414,__READ       );
__IO_REG32(    HASH_HR3,          0x50060418,__READ       );
__IO_REG32(    HASH_HR4,          0x5006041C,__READ       );
__IO_REG32_BIT(HASH_IMR,          0x50060420,__READ_WRITE ,__hash_imr_bits);
__IO_REG32_BIT(HASH_SR,           0x50060424,__READ_WRITE ,__hash_sr_bits);
__IO_REG32(    HASH_CSR0,         0x500604F8,__READ_WRITE );
__IO_REG32(    HASH_CSR1,         0x500604FC,__READ_WRITE );
__IO_REG32(    HASH_CSR2,         0x50060500,__READ_WRITE );
__IO_REG32(    HASH_CSR3,         0x50060504,__READ_WRITE );
__IO_REG32(    HASH_CSR4,         0x50060508,__READ_WRITE );
__IO_REG32(    HASH_CSR5,         0x5006050C,__READ_WRITE );
__IO_REG32(    HASH_CSR6,         0x50060510,__READ_WRITE );
__IO_REG32(    HASH_CSR7,         0x50060514,__READ_WRITE );
__IO_REG32(    HASH_CSR8,         0x50060518,__READ_WRITE );
__IO_REG32(    HASH_CSR9,         0x5006051C,__READ_WRITE );
__IO_REG32(    HASH_CSR10,        0x50060520,__READ_WRITE );
__IO_REG32(    HASH_CSR11,        0x50060524,__READ_WRITE );
__IO_REG32(    HASH_CSR12,        0x50060528,__READ_WRITE );
__IO_REG32(    HASH_CSR13,        0x5006052C,__READ_WRITE );
__IO_REG32(    HASH_CSR14,        0x50060530,__READ_WRITE );
__IO_REG32(    HASH_CSR15,        0x50060534,__READ_WRITE );
__IO_REG32(    HASH_CSR16,        0x50060538,__READ_WRITE );
__IO_REG32(    HASH_CSR17,        0x5006053C,__READ_WRITE );
__IO_REG32(    HASH_CSR18,        0x50060540,__READ_WRITE );
__IO_REG32(    HASH_CSR19,        0x50060544,__READ_WRITE );
__IO_REG32(    HASH_CSR20,        0x50060548,__READ_WRITE );
__IO_REG32(    HASH_CSR21,        0x5006054C,__READ_WRITE );
__IO_REG32(    HASH_CSR22,        0x50060550,__READ_WRITE );
__IO_REG32(    HASH_CSR23,        0x50060554,__READ_WRITE );
__IO_REG32(    HASH_CSR24,        0x50060558,__READ_WRITE );
__IO_REG32(    HASH_CSR25,        0x5006055C,__READ_WRITE );
__IO_REG32(    HASH_CSR26,        0x50060560,__READ_WRITE );
__IO_REG32(    HASH_CSR27,        0x50060564,__READ_WRITE );
__IO_REG32(    HASH_CSR28,        0x50060568,__READ_WRITE );
__IO_REG32(    HASH_CSR29,        0x5006056C,__READ_WRITE );
__IO_REG32(    HASH_CSR30,        0x50060570,__READ_WRITE );
__IO_REG32(    HASH_CSR31,        0x50060574,__READ_WRITE );
__IO_REG32(    HASH_CSR32,        0x50060578,__READ_WRITE );
__IO_REG32(    HASH_CSR33,        0x5006057C,__READ_WRITE );
__IO_REG32(    HASH_CSR34,        0x50060580,__READ_WRITE );
__IO_REG32(    HASH_CSR35,        0x50060584,__READ_WRITE );
__IO_REG32(    HASH_CSR36,        0x50060588,__READ_WRITE );
__IO_REG32(    HASH_CSR37,        0x5006058C,__READ_WRITE );
__IO_REG32(    HASH_CSR38,        0x50060590,__READ_WRITE );
__IO_REG32(    HASH_CSR39,        0x50060594,__READ_WRITE );
__IO_REG32(    HASH_CSR40,        0x50060598,__READ_WRITE );
__IO_REG32(    HASH_CSR41,        0x5006059C,__READ_WRITE );
__IO_REG32(    HASH_CSR42,        0x500605A0,__READ_WRITE );
__IO_REG32(    HASH_CSR43,        0x500605A4,__READ_WRITE );
__IO_REG32(    HASH_CSR44,        0x500605A8,__READ_WRITE );
__IO_REG32(    HASH_CSR45,        0x500605AC,__READ_WRITE );
__IO_REG32(    HASH_CSR46,        0x500605B0,__READ_WRITE );
__IO_REG32(    HASH_CSR47,        0x500605B4,__READ_WRITE );
__IO_REG32(    HASH_CSR48,        0x500605B8,__READ_WRITE );
__IO_REG32(    HASH_CSR49,        0x500605BC,__READ_WRITE );
__IO_REG32(    HASH_CSR50,        0x500605C0,__READ_WRITE );
...
#define NVIC_CRYP		          	94          /* CRYP crypto global interrupt	*/
#define NVIC_HASH_RNG        		95          /* Hash and Rng global interrupt*/

#endif    /* __IOSTM32F215Zx_H */
...
Interrupt51  = TIM8_BRK_TIM12			0xEC
Interrupt52  = TIM8_UP_TIM13  		0xF0
Interrupt53  = TIM8_TRG_COM_TIM14	0xF4
Interrupt54  = TIM8_CC   					0xF8
Interrupt55  = DMA_CH7   					0xFC
Interrupt56  = FSMC   						0x100
Interrupt57  = SDIO   						0x104
Interrupt58  = TIM5           		0x108
Interrupt59  = SPI3           		0x10C
Interrupt60  = UART4          		0x110
Interrupt61  = UART5          		0x114
Interrupt62  = TIM6_DAC						0x118
Interrupt63  = TIM7           		0x11C
Interrupt64  = DMA2Ch0        		0x120
Interrupt65  = DMA2Ch1        		0x124
Interrupt66  = DMA2Ch2        		0x128
Interrupt67  = DMA2Ch3        		0x12C
Interrupt68  = DMA2Ch4        		0x130
Interrupt69  = CAN2_TX        		0x13C
Interrupt70  = CAN2_RX0       		0x140
Interrupt71  = CAN2_RX1       		0x144
Interrupt72  = CAN2_SCE       		0x148
Interrupt73  = DMA2_CH5       		0x150
Interrupt74  = DMA2_CH6       		0x154
Interrupt75  = DMA2_CH7       		0x158
Interrupt76  = USART6         		0x15C
Interrupt77  = I2C3_EV        		0x160
Interrupt78  = I2C3_ER        		0x164
Interrupt79  = OTG_HS_EP1_OUT			0x168
Interrupt80  = OTG_HS_EP1_IN  		0x16C
Interrupt81  = OTG_HS_WKUP				0x170
Interrupt82  = OTG_HS         		0x174
Interrupt83  = CRYP           		0x17C
Interrupt84  = HASH_RNG						0x180
