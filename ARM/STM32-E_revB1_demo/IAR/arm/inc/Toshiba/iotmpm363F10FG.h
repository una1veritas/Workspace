...
#ifndef __IOTMPM363F10FG_H
#define __IOTMPM363F10FG_H
 ...
 ***************************************************************************
 **
 **    TMPM363F10FG SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(HcRevision,          0x40003000, __READ       , __hcrevision_bits);
__IO_REG32_BIT(HcControl,           0x40003004, __READ_WRITE , __hccontrol_bits);
__IO_REG32_BIT(HcCommandStatus,     0x40003008, __READ_WRITE , __hccommandstatus_bits);
__IO_REG32_BIT(HcInterruptStatus,   0x4000300C, __READ_WRITE , __hcinterruptstatus_bits);
__IO_REG32_BIT(HcInterruptEnable,   0x40003010, __READ_WRITE , __hcinterruptenable_bits);
__IO_REG32_BIT(HcInterruptDisable,  0x40003014, __READ_WRITE , __hcinterruptenable_bits);
__IO_REG32(    HcHCCA,              0x40003018, __READ_WRITE );
__IO_REG32(    HcPeriodCurrentED,   0x4000301C, __READ_WRITE );
__IO_REG32(    HcControlHeadED,     0x40003020, __READ_WRITE );
__IO_REG32(    HcControlCurrentED,  0x40003024, __READ_WRITE );
__IO_REG32(    HcBulkHeadED,        0x40003028, __READ_WRITE );
__IO_REG32(    HcBulkCurrentED,     0x4000302C, __READ_WRITE );
__IO_REG32(    HcDoneHead,          0x40003030, __READ_WRITE );
__IO_REG32_BIT(HcFmInterval,        0x40003034, __READ_WRITE , __hcfminterval_bits);
__IO_REG32_BIT(HcFmRemaining,       0x40003038, __READ_WRITE , __hcfmremaining_bits);
__IO_REG32_BIT(HcFmNumber,          0x4000303C, __READ_WRITE , __hcfmnumber_bits);
__IO_REG32_BIT(HcPeriodStart,       0x40003040, __READ_WRITE , __hcperiodstart_bits);
__IO_REG32_BIT(HcLSThreshold,       0x40003044, __READ_WRITE , __hclsthreshold_bits);
__IO_REG32_BIT(HcRhDescriptorA,     0x40003048, __READ_WRITE , __hcrhdescriptora_bits);
__IO_REG32_BIT(HcRhDescriptorB,     0x4000304C, __READ_WRITE , __hcrhdescriptorb_bits);
__IO_REG32_BIT(HcRhStatus,          0x40003050, __READ_WRITE , __hcrhstatus_bits);
__IO_REG32_BIT(HcRhPortStatus,      0x40003054, __READ_WRITE , __hcrhportstatus_bits);
__IO_REG32_BIT(HcBCR0,              0x40003080, __READ_WRITE , __hcbcr0_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(CANMB0ID,            0x40002000, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB0TSVMCF,        0x40002008, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB0DH,            0x40002010, __READ_WRITE );
__IO_REG32(    CANMB0DL,            0x40002018, __READ_WRITE );
__IO_REG32_BIT(CANMB1ID,            0x40002020, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB1TSVMCF,        0x40002028, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB1DH,            0x40002030, __READ_WRITE );
__IO_REG32(    CANMB1DL,            0x40002038, __READ_WRITE );
__IO_REG32_BIT(CANMB2ID,            0x40002040, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB2TSVMCF,        0x40002048, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB2DH,            0x40002050, __READ_WRITE );
__IO_REG32(    CANMB2DL,            0x40002058, __READ_WRITE );
__IO_REG32_BIT(CANMB3ID,            0x40002060, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB3TSVMCF,        0x40002068, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB3DH,            0x40002070, __READ_WRITE );
__IO_REG32(    CANMB3DL,            0x40002078, __READ_WRITE );
__IO_REG32_BIT(CANMB4ID,            0x40002080, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB4TSVMCF,        0x40002088, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB4DH,            0x40002090, __READ_WRITE );
__IO_REG32(    CANMB4DL,            0x40002098, __READ_WRITE );
__IO_REG32_BIT(CANMB5ID,            0x400020A0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB5TSVMCF,        0x400020A8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB5DH,            0x400020B0, __READ_WRITE );
__IO_REG32(    CANMB5DL,            0x400020B8, __READ_WRITE );
__IO_REG32_BIT(CANMB6ID,            0x400020C0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB6TSVMCF,        0x400020C8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB6DH,            0x400020D0, __READ_WRITE );
__IO_REG32(    CANMB6DL,            0x400020D8, __READ_WRITE );
__IO_REG32_BIT(CANMB7ID,            0x400020E0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB7TSVMCF,        0x400020E8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB7DH,            0x400020F0, __READ_WRITE );
__IO_REG32(    CANMB7DL,            0x400020F8, __READ_WRITE );
__IO_REG32_BIT(CANMB8ID,            0x40002100, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB8TSVMCF,        0x40002108, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB8DH,            0x40002110, __READ_WRITE );
__IO_REG32(    CANMB8DL,            0x40002118, __READ_WRITE );
__IO_REG32_BIT(CANMB9ID,            0x40002120, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB9TSVMCF,        0x40002128, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB9DH,            0x40002130, __READ_WRITE );
__IO_REG32(    CANMB9DL,            0x40002138, __READ_WRITE );
__IO_REG32_BIT(CANMB10ID,           0x40002140, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB10TSVMCF,       0x40002148, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB10DH,           0x40002150, __READ_WRITE );
__IO_REG32(    CANMB10DL,           0x40002158, __READ_WRITE );
__IO_REG32_BIT(CANMB11ID,           0x40002160, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB11TSVMCF,       0x40002168, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB11DH,           0x40002170, __READ_WRITE );
__IO_REG32(    CANMB11DL,           0x40002178, __READ_WRITE );
__IO_REG32_BIT(CANMB12ID,           0x40002180, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB12TSVMCF,       0x40002188, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB12DH,           0x40002190, __READ_WRITE );
__IO_REG32(    CANMB12DL,           0x40002198, __READ_WRITE );
__IO_REG32_BIT(CANMB13ID,           0x400021A0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB13TSVMCF,       0x400021A8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB13DH,           0x400021B0, __READ_WRITE );
__IO_REG32(    CANMB13DL,           0x400021B8, __READ_WRITE );
__IO_REG32_BIT(CANMB14ID,           0x400021C0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB14TSVMCF,       0x400021C8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB14DH,           0x400021D0, __READ_WRITE );
__IO_REG32(    CANMB14DL,           0x400021D8, __READ_WRITE );
__IO_REG32_BIT(CANMB15ID,           0x400021E0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB15TSVMCF,       0x400021E8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB15DH,           0x400021F0, __READ_WRITE );
__IO_REG32(    CANMB15DL,           0x400021F8, __READ_WRITE );
__IO_REG32_BIT(CANMB16ID,           0x40002200, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB16TSVMCF,       0x40002208, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB16DH,           0x40002210, __READ_WRITE );
__IO_REG32(    CANMB16DL,           0x40002218, __READ_WRITE );
__IO_REG32_BIT(CANMB17ID,           0x40002220, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB17TSVMCF,       0x40002228, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB17DH,           0x40002230, __READ_WRITE );
__IO_REG32(    CANMB17DL,           0x40002238, __READ_WRITE );
__IO_REG32_BIT(CANMB18ID,           0x40002240, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB18TSVMCF,       0x40002248, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB18DH,           0x40002250, __READ_WRITE );
__IO_REG32(    CANMB18DL,           0x40002258, __READ_WRITE );
__IO_REG32_BIT(CANMB19ID,           0x40002260, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB19TSVMCF,       0x40002268, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB19DH,           0x40002270, __READ_WRITE );
__IO_REG32(    CANMB19DL,           0x40002278, __READ_WRITE );
__IO_REG32_BIT(CANMB20ID,           0x40002280, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB20TSVMCF,       0x40002288, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB20DH,           0x40002290, __READ_WRITE );
__IO_REG32(    CANMB20DL,           0x40002298, __READ_WRITE );
__IO_REG32_BIT(CANMB21ID,           0x400022A0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB21TSVMCF,       0x400022A8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB21DH,           0x400022B0, __READ_WRITE );
__IO_REG32(    CANMB21DL,           0x400022B8, __READ_WRITE );
__IO_REG32_BIT(CANMB22ID,           0x400022C0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB22TSVMCF,       0x400022C8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB22DH,           0x400022D0, __READ_WRITE );
__IO_REG32(    CANMB22DL,           0x400022D8, __READ_WRITE );
__IO_REG32_BIT(CANMB23ID,           0x400022E0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB23TSVMCF,       0x400022E8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB23DH,           0x400022F0, __READ_WRITE );
__IO_REG32(    CANMB23DL,           0x400022F8, __READ_WRITE );
__IO_REG32_BIT(CANMB24ID,           0x40002300, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB24TSVMCF,       0x40002308, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB24DH,           0x40002310, __READ_WRITE );
__IO_REG32(    CANMB24DL,           0x40002318, __READ_WRITE );
__IO_REG32_BIT(CANMB25ID,           0x40002320, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB25TSVMCF,       0x40002328, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB25DH,           0x40002330, __READ_WRITE );
__IO_REG32(    CANMB25DL,           0x40002338, __READ_WRITE );
__IO_REG32_BIT(CANMB26ID,           0x40002340, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB26TSVMCF,       0x40002348, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB26DH,           0x40002350, __READ_WRITE );
__IO_REG32(    CANMB26DL,           0x40002358, __READ_WRITE );
__IO_REG32_BIT(CANMB27ID,           0x40002360, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB27TSVMCF,       0x40002368, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB27DH,           0x40002370, __READ_WRITE );
__IO_REG32(    CANMB27DL,           0x40002378, __READ_WRITE );
__IO_REG32_BIT(CANMB28ID,           0x40002380, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB28TSVMCF,       0x40002388, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB28DH,           0x40002390, __READ_WRITE );
__IO_REG32(    CANMB28DL,           0x40002398, __READ_WRITE );
__IO_REG32_BIT(CANMB29ID,           0x400023A0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB29TSVMCF,       0x400023A8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB29DH,           0x400023B0, __READ_WRITE );
__IO_REG32(    CANMB29DL,           0x400023B8, __READ_WRITE );
__IO_REG32_BIT(CANMB30ID,           0x400023C0, __READ_WRITE , __canmbid_bits);
__IO_REG32_BIT(CANMB30TSVMCF,       0x400023C8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB30DH,           0x400023D0, __READ_WRITE );
__IO_REG32(    CANMB30DL,           0x400023D8, __READ_WRITE );
__IO_REG32_BIT(CANMB31ID,           0x400023E0, __READ_WRITE , __canmb31id_bits);
__IO_REG32_BIT(CANMB31TSVMCF,       0x400023E8, __READ_WRITE , __canmbtcr_bits);
__IO_REG32(    CANMB31DH,           0x400023F0, __READ_WRITE );
__IO_REG32(    CANMB31DL,           0x400023F8, __READ_WRITE );
__IO_REG32_BIT(CANMC,               0x40002400, __READ_WRITE , __canmc_bits);
__IO_REG32_BIT(CANMD,               0x40002408, __READ_WRITE , __canmd_bits);
__IO_REG32_BIT(CANTRS,              0x40002410, __READ_WRITE , __cantrs_bits);
__IO_REG32_BIT(CANTRR,              0x40002418, __READ_WRITE , __cantrr_bits);
__IO_REG32_BIT(CANTA,               0x40002420, __READ_WRITE , __canta_bits);
__IO_REG32_BIT(CANAA,               0x40002428, __READ_WRITE , __canaa_bits);
__IO_REG32_BIT(CANRMP,              0x40002430, __READ_WRITE , __canrmp_bits);
__IO_REG32_BIT(CANRML,              0x40002438, __READ_WRITE , __canrml_bits);
__IO_REG32_BIT(CANLAM,              0x40002440, __READ_WRITE , __canlam_bits);
__IO_REG32_BIT(CANGAM,              0x40002448, __READ_WRITE , __cangam_bits);
__IO_REG32_BIT(CANMCR,              0x40002450, __READ_WRITE , __canmcr_bits);
__IO_REG32_BIT(CANGSR,              0x40002458, __READ       , __cangsr_bits);
__IO_REG32_BIT(CANBCR1,             0x40002460, __READ_WRITE , __canbcr1_bits);
__IO_REG32_BIT(CANBCR2,             0x40002468, __READ_WRITE , __canbcr2_bits);
__IO_REG32_BIT(CANGIF,              0x40002470, __READ_WRITE , __cangif_bits);
__IO_REG32_BIT(CANGIM,              0x40002478, __READ_WRITE , __cangim_bits);
__IO_REG32_BIT(CANMBTIF,            0x40002480, __READ_WRITE , __canmbtif_bits);
__IO_REG32_BIT(CANMBRIF,            0x40002488, __READ_WRITE , __canmbrif_bits);
__IO_REG32_BIT(CANMBIM,             0x40002490, __READ_WRITE , __canmbim_bits);
__IO_REG32_BIT(CANCDR,              0x40002498, __READ_WRITE , __cancdr_bits);
__IO_REG32_BIT(CANRFP,              0x400024A0, __READ_WRITE , __canrfp_bits);
__IO_REG32_BIT(CANCEC,              0x400024A8, __READ       , __cancec_bits);
__IO_REG32_BIT(CANTSP,              0x400024B0, __READ_WRITE , __cantsp_bits);
__IO_REG32_BIT(CANTSC,              0x400024B8, __READ_WRITE , __cantsc_bits);
...
#define INT_USB              (56 + EII)   /* USB                           */
#define INT_CANSTA           (57 + EII)   /* CAN Status                    */
...
#define INT_CANRX            (78 + EII)   /* CAN Reception                 */
#define INT_CANTX            (79 + EII)   /* CAN Transmission              */
...
Interrupt17  = INTRX0         0x80
Interrupt18  = INTTX0         0x84
Interrupt19  = INTRX1         0x88
Interrupt20  = INTTX1         0x8C
Interrupt21  = INTRX2         0x90
Interrupt22  = INTTX2         0x94
Interrupt23  = INTRX3         0x98
Interrupt24  = INTTX3         0x9C
Interrupt25  = INTRX4         0xA0
Interrupt26  = INTTX4         0xA4
Interrupt27  = INTSBI0        0xA8
Interrupt28  = INTSBI1        0xAC
Interrupt29  = INTCECRX       0xB0
Interrupt30  = INTCECTX       0xB4
Interrupt31  = INTAINTRMCRX0  0xB8
Interrupt32  = INTRTC         0xC0
Interrupt33  = INTKWUP        0xC4
Interrupt34  = INTSBI2        0xC8
Interrupt35  = INTSBI3        0xCC
Interrupt36  = INTADHP        0xD4
Interrupt37  = INTADM0        0xD8
Interrupt38  = INTADM1        0xDC
Interrupt39  = INTTB0         0xE0
Interrupt40  = INTTB1         0xE4
Interrupt41  = INTTB2         0xE8
Interrupt42  = INTTB3         0xEC
Interrupt43  = INTTB4         0xF0
Interrupt44  = INTTB5         0xF4
Interrupt45  = INTTB6         0xF8
Interrupt46  = INTTB7         0xFC
Interrupt47  = INTTB8         0x100
Interrupt48  = INTTB9         0x104
Interrupt49  = INTTBA         0x108
Interrupt50  = INTTBB         0x10C
Interrupt51  = INTTBC         0x110
Interrupt52  = INTTBD         0x114
Interrupt53  = INTTBE         0x118
Interrupt54  = INTTBF         0x11C
Interrupt55  = INTUSB         0x120
Interrupt56  = INTCANSTA      0x124
Interrupt57  = INTAD          0x128
Interrupt58  = INTSSP0        0x12C
Interrupt59  = INTCAP10       0x168
Interrupt60  = INTCAP11       0x16C
Interrupt61  = INTCAP20       0x170
Interrupt62  = INTCAP21       0x174
Interrupt63  = INTCANRX       0x178
Interrupt64  = INTCANTX       0x17C
Interrupt65  = INTCAP50       0x180
Interrupt66  = INTCAP51       0x184
Interrupt67  = INTCAP60       0x188
Interrupt68  = INTCAP61       0x18C
Interrupt69  = INTCAP70       0x190
Interrupt70  = INTCAP71       0x194
Interrupt71  = INTCAP90       0x198
Interrupt72  = INTCAP91       0x19C
Interrupt73  = INTCAPA0       0x1A0
Interrupt74  = INTCAPA1       0x1A4
Interrupt75  = INTCAPB0       0x1A8
Interrupt76  = INTCAPB1       0x1AC
Interrupt77  = INTCAPD0       0x1B0
Interrupt78  = INTCAPD1       0x1B4
Interrupt79  = INTCAPE0       0x1B8
Interrupt80  = INTCAPE1       0x1BC
Interrupt81  = INTCAPF0       0x1C0
Interrupt82  = INTCAPF1       0x1C4
Interrupt83  = INTDMACERR     0x1C8
Interrupt84  = INTDMACTC0     0x1CC
