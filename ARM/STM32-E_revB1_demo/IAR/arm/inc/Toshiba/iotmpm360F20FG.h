...
#ifndef __IOTMPM360F20FG_H
#define __IOTMPM360F20FG_H
 ...
 ***************************************************************************
 **
 **    TMPM360F20FG SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(RCWAIT,              0x41FFF058,__READ_WRITE ,__rcwait_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(FCSECBITF0,          0x41FFF010, __READ_WRITE , __secbit_bits);
__IO_REG32_BIT(FCSECBITF1,          0x41FFF018, __READ_WRITE , __secbit_bits);
__IO_REG32_BIT(FCFLCSF0,            0x41FFF020, __READ       , __flcs_bits);
__IO_REG32_BIT(FCFLCSF1,            0x41FFF030, __READ       , __flcs_bits);
